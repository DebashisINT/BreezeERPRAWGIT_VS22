...
namespace BusinessLogicLayer
{
    ...
    public class SlaesActivitiesBL
    {
        ...
        public DataTable PopulateMultipleContactPersonOfCustomer(string InternalId)
        {
            DataTable ds = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_SalesActivity");
            proc.AddVarcharPara("@Action", 100, "PopulateMultipleContactPersonOfCustomer");
            proc.AddVarcharPara("@InternalId", 100, InternalId);
            ds = proc.GetTable();
            return ds;
        }
        ...
        public DataTable GetConatctReferenceSalesManInfoInvoice(string KeyVal)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_SalesOrder_Details");
            proc.AddVarcharPara("@Action", 100, "GetSalesManHistoryForInvoice");
            proc.AddVarcharPara("@BillNumber", 50, KeyVal);
            dt = proc.GetTable();
            return dt;
        }
        ...
        public DataTable GetRateDetails(string productid)
        {
            ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesOrder");
            proc.AddVarcharPara("@Action", 100, "LastSalesRate");
            proc.AddVarcharPara("@ProdID", 100, productid);
            return proc.GetTable();
        }
        ...
        public DataSet GetCustomerDetails_CDRelated(string strCustomerID)
        {
            DataSet dt = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("prc_SalesActivity");
            proc.AddVarcharPara("@Action", 100, "GetCustomerDetails");
            proc.AddVarcharPara("@InternalId", 1000, strCustomerID);
            dt = proc.GetDataSet();
            return dt;
        }
        ...
        public DataTable GetInquiryOnSalesQuotation(string customer, string OrderDate, string Status, Int32 BranchId, string Inventory)
        {
            ...
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_GetInquiryOnSalesQuotation");
        ...
        public DataTable GetQuotationAndInquiryDetailsFromSalesOrder(string mode, string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
            proc.AddVarcharPara("@Mode", 200, mode);
            proc.AddVarcharPara("@Quote_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@QuoteDetails_Id", 1000, Order_Key);
            proc.AddVarcharPara("@Product_Id", 1000, Product_Ids);
            proc.AddVarcharPara("@Action", 10, Action);
        ...
        public DataSet GetInquriydetailsfromSalesOrdertagged(string mode, string Quote_Nos, string Order_Key, string Product_Ids, string Action)
         {   
            DataSet ds=new DataSet();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetInquiryDetailsFromSalesOrder");
            proc.AddVarcharPara("@Mode", 200, mode);
            proc.AddVarcharPara("@Quote_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@QuoteDetails_Id", 1000, Order_Key);
            proc.AddVarcharPara("@Product_Id", 1000, Product_Ids);
        ...
        // Rev Sanchita
        public DataSet GetInquriydetailsfromSalesOrdertagged_New(string mode, string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataSet ds = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetInquiryDetailsFromSalesOrder");
            proc.AddVarcharPara("@Mode", 200, mode);
        ...
        public DataSet GetInquriydetailsfromServiceContracttagged(string mode, string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataSet ds = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetInquiryDetailsFromServiceContract");
            proc.AddVarcharPara("@Mode", 200, mode);
            proc.AddVarcharPara("@Quote_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@QuoteDetails_Id", 1000, Order_Key);
            proc.AddVarcharPara("@Product_Id", 1000, Product_Ids);
        ...
        public DataSet GetInquiryDetailsFromSalesOrder(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataSet ds = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
            proc.AddVarcharPara("@Mode", 200, "GetProjectInquiryTagInProjectOrder");
            proc.AddVarcharPara("@Quote_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@QuoteDetails_Id", 1000, Order_Key);
            proc.AddVarcharPara("@Product_Id", 1000, Product_Ids);
            proc.AddVarcharPara("@Action", 10, Action);
        ...
        public DataTable GetInquiryDetailsFromSalesQuotation(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataTable DT = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
            proc.AddVarcharPara("@Mode", 100, "GetInquiryDetailsFromSalesOrder");
        ...
        public DataSet GetInquirytaggingDetailsFromSalesQuotation(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataSet DT = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationtaggingDetails");
            proc.AddVarcharPara("@Mode", 100, "GetInquiryDetailsFromSalesOrder");
        ...
        public DataSet GetProjectInquiryDetailsFromSalesQuotation(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataSet DT = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetProjectInquiryQuotationDetails");
            proc.AddVarcharPara("@Mode", 100, "GetInquiryDetailsFromSalesOrder");
        ...
        public DataTable GetQuotationMultiUOM(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
            proc.AddVarcharPara("@Mode", 100, "GetQuotationWiseMultiPleUOM");
            proc.AddVarcharPara("@Quote_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@Product_Id", 1000, Product_Ids);
            proc.AddVarcharPara("@Action", 10, Action);
            dt = proc.GetTable();
        ...
        // Rev Sanchita
        public DataTable GetQuotationMultiUOM_New(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
            proc.AddVarcharPara("@Mode", 100, "GetQuotationWiseMultiPleUOM_New");
            proc.AddVarcharPara("@Quote_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@Product_Id", 1000, Product_Ids);
            proc.AddVarcharPara("@Action", 10, Action);
            dt = proc.GetTable();
        ...
        // End of Rev Sanchita
        public DataTable GetQuotationFromInquiryMultiUOM(string SelectedComponentList)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
            proc.AddVarcharPara("@Action", 500, "GetQuotationFromInquiryMultiUOM");
        ...
        public DataSet GetInquirytaggingDetailsFromSalesQuotation_New(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataSet DT = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationtaggingDetails");
            proc.AddVarcharPara("@Mode", 100, "GetInquiryDetailsFromSalesOrder_New");
        ...
        public DataTable GetQuotationFromInquiryMultiUOM_New(string SelectedComponentList)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
            proc.AddVarcharPara("@Action", 500, "GetQuotationFromInquiryMultiUOM_New");
            proc.AddVarcharPara("@SelectedComponentList", 2000, SelectedComponentList);
            // proc.AddVarcharPara("@InvoiceID", 20, InvoiceID);
            dt = proc.GetTable();
            return dt;
        ...
        public DataTable GetQuotationFromInquiryMultiUOM_ECS(string SelectedComponentList)
        {
            DataTable dt = new DataTable();
        ...
        public DataSet GetQuotationDetailsFromProjectOrder(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataSet ds = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetProjectQuotationDetails");
            proc.AddVarcharPara("@Mode", 100, "GetQuotationDetailsFromProjectOrder");
            proc.AddVarcharPara("@Quote_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@QuoteDetails_Id", 1000, Order_Key);
            proc.AddVarcharPara("@Product_Id", 1000, Product_Ids);
            proc.AddVarcharPara("@Action", 10, Action);
        ...
        public DataSet GetQuotationDetailsFromProjectOrderWithDuplicateProduct(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataSet ds = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetProjectQuotationDetails");
            proc.AddVarcharPara("@Mode", 100, "GetQuotationDetailsFromProjectOrderDuplicateProduct");
            proc.AddVarcharPara("@Quote_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@QuoteDetails_Id", 1000, Order_Key);
            proc.AddVarcharPara("@Product_Id", 1000, Product_Ids);
            proc.AddVarcharPara("@Action", 10, Action);
        ...
        public DataSet GetInqandQuotationDetailsFromProjectOrderWithDuplicateProduct(string mode,string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            DataSet ds = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetProjectQuotationDetails");
            proc.AddVarcharPara("@Mode", 100, "GetQuotationDetailsFromProjectOrderDuplicateProduct");
        ...
        public DataTable GetInquiryDetailsFromSalesOrderonly(string Quote_Nos, string Order_Key, string Product_Ids)
        {
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
            proc.AddVarcharPara("@Mode", 100, "GetInquiryDetailsOnly");
            proc.AddVarcharPara("@Quote_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@OrderID_Key", 1000, Order_Key);
            return proc.GetTable();
        }
        ...
        public DataTable GetDocumentDetailsFromSalesOrderonly(string Mode,string Quote_Nos, string Order_Key, string Product_Ids)
        {
            ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
        ...
        public DataTable GetDocumentDetailsFromServiceContractonly(string Mode, string Quote_Nos, string Order_Key, string Product_Ids)
        {
            ProcedureExecute proc = new ProcedureExecute("Prc_GetServiceContractDetails");
            proc.AddVarcharPara("@Mode", 100, Mode);
            proc.AddVarcharPara("@Quote_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@OrderID_Key", 1000, Order_Key);
            return proc.GetTable();
        ...
        public DataTable GetCustomerOutstandingAmount(string Datetime, string CustomerId, string BranchId)
        {
            ProcedureExecute proc = new ProcedureExecute("PRC_PARTYWISEOUTSTANDINGENTRY_REPORT");
            proc.AddVarcharPara("@COMPANYID", 100, Convert.ToString(HttpContext.Current.Session["LastCompany"]));
            proc.AddVarcharPara("@FINYEAR", 4000, Convert.ToString(HttpContext.Current.Session["LastFinYear"]));
            proc.AddVarcharPara("@ASONDATE", 1000, Datetime);
            proc.AddVarcharPara("@BRANCHID", 4000, "");
            proc.AddVarcharPara("@PARTY_CODE", 1000, CustomerId);
            proc.AddVarcharPara("@PARTY_TYPE", 4000, "C");
            //proc.AddIntegerPara("@INCLUDECB", 0);
            //proc.AddIntegerPara("@INCLUDEJV", 0);
            proc.AddIntegerPara("@INCLUDECB", 1);
            proc.AddIntegerPara("@INCLUDEJV", 1);
            return proc.GetTable();
        }

        public DataTable GetCustomerOutstandingRecords(string Datetime,string CustomerId, string BranchId)
        {
            ProcedureExecute proc = new ProcedureExecute("PRC_PARTYWISEOUTSTANDINGDET_REPORT");
            proc.AddVarcharPara("@COMPANYID", 100, Convert.ToString(HttpContext.Current.Session["LastCompany"]));
            proc.AddVarcharPara("@FINYEAR", 4000, Convert.ToString(HttpContext.Current.Session["LastFinYear"]));
            proc.AddVarcharPara("@ASONDATE", 1000, Datetime);
            proc.AddVarcharPara("@ONDATE", 100, "B");
            proc.AddIntegerPara("@DUEDATE", 1);
            proc.AddIntegerPara("@ALLPARTY", 0);
            proc.AddIntegerPara("@PRINTDAYS", 1);
            proc.AddIntegerPara("@SHOWSALESMAN", 1);
            proc.AddVarcharPara("@BRANCHID", 4000, "");
            proc.AddVarcharPara("@PARTY_CODE", 1000, CustomerId);
            proc.AddVarcharPara("@PARTY_TYPE", 4000, "C");
            //proc.AddIntegerPara("@INCLUDECB",0);
            ...
            proc.AddIntegerPara("@INCLUDECB", 1);
            proc.AddIntegerPara("@INCLUDEJV", 1);
            proc.AddIntegerPara("@EXCLUDEDNCN", 0);
        ...
        // Rev Sanchita
        public DataTable GetSalesOrderDetailsFromSalesChallan_New(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            ProcedureExecute proc = new ProcedureExecute("Prc_GetOrderDetailsForSaleChallan");
            proc.AddVarcharPara("@Mode", 100, "GetOrderInfoFromChallanToBindBatchGrid_New");
            proc.AddVarcharPara("@Order_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@ORder_Details_Id", 1000, Order_Key);
            proc.AddVarcharPara("@Product_Id", 1000, Product_Ids);
            proc.AddVarcharPara("@Action", 10, Action);
        ...
        public DataSet TaggedInvoiceFromSalesChallan(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            ProcedureExecute proc = new ProcedureExecute("Prc_TaggedInvoiceForSaleChallan");
            proc.AddVarcharPara("@Mode", 100, "GetOrderInfoFromChallanToBindBatchGrid");
            proc.AddVarcharPara("@Order_Id", 4000, Quote_Nos);
            proc.AddVarcharPara("@ORder_Details_Id", 1000, Order_Key);
            proc.AddVarcharPara("@Product_Id", 1000, Product_Ids);
        ...
        //End
        public DataTable GetSalesInvoiceMultiUOMFromSalesChallan(string Quote_Nos, string Order_Key, string Product_Ids)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetSalesInvoiceForSaleChallan");
            proc.AddVarcharPara("@Mode", 100, "GetSalesInvoiceMultiUOMDetails");
            proc.AddVarcharPara("@SelectedQuotationtList", 4000, Quote_Nos);
        ...
        // Rev Sanchita
        public DataSet TaggedInvoiceFromSalesChallan_New(string Quote_Nos, string Order_Key, string Product_Ids, string Action)
        {
            ProcedureExecute proc = new ProcedureExecute("Prc_TaggedInvoiceForSaleChallan");
            proc.AddVarcharPara("@Mode", 100, "GetOrderInfoFromChallanToBindBatchGrid_New");
            proc.AddVarcharPara("@Order_Id", 4000, Quote_Nos);
        ...
        public DataTable GetSalesInvoiceMultiUOMFromSalesChallan_New(string Quote_Nos, string Order_Key, string Product_Ids)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("Prc_GetSalesInvoiceForSaleChallan");
            proc.AddVarcharPara("@Mode", 100, "GetSalesInvoiceMultiUOMDetails_New");
            proc.AddVarcharPara("@SelectedQuotationtList", 4000, Quote_Nos);
            proc.AddVarcharPara("@SelectedQuotationtdetailsList", 1000, Order_Key);
            proc.AddVarcharPara("@SelectedProductList", 1000, Product_Ids);
            dt = proc.GetTable();
        ...
        public DataSet GetSalesActvityViewDetails(string ActivityId)
        {
          ...
          public DataTable GetQuotationDate(string Quote_Nos)
          {
              ...
              proc.AddVarcharPara("@Mode", 100, "GetProjectQuotationDate");

              return proc.GetTable();
          }
          public DataTable GetSalesInquiryDate(string Quote_Nos)
          {
              ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
              proc.AddVarcharPara("@Quote_Number", 100, Quote_Nos);
          ...
          public DataTable GetInquiryDate(string Quote_Nos)
          {
              ProcedureExecute proc = new ProcedureExecute("Prc_GetQuotationDetails");
              proc.AddVarcharPara("@Quote_Number", 100, Quote_Nos);
          ...
          public DataTable GetNumberingSchemaForPurchaseInvChallan(string strCompanyID, string strBranchID, string strFinYear, string strType, string strIsSplit)
          {
              DataTable ds = new DataTable();
              ProcedureExecute proc = new ProcedureExecute("prc_SalesActivity");
              proc.AddVarcharPara("@Action", 100, "GetNumberingSchemaForPurchaseInvChallan");
              proc.AddVarcharPara("@CompanyID", 100, strCompanyID);
              //proc.AddVarcharPara("@BranchID", 100, strBranchID);
              proc.AddVarcharPara("@BranchID", 4000, strBranchID);
              proc.AddVarcharPara("@FinYear", 100, strFinYear);
          ...
          public DataTable GetNumberingSchemaWithSo(string strCompanyID, string strBranchID, string strFinYear, string strType, string strIsSplit, string strInvoiceID)
          {
              DataTable ds = new DataTable();
              ProcedureExecute proc = new ProcedureExecute("prc_SalesActivity");
              proc.AddVarcharPara("@Action", 100, "GetNumberingSchemaWithSO");
              proc.AddVarcharPara("@CompanyID", 100, strCompanyID);
              //proc.AddVarcharPara("@BranchID", 100, strBranchID);
              proc.AddVarcharPara("@BranchID", 4000, strBranchID);
              proc.AddVarcharPara("@FinYear", 100, strFinYear);
              proc.AddVarcharPara("@Type", 100, strType);
              proc.AddVarcharPara("@IsSplit", 100, strIsSplit);
              proc.AddBigIntegerPara("@SalesOrderId", Convert.ToInt64(strInvoiceID));
              ds = proc.GetTable();
              return ds;
          }
          public DataTable GetNumberingSchemaSalesInquiry(string strCompanyID, string strBranchID, string strFinYear, string strType, string strIsSplit)
          {
              DataTable ds = new DataTable();
              ProcedureExecute proc = new ProcedureExecute("prc_SalesActivity");
              proc.AddVarcharPara("@Action", 100, "GetNumberingSchemaForInquiry");
              proc.AddVarcharPara("@CompanyID", 100, strCompanyID);
              //proc.AddVarcharPara("@BranchID", 100, strBranchID);
              proc.AddVarcharPara("@BranchID", 4000, strBranchID);
              proc.AddVarcharPara("@FinYear", 100, strFinYear);
          ...
          public string GetFeedbackNote(string DetailsId,string Tid)
          {
              string FeedbackNote = string.Empty;
              DataTable dt = new DataTable();
              ProcedureExecute proc = new ProcedureExecute("prc_SalesActivity");
              proc.AddVarcharPara("@action", 100, "GetFeedbackNote");
              proc.AddVarcharPara("@DetailsId", 200, DetailsId);
              proc.AddVarcharPara("@TId", 10, Tid);
              dt = proc.GetTable();
              if (dt != null && dt.Rows.Count > 0)
              {
                  FeedbackNote = Convert.ToString(dt.Rows[0]["Note"]);
          ...
          public DataTable GetsalesActivity(string cnt_internalId, string ActivityTypeId, string FromDate, string ToDate)
          {
              DataTable dt = new DataTable();
              ProcedureExecute proc = new ProcedureExecute("sp_Sales");
              proc.AddVarcharPara("@Mode", 50, "GetSalesActivityDetails");
              proc.AddVarcharPara("@cnt_internalId", 100, cnt_internalId);
              proc.AddVarcharPara("@ActivityTypeId", 50, ActivityTypeId);
