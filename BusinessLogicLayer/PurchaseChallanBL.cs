...
namespace BusinessLogicLayer
{
    public class PurchaseChallanBL
    {
                    ...
                    , string TransporterDocDate, string VehicleNo, string VehicleType)
        {
            ...
            proc.AddBigIntegerPara("@PurchaseChallan_Id", Convert.ToInt32(InvoiceID));
        ...
        public DataSet GetNumberingDropdownForInvGRN(string branchHierchy)
        {
            DataSet ds = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("prc_Purchasechallan_Details");
            proc.AddVarcharPara("@Action", 100, "ChallanNUmberSchemaForInv");
            proc.AddVarcharPara("@userbranchlist", -1, branchHierchy);
            ds = proc.GetDataSet();
            return ds;
        }
        ...
        public int DeletePurchaseChallan(string pcid, string comapanyid, string finyear,Int32 UserId=0)
        {
            int i;
            int rtrnvalue = 0;
