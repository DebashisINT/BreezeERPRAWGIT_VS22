...
{
    public class ProjectPurchaseInvoiceBL
    {
        #region SaleBill
        ...
        public int CheckBillingShippingofVendor(string Vendorid)
        {
            ...
            ProcedureExecute proc = new ProcedureExecute("prc_ProjectPurchaseInvoiceList");
        ...
        public int UpdateEWayBillTransitPB(string InvoiceID, string EWayBillNumber, string EWayBillDate, string EWayBillValue)
        {
            int i;
            int rtrnvalue = 0;
        ...
        public int UpdateEWayBillTransitSB(string InvoiceID, string EWayBillNumber, string EWayBillDate, string EWayBillValue)
        {
            int i;
            int rtrnvalue = 0;
        ...
        public DataTable PopulateNonInventoryCharges(string ProductID, decimal proamt, string vendorId)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_ProjectPurchaseInvoiceDetail");
        ...
        public DataSet GetComponentProductListDetail(string Action, string ComponentList, string InvoiceID, string docno, string Is_Invertory)
        {
            DataSet dst = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("prc_ProjectPurchaseInvoiceDetail");
            proc.AddVarcharPara("@Action", 500, Action);
            ...
            proc.AddVarcharPara("@ComponentList", 2000, ComponentList);
            proc.AddVarcharPara("@InvoiceID", 20, InvoiceID);
            proc.AddVarcharPara("@InventoryType", 20, Is_Invertory);
        ...
        public DataTable GetRetentionDetails(string Invoiceid)
        {
            ...
            proc.AddVarcharPara("@Action", 100, "GetRetentionDetailsPI");
            proc.AddVarcharPara("@InvoiceId", 20, Invoiceid);
            dt = proc.GetTable();
            return dt;
        ...
        public DataTable SaveRetentionDetails(string Invoiceid, string retAmount, string schema_id, string doc_no, string trans_date)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_CRMProjectInvoice");
            proc.AddVarcharPara("@Action", 100, "SaveRetentionDetailsPI");
