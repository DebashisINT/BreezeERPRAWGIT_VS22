...
class TotalSales extends React.Component {
    ...
    componentDidMount() {
        console.log('section Mountedsales', this.props);
        this.generateChart(this.props.data, this.props.charttitle)
    }
    componentDidUpdate(prevprops){
        console.log('section updatedprevprops', prevprops);
        if(prevprops.totAmount != this.props.totAmount) {
            console.log("props not matching");
            this.generateChart(this.props.data, this.props.charttitle)
        }
    }
    generateChart = (data, charttitle) =>{
