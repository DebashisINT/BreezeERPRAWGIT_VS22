...
class TopNCustomer extends React.Component {
    constructor(props) {
      super(props);
    }
    ...
    generateTNSalChart = (data) =>{
        am4core.ready(function() {
            ...
            var chart = am4core.create("TopNCustomer", am4charts.XYChart3D);
              ...
              <div>
                    ...
                    </div>
                    {
                        this.props.data.length ? (
                            <div id="TopNCustomer" style={{ width: "100%", height: "400px" }}></div>
                        ) : <Empty />
                    }  
              </div>
          )
