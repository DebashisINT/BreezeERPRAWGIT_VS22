...
class FollowupUsing extends React.Component {
    constructor(props) {
        super(props);
        this.state = { 
            loading:false,
    ...
    componentDidMount() {
     ...
     SubmitUsing = (fields) => {
         ...
         let value = fields['status'] == undefined ? "" : fields['status'];
         ...
         axios({
             method: 'post',
             url: '../ajax/followUp/followup.aspx/getfl_using',
             data: {
                frmdate: frm,
                todate: to,
                value: value
               ...
               //console.log(this.convertToDate(res.data.d[0].DocDate))
                    ...
                    <Form name="closedFollowupForm" 
                        ...
                        <div className="col-md-6">
                            <Button type="primary" 
                                ...
                                {this.state.usingData.length ? <ExportReactCSV csvData={this.state.usingData} fileName="Followup Using.csv" headers={headers} /> : null }
                ...
                <div className="row">
                    <div className="col-md-12 colorTable">
                        <Table 
                            ...
                            dataSource={this.state.usingData} 
                            scroll={{ x: 1300}}
