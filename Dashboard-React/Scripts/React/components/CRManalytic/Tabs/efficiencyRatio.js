...
class EfficiencyRatio extends React.Component {
    constructor(props) {
        super(props);
        this.state = { 
            loading:false,
    ...
    componentDidMount() {
        axios({
            method: 'post',
            url: '../ajax/crmAnalytic/effRatio.aspx/getPageloadCall',
            data: {}
          }).then(res => {
     ...
     SubmitCallcount = (fields) => {
        ...
        axios({
            method: 'post',
            url: '../ajax/crmAnalytic/effRatio.aspx/GetEff',
            data: {
        ...
        return ( 
            <React.Fragment>
                ...
                <Drawer
                    ...
                    > 
                        <div>
                            <div className="chartHeader">Efficiency Ratio Salesmen wise</div>
