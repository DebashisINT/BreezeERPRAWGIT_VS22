...
class ActSalesmanWise extends React.Component {
    constructor(props) {
        super(props);
        this.state = { 
            loading:false,
    ...
    componentDidMount() {
        axios({
            method: 'post',
            url: '../ajax/crmAnalytic/actisalesManwise.aspx/getPageloadCall',
            data: {}
          }).then(res => {
     ...
     SubmitCallcount = (fields) => {
        ...
        axios({
            method: 'post',
            url: '../ajax/crmAnalytic/actisalesManwise.aspx/GetAcSalesmanWise',
            data: {
    ...
    render() { 
        ...
        const columns = [
          ...
          const headers = [
            ...
            {label: 'Total Entriees', key: 'ActCount'},
            {label: 'Precentage', key: 'Percentage'},
          ];
        const content = (
            <div>
...
export default ActSalesmanWise;