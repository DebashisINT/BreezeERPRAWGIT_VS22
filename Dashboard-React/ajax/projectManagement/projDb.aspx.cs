...
namespace Dashboard_React.ajax.projectManagement
{
    public partial class projDb : System.Web.UI.Page
    {
        ...
        {
            ProjMgmtSettings cls = new ProjMgmtSettings();
            ...
            {
                cls.LiProjectSummary = Convert.ToBoolean(dt.Rows[0]["pmsProjectSummary"]);
                cls.LiProjectDetails = Convert.ToBoolean(dt.Rows[0]["pmsProjectDetails"]);
                cls.LiTimeline = Convert.ToBoolean(dt.Rows[0]["pmsTimeline"]);
                cls.LiCostBreakup = Convert.ToBoolean(dt.Rows[0]["pmsCostBreakup"]);
            }
            else
            {
                cls.LiProjectSummary = Convert.ToBoolean(0);
                cls.LiProjectDetails = Convert.ToBoolean(0);
                cls.LiTimeline = Convert.ToBoolean(0);
                cls.LiCostBreakup = Convert.ToBoolean(0);
            }
    ...
    public class ProjMgmtSettings
    {
        public bool LiProjectSummary { get; set; }
        public bool LiProjectDetails { get; set; }
        public bool LiTimeline { get; set; }
        public bool LiCostBreakup { get; set; }
    }
