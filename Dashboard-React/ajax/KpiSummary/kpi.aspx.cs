...
namespace Dashboard_React.ajax.KpiSummary
{
    public partial class kpi : System.Web.UI.Page
    {
        ...
        {
            KPISummarySettings cls = new KPISummarySettings();
            ...
            {
                cls.liPerformance = Convert.ToBoolean(dt.Rows[0]["KPIPerformance"]);
                cls.liActivities = Convert.ToBoolean(dt.Rows[0]["KPIActivities"]);
                cls.liEmployeeInfo = Convert.ToBoolean(dt.Rows[0]["KPIEmployeeInfo"]);
                cls.liResolution = Convert.ToBoolean(dt.Rows[0]["KPIResolution"]);
            }
            else
            {
                cls.liPerformance = Convert.ToBoolean(0);
                cls.liActivities = Convert.ToBoolean(0);
                cls.liEmployeeInfo = Convert.ToBoolean(0);
                cls.liResolution = Convert.ToBoolean(0);
            }
    ...
    public class KPISummarySettings
    {
        public bool liPerformance { get; set; }
        public bool liActivities { get; set; }
        public bool liEmployeeInfo { get; set; }
        public bool liResolution { get; set; }
    }
