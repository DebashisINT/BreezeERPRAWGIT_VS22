...
namespace Dashboard_React.ajax.CustomerProfile
{
    public partial class CustomerProfile : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static List<GetCustomerProfileSearchClass> GetCustomerProfileSearch()
        {
            ...
            if (HttpContext.Current.Session["userid"] != null)
            {
                ...
                SqlCommand cmd = new SqlCommand("prcDashboardfetchCustomer", con);
                ...
                if (cust != null && cust.Rows.Count > 0)
                {
                    ...
                    {
                        listCust.Add(new GetCustomerProfileSearchClass
                        {
                            value = item["cnt_internalid"].ToString(),
        ...
        [WebMethod]
        public static List<GetCustomerProfileSearchClass> GetCustomerProfileSearchPhone()
        {
            List<GetCustomerProfileSearchClass> listCust = new List<GetCustomerProfileSearchClass>();
            if (HttpContext.Current.Session["userid"] != null)
            {
                ...
                cmd.Parameters.AddWithValue("@Action", "CUSTOMER_PHONE");
                ...
                if (cust != null && cust.Rows.Count > 0)
                {
                    foreach (DataRow item in cust.Rows)
                    {
                        ...
                        {
                            value = item["cnt_internalid"].ToString(),
                            label = Convert.ToString(item["Phone"]),
                            //Email = Convert.ToString(item["Email"]),
                            //Phone = Convert.ToString(item["Phone"])
                        });
                    }
