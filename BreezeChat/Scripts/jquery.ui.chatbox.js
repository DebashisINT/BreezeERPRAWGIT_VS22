    ...
    $.widget("ui.chatbox", {
        options: {
            ...
            boxManager: {
                ...
                addMsg: function (peer, msg, uuID, time) {
                    var d = new Date(time);
                    ...
                    if (currentUserId === uuID) {
                        addEle += "<div style=\"display: block; float:right;\" class=\"ui-chatbox-msg self\"><img src='/assests/images/user2.png' class='userImg ss' style='margin-left:5px' /><div class='uiCnt'><div class='uiCntHd'>" + peer + ": </div><div>" + msg + "</div></div><div style='clear:both'></div><div class='tt'>" + tt + "&nbsp;" + d3 + "</div></div>";
                        
                    } else {
                        addEle += "<div style=\"display: block; \" class=\"ui-chatbox-msg userEnd\"><img src='/assests/images/user1.png' class='userImg ss' /><div class='uiCnt'><div class='uiCntHd'>" + peer + ": </div><div>" + msg + "</div></div><div style='clear:both'></div><div class='tt'>" + tt + "&nbsp;" + d3 + "</div></div>";
