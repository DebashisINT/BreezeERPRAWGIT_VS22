...
namespace Manufacturing.Controllers
{
    ...
    {
        WorkCenterViewModel WCM = null;
        WorkCenterModel WCMOBJ = null;
        ...
        {
            WCM = new WorkCenterViewModel();
            WCMOBJ = new WorkCenterModel();
        }
        //
        // GET: /WorkOrder/
        ...
        public ActionResult WorkCenterEntry()
        {
        ...
        public JsonResult WorkCenterInsertUpdate(WorkCenterViewModel obj)
        {
        ...
        public ActionResult WorkCenterList()
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSessionMVC("/WorkCenterList", "WorkCenter");
            TempData.Clear();
