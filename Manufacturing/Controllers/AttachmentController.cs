...
namespace Manufacturing.Controllers
{
    public class AttachmentController : Controller
    {
        ...
        public ActionResult AttachmentDocument(String module, String DocNo)
        {
            ...
            if (module == "BillOfMaterials")
            {
                string[,] DocyType = objEngine.GetFieldValue("tbl_master_documentType", "dty_id,dty_documentType", " dty_applicableFor='BillOfMaterials'", 2, "dty_documentType");
                if (DocyType[0, 0] != "n")
                {
            ...
            if (module == "ProductionIssue")
            {
                string[,] DocyType = objEngine.GetFieldValue("tbl_master_documentType", "dty_id,dty_documentType", " dty_applicableFor='ProductionIssue'", 2, "dty_documentType");
                if (DocyType[0, 0] != "n")
                {
                    for (int i = 0; i < (DocyType.Length / 2); i = i + 1)
                    {
            ...
            if (module == "JobWorkOrder")
            {
                string[,] DocyType = objEngine.GetFieldValue("tbl_master_documentType", "dty_id,dty_documentType", " dty_applicableFor='JobWorkOrder'", 2, "dty_documentType");
                if (DocyType[0, 0] != "n")
                {
                    for (int i = 0; i < (DocyType.Length / 2); i = i + 1)
                    {
            ...
            if (module == "MaterialIssue")
            {
                string[,] DocyType = objEngine.GetFieldValue("tbl_master_documentType", "dty_id,dty_documentType", " dty_applicableFor='MaterialIssue'", 2, "dty_documentType");
                if (DocyType[0, 0] != "n")
                {
                    for (int i = 0; i < (DocyType.Length / 2); i = i + 1)
                    {
            ...
            if (module == "FGReceived")
            {
                string[,] DocyType = objEngine.GetFieldValue("tbl_master_documentType", "dty_id,dty_documentType", " dty_applicableFor='FGReceived'", 2, "dty_documentType");
                if (DocyType[0, 0] != "n")
                {
                    for (int i = 0; i < (DocyType.Length / 2); i = i + 1)
                    {
            ...
            if (module == "ReturnMaterialsIssue")
            {
                string[,] DocyType = objEngine.GetFieldValue("tbl_master_documentType", "dty_id,dty_documentType", " dty_applicableFor='ReturnMaterialsIssue'", 2, "dty_documentType");
                if (DocyType[0, 0] != "n")
                {
                    for (int i = 0; i < (DocyType.Length / 2); i = i + 1)
                    {
            ...
            if (module == "ReturnFGReceived")
            {
                string[,] DocyType = objEngine.GetFieldValue("tbl_master_documentType", "dty_id,dty_documentType", " dty_applicableFor='ReturnFGReceived'", 2, "dty_documentType");
                if (DocyType[0, 0] != "n")
                {
                    for (int i = 0; i < (DocyType.Length / 2); i = i + 1)
                    {
            ...
            return PartialView("_AttachmentDocument", listmodel);
        }
        ...
        public ActionResult GetAttachmentDocumentList(String module, String DocNo)
        {
            ...
            TempData.Keep();
            return PartialView("_AttachmentDocumentGrid", list);
        }
