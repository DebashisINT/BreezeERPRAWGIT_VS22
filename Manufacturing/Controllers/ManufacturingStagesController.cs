...
{
    public class ManufacturingStagesController : Controller
    {
        //
        // GET: /ManufacturingStages/
        ManufacturingStagesViewModel WCM = null;
        ManufacturingStagesModel WCMOBJ = null;
        ...
        public ManufacturingStagesController()
        {
            WCM = new ManufacturingStagesViewModel();
            WCMOBJ = new ManufacturingStagesModel();
        }
        //
        // GET: /WorkOrder/
        ...
        public ActionResult StagesEntry()
        {
        ...
        public JsonResult WorkCenterInsertUpdate(ManufacturingStagesViewModel obj)
        {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSessionMVC("/StagesList", "ManufacturingStages");
            TempData.Clear();
        ...
        {
            List<ManufacturingStagesViewModel> list = new List<ManufacturingStagesViewModel>();
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSessionMVC("/StagesList", "ManufacturingStages");
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ManufacturingStagesViewModel obj = new ManufacturingStagesViewModel();
                    foreach (DataRow item in dt.Rows)
                    {
                        obj = new ManufacturingStagesViewModel();
