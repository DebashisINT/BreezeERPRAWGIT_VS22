...
{
    public class ReturnFGReceivedViewModel
    {
        ...
        // End of Rev Sanchita
        List<ReturnFGReceivedFinishItemDetails> ListReturnFGReceivedFinishItemDetails { get; set; }
    }
    public class ReturnFGReceivedFinishItemDetails
    {
        ...
        public String FGReturn_Id { get; set; }
