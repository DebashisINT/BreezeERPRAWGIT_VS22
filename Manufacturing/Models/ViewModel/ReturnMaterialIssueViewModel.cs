...
{
    public class ReturnMaterialIssueViewModel
    {
        ...
        List<ReturnMaterialsFinishItemDetails> ListMaterialsFinishItemDetails { get; set; }
    ...
    public class ReturnMaterialsFinishItemDetails
    {
        ...
        public String ReturnMaterialIssueID { get; set; }
    ...
    public class udtReturnMaterialProductionIssueDetails
    {
    ...
    public class udt_ReturnMaterialsDetails
    {
    ...
    public class ReturnMaterialIssueStkWarehouse
    {
    ...
    public class udtReturnMaterialStockProduct
    {
        public String Batch { get; set; }
