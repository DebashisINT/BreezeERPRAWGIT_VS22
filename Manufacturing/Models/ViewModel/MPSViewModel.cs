...
{   
    public class MPSViewModel
    {
        ...
        public String EstimateStartDate_dt { get; set; }
        public String EstimateEndDate_dt { get; set; }
        public String ActualsStartDate_dt { get; set; }
        public String ActualsEndDate_dt { get; set; }
