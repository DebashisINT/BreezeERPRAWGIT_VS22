...
{
    public class ManufacturingProcessMasterModel
    {
        string ConnectionString = String.Empty;
        public ManufacturingProcessMasterModel()
        {
            ConnectionString = Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]);
        }

        public DataTable WorkCenterInsertUpdate(ManufacturingProcessMasterViewModel obj)
        {
