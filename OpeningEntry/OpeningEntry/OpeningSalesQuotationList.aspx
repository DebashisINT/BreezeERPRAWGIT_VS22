<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningSalesQuotationList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningSalesQuotationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/SalesQuotation.aspx?key=' + keyValue + '&req=V' + '&type=QO';
            window.location.href = url;
        }
