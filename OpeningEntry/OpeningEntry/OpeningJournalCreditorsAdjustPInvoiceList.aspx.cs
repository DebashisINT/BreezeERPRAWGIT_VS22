...
{
    public partial class OpeningJournalCreditorsAdjustPInvoiceList : System.Web.UI.Page
    {
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                if (strBranchID == "0")
                {
                    ...
                    var q = from d in dc.v_JournalAdjustmentPurchaseInvoiceLists
        ...
        protected void gridAdvanceAdj_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int rowsNo = customerReceiptAdjustment.DeleteJournalPurchaseInvoiceAdj(param.Split('~')[1]);
                if (rowsNo > 0)
                {
        ...
        private void bindexport(int Filter)
        {
            ...
            string filename = "Adjustment of Document- Journal with Purchase Invoice";
            exporter.FileName = filename;
            exporter.FileName = "Adjustment of Document- Journal with Purchase Invoice";

            exporter.PageHeader.Left = "Adjustment of Document- Journal with Purchase Invoice";
