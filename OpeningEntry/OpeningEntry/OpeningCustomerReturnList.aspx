<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningCustomerReturnList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningCustomerReturnList_aspx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/CustomerReturn.aspx?key=' + keyValue + '&req=V' + '&type=CR';
            window.location.href = url;
        }
