...
{
    public partial class OpeningPurchaseInvoiceListForCustomer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Session.Remove("SaveModePBCL");  // Use this session to remove default cursor from manual oe auto schema type
                Session.Remove("schemavaluePBCL"); // Use this session to remove default cursor from manual oe auto schema type
        ...
        //[WebMethod]
        //public static string UpdateEWayBill(string InvoiceID, string UpdateEWayBill)
        //{
        //    PurchaseInvoiceBL objPurchaseInvoiceBL = new PurchaseInvoiceBL();
        //    int EWayBill = 0;
        //    EWayBill = objPurchaseInvoiceBL.UpdateEWayBill(InvoiceID, UpdateEWayBill);
