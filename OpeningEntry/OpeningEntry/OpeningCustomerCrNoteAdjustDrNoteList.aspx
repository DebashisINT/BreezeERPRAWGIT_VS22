<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningCustomerCrNoteAdjustDrNoteList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningCustomerCrNoteAdjustDrNoteList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/CustomerCrNoteAdjustDrNote.aspx?key=' + keyValue + '&req=V';
