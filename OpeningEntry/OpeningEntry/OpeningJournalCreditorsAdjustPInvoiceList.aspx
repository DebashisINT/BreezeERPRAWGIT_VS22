<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningJournalCreditorsAdjustPInvoiceList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningJournalCreditorsAdjustPInvoiceList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/JournalCreditorsAdjustPInvoice.aspx?key=' + keyValue + '&req=V';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="pull-left">Opening Adjustment of Documents - Journal with Purchase Invoice</h3>
        </div>
    </div>
    <table class="padTab">
        <tr>
