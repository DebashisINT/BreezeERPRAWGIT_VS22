...
function GetCustomerAddress(CustomerId) {
    ...
    if ((CustomerId != null) && (CustomerId != "")) {
        ...
        $.ajax({
            type: "POST",
            url: "OpeningServices/OpeningBillingShipping.asmx/FetchCustomAddress",
...
function CustomerBillingDetailsByPin() {
    ...
    if (detailsByPin != '') {
        ...
        $.ajax({
            type: "POST",
            url: "OpeningServices/OpeningBillingShipping.asmx/CustomAddressByPin",
...
function SetShippingAddressFromAllAddress(SelectedId) {
    ...
    if (billingAdd) {
        if (($('#hdStateCodeShipping').val() != billingAdd[0].StateCode) && AllowAddressShipToPartyState == false) {
...
function AreaAddressByCity(SearchKey, CityId) {
    ...
    $.ajax({
        type: "POST",
        url: "OpeningServices/OpeningBillingShipping.asmx/AreaByCity",
        data: JSON.stringify(),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
...
function areakeydown(e) {
    ...
    if (e.code == "Enter" || e.code == "NumpadEnter") {
        ...
        if ($("#txtbillingArea").val() != '') {
            callonServer("OpeningServices/OpeningBillingShipping.asmx/AreaByCity", OtherDetails, "billingAreatable", HeaderCaption, "BillingAreaIndex", "SetBillingArea");
        }
    }
    else if (e.code == "ArrowDown") {
...
function areakeydownshipping(e) {
    ...
    if (e.code == "Enter" || e.code == "NumpadEnter") {
        ...
        if ($("#txtshippingArea").val() != '') {
            callonServer("OpeningServices/OpeningBillingShipping.asmx/AreaByCity", othersdetails, "shippingAreatable", HeaderCaption, "ShippingAreaIndex", "SetShippingArea");
        }
...
function ShipToPartykeydown(e) {
    ...
    if (e.code == "Enter" || e.code == "NumpadEnter") {
        ...
        if ($("#txtshippingShipToParty").val() != '') {
            callonServer("OpeningServices/OpeningMaster.asmx/GetCustomer", OtherDetails, "ShippingShipToPartytable", HeaderCaption, "customeraddressIndex", "SetCustomeraddress");
        }
    }
    else if (e.code == "ArrowDown") {
