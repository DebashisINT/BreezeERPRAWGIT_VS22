...
{
    public partial class OpeningPurchaseInvoicelist : System.Web.UI.Page
    {
        ...
        public static string UpdateEWayBill(string InvoiceID, string UpdateEWayBill, string EWayBillDate, string EWayBillValue)
        {
            ...
            int EWayBill = 0;
            EWayBill = objPurchaseInvoiceBL.UpdateEWayBill(InvoiceID, UpdateEWayBill, EWayBillDate, EWayBillValue, "", "", "0", "0", "", null, "", "");
