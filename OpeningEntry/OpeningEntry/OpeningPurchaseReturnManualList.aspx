<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningPurchaseReturnManualList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningPurchaseReturnManualList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/PurchaseReturnManual.aspx?key=' + keyValue + '&req=V' + '&type=PRM';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading">
        <div class="panel-title">
            <h3>Opening Purchase Return Manual</h3>
        </div>
    </div>
    <div class="form_main">
        <div class="clearfix">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdPurchaseReturn" runat="server" KeyFieldName="SrlNo" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn Caption="E-Way Bill No." FieldName="EWayBillNumber" VisibleIndex="4" Width="100px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="5" Width="15%">
                    <DataItemTemplate>
                        <% if (rights.CanView)
                           { %>
