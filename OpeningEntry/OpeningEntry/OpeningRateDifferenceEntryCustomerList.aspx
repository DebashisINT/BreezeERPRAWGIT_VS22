<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningRateDifferenceEntryCustomerList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningRateDifferenceEntryCustomerList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/RateDifferenceEntryCustomer.aspx?key=' + keyValue + '&req=V' + '&type=RDEC';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading">
        <div class="panel-title">
            <h3>Opening Rate Difference Entry Customer</h3>
        </div>
    </div>
    <div class="form_main">
        <div class="clearfix">
        ...
        <dxe:ASPxGridView ID="GrdSalesReturn" ClientInstanceName="cGrdSalesReturn" runat="server" KeyFieldName="SrlNo"
           ...
           Setting-HorizontalScrollBarMode="Auto"  DataSourceID="EntityServerModeDataSource" SettingsDataSecurity-AllowEdit="false" SettingsDataSecurity-AllowInsert="false" SettingsDataSecurity-AllowDelete="false"  >
            <Columns>
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="17" Width="188px">
                    <DataItemTemplate>
                        <% if (rights.CanView)
                           { %>
