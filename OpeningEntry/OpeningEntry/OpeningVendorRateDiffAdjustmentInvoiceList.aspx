<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningVendorRateDiffAdjustmentInvoiceList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningVendorRateDiffAdjustmentInvoiceList" %>
    ...
    <script>
        ...
        function AllControlInitilize() {
            if (isFirstTime) {
                ...
                //if (localStorage.getItem('VendorRateDifferAdjFromDate')) {
                //    var fromdatearray = localStorage.getItem('VendorRateDifferAdjFromDate').split('-');
                //    var fromdate = new Date(fromdatearray[0], parseFloat(fromdatearray[1]) - 1, fromdatearray[2], 0, 0, 0, 0);
                //    cFormDate.SetDate(fromdate);
                //}

                //if (localStorage.getItem('VendorRateDifferAdjToDate')) {
                //    var todatearray = localStorage.getItem('VendorRateDifferAdjToDate').split('-');
                //    var todate = new Date(todatearray[0], parseFloat(todatearray[1]) - 1, todatearray[2], 0, 0, 0, 0);
                //    ctoDate.SetDate(todate);
                //}
                //if (localStorage.getItem('VendorRateDifferAdjListBranch')) {
                //    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('VendorRateDifferAdjListBranch'))) {
                //        ccmbBranchfilter.SetValue(localStorage.getItem('VendorRateDifferAdjListBranch'));
                //    }
        ...
        function onEditClick(id) {
            window.location.href = 'VendorRateDiffAdjustmentInvoice.aspx?Key=' + id;
        }
        function OnViewClick(keyValue) {
            var url = '/OMS/MAnagement/Activities/VendorRateDiffAdjustmentInvoice.aspx?key=' + keyValue + '&req=V';
        ...
        function updateGridByDate() {
            ...
            if (cFormDate.GetDate() == null) {
                ...
                localStorage.setItem("VendorRateDifferAdjFromDate", cFormDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("VendorRateDifferAdjToDate", ctoDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("VendorRateDifferAdjListBranch", ccmbBranchfilter.GetValue());
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="panel-heading">
        <div class="panel-title clearfix">
                <h3 class="pull-left">Adjustment of Documents - Rate difference With Invoice</h3>
            </div>
        </div>
            <table class="padTab">
                <tr>
    ...
    <div class="form_main">
     ...
     <div class="GridViewArea">
          ...
          <dxe:ASPxGridViewExporter ID="exporter" GridViewID="gridAdvanceAdj" runat="server" Landscape="false" PaperKind="A4" PageHeader-Font-Size="Larger" PageHeader-Font-Bold="true">
                            ...
                            <dxe:ASPxGridView ID="gridAdvanceAdj" runat="server" KeyFieldName="AdjRateDiffer_id" AutoGenerateColumns="False"
                            ...
                            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                                ContextTypeName="ERPDataClassesDataContext" TableName="v_VendorRateDiffAdjustInvoiceList" />
