...
{
    public partial class OpeningTPurchaseInvoicelist : System.Web.UI.Page
    {
        ...
        public static string UpdateEWayBill(string InvoiceID, string UpdateEWayBill, string EWayBillDate, string EWayBillValue)
        {
            ...
            int EWayBill = 0;
            EWayBill = objPurchaseInvoiceBL.UpdateEWayBillTransitPB(InvoiceID, UpdateEWayBill, EWayBillDate, EWayBillValue, "", "", "0", "0", "", null, "", "");
