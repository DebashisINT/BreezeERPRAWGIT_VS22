<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningUndeliveryReturnList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningUndeliveryReturnList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/UndeliveryReturn.aspx?key=' + keyValue + '&req=V' + '&type=USR';
            window.location.href = url;
        }
