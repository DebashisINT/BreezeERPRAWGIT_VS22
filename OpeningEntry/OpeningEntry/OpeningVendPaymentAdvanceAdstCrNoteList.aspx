<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningVendPaymentAdvanceAdstCrNoteList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningVendPaymentAdvanceAdstCrNoteList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/VendPaymentAdvanceAdstCrNote.aspx?key=' + keyValue + '&req=V';
