<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningSalesInvoiceList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningSalesInvoiceList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnViewClick(keyValue) {
            ...
            //window.location.href = url;
            //var url = '/OpeningEntry/OpeningInvoiceView/OpeningSInvoiceView.html?id=' + keyValue;
            var url = '/OpeningEntry/OpeningInvoiceView/OpeningSInvoiceView.html?id=' + keyValue;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="pull-left">Opening Sales Invoice</h3>
    ...
    <div class="form_main">
        <div class="clearfix">
            ...
            <a href="javascript:void(0);" onclick="OnAddSeriviceButtonClick()" class="btn btn-primary"><span>Add <u>S</u>ervice</span> </a>
...
<%--            <asp:DropDownList ID="drdExport" runat="server" CssClass="btn btn-sm btn-primary" OnSelectedIndexChanged="cmbExport_SelectedIndexChanged" AutoPostBack="true" OnChange="if(!AvailableExportOption()){return false;}">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdQuotation" runat="server" KeyFieldName="Invoice_Id" AutoGenerateColumns="False" SettingsBehavior-AllowFocusedRow="true"
            ...
            Settings-HorizontalScrollBarMode="Auto" DataSourceID="EntityServerModeDataSource" SettingsDataSecurity-AllowEdit="false" SettingsDataSecurity-AllowInsert="false" SettingsDataSecurity-AllowDelete="false">
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn Caption="Balance Amount" FieldName="BalanceAmount"
                 ...
                 <dxe:GridViewDataTextColumn Caption="Place of Supply[GST]" FieldName="PosState" VisibleIndex="13" Width="130px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AllowAutoFilterTextInputTimer="False" />
                    <Settings AutoFilterCondition="Contains" />
    ...
    <dxe:ASPxPopupControl ID="Popup_EWayBill" runat="server" ClientInstanceName="cPopup_EWayBill"
     ...
     <dxe:ASPxPopupControl ID="PosView" runat="server"
        ...
        Width="1020px" HeaderText="Opening Sales Invoice" Modal="true">
