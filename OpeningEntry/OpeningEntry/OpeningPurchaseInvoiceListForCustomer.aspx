<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningPurchaseInvoiceListForCustomer.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningPurchaseInvoiceListForCustomer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/PurchaseInvoiceForCustomer.aspx ?key=' + keyValue + '&req=V' + '&type=PB';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdQuotation" runat="server" KeyFieldName="Invoice_Id" AutoGenerateColumns="False" Settings-HorizontalScrollBarMode="Visible"
            ...
            Settings-VerticalScrollBarMode="Visible" OnPageIndexChanged="GrdQuotation_PageIndexChanged" OnDataBinding="GrdQuotation_DataBinding"
            OnSummaryDisplayText="GrdQuotation_SummaryDisplayText" DataSourceID="EntityServerModeDataSource" SettingsDataSecurity-AllowEdit="false" SettingsDataSecurity-AllowInsert="false" SettingsDataSecurity-AllowDelete="false" SettingsBehavior-AllowFocusedRow="true">
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn Caption="Posting Date" FieldName="InvoiceDate" VisibleIndex="1" Width="85px" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AllowAutoFilterTextInputTimer="False" />
                    <Settings AutoFilterCondition="Contains" />
                ...
                <dxe:GridViewDataTextColumn Caption="E-Way Bill No." FieldName="EWayBillNumber" VisibleIndex="8" Width="100px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AllowAutoFilterTextInputTimer="False" />
                    <Settings AutoFilterCondition="Contains" />
                ...
                <dxe:GridViewDataTextColumn Caption="Entered by" FieldName="CreatedBY" VisibleIndex="9" Width="80px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AllowAutoFilterTextInputTimer="False" />
                    <Settings AutoFilterCondition="Contains" />
                ...
                <dxe:GridViewDataTextColumn Caption="Entered On" FieldName="CreatedDate" Width="80px" VisibleIndex="10">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AllowAutoFilterTextInputTimer="False" />
                    <Settings AutoFilterCondition="Contains" />
                ...
                <dxe:GridViewDataTextColumn Caption="Updated by" FieldName="UpdatedBy" VisibleIndex="11" Width="80px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AllowAutoFilterTextInputTimer="False" />
                    <Settings AutoFilterCondition="Contains" />
                ...
                <dxe:GridViewDataTextColumn Caption="Updated On" FieldName="updatedOn" Width="80px" VisibleIndex="12" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AllowAutoFilterTextInputTimer="False" />
                    <Settings AutoFilterCondition="Contains" />
                ...
                <dxe:GridViewDataTextColumn Caption="Amount" FieldName="TotalAmount" VisibleIndex="13" Width="100px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                ...
                <dxe:GridViewDataTextColumn FieldName="Product" Caption="" VisibleIndex="14" Width="80px">
                    <DataItemTemplate>
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="15" Width="160px">
                    <DataItemTemplate>
                        <% if (rights.CanView)
                           { %>
                ...
                <div class="Top clearfix">
                    ...
                    <table style="width: 100%; margin: 0 auto; margin-top: 5px;">
                        ...
                        <tr>
                            ...
                            <dxe:ASPxTextBox ID="txtEWayBillNumber" MaxLength="30" ClientInstanceName="ctxtEWayBillNumber"
                                runat="server" Width="100%">
