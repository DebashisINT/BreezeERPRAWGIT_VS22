<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningSelfPurchaseInvoiceList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningSelfPurchaseInvoiceList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/SelfPurchaseInvoice.aspx?key=' + keyValue + '&req=V' + '&type=PB';
            window.location.href = url;
        }
