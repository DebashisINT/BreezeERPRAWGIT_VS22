<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningJournalDebtorsAdjustInvoiceList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningJournalDebtorsAdjustInvoiceList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/JournalDebtorsAdjustmentInvoice.aspx?key=' + keyValue + '&req=V';
