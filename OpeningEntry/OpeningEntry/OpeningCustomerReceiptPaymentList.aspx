<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningCustomerReceiptPaymentList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningCustomerReceiptPaymentList_aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading clearfix">
        <div class="panel-title pull-left" id="td_contact1" runat="server">
            <h3>
                <asp:Label ID="lblHeadTitle" runat="server" Text="Opening Customer Receipt/Payment"></asp:Label>
            </h3>
        </div>
