<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpenningJournalEntry.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpenningJournalEntry" %>
        ...
        <div class="panel-title clearfix">
            <h3 class="clearfix" style="padding: 0;">
                <span class="pull-left" style="margin-top: 8px;">
                    <asp:Label ID="lblHeading" runat="server" Text="Opening Journal Voucher"></asp:Label></span>

                <div id="loadCurrencyMassage" class="pull-left" style="display: none;">
                    <label><span style="color: red; font-weight: bold; font-size: medium;">**  Mismatch detected.</span></label>
                </div>
                <div id="pageheaderContent" class="pull-right reverse wrapHolder content horizontal-images" style="width:230px">
                                ...
                                <div class="clearfix">
                                    <dxe:ASPxGridView ID="GridFullInfo" runat="server" AutoGenerateColumns="False" SettingsBehavior-AllowSort="true"
                                        ...
                                        <Columns>
                                            ...
                                            <dxe:GridViewDataTextColumn VisibleIndex="0" FieldName="JV_DATE" Caption="Posting Date" FixedStyle="Left">
                                                <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                                            </dxe:GridViewDataTextColumn>
                                            <dxe:GridViewDataTextColumn VisibleIndex="1" FieldName="JV_NO" Width="150px" Caption="Document No." FixedStyle="Left">
                                                <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                                            </dxe:GridViewDataTextColumn>

                                            <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="MainAccount" Width="150px" Caption="Ledger Desc." FixedStyle="Left">
                                                <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                                            </dxe:GridViewDataTextColumn>
