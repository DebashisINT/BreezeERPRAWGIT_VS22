<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningPurchaseInvoiceListForTransporter.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningPurchaseInvoiceListForTransporter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/PurchaseInvoiceForTransporter.aspx?key=' + keyValue + '&req=V' + '&type=PB';
            window.location.href = url;
        }
