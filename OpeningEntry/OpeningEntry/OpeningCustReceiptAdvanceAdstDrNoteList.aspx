<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="OpeningCustReceiptAdvanceAdstDrNoteList.aspx.cs" Inherits="OpeningEntry.OpeningEntry.OpeningCustReceiptAdvanceAdstDrNoteList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnViewClick(keyValue) {
            var url = '/OMS/Management/Activities/CustReceiptAdvanceAdstDrNote.aspx?key=' + keyValue + '&req=V';
