    ...
    public partial class ConsolidatedVendor : System.Web.UI.Page
    {
          ...
          //  string AmountOs = (ddltype.SelectedValue == "PB" || ddltype.SelectedValue == "RET") ? txt_docamt.Text : txt_docamt2.Text;
            ...
            if (WhichCall == "TemporaryData")
            {
                ...
                if (Convert.ToString(dt.Rows[0][0]) == "0" && (ddltype.SelectedValue != "CDB" || ddltype.SelectedValue != "CCR"))
                {
                    ...
                    //string RetAmount = Convert.ToString(0);
                    //string GL = Convert.ToString(0);
                    //DateTime? dtDuedt = null;
        ...
        public static object SaveRetentionDetails(string invoice_id, string Ret_Amount, string schema_id, string doc_no, string trans_date)
        {
            ...
            try
            {
                ...
                dtRetention = objProjectInvoiceBL.SaveRetentionDetailsOpeningPI(invoice_id, Ret_Amount, schema_id, bill_no, trans_date);
