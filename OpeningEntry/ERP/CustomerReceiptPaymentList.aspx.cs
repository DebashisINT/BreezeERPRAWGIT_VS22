...
{
    public partial class CustomerReceiptPaymentList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            FillGrid();
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/ERP/CustomerReceiptPaymentList.aspx");
        }
        ...
        public DataTable GetCustomerReceiptPaymentListGridData()
        {
            ...
            proc.AddVarcharPara("@Action", 500, "CustomerReceiptPaymentDetailsOpening");
