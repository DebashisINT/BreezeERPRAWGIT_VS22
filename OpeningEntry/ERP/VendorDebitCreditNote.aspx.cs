...
namespace OpeningEntry.ERP
{
    public partial class VendorDebitCreditNote : System.Web.UI.Page//ERP.OMS.ViewState_class.VSPage//System.Web.UI.Page
    {
        ...
        public static string getSchemeType(string sel_scheme_id)
        {
            ...
            //string[] scheme = oDbEngine1.GetFieldValue1("tbl_master_Idschema", " schema_type,lejgth ", "Id = " + Convert.ToInt32(sel_scheme_id), 1);
        ...
        public static List<ListItem> GetScheme(string sel_type_id)
        {
            ...
            string query = "Select ID,SchemaName From tbl_master_Idschema  Where TYPE_ID=(Case When '" + sel_type_id + "'='Dr' Then '27' Else '28' End) AND IsActive=1 AND Isnulh(Branch,'')='" + userbranchID + "' AND Isnull(comapanyInt,'')='" + LastCompany + "'";
