<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpeningTermsConditionsControl.ascx.cs" Inherits="OpeningEntry.UserControls.OpeningTermsConditionsControl" %>
