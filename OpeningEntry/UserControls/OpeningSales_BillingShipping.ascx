<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpeningSales_BillingShipping.ascx.cs" Inherits="OpeningEntry.UserControls.OpeningSales_BillingShipping" %>


<script src="../OpeningEntry/OpeningJS/OpeningSalesBillingShipping.js?v1.0.0.001"></script>
    <style>
        .headText {
                margin: 0;
