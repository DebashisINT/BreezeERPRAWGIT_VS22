...
namespace Payroll.Controllers
{
    ...
    public class payrollTableFormulaController : Controller
    {
        ...
        {
            return PartialView("PartialFormulaGrid", GetFormulaList());
        }
            ...
            
        {
            ...
            return PartialView("partialReferredGrid", GetReferrerList(TblFormulaCode));
        }
        ...
        public PartialViewResult partialReferredInnerGrid(int TableBreakup_ID)
        {
            ...
            return PartialView("partialReferredInnerGrid", GetRefferedInnerList(TableBreakup_ID));
        }
