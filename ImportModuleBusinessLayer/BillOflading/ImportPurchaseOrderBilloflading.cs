...
namespace ImportModuleBusinessLayer.BillOflading
{

    public class ImportPurchaseOrderBilloflading
    {
        ...
        public DataTable GetIndentOnPO(string OrderDate, string Status,string branch,string vendor)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_GetPurchaseOrderBillOfLading");           
