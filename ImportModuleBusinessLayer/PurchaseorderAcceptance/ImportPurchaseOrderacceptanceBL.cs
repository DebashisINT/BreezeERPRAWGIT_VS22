...
namespace ImportModuleBusinessLayer.PurchaseorderAcceptance
{
    public class ImportPurchaseOrderacceptanceBL
    {
        ...
        public DataTable GetIndentOnPO(string OrderDate, string Status, string branch, string vendor, string PurchaseOrder_Id)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_GetAcceptanceIndentOnPurchaseOrder");           
            ...
            proc.AddVarcharPara("@vendorID", 500, vendor);
            proc.AddVarcharPara("@PurchaseOrder_Id", 500, PurchaseOrder_Id);
