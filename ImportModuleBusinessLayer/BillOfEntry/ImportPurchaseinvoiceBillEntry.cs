...
namespace ImportModuleBusinessLayer.BillOfEntry
{
   public  class ImportPurchaseinvoiceBillEntry
    {
        ...
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_GetPurchaseOrderBillOfEntryInvoicetagged");           
