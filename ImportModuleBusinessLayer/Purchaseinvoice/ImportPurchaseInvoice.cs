...
namespace ImportModuleBusinessLayer.Purchaseinvoice
{
    public  class ImportPurchaseInvoice
    {
        ...
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_GetPurchaseInvoicetaggedwithpurchaseOrder");           
