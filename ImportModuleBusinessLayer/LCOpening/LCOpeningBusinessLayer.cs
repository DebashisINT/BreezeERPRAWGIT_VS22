...
namespace ImportModuleBusinessLayer.LCOpening
{
    public class LCOpeningBusinessLayer
    {
        ...
        //    return ds;
        //}
        public DataSet GetAllDropDownDetail(string branchHierchy)
        {
            DataSet ds = new DataSet();
        ...
        public DataTable GetPurchaseInvoice(string OrderDate, string Status, string branch, string vendor)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_GetLCEntryPurchaseInvoicetagged");           
        ...
        public DataTable GetPurchaseInvoiceOnly(string Indent_Id, string Order_Key, string Product_Ids, string Action)
        {
            ProcedureExecute proc = new ProcedureExecute("prc_LC_EntryDetailsList_Import");
            proc.AddVarcharPara("@Action", 100, "GetPurchaseInvoiceOnly");
        ...
        public DataSet GetPurchaseInvoiceForGridBind(string Indent_Id, string Order_Key, string Product_Ids, string Action)
        {
            ProcedureExecute proc = new ProcedureExecute("prc_LC_EntryDetailsList_Import");
            proc.AddVarcharPara("@Action", 100, "GetPurchaseInvoiceForGridBind");
            proc.AddVarcharPara("@Indent_Id", 4000, Indent_Id);
