      ...
      <div class="container" >
        ...
        <div class="sectionWraper">
          <div class="textSection">
            ...
            <h3 class="scndSize">We are focussed on getting your business disruption-ready.</h3>
             <ul class="styleList mainlist" style="margin-top: 18px;">
                 <li>End-to-end accounting solutions</li>
                <li>GST compliance</li>
                <li>E-invoicing </li>
                <li>Dedicated Customer and Vendor Portals </li>
                <li>Warehouse wise Analytics and Report</li>
