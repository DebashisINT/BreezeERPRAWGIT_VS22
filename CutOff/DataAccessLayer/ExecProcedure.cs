...
namespace CutOff.DataAccessLayer
{
    public class ExecProcedure
    {
        ...
        /// <summary>
        /// Overload constructor by procedure name.
        /// </summary>
        /// <param name="PorcName"> Procedure Name </param>
        ...
        {
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings[Convert.ToString(HttpContext.Current.Session["CurConString"])].ToString());
