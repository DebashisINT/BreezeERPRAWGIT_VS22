<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/Masterpage/ERP.Master" AutoEventWireup="true" CodeBehind="HighSeaImportTransitList.aspx.cs" Inherits="Import.Import.HighSeaImportTransitList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowMsgLastCall() {
            ...
            if (CgvPurchaseInvoice.cpDelete != null) {

                jAlert(CgvPurchaseInvoice.cpDelete)
                CgvPurchaseInvoice.PerformCallback();
                CgvPurchaseInvoice.cpDelete = null
            }
        }
        ...
        function AddButtonClick() {
            ...
            if (keyOpening != '') {
                var url = 'HighSeaImportTransit.aspx?key=' + 'ADD&&op=' + 'yes';
            }
            else {
                var url = 'HighSeaImportTransit.aspx?key=' + 'ADD';
            }
        ...
        function OnMoreInfoClick(keyValue) {
            ...
            //$.ajax({
            //    type: "POST",
            //    url: "PurchaseInvoiceList-Import.aspx/TaggigExistance",
            ...
            //        }
            //        else {
            //            var url = 'PurchaseInvoice-Import.aspx?key=' + keyValue + '&type=IPINV';
            //            window.location.href = url;
            //        }
            //    }
            //});

            var url = 'HighSeaImportTransit.aspx?key=' + keyValue + '&type=IPINV';
            window.location.href = url;

        } 
        function OnViewClick(keyValue) {
            var url = 'HighSeaImportTransit.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }
        function OnClickDelete(keyValue) {
            jConfirm('Confirm delete?', 'Confirmation Dialog', function (r) {
                if (r == true) {
                    CgvPurchaseInvoice.PerformCallback('Delete~' + keyValue);
                    CgvPurchaseInvoice.Refresh();
                }
            });
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title" id="td_contact1" runat="server">
            <h3>
                <asp:Label ID="lblHeadTitle" runat="server" Text="High Sea Import (Transit)"></asp:Label>
            </h3>
        </div>
    </div>
    ...
    <div>
        ...
        <dxe:ASPxGridView ID="Grid_PurchaseInvoice" runat="server" AutoGenerateColumns="False" KeyFieldName="PurchaseInvoice_Id"   OnSummaryDisplayText="ShowGrid_SummaryDisplayText"
            ClientInstanceName="CgvPurchaseInvoice"  Width="100%"  OnCustomCallback="Grid_PurchaseInvoice_CustomCallback"
          ...
          SettingsCookies-StoreFiltering="true" SettingsCookies-StoreGroupingAndSorting="true" DataSourceID="EntityServerModeDataSource" SettingsDataSecurity-AllowEdit="false" SettingsDataSecurity-AllowInsert="false" SettingsDataSecurity-AllowDelete="false"  >
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn FieldName="PurchaseInvoice_Id" Visible="false">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
        ...
        ContextTypeName="ImportmoduleclassDataContext" TableName="v_PurchaseInvoiceList_Import" />
