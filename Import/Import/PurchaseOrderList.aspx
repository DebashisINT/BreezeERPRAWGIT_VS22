<%@ Page Title="PurchaseOrder" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PurchaseOrderList.aspx.cs"
    Inherits="Import.Import.ImportPurchaseOrderList" EnableEventValidation="false" %>
    ...
    <%-- Code Added By Sandip For Approval Detail Section End--%>
     ...
     <script type="text/javascript">
        ...
        function OnMoreInfoClick(keyValue) {
            var url = 'Purchaseorder-Import.aspx?key=' + keyValue + '&type=PO';
            window.location.href = url;
        }
