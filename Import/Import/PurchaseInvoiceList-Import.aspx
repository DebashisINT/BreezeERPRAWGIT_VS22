<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/Masterpage/ERP.Master" AutoEventWireup="true" CodeBehind="PurchaseInvoiceList-Import.aspx.cs" Inherits="Import.Import.PurchaseInvoiceList_Import" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddButtonClick() {
            ...
            if (keyOpening != '') {
                var url = 'PurchaseInvoice-Import.aspx?key=' + 'ADD&&op=' + 'yes';
            }
            else {
                var url = 'PurchaseInvoice-Import.aspx?key=' + 'ADD';
            }
        ...
        function OnViewClick(keyValue) {
            var url = 'PurchaseInvoice-Import.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title" id="td_contact1" runat="server">
            <h3>
                <asp:Label ID="lblHeadTitle" runat="server" Text="Import Purchase Invoice"></asp:Label>
            </h3>
        </div>
    </div>
