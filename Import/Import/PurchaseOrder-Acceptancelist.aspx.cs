...
{
    public partial class PurchaseOrder_Acceptancelist : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/PurchaseOrder-Acceptancelist.aspx");
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (strBranchID == "0")
            {
                ...
                var q = from d in dc.v_PurchaseOrderList_Import_Indents
