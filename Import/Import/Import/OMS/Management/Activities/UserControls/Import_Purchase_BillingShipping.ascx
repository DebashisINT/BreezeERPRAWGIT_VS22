<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Import_Purchase_BillingShipping1.ascx.cs" Inherits="ERP.OMS.Management.Activities.UserControls.Import_Purchase_BillingShipping" %>


<script src="Import/OMS/management/Activities/Js/PurchaseBillingShipping.js"></script>
<div>
    <table>
        <tr>
            <td></td>
