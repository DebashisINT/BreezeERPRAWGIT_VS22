...
{
    public partial class Import_TermsConditionsControl : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable DtIncoterms = GetIncoterms();
            if (DtIncoterms.Rows.Count > 0)
            {
                ddlIncoDVTerms.Items.Clear();
                ddlIncoDVTerms.DataSource = DtIncoterms;
                ddlIncoDVTerms.DataBind();
            }
        }
        ...
        public void BindTC(string docid, string Type)
        {
            try
            {
                ...
                DataTable DT = new DataTable();
                ProcedureExecute proc = new ProcedureExecute("prc_Import_ShowTermsAndCondition");
        ...
        public DataTable GetIncoterms()
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_Import_TermsAndCondition");
            proc.AddVarcharPara("@Action", 500, "GetIncoterms");
            dt = proc.GetTable();
            return dt;
        }
