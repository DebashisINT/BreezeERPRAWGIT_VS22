<%@ Page Title="Purchase Order Bill Of Lading" Language="C#" MasterPageFile="~/OMS/Masterpage/ERP.Master" AutoEventWireup="true" CodeBehind="PurchaseorderBillofladingList.aspx.cs" Inherits="Import.Import.PurchaseorderBillofladingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddButtonClick() {
            ...
            if (keyOpening != '') {
                var url = 'PurchaseorderBilloflading.aspx?key=' + 'ADD&&op=' + 'yes';
            }
            else {
                var url = 'PurchaseorderBilloflading.aspx?key=' + 'ADD';
            }

            window.location.href = url;
        }
        function OnMoreInfoClick(keyValue) {
            var url = 'PurchaseorderBilloflading.aspx?key=' + keyValue + '&type=PO';
            window.location.href = url;
        }

        function Ontracking(linktracking) {
            //  alert(linktracking);
            var url = linktracking;
            // window.location.href = url;
        ...
        function OnViewClick(keyValue) {
            ...
            var url = 'PurchaseorderBilloflading.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        ...
        <div class="panel-title" id="td_contact1" runat="server">
            <h3>
                <asp:Label ID="lblHeadTitle" runat="server" Text="Bill Of Lading (B/L)"></asp:Label>
            </h3>
        </div>
    ...
    <div>
        <dxe:ASPxGridView ID="Grid_PurchaseOrder" runat="server" AutoGenerateColumns="False" KeyFieldName="PurchaseOrder_Id" OnSummaryDisplayText="ShowGrid_SummaryDisplayText"
            ...
            <columns>
                ...
                <dxe:GridViewDataTextColumn VisibleIndex="3" Caption="Vendor" FieldName="Customer" width="2500px">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>


               <%--   <dxe:GridViewDataHyperLinkColumn  VisibleIndex="4" Caption="Tracking" FieldName="Tracking" width="150px" >
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>

                </dxe:GridViewDataHyperLinkColumn>--%>


                   <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" Caption="Tracking Url" CellStyle-HorizontalAlign="center" VisibleIndex="4" Width="15%">
                    <DataItemTemplate>
                  <a href="javascript:void(0);" onclick="Ontracking('<%# Eval("Tracking")%>')" class="pad" target="_blank" title="View" >click to open link
              </a>
                   </DataItemTemplate>
                                 <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                   ...
                   <dxe:GridViewDataTextColumn VisibleIndex="5" Caption="Currency" FieldName="Currency_AlphaCode">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>


                  <dxe:GridViewDataTextColumn VisibleIndex="6" Caption="Amount (In Foreign)" FieldName="ValueInCurrency" PropertiesTextEdit-DisplayFormatString="0.00">
                    <CellStyle CssClass="gridcellleft"  HorizontalAlign="right"></CellStyle>
                </dxe:GridViewDataTextColumn>

                <dxe:GridViewDataTextColumn VisibleIndex="7" Caption="Amount (In Base)" FieldName="ValueInBaseCurrency" PropertiesTextEdit-DisplayFormatString="0.00">
                    <CellStyle CssClass="gridcellleft" HorizontalAlign="right"></CellStyle>
                </dxe:GridViewDataTextColumn>
        ...
        <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
            ContextTypeName="ImportmoduleclassDataContext" TableName="v_PurchaseOrderList_Import_BillOfLading" />
