...
{
    public partial class PurchaseorderBillofladingList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/PurchaseorderBillofladingList.aspx");
        ...
        public void bindexport(int Filter)
        {
            ...
            exporter.FileName = "PurchaseOrderAcceptance";
        ...
        protected void Grid_PurchaseOrder_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (Command == "Delete")
            {
                ...
                {
                    Grid_PurchaseOrder.JSProperties["cpDelete"] = "This B/L is tagged in other modules. Cannot Delete.";
                }
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (strBranchID == "0")
            {
                ...
                var q = from d in dc.v_PurchaseOrderList_Import_BillOfLadings
