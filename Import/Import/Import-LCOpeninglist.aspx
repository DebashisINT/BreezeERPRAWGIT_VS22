<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/Masterpage/ERP.Master" AutoEventWireup="true" CodeBehind="Import-LCOpeninglist.aspx.cs" Inherits="Import.Import.Import_LCOpeninglist" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddButtonClick() {
            ...
            if (keyOpening != '') {
                var url = 'Import-LCOpeningEntry.aspx?key=' + 'ADD&&op=' + 'yes';
            }
            else {
                var url = 'Import-LCOpeningEntry.aspx?key=' + 'ADD';
            }
        ...
        function OnMoreInfoClick(keyValue) {
            ...
            var url = 'Import-LCOpeningEntry.aspx?key=' + keyValue + '&type=LCE';
            window.location.href = url;
            ...
            //$.ajax({
            //    type: "POST",
            //    url: "PurchaseBillOfEntry-Import.aspx/TaggigExistance",
            ...
            //        }
            //        else {
            //            var url = 'PurchaseBillOfEntry-Import.aspx?key=' + keyValue + '&type=PO';
            //            window.location.href = url;
            //        }
            //    }
            //});
        ...
        function OnViewClick(keyValue) {
            var url = 'Import-LCOpeningEntry.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        ...
        <div class="panel-title" id="td_contact1" runat="server">
            <h3>
                <asp:Label ID="lblHeadTitle" runat="server" Text="Import L/C Entry"></asp:Label>
            </h3>
        </div>
    </div>
    ...
    <div >
        <dxe:ASPxGridView ID="Grid_PurchaseOrder" runat="server" AutoGenerateColumns="False" KeyFieldName="LCEntry_Id"   OnSummaryDisplayText="ShowGrid_SummaryDisplayText"
          ...
          SettingsCookies-StoreFiltering="true" SettingsCookies-StoreGroupingAndSorting="true" DataSourceID="EntityServerModeDataSource" SettingsDataSecurity-AllowEdit="false" SettingsDataSecurity-AllowInsert="false" SettingsDataSecurity-AllowDelete="false"  >
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn FieldName="LCEntry_Id" Visible="false" SortOrder="Descending">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn VisibleIndex="1" Caption="Document No." FieldName="LCEntry_Number">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn VisibleIndex="2" Caption="Posting Date" FieldName="LCEntry_Date"  PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn VisibleIndex="3" Caption="Vendor" FieldName="VendorName" width="400px">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
        ...
        ContextTypeName="ImportmoduleclassDataContext" TableName="v_LCEntryList_Import" />
