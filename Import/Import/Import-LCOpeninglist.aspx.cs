...
{
    public partial class Import_LCOpeninglist : System.Web.UI.Page
    {

        BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(string.Empty);
        LCOpeningBusinessLayer objPurchaseOrderBL = new LCOpeningBusinessLayer();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //................Cookies..................
                Grid_PurchaseOrder.SettingsCookies.CookiesID = "BreeezeErpGridCookiesGrid_LCEntryPageLCEntry";
                this.Page.ClientScript.RegisterStartupScript(GetType(), "setCookieOnStorage", "<script>addCookiesKeyOnStorage('BreeezeErpGridCookiesGrid_LCEntryPageLCEntry');</script>");
                //...........Cookies End............... 
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Import-LCOpeninglist.aspx");
        ...
        public void bindexport(int Filter)
        {
            ...
            exporter.FileName = "L/CEntry";

            exporter.PageHeader.Left = "Import L/C Entry";
        ...
        protected void Grid_PurchaseOrder_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (Command == "Delete")
            {
                ...
                //else
                //{
                //    Grid_PurchaseOrder.JSProperties["cpDelete"] = "This L/C Entry is tagged in other modules. Cannot Delete.";
                //}
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (strBranchID == "0")
            {
                ...
                var q = from d in dc.v_LCEntryList_Imports
                        ...
                        where
                         ...
                         //branchidlist.Contains(Convert.ToInt32(d.PurchaseOrder_BranchId))
                          ...
                          d.LCEntry_Dt >= Convert.ToDateTime(strFromDate) && d.LCEntry_Dt <= Convert.ToDateTime(strToDate)

                       // && d.LCEntryAdd_addressType == "Shipping"
                        && d.CreatedBy == userid

                        orderby d.LCEntry_Id descending
                        select d;
            ...
            else
            {
                ...
                var q = from d in dc.v_LCEntryList_Imports
                       ...
                       // && d.LCEntryAdd_addressType == "Shipping"
                        && d.CreatedBy == userid
                        && branchidlist.Contains(Convert.ToInt32(d.LCEntry_BranchId))
                        orderby d.LCEntry_Id descending
                        select d;
                e.QueryableSource = q;
            }
