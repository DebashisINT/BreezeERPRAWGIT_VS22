<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/Masterpage/ERP.Master" AutoEventWireup="true" CodeBehind="GoodsReceivedNoteList_Import.aspx.cs" Inherits="Import.Import.GoodsReceivedNoteList_Import" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddButtonClick() {
            ...
            if (keyOpening != '') {
                var url = 'GoodsReceivedNoteAdd_Import.aspx?key=' + 'ADD&&op=' + 'yes';
            }
            else {
                var url = 'GoodsReceivedNoteAdd_Import.aspx?key=' + 'ADD';
            }
        ...
        function OnMoreInfoClick(keyValue) {           
            ...
            var url = 'GoodsReceivedNoteAdd_Import.aspx?key=' + keyValue + '&type=IPSTKREC';
            window.location.href = url;

        } 
        function OnViewClick(keyValue) {
            var url = 'GoodsReceivedNoteAdd_Import.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title" id="td_contact1" runat="server">
            <h3>
                <asp:Label ID="lblHeadTitle" runat="server" Text="Import Stock Receipt"></asp:Label>
            </h3>
        </div>
    </div>
    ...
    <div>
        <dxe:ASPxGridView ID="Grid_StockReceipt" runat="server" AutoGenerateColumns="False" KeyFieldName="GoodReceivedNote_Id"   OnSummaryDisplayText="ShowGrid_SummaryDisplayText"
            ClientInstanceName="CgvPurchaseInvoice"  Width="100%"  OnCustomCallback="Grid_StockReceipt_CustomCallback"
          ...
          SettingsCookies-StoreFiltering="true" SettingsCookies-StoreGroupingAndSorting="true" DataSourceID="EntityServerModeDataSource" 
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn FieldName="GoodReceivedNote_Id" Visible="false">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
        ...
        ContextTypeName="ImportmoduleclassDataContext" TableName="v_ImportStockReceiptList" />
