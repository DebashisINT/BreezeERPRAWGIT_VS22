<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/Masterpage/ERP.Master" AutoEventWireup="true" CodeBehind="PurchaseBillOfEntryList-Import.aspx.cs" Inherits="Import.Import.PurchaseBillOfEntryList_Import" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddButtonClick() {
            ...
            if (keyOpening != '') {
                var url = 'PurchaseBillOfEntry-Import.aspx?key=' + 'ADD&&op=' + 'yes';
            }
            else {
                var url = 'PurchaseBillOfEntry-Import.aspx?key=' + 'ADD';
            }
        ...
        function OnMoreInfoClick(keyValue) {
            ...
            $.ajax({
                type: "POST",
                url: "PurchaseBillOfEntryList-Import.aspx/TaggigExistance",
                ...
                success: function (msg) {
                    ...
                    if (s == "1") {
                        ...
                        var url = 'PurchaseBillOfEntry-Import.aspx?key=' + keyValue + '&type=IPBETR';
        ...
        function OnViewClick(keyValue) {
            var url = 'PurchaseBillOfEntry-Import.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        ...
        <div class="panel-title" id="td_contact1" runat="server">
            <h3>
                <asp:Label ID="lblHeadTitle" runat="server" Text="Import Bill Of Entry (B/E)"></asp:Label>
            </h3>
        </div>
    </div>
    ...
    <div>
        ...
        ContextTypeName="ImportmoduleclassDataContext" TableName="v_PurchaseOrderList_Import_BillEntry" />
