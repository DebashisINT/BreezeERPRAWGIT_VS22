...
{
    public partial class PurchaseInvoiceList_Import : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //................Cookies..................
                Grid_PurchaseInvoice.SettingsCookies.CookiesID = "BreeezeErpGridCookiesGrid_PurchaseOrderPagePurchaseOrder";
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/PurchaseInvoiceList-Import.aspx");
        ...
        public void bindexport(int Filter)
        {
         //   Grid_PurchaseInvoice.Columns[7].Visible = false;
            ...
            exporter.GridViewID = "Grid_PurchaseInvoice";
            exporter.FileName = "ImportPurchaseInvoice";

            exporter.PageHeader.Left = "Import Purchase Invoice";
        ...
        public void FillGrid()
        {
            ...
            {
                Grid_PurchaseInvoice.DataSource = dtdata;
                Grid_PurchaseInvoice.DataBind();
            }
            else
            {
                Grid_PurchaseInvoice.DataSource = null;
                Grid_PurchaseInvoice.DataBind();
            }
        }
        ...
        protected void Grid_PurchaseInvoice_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            Grid_PurchaseInvoice.JSProperties["cpDelete"] = null;
            if (Command == "Delete")
            {
                if (!IsPITransactionExist(POID))
                {
                    ...
                    if (deletecnt == 1)
                    {
                        Grid_PurchaseInvoice.JSProperties["cpDelete"] = "Deleted successfully";
                ...
                {
                    Grid_PurchaseInvoice.JSProperties["cpDelete"] = "This Purchase Invoice is tagged in other modules. Cannot Delete.";
                }
        ...
        {
            e.KeyExpression = "PurchaseInvoice_Id";
            ...
            if (strBranchID == "0")
            {
                ...
                var q = from d in dc.v_PurchaseInvoiceList_Imports
                        ...
                        && d.InvoiceAdd_addressType == "Shipping"
                        && d.CreatedBy == userid
                     
                        orderby d.PurchaseInvoice_Id descending
                        select d;
