...
{
    public partial class GoodsReceivedNoteList_Import : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //................Cookies..................
                Grid_StockReceipt.SettingsCookies.CookiesID = "BreeezeErpGridCookiesGrid_ImportPageStockReceipt";
                this.Page.ClientScript.RegisterStartupScript(GetType(), "setCookieOnStorage", "<script>addCookiesKeyOnStorage('BreeezeErpGridCookiesGrid_ImportPageStockReceipt');</script>");
                //...........Cookies End............... 
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GoodsReceivedNoteList_Import.aspx");
        ...
        {
         //   Grid_PurchaseInvoice.Columns[7].Visible = false;
            //string filename = "Purchase Order";
            //exporter.FileName = filename;
            exporter.GridViewID = "Grid_StockReceipt";
            exporter.FileName = "ImportStockReceipt";

            exporter.PageHeader.Left = "Import Stock Receipt";
        ...
        public void FillGrid()
        {
            ...
            {
                Grid_StockReceipt.DataSource = dtdata;
                Grid_StockReceipt.DataBind();
            }
            else
            {
                Grid_StockReceipt.DataSource = null;
                Grid_StockReceipt.DataBind();
            }
        }
        ...
        protected void Grid_StockReceipt_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            DataTable PurchaseOrderdt = new DataTable();
            string Command = Convert.ToString(e.Parameters).Split('~')[0];
            string StockReceiptID = null;
            int deletecnt = 0;
            if (Convert.ToString(e.Parameters).Contains("~"))
            {
                if (Convert.ToString(e.Parameters).Split('~')[1] != "")
                {
                    StockReceiptID = Convert.ToString(e.Parameters).Split('~')[1];
                }
            }
            Grid_StockReceipt.JSProperties["cpDelete"] = null;
            if (Command == "Delete")
            {
            //    if (!IsPITransactionExist(StockReceiptID))
            //    {
                deletecnt = blLayer.DeleteStockReceipt(StockReceiptID);

                    if (deletecnt == 1)
                    {
                        Grid_StockReceipt.JSProperties["cpDelete"] = "Deleted successfully";
                ...
                //else
                //{
                //    Grid_StockReceipt.JSProperties["cpDelete"] = "This Purchase Order is tagged in other modules. Cannot Delete.";
                //}
        ...
        {
            e.KeyExpression = "GoodReceivedNote_Id";
            ...
            string connectionString = Convert.ToString(HttpContext.Current.Session["ErpConnection"]);
            ...
            if (strBranchID == "0")
            {
                ...
                var q = from d in dc.v_ImportStockReceiptLists
                        ...
                        && d.GRNAdd_addressType == "Shipping"
                     //   && d.CreatedBy == userid

                        orderby d.GoodReceivedNote_Id descending
                        select d;
