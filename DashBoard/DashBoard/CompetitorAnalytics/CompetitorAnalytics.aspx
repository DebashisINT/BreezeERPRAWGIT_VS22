<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompetitorAnalytics.aspx.cs" Inherits="DashBoard.DashBoard.CompetitorAnalytics.CompetitorAnalytics" %>
...
<body>
    ...
    <div class="col-md-12 " id="competitorAnalytics">
            <h1 class="leadH">Competitor Analytics</h1>

            <div class="clearfix">
                <div class="row">
                    <div class="col-md-12">
                        <div id=""><img src="/assests/images/dbCom.jpg" class="resposive-image"></div>
                    </div>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="leaderboardHeader">CREDIT CARD HOLDING BY CUSTOMERS
                                <div class="pull-right">
                                    <table>
                                        <tbody><tr>
                                            <td style="font-size:13px;font-weight:400">Select Item</td>
                                            <td>
                                                <select>
                            ...
                            <div id=""><img src="/assests/images/creditCard.jpg" class="resposive-image"></div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="leaderboardHeader">ICICI VS HDFC</div>
                            <div id=""><img src="/assests/images/icvshd.jpg" class="resposive-image"></div>
                        </div>
                    </div>
