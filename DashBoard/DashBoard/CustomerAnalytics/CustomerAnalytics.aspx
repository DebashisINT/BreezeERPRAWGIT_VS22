<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerAnalytics.aspx.cs" Inherits="DashBoard.DashBoard.CustomerAnalytics.CustomerAnalytics" %>
...
<body>
    <form id="form1" runat="server">
     <div class="col-md-12 " id="customerAnalytics">
                <h1 class="leadH">Customer Analytics</h1>
                                    
                <div class="clearfix">
                    <div class="row">
                        <div class="col-md-12">
                            <div id=""><img src="/assests/images/nw.jpg" class="resposive-image"></div>
                        </div>
                        <div class="col-md-12">
                            <div class="card">
                                <div class="leaderboardHeader">YEAR WISE - CUSTOMER ANALYTICS (BY UNITS)</div>
                                <div id=""><img src="/assests/images/yearWise.jpg" class="resposive-image"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="card">
                                <div class="leaderboardHeader">CUSTOMER AGEING (BY YEARS)</div>
                                <div id=""><img src="/assests/images/ageing.jpg" class="resposive-image"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="card">
                                <div class="leaderboardHeader">SERVICES RECEIVED BY CUSTOMERS</div>
                                <div id=""><img src="/assests/images/servicess.jpg" class="resposive-image"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="card">
                                <div class="leaderboardHeader">RATING BY ISSUE RESOLUTION</div>
                                <div id=""><img src="/assests/images/rating.jpg" class="resposive-image"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="card">
                                <div class="leaderboardHeader">EMPLOYEE BEHAVIOUR</div>
                                <div id=""><img src="/assests/images/behaviour.jpg" class="resposive-image"></div>
                            </div>
                        </div>
                    </div>
                </div>
