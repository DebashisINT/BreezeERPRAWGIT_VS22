...
namespace DashBoard.DashBoard.FinancialDB
{
    public partial class FinancialDB : System.Web.UI.Page
    {
        ...
        [WebMethod]
        //for Activities
        public static object GetonRefresh()
        {
            //List<TopBoxDataClass> lEfficency = new List<TopBoxDataClass>();
            ProcedureExecute proc = new ProcedureExecute("PRC_STOCK_ADDEDIT");
