...
{
    public partial class Reports_TopClientsByBrokarage : System.Web.UI.Page
    {
        ...
        void procedure()
        {
            ...
            //cmd.Connection = con;
            //cmd.CommandText = "[Report_MISReport]";
            //cmd.CommandType = CommandType.StoredProcedure;

            //cmd.Parameters.AddWithValue("@Module", "TopClientsByBrokarage");
            //cmd.Parameters.AddWithValue("@NoOfClients", txtNo.Text);
            //cmd.Parameters.AddWithValue("@dateFrom", dtFrom.Value);
            //cmd.Parameters.AddWithValue("@dateTo", dtTo.Value);
            ...
            //cmd.Parameters.AddWithValue("@FinancialYear",HttpContext.Current.Session["LastFinYear"].ToString());
            ...
            //da.Fill(ds);
            //da.Dispose();
            ds = misrep.Report_MISReport("TopClientsByBrokarage", txtNo.Text, dtFrom.Value.ToString(), dtTo.Value.ToString(),
        ...
        protected void btnshow_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                strHtml += "<td align=\"left\" colspan=6><B>" + "Total Of TotalBrokarage During The Period :  " + dt1.Rows[0]["TotalBrokarage"].ToString() + "</B></td>";
                strHtml += "</tr>";
                ...
                strHtml += "<td align=\"center\"><b>Brokarage</b></td>";
                ...
                if (dt1.Rows.Count > 0)
                {
                    for (i = 0; i < dt1.Rows.Count; i++)
                    {
                        ...
                        strHtml += "<td align=\"right\">" + dt1.Rows[i]["Brokarage"].ToString() + " </td>";
                    ...
                    strHtml += "<tr id=\"tr_id" + flag + "&" + GetRowColor(flag) + "\" onclick=heightlight(this.id) style=\"background-color: " + GetRowColor(flag) + " ;text-align:center\">";
                    strHtml += "<td></td>";
                    strHtml += "<td align=\"left\"><B>" + "Total : " + "</B></td>";
                    strHtml += "<td></td>";
                    strHtml += "<td align=\"right\" colspan=2> <B>" + dt1.Rows[0]["SumBrokarage"].ToString() + "</B> </td>";
                    strHtml += "</tr>";
        ...
        protected void export()
        {
            ...
            else
            {
                ...
                dtExport1.Columns.Add("Brokarage", Type.GetType("System.String"));
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (ds.Tables[0].Rows[i]["Brokarage"] != DBNull.Value)
                        {
                            row["Brokarage"] = ds.Tables[0].Rows[i]["Brokarage"].ToString();
                        }
                    ...
                    if (ds.Tables[0].Rows[0]["SumBrokarage"] != DBNull.Value)
                    {
                        row1["Brokarage"] = ds.Tables[0].Rows[0]["SumBrokarage"].ToString();
                    ...
                    str = " Top " + ViewState["NoOfClients"] + "  Clients By Brokarage " + " For Period " + oconverter.ArrangeDate2(dtFrom.Value.ToString()) + " - " + oconverter.ArrangeDate2(dtTo.Value.ToString());
                    ...
                    DrRowR2[0] = "Total Of TotalBrokarage During The Period :  " + ds.Tables[0].Rows[0]["TotalBrokarage"].ToString();
                    ...
                    objExcel.ExportToExcelforExcel(dtExport1, "Top Clients By Brokarage", "Total : ", dtReportHeader1, dtReportFooter1);
