            ...
            if (HttpContext.Current.Session["FromNo"] != null && HttpContext.Current.Session["ToNo"] != null)
            {
                if (HttpContext.Current.Session["FromNo"].ToString() != "" && HttpContext.Current.Session["ToNo"].ToString() != "")
                {
                    try
                    {
                        ...
                        cmd.Connection = con;
                        cmd.CommandText = "[Contract_Report_BSECMdos]";
                        ...
                        cmd.Parameters.AddWithValue("@dp", "BSE - CM");
                        ...
                        */
                        ...
                        ds = ObjReport.Get_Contract_Report_BSECMdos(HttpContext.Current.Session["LastCompany"].ToString(), HttpContext.Current.Session["usersegid"].ToString(),
                            "BSE - CM", date, HttpContext.Current.Session["Customer"].ToString(), HttpContext.Current.Session["contractID"].ToString(), "",
