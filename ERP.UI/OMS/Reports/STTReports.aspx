<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" EnableEventValidation="false" AutoEventWireup="true" Inherits="ERP.OMS.Reports.Reports_STTReports" CodeBehind="STTReports.aspx.cs" %>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="gridcellleft">
                                <table cellpadding="1" cellspacing="1" class="tableClass">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">Calculation Type :</td>
                                        <td>
                        ...
                        <tr id="Tr_Asset">
                            <td class="gridcellleft">
                                <table cellpadding="1" cellspacing="1" class="tableClass">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">Asset :</td>
                                        <td>
