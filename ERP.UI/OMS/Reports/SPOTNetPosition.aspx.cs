...
{
    public partial class Reports_SPOTNetPosition : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
    {
        ...
        void ICallbackEventHandler.RaiseCallbackEvent(string eventArgument)
        {
            ...
            else
            {
                ...
                {
                    if (idlist[0] != "Clients" && idlist[0] != "SettlementType")
                    {
        ...
        void procedure()
        {
            ...
            string ChkCharge = string.Empty;
            string Cksign = string.Empty;
            ...
            if (ddlGroup.SelectedItem.Value.ToString() == "3")/////option client wise
            {
                ...
                else
                {
                    ...
                    {
                        ClientsID = Convert.ToString(HiddenField_Client.Value);
                    }
            ...
            {
                instrument = Convert.ToString(HiddenField_ScripsExchange.Value);
            }
            ...
            if (Chksign.Checked)
                ...
                Cksign = "UNCHK";
            ds = oReports.NetPositionSPOT(
                Convert.ToString(dtfor.Value),
                  Convert.ToString(dtfor.Value),
                  "ALL",
                 ...
                 ChkCharge,
                 Cksign,
                  Convert.ToString(ddlrptview.SelectedItem.Value),
                  Convert.ToDecimal(txtAmntGreaterThan.Value),
                  "ALL"
                );
            ...
            for (int j = 0; j < cmbgroup.Items.Count; j++)
            {
                ...
                for (int k = 0; k < cmbclient.Items.Count; k++)
                {
                    ...
                    if (dt1.Rows[0]["STTAX_NAME"] != DBNull.Value)
                    {
                        ...
                        row6[1] = oconverter.formatmoneyinUs(Convert.ToDecimal(dt1.Rows[0]["STTAX_SUM"].ToString()));
                        dtExport.Rows.Add(row6);
                    }
                    ///////////SEBI Fee
                    if (dt1.Rows[0]["SEBICHARGE_NAME"] != DBNull.Value)
                    ...
                    if (dt1.Rows[0]["DELIVERYCHARGE_NAME"] != DBNull.Value)
                    {
                        ...
                        row8[0] = dt1.Rows[0]["DELIVERYCHARGE_NAME"].ToString();
                        row8[1] = oconverter.formatmoneyinUs(Convert.ToDecimal(dt1.Rows[0]["DELIVERYCHARGE"].ToString()));
                    ...
                    if (dt1.Rows[0]["SRVTAXDELIVERYCHARGE_NAME"] != DBNull.Value)
                    {
                        ...
                        row9[0] = dt1.Rows[0]["SRVTAXDELIVERYCHARGE_NAME"].ToString();
                        row9[1] = oconverter.formatmoneyinUs(Convert.ToDecimal(dt1.Rows[0]["SRVTAXDELIVERYCHARGE"].ToString()));
                    ...
                    if (dt1.Rows[0]["NETROUNDOFF_NAME"] != DBNull.Value)
                    {
                        ...
                        row10[0] = dt1.Rows[0]["NETROUNDOFF_NAME"].ToString();
                        row10[1] = oconverter.formatmoneyinUs(Convert.ToDecimal(dt1.Rows[0]["NETROUNDOFF"].ToString()));
                    ...
                    if (dt1.Rows[0]["NETOBLIGATIONCHARGE"] != DBNull.Value)
                    {
                        ...
                        row11[0] = dt1.Rows[0]["NETOBLIGATIONCHARGE_NAME"].ToString();
                        row11[1] = oconverter.formatmoneyinUs(Convert.ToDecimal(dt1.Rows[0]["NETOBLIGATIONCHARGE"].ToString()));
        ...
        void clientwiseemail()
        {
            ...
            for (int j = 0; j < cmbgroup.Items.Count; j++)
            {
                ...
                for (int k = 0; k < cmbclient.Items.Count; k++)
                {
                    ...
                    if (oDBEngine.SendReport(ViewState["mail"].ToString().Trim(), cmbclient.Items[k].Value, ViewState["billdate"].ToString().Trim(), "Net Position [" + ViewState["billdate"].ToString().Trim() + "]") == true)
                    {
        ...
        void optionforemailclient()
        {
            ...
            else
            {
                ...
                {
                    if (oDBEngine.SendReportSt(ViewState["Usermail"].ToString().Trim(), clnt[i].ToString().Trim(), ViewState["billdate"].ToString().Trim(), "Net Position [" + ViewState["billdate"].ToString().Trim() + "]") == true)
                    {
                        if (ViewState["mailsendresult"].ToString().Trim() == "errorsuccess")
                        {
                            ViewState["mailsendresult"] = "someclienterror";
        ...
        void optionforemailshare()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < clnt.Length; i++)
                {
                    if (oDBEngine.SendReportSt(ViewState["GRPmail"].ToString().Trim(), clnt[i].ToString().Trim(), ViewState["billdate"].ToString().Trim(), "Net Position [" + ViewState["billdate"].ToString().Trim() + "]") == true)
                    {
                        if (ViewState["mailsendresult"].ToString().Trim() == "errorsuccess")
                        {
                            ViewState["mailsendresult"] = "someclienterror";
