<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Reports.Reports_frmReport_CommissionPaybleReport" Codebehind="frmReport_CommissionPaybleReport.aspx.cs" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:Panel ID="Panel1" runat="server" Height="100%" Width="990px" ScrollBars="Horizontal">
                                <%--                                <asp:GridView ID="grdCashBankBook" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                    ...
                                    <Columns>
                                         ...
                                         <asp:TemplateField HeaderText="SubBroker">
                                          ...
                                          <asp:TemplateField HeaderText="Payble Commission">
                                            <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblCommission" runat="server" Font-Size="12px" Text='<%# Eval("BaseCommission")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <dxe:aspxgridview id="grdCashBankBook" runat="server" width="100%" clientinstancename="grid"
                                    autogeneratecolumns="False" keyfieldname="trn_id"  >
...
<Header SortingImageSpacing="5px" ImageSpacing="5px"></Header>
                                        ...
                                        <Columns>
<dxe:GridViewDataTextColumn VisibleIndex="0" FieldName="Associates" Caption="Associates">
...
<dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="SalesRep" Caption="Sales Representative">
<Settings AutoFilterCondition="Contains" FilterMode="DisplayText"></Settings>

<CellStyle CssClass="gridcellleft"></CellStyle>
</dxe:GridViewDataTextColumn>
<dxe:GridViewDataTextColumn UnboundType="Integer" VisibleIndex="3" FieldName="SubBroker" Caption="Sub Broker">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxe:GridViewDataTextColumn>
<dxe:GridViewDataTextColumn UnboundType="Integer" VisibleIndex="4" FieldName="TeleCaller" Caption="Tele Caller">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxe:GridViewDataTextColumn>
<dxe:GridViewDataTextColumn VisibleIndex="5" FieldName="branch" Caption="Branch">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxe:GridViewDataTextColumn>
<dxe:GridViewDataTextColumn  VisibleIndex="6" FieldName="policy" Caption="Policy">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxe:GridViewDataTextColumn>
<dxe:GridViewDataTextColumn  VisibleIndex="7" FieldName="mode" Caption="Transaction Mode">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxe:GridViewDataTextColumn>
<dxe:GridViewDataTextColumn  VisibleIndex="8" FieldName="premiumAmt" Caption="Premium Amount">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxe:GridViewDataTextColumn>
<dxe:GridViewDataTextColumn VisibleIndex="9" FieldName="issueDateF" Caption="Issue Date">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxe:GridViewDataTextColumn>
<dxe:GridViewDataTextColumn VisibleIndex="10" FieldName="BaseCommission" Caption="Payble Commission">
<Settings AllowAutoFilter="False"></Settings>
...
<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
                                        ...
                                        <TotalSummary>
<dxe:ASPxSummaryItem FieldName="BaseCommission" DisplayFormat="#,##,###.00" Tag="Total Holding Value" ShowInGroupFooterColumn="BaseCommission" ShowInColumn="BaseCommission" SummaryType="Sum"></dxe:ASPxSummaryItem>
</TotalSummary>
