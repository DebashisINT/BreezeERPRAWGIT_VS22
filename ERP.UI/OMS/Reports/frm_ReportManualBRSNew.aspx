<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Reports.Reports_frm_ReportManualBRSNew" CodeBehind="frm_ReportManualBRSNew.aspx.cs" %>
            ...
            <tr valign="top">
                <td>
                    <table id="tab1" cellspacing="1" cellpadding="2">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DdlReportView" runat="server" CssClass="form-control">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlGeneration" runat="server" CssClass="form-control" onchange="FnddlGeneration(this.value)">
                        ...
                        <tr>
                            ...
                            <td id="td_pdf">
                                <asp:Button ID="btnpdf" runat="server" CssClass="btn btn-warning" Text="Export to PDF"
                                    OnClientClick="selecttion()" OnClick="btnpdf_Click" /></td>
                        </tr>
                        <tr>
                ...
                <td>
                    <table cellpadding="1" cellspacing="1" id="showFilter">
                        <tr>
                            <td>
                                <asp:TextBox ID="txtSelectionID" runat="server" CssClass="form-control" Width="320px" onkeyup="FnCallajax(this,event)"></asp:TextBox></td>
                            <td>
                                <asp:DropDownList ID="cmbsearchOption" runat="server" CssClass="form-control" Width="70px"
                                    Enabled="false">
                            ...
                            <td>
                                <a id="A4" href="javascript:void(0);" class="btn btn-primary" onclick="btnAddsubscriptionlist_click()"><span>Add to List</span></a><span
                        ...
                        <tr>
                            <td style="text-align: center">
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <a id="A2" href="javascript:void(0);" class="btn btn-primary" onclick="clientselectionfinal()"><span>Done</span></a>&nbsp;&nbsp;
                                        </td>
                                        <td>
                                            <a id="A1" href="javascript:void(0);" class="btn btn-danger" onclick="btnRemovefromsubscriptionlist_click()">
                                                <span>Remove</span></a>
                                        </td>
                                    </tr>
                                </table>
