<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" Inherits="ERP.OMS.Reports.Reports_trademodification" CodeBehind="trademodification.aspx.cs" %>
    ...
    <div>
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Trade Modification Report</span></strong></td>
        ...
        <table id="tab1" border="0" cellpadding="0" cellspacing="0">
            <tr valign="top">
                        ...
                        <tr>
                            <td class="gridcellleft">
                                <table class="tableClass" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">Modification Type :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlModification" runat="server" Width="250px" Font-Size="12px">
                                                <asp:ListItem Value="Client">Client Change</asp:ListItem>
                                                <asp:ListItem Value="Split">Split Trades</asp:ListItem>
                                                <asp:ListItem Value="Brkg">Brokerage Change</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
                ...
                <td>
                    <table class="tableBorderClass" cellpadding="1" cellspacing="1" id="showFilter">
                        <tr>
