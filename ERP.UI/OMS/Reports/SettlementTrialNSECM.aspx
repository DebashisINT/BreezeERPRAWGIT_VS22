<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true"
    Inherits="ERP.OMS.Reports.Reports_SettlementTrialNSECM" CodeBehind="SettlementTrialNSECM.aspx.cs" %>
            ...
            <tr>
                ...
                <td class="EHEADER" width="25%" id="filter">
                    <a href="javascript:void(0);" onclick="filter();"><span style="color: Blue; text-decoration: underline; font-size: 8pt; font-weight: bold">Filter</span></a> ||
                        <asp:DropDownList ID="ddlExport" Font-Size="12px" runat="server" AutoPostBack="True"
                    ...
                    <table id="tab_All">
                        ...
                        <tr>
                            <td>
                                <table cellpadding="1" cellspacing="1" class="tableClass">
                                    <tr>
                                        <td bgcolor="#B7CEEC" class="gridcellleft">Report View :
                                        </td>
                                        <td class="gridcellleft" colspan="2">
                                            <asp:DropDownList ID="ddlType" runat="server" Width="128px" Font-Size="12px"
                        ...
                        <tr>
                            <td>
                                <table cellpadding="1" cellspacing="1" class="tableClass">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">Settlement Type
                                        </td>
                                        <td>
                                            <table cellpadding="1" cellspacing="1" class="tableClass">
                                                <tr>
                                                    ...
                                                    <td>(<span id="litSettlementTypeCurrent" runat="server" style="color: Maroon"></span>)
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
