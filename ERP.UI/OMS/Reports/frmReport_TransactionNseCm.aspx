<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Reports.Reports_frmReport_TransactionNseCm" Codebehind="frmReport_TransactionNseCm.aspx.cs" %>
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">Demat Transaction Report</span></strong>
                    </td>
                </tr>
            </table>
            <table class="TableMain100">
                ...
                <tr id="TrFilter">
                    <td colspan="2" style="text-align: right">
                        <span style="font-weight: bold; color: Blue; cursor:pointer" onclick="javascript:ForFilter();">Filter</span>                        
                ...
                <tr id="lnkButton">
                    <td colspan="2">
                        <asp:LinkButton id="btnTransPrevious" runat="server" Font-Bold="True" ForeColor="Blue" OnClick="btnTransPrevious_Click">Previous</asp:LinkButton>&nbsp; 
                           <asp:LinkButton id="btnTransnNext" runat="server" Font-Bold="True" ForeColor="Blue" OnClick="btnTransnNext_Click1">Next</asp:LinkButton> 
                    </td>
                </tr>
            </table>
        </div>
