...
{
    public partial class Reports_frmReport_TransInsurance_Iframe : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
    {
        ...
        public void FillGrid()
        {
            ...
            {
                DT = oDBEngine.GetDataTable(" tbl_trans_InsMain ", " cast(trn_transDate as datetime) as transDate,convert(varchar(11),cast(trn_transDate as datetime),113) as transDateF,cast(trn_issueDate as datetime) as issueDate,convert(varchar(11),cast(trn_issueDate as datetime),113) as issueDateF, " +
