...
{
    public partial class Reports_PositionFileSpanNCDXCOM : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
    {
        ...
        void procedure()
        {
            ...
            fn_Client();
            ds = oDailyTaskOther.ExportPosition_NCDXCOMM(
        ...
        void CreatetxtFile()
        {
            ...
            if (ds.Tables[1].Rows.Count > 0)
            {
                ...
                oDailyTaskOther.sp_Insert_ExportFiles(
                 Convert.ToString(Session["usersegid"]),
                  "FO Position txt",
                  Convert.ToString(ds.Tables[0].Rows[0]["filename1"].ToString()),
                  Convert.ToString(HttpContext.Current.Session["userid"]),
                  Convert.ToString(ds.Tables[0].Rows[0]["rowno"].ToString()),
