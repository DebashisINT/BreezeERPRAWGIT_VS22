<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Reports.Reports_frmReport_NsdlClientMaster" Codebehind="frmReport_NsdlClientMaster.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div>
            ...
            <table class="TableMain100">
                ...
                <tr>
                    <td style="text-align: right; width: 770px;" id="TdExport">
                                    ...
                                    <tr>
                                        <td id="TdGrid">
                                            ...
                                            <dxe:ASPxGridView ID="EmployeeGrid" runat="server" KeyFieldName="BenAccountID"
                                                AutoGenerateColumns="False" Width="970px" ClientInstanceName="grid" OnCustomCallback="EmployeeGrid_CustomCallback"
                                                ...
                                                <Columns>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="0" FieldName="FirstHolderName"
                                                        Width="250px">
                                                        <DataItemTemplate>
                                                    ...
                                                    <dxe:GridViewDataTextColumn VisibleIndex="1" FieldName="BenAccountID" Width="75px"
                                                    ...
                                                    <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="SecondHolderName" Width="150px"
                                                    ...
                                                    <dxe:GridViewDataTextColumn VisibleIndex="5" FieldName="GroupDetails" Caption="Group Details"
                                                        Width="150px">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="6" FieldName="BenAccountStatus"
                                                        Width="75px" Caption="A/C Status">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn VisibleIndex="7" FieldName="BenAccountCategory" Width="150px"
                                                        Caption="A/C Category">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn VisibleIndex="8" FieldName="AccountTypeSubType" Width="150px"
                                                        Caption="A/C Type/ Sub Type">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="9" FieldName="TradingCode"
                                                        Width="75px" Caption="Trading Code">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="10" FieldName="ActivationDate"
                                                        Width="80px" Caption="Activation Date">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="11" FieldName="ClosureDate"
                                                        Width="80px" Caption="Closure Date">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="12" FieldName="FirstHolderAddress"
                                                        Width="250px" Caption="First Holder Address">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataDateColumn ReadOnly="True" VisibleIndex="13" FieldName="FirstHolderEmail"
                                                        Width="150px" Caption="First Holder Email">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataDateColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="14" FieldName="FirstHolderFatherHusbandName"
                                                        Width="150px" Caption="First Holder Father/Husband Name">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="15" FieldName="FirstHolderMobile"
                                                        Width="75px" Caption="First Holder Mobile">
                                                        <CellStyle Wrap="False" HorizontalAlign="Right">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="16" FieldName="NSDLCLIENTS_FIRSTHOLDERPHONE"
                                                        Width="150px" Caption="First Holder Phone">
                                                        <CellStyle Wrap="False" HorizontalAlign="Right">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="17" FieldName="FirstHolderPAN"
                                                        Width="75px" Caption="First Holder PAN">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="18" FieldName="SecondHolderPAN"
                                                        Width="75px" Caption="Second Holder PAN">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="19" FieldName="ThirdHolderPAN"
                                                        Width="75px" Caption="Third Holder PAN">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="20" FieldName="NomineeType"
                                                        Width="150px" Caption="Nominee Type">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="21" FieldName="NomineeName"
                                                        Width="150px" Caption="Nominee/Gurdian Name">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="22" FieldName="NOMINEEAddress"
                                                        Width="250px" Caption="Nominee Address ">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="23" FieldName="MinorNomineeGurdianName"
                                                        Width="250px" Caption="Minor Nominee Gurdian Name">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="24" FieldName="MinorNomineeDOB"
                                                        Width="200px" Caption="Minor Nominee DOB">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="25" FieldName="MinorNomineeAddress"
                                                        Caption="Minor Nominee Address ">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="26" FieldName="BankAccountType"
                                                        Width="150px" Caption="A/C Type">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="27" FieldName="NsdlClients_BenBankName"
                                                        Width="250px" Caption="Bank Name">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="28" FieldName="BankAddress"
                                                        Width="250px" Caption="Bank Address">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="29" FieldName="AccNo"
                                                        Width="200px" Caption="A/C No.">
                                                        <CellStyle Wrap="False" HorizontalAlign="right">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="30" FieldName="MICR"
                                                        Width="150px" Caption="MICR">
                                                        <CellStyle Wrap="False"  HorizontalAlign="right">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="31" FieldName="nsdlCorporatePOA_ShortName"
                                                        Width="200px" Caption="POA Name">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="32" FieldName="nsdlCorporatePOA_POAID"
                                                        Width="150px" Caption="POA ID">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="33" FieldName="nsdlPOAMapping_POACreationdate"
                                                        Width="150px" Caption="POA Act. Date">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="34" FieldName="nsdlCorporatePOA_Description"
                                                        Width="250px" Caption="POA Details">
                                                        <CellStyle Wrap="False" CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="35" Width="150px" FieldName="MICR"
                                                        Caption="Bank MICR">
                                                        <CellStyle Wrap="False"  HorizontalAlign="right">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="36" Width="70px" FieldName="ledgerBalance"
                                                        Caption="Ledger Balance">
                                                        <CellStyle Wrap="False"  HorizontalAlign="right">
                                                        </CellStyle>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="37" Width="70px" FieldName="FreeHolding"
