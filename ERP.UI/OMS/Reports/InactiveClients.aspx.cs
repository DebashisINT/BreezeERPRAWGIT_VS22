...
namespace ERP.OMS.Reports
{
    ...
    public partial class Reports_InactiveClients : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dtdate.Date = Convert.ToDateTime(Session["serverdate"].ToString());
                settno();
            }
        }
        void settno()
        ...
        void procedure()
        {
            ...
            ds = misrep.Report_MISReport_Inactive(days, rdbSegAll.Checked == true ? "All" : Session["usersegid"].ToString(), Session["LastCompany"].ToString());
