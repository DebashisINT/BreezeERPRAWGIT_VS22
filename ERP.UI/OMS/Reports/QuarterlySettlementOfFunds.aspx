<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Reports.Reports_QuarterlySettlementOfFunds" CodeBehind="QuarterlySettlementOfFunds.aspx.cs" %>
    ...
    <div>
        <div class="TableMain100">
            <div class="EHEADER" style="text-align: center;">
                <strong><span style="color: #000099">Quarterly Settlement of Funds</span></strong>
            </div>
        </div>
        <div class="pageContent">
            <div id="showFilter" class="right" style="width: 472px; background-color: #B7CEEC; border: solid 2px  #ccc; display: none;">
                <div style="width: 100%">
                ...
                <div class="frmleftContent" style="text-align: center">
                    <a id="A2" href="javascript:void(0);" onclick="clientselectionfinal()" tabindex="0"><span style="color: #000099; text-decoration: underline; font-size: 10pt;">Done</span></a>&nbsp;&nbsp; <a id="A1"
