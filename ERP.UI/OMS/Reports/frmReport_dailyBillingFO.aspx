<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Reports.Reports_frmReport_dailyBillingFO" EnableEventValidation="false" Codebehind="frmReport_dailyBillingFO.aspx.cs" %>
            ...
            <table class="TableMain100">
                <tr class="EHEADER">
                    <td colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">Daily Billing Report</span></strong>
                    </td>
                    <td style="width: 25%;" id="td_filter">
                        <a href="javascript:void(0);" onclick="Sendmail();"><span style="color: Blue; text-decoration: underline;
                            font-size: 8pt; font-weight: bold">Send Email</span></a>|| <a href="javascript:void(0);"
                    ...
                    <td valign="top" style="height: 247px">
                        <table>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlAppMargin" runat="server" Width="187px" Font-Size="12px">
                                        <asp:ListItem Value="1">Span+Premium+Exposure Margin</asp:ListItem>
                                        <asp:ListItem Value="2">Span+Premium Margin</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td class="gridcellleft" bgcolor="#B7CEEC">
                                    Margin Calculation Type:</td>
                                <td colspan="2">
                                ...
                                <div id="divgrid" runat="Server">
                                    <asp:GridView ID="grdBilling" runat="server" BorderColor="CornflowerBlue" ShowFooter="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="ASN/EXC Fin Sett">
                                                <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                                <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblASNEXCFINSET" runat="server" Text='<%# Eval("ASNEXCFINSET")%>'
                                                        CssClass="gridstyleheight1"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Span Margin">
                                                <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                                <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSpanMrgn" runat="server" Text='<%# Eval("SpanMargin")%>' CssClass="gridstyleheight1"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Premium Margin">
                                                <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                                <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPremiumMrgn" runat="server" Text='<%# Eval("PremiumMargin")%>'
                                                        CssClass="gridstyleheight1"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Exposure Margin">
                                                <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                                <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExposureMrgn" runat="server" Text='<%# Eval("ExposureMargin")%>'
                                                        CssClass="gridstyleheight1"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
