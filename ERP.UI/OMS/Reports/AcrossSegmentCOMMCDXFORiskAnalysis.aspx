<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true"
    Inherits="ERP.OMS.Reports.Reports_AcrossSegmentCOMMCDXFORiskAnalysis" CodeBehind="AcrossSegmentCOMMCDXFORiskAnalysis.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function DateCompare(DateobjFrm, DateobjTo) {
            var Msg = "From Date Can Not Be Greater Than To Date!!!";
            DevE_CompareDateFromMax(DateobjFrm, DateobjTo, Msg);
        }
        function DateCheck(DateobjTo) {
            var FYE = '<%=Session["FinYearEnd"]%>';
            var Msg = "To Date Can Not Be More Than Financial Year!!!";
            DevE_CompareDateToMax(DateobjTo, FYE, Msg);
        }
    ...
    <script type="text/javascript" language="javascript">
        function fn_Segment(obj) {
            if (obj == "a") {
                ...
                var cmbSegment = document.getElementById('cmbsearchOption');
                cmbSegment.value = 'Segment';
                Show('showFilter');
                document.getElementById('divExport').style.display = 'none';
                document.getElementById('txtSelectionID').focus();
            }
        }
    ...
    <div>
        <div class="TableMain100">
            <div class="EHEADER" style="text-align: center;">
                <strong><span style="color: #000099">Across Segment COMM/CDX/FO Risk Analysis</span></strong>
            </div>
        </div>
        <br class="clear" />
                ...
                <div id="showFilter" class="right" style="width: 452px; background-color: #B7CEEC; border: solid 2px  #ccc; display: none;">
                    <div style="width: 100%">
                        ...
                        <div class="frmleftContent" style="padding-top: 3px">
                            <asp:DropDownList ID="cmbsearchOption" runat="server" Font-Size="13px" Width="85px"
                                Enabled="false">
                        ...
                        <div class="left">
                            ...
                            <div class="frmleftContent">
                                <dxe:ASPxDateEdit ID="dtto" runat="server" ClientInstanceName="dtto" DateOnError="Today"
                                    ...
                                    <ClientSideEvents DateChanged="function(s,e){DateCheck(dtto);}"></ClientSideEvents>
                                </dxe:ASPxDateEdit>
                            </div>
                        </div>
                    </div>
                    <span class="clear"></span>
                    <div id="forSegment" class="Row">
                        <div class="frmleftContent" style="width: 110px; line-height: 20px">
                            <asp:Label ID="lblSegment" runat="server" Text="Segment : "></asp:Label>
                        </div>
                        <div id="divSegment" class="frmleftContent" style="width: 125px; padding-top: 3px; font-size: 12px;">
                            <asp:RadioButton ID="rdbSegmentAll" runat="server" Checked="True" GroupName="seg" onclick="fn_Segment('a')"
                                TabIndex="0" />
                            All
                                <asp:RadioButton ID="rdbSegmentSelected" runat="server" GroupName="seg" onclick="fn_Segment('b')"
                                    TabIndex="0" />Selected
                        </div>
                    </div>
                    <span class="clear"></span>
