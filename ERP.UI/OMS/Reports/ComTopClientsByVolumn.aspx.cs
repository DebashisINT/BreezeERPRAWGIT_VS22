...
{
    public partial class Reports_TopClientsByVolumn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dtFrom.Value = oDBEngine.GetDate().AddDays(-30);
        ...
        protected void btnshow_Click(object sender, EventArgs e)
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                strHtml += "<td align=\"left\" colspan=6><B>" + "Total Market Value During The Period :  " + Convert.ToString(dt1.Rows[0]["TotalValue"]) + "</B></td>";
            }
            else
            {
                strHtml += "<td align=\"left\" colspan=6><B>" + "Total Market Value During The Period :  " + "0" + "</B></td>";
            }
            strHtml += "</tr>";
