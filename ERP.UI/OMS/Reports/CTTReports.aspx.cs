...
{
    public partial class Reports_CTTReports : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
    {
        ...
        void FnHtml(DataSet ds)
        {
            ...
            {
                //------ For Rename Column Name  Start -------------------

                string vColumnname = "";
                vColumnname = ds.Tables[0].Columns[i].ColumnName.ToString().ToUpper();

                vColumnname = vColumnname.Replace("STT", "CTT");

                //------ For Rename Column Name  End -------------------


                strHtml += "<td align=\"center\" style=\"font-size:smaller;\" nowrap=nowrap;><b>" + vColumnname + "</b></td>";
            }
            strHtml += "</tr>";
        ...
        void export(DataSet ds)
        {
            ...
            for (int i = 0; i < dtExport.Columns.Count; i++)
            {
                ...
                string vColumnname = "";
                vColumnname = dtExport.Columns[i].ColumnName.ToString().ToUpper();
                vColumnname = vColumnname.Replace("STT", "CTT");
                dtExport.Columns[i].ColumnName = vColumnname;
            ...
            objExcel.ExportToExcelforExcel(dtExport, "CTT Reports", "Client Total", dtReportHeader, dtReportFooter);
