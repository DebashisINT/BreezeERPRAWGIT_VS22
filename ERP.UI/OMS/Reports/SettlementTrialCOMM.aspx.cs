...
{
    public partial class Reports_SettlementTrialCOMM : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
    {
        ...
        DataSet Procedure(string DisPlayType)
        {
            ...
            string retSp = oGenericMethod.OldSpExecuteWriter("Report_SettlementTrialCOMM", InputName, InputValue);

            //////////////Sp Call
            ds = SQLProcedures.SelectProcedureArrDS("[Report_SettlementTrialCOMM]", InputName, InputType, InputValue);
        ...
        string FnHtml(DataSet ds)
        {
            ...
            foreach (DataRow dr1 in ds.Tables[1].Rows)
            {
                ...
                for (int j = 0; j < ds.Tables[1].Columns.Count; j++)
                {
                    ...
                    {
                        if (dr1[j].ToString().Trim().StartsWith("Branch") || dr1[j].ToString().Trim().StartsWith("Client Total:") || dr1[j].ToString().Trim().StartsWith("Total:") || dr1[j].ToString().Trim().StartsWith("Grand Client Total:") || dr1[j].ToString().Trim().StartsWith("Client Net :") || dr1[j].ToString().Trim().StartsWith("Round"))
                        {
        ...
        void Export(DataSet ds)
        {
            ...
            if ((cmbExport.SelectedItem.Value.ToString().Trim() == "E") || (ddlGeneration.SelectedValue.ToString() == "3"))
