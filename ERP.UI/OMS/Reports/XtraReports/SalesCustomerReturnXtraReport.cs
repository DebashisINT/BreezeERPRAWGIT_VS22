...
{
    public partial class SalesCustomerReturnXtraReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        int serial_no;
        string barcode_slno = "";
        public SalesCustomerReturnXtraReport()
        {
            InitializeComponent();
        }
        ...
        private void xrSubreport1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            xrSubReport.ReportSource.Parameters["ReturnId"].Value = Convert.ToInt32(xrLabel19.Text);
        }
    }
}
