<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.QuotationReportViewer" %>
...
<head runat="server">
   <link rel="stylesheet" href="/assests/css/custom/main.css" />
    ...
    <title>Proforma Invoice/ Quotation</title>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../management/Activities/SalesQuotationList.aspx"><i class="fa fa-times"></i></a></div>
    <div>
