...
{
    public partial class QuotationReportViewer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            QuotationXtraReport jv = new QuotationXtraReport();
            ...
            {
                var param1 = jv.Parameters.GetByName("Quote_id");
