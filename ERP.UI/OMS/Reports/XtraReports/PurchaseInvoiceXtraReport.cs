...
{
    public partial class PurchaseInvoiceXtraReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        int serial_no;
        string barcode_slno = "";
        public PurchaseInvoiceXtraReport()
        {
            InitializeComponent();
        }
        ...
        private void xrSubreport1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            xrSubReport.ReportSource.Parameters["PInvoice_id"].Value = Convert.ToInt32(xrLabel19.Text);
        }
