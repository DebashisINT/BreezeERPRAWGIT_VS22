<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseInvoiceReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.PurchaseInvoiceReportViewer" %>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/Purchaseinvoicelist.aspx"><i class="fa fa-times"></i></a></div>
    <div>
