<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.OrderReportViewer" %>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/SalesOrderList.aspx"><i class="fa fa-times"></i></a></div>
    <div>
