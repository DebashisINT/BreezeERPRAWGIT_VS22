<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReturnGRNReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.PurchaseReturnGRNReportViewer" %>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/PurchaseReturnIssueList.aspx"><i class="fa fa-times"></i></a></div>
    <div>
