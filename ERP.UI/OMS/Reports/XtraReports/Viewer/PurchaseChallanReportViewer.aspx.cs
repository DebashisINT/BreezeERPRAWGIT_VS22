...
{
    public partial class PurchaseChallanReportViewer : System.Web.UI.Page
    {
        ...
        {
            PurchaseChallanXtraReport jv = new PurchaseChallanXtraReport();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                jv.PrintCopy = Convert.ToInt32(Request.QueryString["PrintOption"]);
            }


            if (Request.QueryString["id"] != null)
            {
                var param1 = jv.Parameters.GetByName("PChallan_id");
