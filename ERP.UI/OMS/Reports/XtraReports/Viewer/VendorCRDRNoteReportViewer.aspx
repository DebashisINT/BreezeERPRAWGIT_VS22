<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorCRDRNoteReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.VendorCRDRNoteReportViewer" %>
...
<head runat="server">
   <link rel="stylesheet" href="/assests/css/custom/main.css" />
    ...
    <title>Vendor Debit Credit Note</title>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/VendorDebitCreditNote.aspx"><i class="fa fa-times"></i></a></div>
    <div>
