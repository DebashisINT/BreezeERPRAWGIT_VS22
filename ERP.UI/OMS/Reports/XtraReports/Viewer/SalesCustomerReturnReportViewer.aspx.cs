...
{
    public partial class SalesCustomerReturnReportViewer : System.Web.UI.Page
    {
        ...
        {
            SalesCustomerReturnXtraReport jv = new SalesCustomerReturnXtraReport();
            ...
            {
                var param1 = jv.Parameters.GetByName("Return_id");
