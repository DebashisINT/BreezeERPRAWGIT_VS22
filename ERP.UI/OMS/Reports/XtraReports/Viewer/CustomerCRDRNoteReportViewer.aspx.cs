...
{
    public partial class CustomerCRDRNoteReportViewer : System.Web.UI.Page
    {
        ...
        {
            CustomerCRDRNoteXtraReport jv = new CustomerCRDRNoteXtraReport();
            ...
            {
                var param1 = jv.Parameters.GetByName("Customer_CRDR_id");
