<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReturnReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.PurchaseReturnReportViewer" %>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/PuchaseReturnList.aspx"><i class="fa fa-times"></i></a></div>
    <div>
