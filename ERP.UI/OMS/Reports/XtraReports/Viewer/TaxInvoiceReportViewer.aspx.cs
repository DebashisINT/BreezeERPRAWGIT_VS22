...
{
    public partial class TaxInvoiceReportViewer : System.Web.UI.Page
    {
        ...
        {
            TaxSalesInvoiceXtraReport jv = new TaxSalesInvoiceXtraReport();
            ...
            {
                var param1 = jv.Parameters.GetByName("Invoice_id");
