<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseChallanReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.PurchaseChallanReportViewer" %>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/PurchaseChallanList.aspx"><i class="fa fa-times"></i></a></div>
    <div>
