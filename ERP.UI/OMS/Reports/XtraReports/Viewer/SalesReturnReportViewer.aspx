<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesReturnReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.SalesReturnReportViewer" %>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/SalesReturnList.aspx"><i class="fa fa-times"></i></a></div>
    <div>
