<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChallanReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.ChallanReportViewer" %>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/SalesChallan.aspx"><i class="fa fa-times"></i></a></div>
    <div>
