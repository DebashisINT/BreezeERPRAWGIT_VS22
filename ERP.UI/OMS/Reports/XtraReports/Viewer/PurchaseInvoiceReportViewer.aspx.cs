...
{
    public partial class PurchaseInvoiceReportViewer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PurchaseInvoiceXtraReport jv = new PurchaseInvoiceXtraReport();
            ...
            {
                var param1 = jv.Parameters.GetByName("PInvoice_id");
