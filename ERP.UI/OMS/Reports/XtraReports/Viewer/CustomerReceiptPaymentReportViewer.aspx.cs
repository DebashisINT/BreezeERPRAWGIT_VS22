...
{
    public partial class CustomerReceiptPaymentReportViewer : System.Web.UI.Page
    {
        ...
        {
           CustomerReceiptPaymentXtraReport jv = new CustomerReceiptPaymentXtraReport();
            ...
            {
                var param1 = jv.Parameters.GetByName("Customer_PR_id");
