<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaxInvoiceReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.TaxInvoiceReportViewer" %>
...
<body>
    ...
    <div>
     <%--<div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/SalesInvoiceList.aspx"><i class="fa fa-times"></i></a></div>--%>
    <div>
