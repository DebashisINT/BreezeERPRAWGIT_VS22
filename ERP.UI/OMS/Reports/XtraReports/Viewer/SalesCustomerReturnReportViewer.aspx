<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesCustomerReturnReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.SalesCustomerReturnReportViewer" %>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/CustomerReturnList.aspx"><i class="fa fa-times"></i></a></div>
    <div>
