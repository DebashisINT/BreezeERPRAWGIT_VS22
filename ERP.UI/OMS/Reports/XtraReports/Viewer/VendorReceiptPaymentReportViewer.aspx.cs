...
{
    public partial class VendorReceiptPaymentReportViewer : System.Web.UI.Page
    {
        ...
        {
            VendorReceiptPaymentXtraReport jv = new VendorReceiptPaymentXtraReport();
            ...
            {
                var param1 = jv.Parameters.GetByName("Vendor_PR_id");
