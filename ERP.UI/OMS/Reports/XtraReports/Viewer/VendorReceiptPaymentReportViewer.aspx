<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorReceiptPaymentReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.VendorReceiptPaymentReportViewer" %>
...
<head runat="server">
   <link rel="stylesheet" href="/assests/css/custom/main.css" />
    ...
    <title>Vendor Receipt/Payment</title>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/VendorPaymentReceiptList.aspx"><i class="fa fa-times"></i></a></div>
    <div>
