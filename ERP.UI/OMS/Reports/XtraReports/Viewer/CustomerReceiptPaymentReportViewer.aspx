<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerReceiptPaymentReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.CustomerReceiptPaymentReportViewer" %>
...
<head runat="server">
   <link rel="stylesheet" href="/assests/css/custom/main.css" />
    ...
    <title>Customer Receipt/Payment</title>
...
<body>
    ...
    <div>
     <%--<div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/CustomerReceiptPaymentList.aspx"><i class="fa fa-times"></i></a></div>--%>
    <div>
