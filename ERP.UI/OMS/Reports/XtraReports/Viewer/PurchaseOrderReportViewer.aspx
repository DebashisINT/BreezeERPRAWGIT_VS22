<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrderReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.PurchaseOrderReportViewer" %>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/PurchaseOrderList.aspx"><i class="fa fa-times"></i></a></div>
    <div>
