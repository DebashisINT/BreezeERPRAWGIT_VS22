...
{
    public partial class PurchaseOrderReportViewer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PurchaseOrderXtraReport jv = new PurchaseOrderXtraReport();
            ...
            {
                var param1 = jv.Parameters.GetByName("POrder_id");
