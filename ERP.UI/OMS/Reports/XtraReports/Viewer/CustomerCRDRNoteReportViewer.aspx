<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerCRDRNoteReportViewer.aspx.cs" Inherits="ERP.OMS.Reports.XtraReports.Viewer.CustomerCRDRNoteReportViewer" %>
...
<head runat="server">
   <link rel="stylesheet" href="/assests/css/custom/main.css" />
    ...
    <title>Customer Debit Credit Note</title>
...
<body>
    ...
    <div>
     <div class="crossBtn" style="top: 41px;color:#ccc"><a href=" ../../../management/Activities/CustomerNote.aspx"><i class="fa fa-times"></i></a></div>
    <div>
