...
{
    public partial class QuotationXtraReportNew : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void xrSubreport1_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            xrSubReport.ReportSource.Parameters["QuoteId"].Value = Convert.ToInt32(xrLabel19.Text);
        }
