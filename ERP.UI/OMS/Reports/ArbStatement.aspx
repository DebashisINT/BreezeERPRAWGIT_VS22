<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Reports.Reports_ArbStatement" CodeBehind="ArbStatement.aspx.cs" %>
                    ...
                    <table>
                        ...
                        <tr id="Tr_Exchange">
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">Exchange</td>
                                        <td align="left">&nbsp;<asp:RadioButton ID="RdoExchange_ALL" runat="server" Checked="True" GroupName="RdbGroup_Exchange" onclick="fnArbExchange('ALL')" /></td>
                                        <td align="left" style="width: 22px">ALL</td>
                                        <td align="left">
                                            <asp:RadioButton ID="RdoExhange_Selected" runat="server" GroupName="RdbGroup_Exchange" onclick="fnArbExchange('SELECTED')" /></td>
                        ...
                        <tr id="Tr_Segment">
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1" style="width: 398px">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">Segment</td>
                                        <td align="left">
                                            <asp:CheckBox ID="ChkSegment_CM" runat="server" Checked="true" />CM</td>
                                        <td align="left">
                                            <asp:CheckBox ID="ChkSegment_FO" runat="server" Checked="true" />FO</td>
                                        <td align="left">
                                            <asp:CheckBox ID="ChkSegment_CDX" runat="server" Checked="true" />CDX</td>
                                        <td align="left">
                                            <asp:CheckBox ID="ChkSegment_COMM" runat="server" Checked="true" />COMM</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
