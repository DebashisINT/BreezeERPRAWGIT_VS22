...
{
    public partial class Reports_frm_ContactChargeSetup : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dtDate.Value = oDBEngine.GetDate();
            }
            Page.ClientScript.RegisterStartupScript(GetType(), "height", "<script>height();</script>");
            Page.ClientScript.RegisterStartupScript(GetType(), "height1", "<script>Page_Load();</script>");
        ...
        public void Procedure()
        {
            ...
            ds = mr.Fetch_ChargeSetupDetails1(dtDate.Value.ToString(), cmpType.SelectedItem.Value.ToString(), cmbBasis.SelectedItem.Value.ToString(),
                 Session["usersegid"].ToString(), Session["LastCompany"].ToString(), GRPTYPE, Groupby, CLIENTS);
            ViewState["DatasetMain"] = ds;
            GridBind();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "JSct1", "selecttion()", true);
        }
