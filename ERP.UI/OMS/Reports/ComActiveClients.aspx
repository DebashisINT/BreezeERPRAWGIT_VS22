<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Reports.Reports_ComActiveClients" CodeBehind="ComActiveClients.aspx.cs" %>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Most / Least Active Clients</span></strong></td>
        ...
        <table id="tab2" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="5" class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td bgcolor="#b7ceec" style="width: 84px">
                                            <strong>Most &nbsp;:</strong>
                                        </td>
            ...
            <tr>
                <td>
                    ...
                    <table id="tbl_Inactive">
                        <tr>
                            <td bgcolor="#b7ceec" style="width: 587px">
                                <strong>Select
                                    <asp:TextBox ID="txtNo1" runat="server" onkeypress="return AllowNumericOnly(this);"
                                        Width="50px">10</asp:TextBox>
                                    Clients who have traded less than
                                    <asp:TextBox ID="txtPercentage1" runat="server" onkeypress="return AllowNumericOnly(this);"
                                        Width="39px">10</asp:TextBox>
                                    % of working days during the period </strong>
                            </td>
                        </tr>
                    </table>
