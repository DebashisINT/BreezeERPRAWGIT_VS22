<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" Inherits="ERP.OMS.Reports.Reports_SPOTNetPosition" CodeBehind="SPOTNetPosition.aspx.cs" %>
                        ...
                        <tr>
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr valign="top">
                                        <td class="gridcellleft">
                                            <asp:DropDownList ID="ddldate" runat="server" Width="100px" Font-Size="12px" onchange="fn_ddldateChange(this.value)" Enabled="False">
                                        ...
                                        <td id="td_dtfor" class="gridcellleft">
                                            <dxe:ASPxDateEdit ID="dtfor" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                Font-Size="12px" Width="108px" ClientInstanceName="dtfor" EditFormatString="dd-MM-yyyy">
                                    ...
                                    <tr id="tr_otherselection" valign="top">
                                        <td>
                                            <table border="10" cellpadding="1" cellspacing="1">
                                                ...
                                                <tr id="tr_setttype">
                                                    <td>
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:RadioButton ID="rdSetttypeSelected" runat="server" GroupName="cb" onclick="fn_Settlementtype('b')" Enabled="false" Visible="False" />&nbsp;
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="gridcellleft" bgcolor="#B7CEEC">
                                                        <asp:CheckBox ID="Chksign" runat="server" onclick="selecttion()" />
                        ...
                        <tr id="tr_Securitytype">
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="DdlSecurityType" runat="server" Font-Size="11px" Width="150px" Visible="False">
