...
namespace ERP.OMS.Reports
{
    public partial class Reports_frmReport_LeaveBalance_FromMyPage : System.Web.UI.Page
    {
        ...
        ClsDropDownlistNameSpace.clsDropDownList clsd = new ClsDropDownlistNameSpace.clsDropDownList();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                clsd.AddDataToDropDownList(branches, cmbBranch, "All");
                ...
                clsd.AddDataToDropDownList(companies, cmbCompany, "All");
