<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="True" Inherits="ERP.OMS.Reports.Reports_TurnoverReportCM" CodeBehind="TurnoverReportCM.aspx.cs" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function FunClientScrip(objID, objListFun, objEvent) {
            ...
            if (document.getElementById('cmbsearchOption').value == "Clients") {
                ...
                //            else  if(document.getElementById('cmbsearchOption').value=="Broker")
                //            {
                //            
                //                 ajax_showOptions(objID,"Broker",objEvent);
                //            }
            else {
        ...
        function FnrptViewClient(obj) {
            if (obj == '12') {
                ...
                Hide('Td_ActivePassive');
                Show('Tr_Company');
                Hide('Td_ShowProClientSplit');
                ...
                if (obj == "1" || obj == "2" || obj == "3")
                    Show('Td_ActivePassive');
                else
                    Hide('Td_ActivePassive');

                if (obj == "1" || obj == "3")
                    Show('Td_ShowProClientSplit');
                else
                    Hide('Td_ShowProClientSplit');
            }
        }
        ...
        function FnChkSplit(obj, objtype) {
            if (objtype == 'AP') {
                if (obj.checked == true) {
                    Hide('Td_ShowProClientSplit');
                }
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="gridcellleft">
                                <table cellpadding="1" cellspacing="1" class="tableClass">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">Report For :</td>
                                        <td>
                            ...
                            <td class="gridcellleft">
                                <table cellpadding="1" cellspacing="1" class="tableClass">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DdlrptViewClient" runat="server" Width="250px" Font-Size="12px" onchange="FnrptViewClient(this.value)">
                                                ...
                                                <asp:ListItem Value="4">OrderNumber Wise [Detail]</asp:ListItem>
                                                <asp:ListItem Value="5">OrderNumber Wise [Summary]</asp:ListItem>
                            ...
                            <td class="gridcellleft">
                                <table cellpadding="1" cellspacing="1" class="tableClass">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">Report View :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlrptViewExchange" runat="server" Width="250px" Font-Size="12px" onchange="FnrptViewExchange(this.value)">
                                                <asp:ListItem Value="1">Date Wise</asp:ListItem>
                                                <asp:ListItem Value="2">Asset Wise</asp:ListItem>
                                                <asp:ListItem Value="3">Consolidated</asp:ListItem>
                                                <asp:ListItem Value="4">Product Wise Delivery & Sqr Off</asp:ListItem>
                        ...
                        <tr id="tr_productinstrument" runat="server">
                            <td colspan="4">
                                <table cellpadding="1" cellspacing="1" class="tableBorderClass">
                                    ...
                                    <tr id="Tr_Scrip">
                                        <td class="gridcellleft" bgcolor="#B7CEEC">Instument(s)</td>
                                        <td>
                                    ...
                                    <tr id="Tr_Assets">
                                        <td bgcolor="#b7ceec" class="gridcellleft">Product(s)</td>
                                        <td>
                            ...
                            <td class="gridcellleft">
                                <table cellpadding="1" cellspacing="1" class="tableClass">
                                    <tr>
                                        ...
                                        <td class="gridcellleft" bgcolor="#B7CEEC" id="Td_ActivePassive">
                                            <asp:CheckBox ID="ChkActivePassive" runat="server" onclick="FnChkSplit(this,'AP')" />
                                            Show Active/Passive Splitted
                                        </td>
                                        <td class="gridcellleft" bgcolor="#B7CEEC" id="Td_ShowProClientSplit">
                                            <asp:CheckBox ID="ChkShowProClientSplit" runat="server" onclick="FnChkSplit(this,'PC')" />
                                            Show Pro/Client Splitted
                                        </td>
                                    </tr>
                                </table>
                            </td>
