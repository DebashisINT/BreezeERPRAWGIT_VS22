...
{
    public partial class Reports_ComActiveClients : System.Web.UI.Page
    {
        ...
        void procedure()
        {
            ...
            ds = mis.Report_ComMISReport_Active(ddlActive.SelectedValue == "0" ? "Active Clients" : "Inactive Clients",
                NoOfClients, dtFrom.Value.ToString(), dtTo.Value.ToString(), Percentage, rdbSegAll.Checked == true ? "All" : Session["usersegid"].ToString(),
