...
namespace ERP.OMS.Reports
{
    ...
    public partial class Reports_ComTopClientsByVolumn : System.Web.UI.Page
    {
        ...
        void procedure()
        {
            ds = mis.Report_ComMISReport("TopClientsByVolumn", txtNo.Text, dtFrom.Value.ToString(),
              dtTo.Value.ToString(), rdbSegAll.Checked == true ? "All" : Session["usersegid"].ToString(),
              Session["LastCompany"].ToString(), HttpContext.Current.Session["LastFinYear"].ToString());
        ...
        protected void btnshow_Click(object sender, EventArgs e)
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                strHtml += "<td align=\"left\" colspan=6><B>" + "Total Of TotalBrokarage During The Period :  " + Convert.ToString(dt1.Rows[0]["TotalBrokarage"]) + "</B></td>";
            }
            else
            {
                strHtml += "<td align=\"left\" colspan=6><B>" + "Total Of TotalBrokarage During The Period :  " + "0" + "</B></td>";
            }
            strHtml += "</tr>";
