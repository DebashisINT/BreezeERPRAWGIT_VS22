<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Reports.Reports_ChequePrintingintermediate" CodeBehind="ChequePrintingintermediate.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
                        ...
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblPrint" runat="server" Text="Print:" Width="37px" Height="22px"></asp:Label>
                ...
                <td style="width: 100%">
                    <asp:GridView ID="gridview" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="gridview_PageIndexChanging" ForeColor="#333333" Width="100%" OnRowDataBound="gridview_RowDataBound" OnRowUpdating="gridview_RowUpdating">
                        <Columns>
                            ...
                            <asp:BoundField DataField="CashBankDetail_InstrumentDate" HeaderText="Instrument Date">
                                <ItemStyle Font-Size="Small" />
                                <HeaderStyle Font-Size="Small" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="cnt_branchID" HeaderText="BranchId" Visible="true">
                                <ItemStyle Font-Size="Small" />
                                <HeaderStyle Font-Size="Small" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="ClientBankID" HeaderText="Client BankID" Visible="true">
                                <ItemStyle Font-Size="Small" />
                                <HeaderStyle Font-Size="Small" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ClientBankName" HeaderText="Client BankName" Visible="true">
                                <ItemStyle Font-Size="Small" />
                                <HeaderStyle Font-Size="Small" />
                            </asp:BoundField>
        ...
        <cr:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="ChequePrint.rpt">
            </Report>
