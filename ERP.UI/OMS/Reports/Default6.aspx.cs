...
namespace ERP.OMS.Reports
{
    ...
    public partial class Reports_Default6 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@dp", "NSE - CDX");
                ...
                */
                ...
                ds = ObjReport.Data_ICEXContract_Reportdos(HttpContext.Current.Session["LastCompany"].ToString(), HttpContext.Current.Session["usersegid"].ToString(),
                    "NSE - CDX", date, HttpContext.Current.Session["Customer"].ToString(), HttpContext.Current.Session["contractID"].ToString(), "",
