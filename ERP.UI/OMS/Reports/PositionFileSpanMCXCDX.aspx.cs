...
{
    public partial class Reports_PositionFileSpanMCXCDX : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
    {
        ...
        void procedure()
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["DBConnectionDefault"]))
            {
                ...
                //cmd.Connection = con;
                //cmd.CommandText = "[ExportPosition_MCXCDX]";
                ...
                //else
                //    cmd.Parameters.AddWithValue("@GrpType", ddlgrouptype.Text.Trim());
                ...
                ds.Reset();
                ds = Reports.ExportPosition_MCXCDX(Convert.ToString(dtDate.Value), Session["usersegid"].ToString(), Session["LastCompany"].ToString(),
                    HttpContext.Current.Session["ExchangeSegmentID"].ToString(), HiddenField_Client.Value.ToString().Trim(), ddlGroup.SelectedValue, ddlgrouptype.Text.Trim());
