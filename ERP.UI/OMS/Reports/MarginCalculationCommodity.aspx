<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Reports.MarginCalculationCommodity" Codebehind="MarginCalculationCommodity.aspx.cs" %>
       ...
       <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div>
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                        <strong><span id="SpanHeader" style="color: #000099">Margin Calculation For Commodity</span></strong></td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    <td style="display: none;">
                        <asp:Button ID="Button1" runat="server" Text="Button" OnClientClick="selecttion()"
