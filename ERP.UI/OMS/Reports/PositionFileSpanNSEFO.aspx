<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" Inherits="ERP.OMS.Reports.Reports_PositionFileSpanNSEFO" CodeBehind="PositionFileSpanNSEFO.aspx.cs" %>
                     ...
                     <dxe:ASPxDateEdit ID="dtDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                        ...
                        <tr>
                            <td class="gridcellleft" colspan="5">
                                <strong>
                                    <asp:CheckBox ID="CheckBox1" runat="server" />Generate using Client Name &amp; Ucc</strong></td>
                        </tr>
                        <tr>
