<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" 
    CodeBehind="SrvTechMast_document.aspx.cs" Inherits="ERP.OMS.Management.Master.SrvTechMast_document" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     ...
     <script language="javascript" type="text/javascript">
         ...
         function disp_prompt(name) {
             if (name == "tab0") {
                 document.location.href = "SrvTechMast.aspx?id=" + <%=Convert.ToString(Session["KeyVal"])%> +"";
            }
            if (name == "tab1") {
        ...
        function Show() {
            var url = "frmAddDocuments.aspx?id=rootComp_document.aspx&id1=TechnicianMaster&AcType=Add";
        ...
        function ShowEditForm(KeyValue) {
            var url = "frmAddDocuments.aspx?id=rootComp_document.aspx&id1=TechnicianMaster&AcType=Edit&docid=" + KeyValue;
            popup.SetContentUrl(url);
            popup.Show();
        }
