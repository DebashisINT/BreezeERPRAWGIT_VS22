<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/OMS/MasterPage/PopUp.Master" CodeBehind="BudgetCustomerAdd.aspx.cs" Inherits="ERP.OMS.Management.Master.BudgetCustomerAdd" %>
                    ...
                    <dxe:PanelContent runat="server">
                        <div id="divbudget" runat="server">
                            ...
                            <div class="col-sm-12">
                                ...
                                <dxe:ASPxComboBox ClientInstanceName="gridcomboproductclass" runat="server" Enabled="true" ID="gridproductclass" Width="100%">
