<%@ Page Title="Opening Balance" Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/Erp.Master"
    Inherits="ERP.OMS.Management.Master.management_master_frm_ProjectOpeningBalance" CodeBehind="frm_ProjectOpeningBalance.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ProjectValueChange(s, e) {
            ...
            $.ajax({
                type: "POST",
                url: 'frm_ProjectOpeningBalance.aspx/getHierarchyID',
            ...
            if (status == "Edit") {
                projID = $('#hdnProjectID').val();
            }
            if (ccmbAccount.GetValue() != null && projID != "" && projID != null && cmbBranch.GetValue() != "")
            {
                cQuotationComponentPanel.PerformCallback("ProjectCode~" + ccmbAccount.GetValue() + "~" + $('#hdSubAccountId').val() + "~" + cmbBranch.GetValue() + "~" + projID);
                cAmountPanel.PerformCallback("SubMainAccount~" + ccmbAccount.GetValue() + "~" + $('#hdSubAccountId').val() + "~" + cmbBranch.GetValue());
            }
            
        }
        function componentEndCallBack(s, e) {

            if (cQuotationComponentPanel.cpAmount) {
                var panelRetData = cQuotationComponentPanel.cpAmount;
                ccmbDrorCr.SetValue(panelRetData.split('~')[0]);

                if (status == "Edit") {
                    if (panelRetData.split('~')[1] == "0.0")
                    {
                    }
                    else
                    {
        ...
        function BranchIndexChange(s, e) {
            ...
            $("#hfBranchID").val(cmbBranch.GetValue());
            clookup_Project.SetText('');
            clookup_Project.SetValue("");
            $("#ddlHierarchy").val(0);
        ...
        function OpeningGridEndCallBack(s, e) {
            ...
            if (status == "Edit") {
                if (cOpeningGrid.cpBeforeEdit) {
                    if (cOpeningGrid.cpBeforeEdit != "") {
                       ...
                       // clookup_Project.gridView.Refresh();
                        var projectId = ReturnData.split('~')[7];
                        $('#hdnProjectID').val(ReturnData.split('~')[7]);
                        
                        //clookup_Project.SetValue(ReturnData.split('~')[7]);
                        //clookup_Project.gridView.SelectItemsByKey(projectId);
                        //clookup_Project.SetEnabled(false);
                        //ProjectValueChange(s, e);

                        $("#ddlHierarchy").val(ReturnData.split('~')[9]);
            ...
            if (cOpeningGrid.cpClientMsg) {
                if (cOpeningGrid.cpClientMsg != "") {
                    ...
                    window.location.href = 'frm_ProjectOpeningBalance.aspx';
                }
            }
        ...
        function cmbAccountEndCallBack(s, e) {
            if (status == "Edit") {
                ...
                ctxtSubName.SetText(ReturnData.split('~')[10]);
                clookup_Project.gridView.SelectItemsByKey($('#hdnProjectID').val());
                clookup_Project.SetEnabled(false);
        ...
        function ClearClientClick(s, e) {
            ...
            $('#MandatoryProject').css({ 'display': 'none' });
        ...
        function validAllData() {
            ...
            //if (clookup_Project.GetValue() == 0 && clookup_Project.GetValue() ==null)
            if (clookup_Project.GetValue() == null) {
                $('#MandatoryProject').css({ 'display': 'block' });
                retdata = false;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="pull-left">Project Opening Balance  </h3>
            <div id="pageheaderContent" class=" wrapHolder content horizontal-images" style="width:auto">
                <ul>
                    <li>
                        <div class="lblHolder">
                            <table>
    ...
    <div class="form_main">
        ...
        <table width="100%">
            <tr>
                ...
                <td style="140px">Project Name</td>
                <td style="140px">Hierarchy</td>
                <td>DR/CR</td>
            ...
            <tr>
                            ...
                            <dxe:PanelContent runat="server">
                                ...
                                <dxe:ASPxGridLookup ID="lookup_Project" runat="server" ClientInstanceName="clookup_Project" DataSourceID="EntityServerModeDataJournal"
                                    ...
                                    <Columns>
                                        ...
                                        <dxe:GridViewDataColumn FieldName="Proj_Code" Visible="true" VisibleIndex="2" Caption="Project Code" Settings-AutoFilterCondition="Contains" Width="200px">
                                        </dxe:GridViewDataColumn>                                       
                ...
                <td style="padding-right: 15px;padding-top:3px" class="relative">
            ...
            <tr>
                <td class="relative" colspan="7" style="padding-top:5px" id="divsave">
        ...
        <div class="GridViewArea relative">
            <dxe:ASPxGridView ID="OpeningGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="cOpeningGrid" SettingsPager-Mode="ShowAllRecords" Settings-VerticalScrollBarMode="Auto" Settings-VerticalScrollableHeight="350"
                ...
                <Columns>
                    ...
                    <dxe:GridViewDataTextColumn Caption="Project Name" FieldName="ProjectCode" ReadOnly="True" Visible="True" FixedStyle="Left" VisibleIndex="0">
                        <Settings AutoFilterCondition="Contains" />
                        <Settings AllowAutoFilterTextInputTimer="False" />
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn Caption="Hierarchy" FieldName="Hierarchy" ReadOnly="True" Visible="True" FixedStyle="Left" VisibleIndex="0">
                        <Settings AutoFilterCondition="Contains" />
                        <Settings AllowAutoFilterTextInputTimer="False" />
                    </dxe:GridViewDataTextColumn>
