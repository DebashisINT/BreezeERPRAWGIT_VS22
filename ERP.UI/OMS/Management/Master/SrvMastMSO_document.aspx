<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="SrvMastMSO_document.aspx.cs" Inherits="ERP.OMS.Management.Master.SrvMastMSO_document" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     ...
     <script language="javascript" type="text/javascript">
         ...
         function disp_prompt(name) {
             if (name == "tab0") {
                 document.location.href = "SrvMastSMO.aspx?id=" + <%=Convert.ToString(Session["KeyVal"])%> +"";
             }
             if (name == "tab1") {
         ...
         function Show() {
             var url = "frmAddDocuments.aspx?id=rootComp_document.aspx&id1=MSOMaster&AcType=Add";
         ...
         function ShowEditForm(KeyValue) {
             var url = "frmAddDocuments.aspx?id=rootComp_document.aspx&id1=MSOMaster&AcType=Edit&docid=" + KeyValue;
             popup.SetContentUrl(url);
             popup.Show();
         }
                    ...
                    <dxe:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="2" ClientInstanceName="page"
                        ...
                        <TabPages>
                            ...
                            <dxe:TabPage Name="Documents" Text="Documents">
                                <ContentCollection>
                                    <dxe:ContentControl runat="server">
                                        <div class="pull-left" id="DivDocumentAdd" runat="server">
                                            <% if (rights.CanAdd)
                                               { %>
