<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="SrvMastEntity_document.aspx.cs" Inherits="ERP.OMS.Management.Master.SrvMastEntity_document" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     ...
     <script language="javascript" type="text/javascript">
         ...
         function Show() {
             var url = "frmAddDocuments.aspx?id=rootComp_document.aspx&id1=EntityMaster&AcType=Add";
         ...
         function ShowEditForm(KeyValue) {
             var url = "frmAddDocuments.aspx?id=rootComp_document.aspx&id1=EntityMaster&AcType=Edit&docid=" + KeyValue;
             popup.SetContentUrl(url);
             popup.Show();
         }
