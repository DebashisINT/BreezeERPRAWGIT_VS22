    ...
    public partial class management_master_rta : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    //rtaSource.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];MULTI
                    //rtaAddress.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];MULTI
                    //rtaPhone.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];MULTI
                    //rtaEmail.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];MULTI
                    rtaSource.ConnectionString = Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]);
                    rtaAddress.ConnectionString = Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]);
                    rtaPhone.ConnectionString = Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]);
                    rtaEmail.ConnectionString = Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]);

                }
                else
                {
                    //rtaSource.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];MULTI
                    //rtaAddress.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];MULTI
                    //rtaPhone.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];MULTI
                    //rtaEmail.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];MULTI
                    rtaSource.ConnectionString = Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]);
                    rtaAddress.ConnectionString = Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]);
                    rtaPhone.ConnectionString = Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]);
                    rtaEmail.ConnectionString = Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]);
