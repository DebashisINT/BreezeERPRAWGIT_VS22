...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fn_TxtNumber_TextChanged() {
            ...
            // Rev Start Deep 0024353: Customer Master: Customer 'PAN' is not allowing to enter duplicate PAN for two different customer where as system setting is YES
            var CrgNumber = ctxtNumber.GetText();
            var contaType='<%= Session["requesttype"] %>';
            if ($("#hdnduplicate_PAN_Number").val() != "1") {
                if (contaType == "Relationship Partners")
                {// && $("#hdnduplicate_PAN_Number").val() == "1"


                    $.ajax({
                        type: "POST",
                        //url: "Contact_Registration.aspx/CheckUniqueNumber",     
                        url: "Contact_Registration.aspx/CheckUniqueNumberRetInfluencername",
                        ...
                        success: function (msg) {
                            ...
                            //}
                            if (data != "") {
                                jAlert("Entered value is already exist for influencer " + data + ". Cannot Proceed.");
                                ctxtNumber.Focus();
                                return false;
                            }
                        }
                ...
                else if (contaType == "Customer/Client") { // && $("#hdnduplicate_PAN_Number").val() == "1"
                    $.ajax({
                        type: "POST",
                        //url: "Contact_Registration.aspx/CheckUniqueNumber",     
                        url: "Contact_Registration.aspx/SettingsCheckUniqueNumberRetCustomername",
                        data: JSON.stringify({ CrgNumber: CrgNumber, procode: procode }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
        ...
        // Rev End Deep 0024353: Customer Master: Customer 'PAN' is not allowing to enter duplicate PAN for two different customer where as system setting is YES
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form_main">
        ...
        <asp:SqlDataSource ID="SqlSegment" runat="server"
     ...
     <asp:HiddenField ID="hdnduplicate_PAN_Number" runat="server" Value="N" />
</asp:Content>
