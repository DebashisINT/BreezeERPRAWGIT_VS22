<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="SrvMastSMO.aspx.cs" Inherits="ERP.OMS.Management.Master.SrvMastSMO" %>
   ...
   <%--<script src="/assests/pluggins/choosen/choosen.min.js"></script>--%>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ChangeSourceMainAccount() {
            ...
            $.ajax({
                type: "POST",
                url: "SrvMastSMO.aspx/GetEmployeeList",
        ...
        function BindAssign(branchid) {
            ...
            $.ajax({
                ...
                url: 'SrvMastSMO.aspx/GetAllUserListBeforeSelect',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
                    var list = msg.d;
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ErrorpopUpRedirect() {
            alert('OSTB Vendor code already exists');
            $("#txtMSOCode").focus();
        }
        ...
        function isValid() {
            if (document.getElementById('txtMSOCode').value.trim() == '') {
                return false;
            }
        ...
        function disp_prompt(name) {
            if (name == "tab1") {
                ...
                document.location.href = "SrvMastMSO_Correspondence.aspx";
            }
            if (name == "tab2") {

                document.location.href = "SrvMastMSO_document.aspx";
            }
        }

        function onMSOChange() {

            var finCd = 0;
            if (GetObjectID('hiddenedit').value != '') {
                finCd = GetObjectID('hiddenedit').value;
            }
            var ShortName = document.getElementById("txtMSOCode").value.trim();
            $.ajax({
                type: "POST",
                url: "SrvMastSMO.aspx/CheckUniqueName",
                ...
                success: function (msg) {
                    ...
                    if (data == true) {
                        jAlert("Please enter unique OSTB Vendor Code");
                        document.getElementById("txtMSOCode").value = '';
                        document.getElementById("txtMSOCode").focus();
                        return false;
                    }
                }
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="panel-heading">
        <div class="panel-title">
            <h3 id="headingName" runat="server">Add/Edit OSTB Vendor</h3>
            <div class="crossBtn"><a href="SrvMastSMOList.aspx"><i class="fa fa-times"></i></a></div>
        </div>
    </div>
                                    ...
                                    <dxe:ContentControl runat="server">
                                        <div class="totalWrap">
                                            <table class="pdBotm">
                                                <tr>
                                                    <td width="150px">
                                                        <label>OSTB Vendor Code <span style="color: red">*</span></label></td>
                                                    <td width="300px" style="position: relative;">
                                                        <asp:TextBox ID="txtMSOCode" runat="server" Width="100%" onblur="onMSOChange()"
                                                            MaxLength="20" />

                                                        <asp:RequiredFieldValidator Display="Dynamic" runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtMSOCode"
