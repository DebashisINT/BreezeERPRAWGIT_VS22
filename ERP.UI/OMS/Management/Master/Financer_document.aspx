<%@ Page Title="Documents" Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.Master.management_master_Financer_document" CodeBehind="Financer_document.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Show() {
             var url = "frmAddDocuments.aspx?id=rootComp_document.aspx&id1=Financer&AcType=Add";
        ...
        function ShowEditForm(KeyValue) {
            var url = "frmAddDocuments.aspx?id=rootComp_document.aspx&id1=Financer&AcType=Edit&docid=" + KeyValue;
            popup.SetContentUrl(url);
             popup.Show();
        }
