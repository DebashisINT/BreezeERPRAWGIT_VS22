...
$(document).ready(function () {
    ...
    $("#uniqueId").focus();
    $("#VenuniqueId").focus();
    document.getElementById("txtSegment1").maxLength = "2";
    document.getElementById("txtSegment2").maxLength = "2";
    document.getElementById("txtSegment3").maxLength = "2";
    document.getElementById("txtSegment4").maxLength = "2";
    document.getElementById("txtSegment5").maxLength = "2";
...
$(document).ready(function () {
    ...
    $.ajax({
     ...
     $.ajax({
         url: "/OMS/management/Master/View/Services/ViewCustomerService.asmx/PopulateAllModule",
         contentType: "application/json; charset=utf-8",
         datatype: "JSON",
         type: "POST",
         success: function (data) {
