...
{
    public partial class management_master_Financer_document : ERP.OMS.ViewState_class.VSPage //System.Web.UI.Page
    {
        Int32 ID;
        /* For Tier Structure
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                LitCompName.Text = "Company Name :" + "  " + Session["CompanyName"].ToString();// Session["Name"].ToString();
            }
            BindGrid();
