<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="essRights.aspx.cs" Inherits="ERP.OMS.Management.Master.essRights" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Js/essRights.js?v=1.0"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        ...
        <div id="divcross" runat="server" class="crossBtn"><a href="root_essGroups.aspx"><i class="fa fa-times"></i></a></div>
    </div>
    <div class="form_main">
