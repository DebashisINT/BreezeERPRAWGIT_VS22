<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.SettingsOptions.management_SettingsOptions_targetSetUpBranch" Codebehind="targetSetUpBranch.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            <h3>Target setup for branches</h3>
        </div>
    </div>
     <div class="form_main">
        <table class="TableMain100">
            <%--<tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Target setup for branches</span></strong>
                </td>
            </tr>--%>
            <tr>
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2" style="padding-top:5px">
                                    <input id="BtnSave" type="button" value="Save" class="btnUpdate btn btn-primary mTop5" style="width: 62px"
