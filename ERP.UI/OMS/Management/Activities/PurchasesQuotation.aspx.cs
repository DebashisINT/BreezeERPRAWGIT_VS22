...
{
    public partial class PurchasesQuotation : System.Web.UI.Page
    {
                ...
                if (Request.QueryString["key"] != null)
                {
                   ...
                   if ((Convert.ToString(Request.QueryString["key"]) != "ADD") && (Convert.ToString(Request.QueryString["Typenew"]) != "Copy"))
                        //ENd Rev Rajdip
                    {
                        ...
                        Session["MultiUOMDataPQT"] = GetMultiUOMData();
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                if (Session["MultiUOMDataPQT"] != null)
                {
                    DataTable MultiUOM = (DataTable)Session["MultiUOMDataPQT"];
                    ...
                    foreach (DataRow dr in tempQuotation.Rows)
                    {
                       ...
                       // string strDetailsId = Convert.ToString(dr["DetailsId"]);
                        ...
                        if (StockUOM != "0")
                        {
                            ...
                            else if (Session["MultiUOMDataPQT"] == null)
                            {
                                validate = "checkMultiUOMData";
                                grid.JSProperties["cpcheckMultiUOMData"] = strSrlNo;
                                break;
               ...
               .Select(g => g.Key);
                ...
                if (validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "duplicateProduct" || validate == "nullAmount" || validate == "nullQuantity" || validate == "errorUdf" || validate == "transporteMandatory" || validate == "nullStateCode" || validate == "TCMandatory" || validate == "BillingShippingNull" || validate == "checkMultiUOMData")
                {
        ...
        public void GetQuantityBaseOnProductforDetailsId(string strSrlNo, ref decimal strUOMQuantity)
        {
            ...
            if (Session["MultiUOMDataPQT"] != null)
            {
                MultiUOMData = (DataTable)Session["MultiUOMDataPQT"];
        ...
        protected void MultiUOM_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if(SpltCmmd=="SaveDisplay")
            {
                ...
                DataTable allMultidataDetails = (DataTable)Session["MultiUOMDataPQT"];
                ...
                if (Validcheck != "DuplicateUOM")
                {
                    if (Session["MultiUOMDataPQT"] != null)
                    {
                        ...
                        MultiUOMSaveData = (DataTable)Session["MultiUOMDataPQT"];
                    ...
                    Session["MultiUOMDataPQT"] = MultiUOMSaveData;
            ...
            else if(SpltCmmd=="MultiUomDelete")
            {
                ...
                DataTable dt = (DataTable)Session["MultiUOMDataPQT"];
        ...
        public static Int32 GetQuantityfromSL(string SLNo)
        {
            ...
            DataTable dt = new DataTable();
            int SLVal = 0;
            if (HttpContext.Current.Session["MultiUOMDataPQT"] != null)
            {
                 dt = (DataTable)HttpContext.Current.Session["MultiUOMDataPQT"];
        ...
        public void DeleteMultiUOMDetails(string SrlNo)
        {
            ...
            if (Session["MultiUOMDataPQT"] != null)
            {
                ...
                Session["MultiUOMDataPQT"] = MultiUOMData;
            }
        }
