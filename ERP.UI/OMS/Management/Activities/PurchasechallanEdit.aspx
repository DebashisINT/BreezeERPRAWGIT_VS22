<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PurchasechallanEdit.aspx.cs" EnableEventValidation="false" Inherits="ERP.OMS.Management.Activities.PurchasechallanEdit" %>
...
<%--    <link href="../../../assests/pluggins/DataTable/jquery.dataTables.min.css" rel="stylesheet" />--%>
    <%--<script src="../../Tax%20Details/Js/TaxDetailsItemlevel.js?v=1.00" type="text/javascript"></script>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <dxe:ContentControl runat="server">
                            <div class="row">
                                <div class="col-md-2 lblmTop8">
                                    ...
                                    <asp:DropDownList ID="ddlInventory" CssClass="backSelect" runat="server" Width="100%" Enabled="false">
                                ...
                                <div class="col-md-2 lblmTop8">
                                    ...
                                    <dxe:ASPxComboBox ID="cmbContactPerson" runat="server" OnCallback="cmbContactPerson_Callback" Width="100%" ClientInstanceName="cContactPerson" ClientEnabled="false"
                                ...
                                <div class="col-md-2 lblmTop8">
                                    ...
                                    <span style="color: red;">*</span>
                                    <dxe:ASPxTextBox ID="txtPartyInvoice" ClientInstanceName="ctxtPartyInvoice" runat="server" Width="100%" ClientEnabled="false">
                                    </dxe:ASPxTextBox>
                                ...
                                <div class="col-md-2 lblmTop8">
                                    ...
                                    <dxe:ASPxDateEdit ID="dt_PartyDate" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy" ClientInstanceName="cPLPartyDate" Width="100%" ClientEnabled="false">
                                        <ButtonStyle Width="13px">
                                        </ButtonStyle>
                                ...
                                <div class="col-md-2 lblmTop8">
                                    ...
                                    <dxe:ASPxButtonEdit ID="taggingList" ClientInstanceName="ctaggingList" runat="server" ReadOnly="true" Width="100%" ClientEnabled="false">
                                        <Buttons>
                                            <dxe:EditButton>
                                            </dxe:EditButton>
                                        </Buttons>
                                ...
                                <div class="col-md-2 lblmTop8">
                                    ...
                                    <span style="color: red;">*</span>
                                    <dxe:ASPxComboBox ID="ddl_AmountAre" runat="server" SelectedIndex="0" ClientIDMode="Static" ClientInstanceName="cddl_AmountAre" Width="100%" ClientEnabled="false">
                                ...
                                <div class="col-md-4 lblmTop8">
                                    ...
                                    <dxe:ASPxTextBox ClientInstanceName="ctxtNarration" ID="txtNarration" runat="server" Width="100%" MaxLength="500" ClientEnabled="false">
                                    </dxe:ASPxTextBox>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <dxe:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" KeyFieldName="SrlNo"
                                        ...
                                        <Columns>
                                            <dxe:GridViewCommandColumn ShowDeleteButton="false" ShowNewButtonInHeader="false" Width="0" VisibleIndex="0" Caption="" >
                                                <CustomButtons>
                                            ...
                                            <dxe:GridViewDataTextColumn FieldName="ProductDiscription" Caption="Description" VisibleIndex="4" Width="17%" ReadOnly="true">
                                                <PropertiesTextEdit>
                                                </PropertiesTextEdit>
                                            </dxe:GridViewDataTextColumn>


                                            <dxe:GridViewCommandColumn Caption="Addl Desc." Width="40" VisibleIndex="5">
                                                <CustomButtons>
                                            ...
                                            <dxe:GridViewDataTextColumn FieldName="Quantity" Caption="Quantity" VisibleIndex="6" Width="6%" HeaderStyle-HorizontalAlign="Right" ReadOnly="true">
                                                <PropertiesTextEdit>
                                                    <ClientSideEvents GotFocus="EditQuantityProductsGotFocus" LostFocus="QuantityTextChange" />
                                            ...
                                            <dxe:GridViewDataTextColumn FieldName="PurchaseUOM" Caption="UOM" VisibleIndex="7" Width="5%" ReadOnly="true">
                                                <PropertiesTextEdit>
                                                </PropertiesTextEdit>
                                            </dxe:GridViewDataTextColumn>
                                            ...
                                            <dxe:GridViewCommandColumn Width="8%" VisibleIndex="11" Caption="Stock">
                                                <CustomButtons>
                                            ...
                                            <dxe:GridViewDataTextColumn FieldName="PurchasePrice" Caption="Price" VisibleIndex="12" Width="7%" HeaderStyle-HorizontalAlign="Right">
                                                <PropertiesTextEdit DisplayFormatString="0.000">
                                                    <ClientSideEvents GotFocus="EditPurchasePriceTextFocus" LostFocus="EditPurchasePriceTextChange" />
                                            ...
                                            <dxe:GridViewDataSpinEditColumn FieldName="Discount" Caption="Disc(%)" VisibleIndex="13" Width="4%" HeaderStyle-HorizontalAlign="Right" ReadOnly="true">
                                            ...
                                            <dxe:GridViewDataTextColumn FieldName="TotalAmount" Caption="Amount" VisibleIndex="14" Width="9%" HeaderStyle-HorizontalAlign="Right">
                                                <PropertiesTextEdit DisplayFormatString="0.00">
                                                    <ClientSideEvents GotFocus="EditAmountTextFocus" LostFocus="EditAmountTextChange"></ClientSideEvents>
                                            ...
                                            <dxe:GridViewDataButtonEditColumn FieldName="TaxAmount" Caption="Charges" VisibleIndex="15" Width="9%" HeaderStyle-HorizontalAlign="Right" ReadOnly="true">
                                            ...
                                            <dxe:GridViewDataTextColumn FieldName="NetAmount" Caption="Net Amount" VisibleIndex="16" Width="9%" HeaderStyle-HorizontalAlign="Right" ReadOnly="true">
                                                <PropertiesTextEdit DisplayFormatString="0.00">
                                                    <MaskSettings AllowMouseWheel="False" Mask="&lt;0..999999999&gt;.&lt;00..99&gt;"></MaskSettings>
                                                    <ValidationSettings Display="None"></ValidationSettings>
                                                    <Style HorizontalAlign="Right"></Style>
                                               ...
                                               <dxe:GridViewDataTextColumn Caption="Remarks" FieldName="ChallanDetails_InlineRemarks" Width="150" VisibleIndex="17" PropertiesTextEdit-MaxLength="5000">
                                            ...
                                            <dxe:GridViewCommandColumn ShowDeleteButton="false" ShowNewButtonInHeader="false" Width="5%" VisibleIndex="18" Caption="Add New">
                                                <CustomButtons>
                                            ...
                                            <dxe:GridViewDataTextColumn FieldName="PurchasePriceValue" Caption="PurchasePriceValue" VisibleIndex="28" ReadOnly="True" Width="0">
                                            </dxe:GridViewDataTextColumn>
                                            <dxe:GridViewDataTextColumn FieldName="PurchaseAmountValue" Caption="PurchaseAmountValue" VisibleIndex="26" ReadOnly="True" Width="0">
                                            </dxe:GridViewDataTextColumn>
                                            <%--Mantis Issue 24395--%>
                                            <dxe:GridViewDataTextColumn FieldName="Balance_Amount" Caption="Balance Amount" VisibleIndex="30" ReadOnly="True" Width="0">
                                            </dxe:GridViewDataTextColumn>
                                ...
                                <%--Mantis Issue 24429--%>
                                 <td>
                                    <div style="margin-bottom: 5px;">
                                        ...
                                        <div>
                                            <dxe:ASPxTextBox ID="cmbBaseRate" runat="server" Width="80px" ClientInstanceName="ccmbBaseRate" DisplayFormatString="0.0000" MaskSettings-Mask="&lt;0..999999999&gt;.&lt;00..9999&gt;" FocusedStyle-HorizontalAlign="Right" HorizontalAlign="Right" ReadOnly="true" ></dxe:ASPxTextBox>
                                        </div>
                                    </div>
                                </td>
                                <%--End of Mantis Issue 24429--%>
                                ...
                                <%--Mantis Issue 24429--%>
                                 <td>
                                    <div style="margin-bottom: 5px;">
                                        ...
                                        <div>
                                            <dxe:ASPxTextBox ID="cmbAltRate" Width="80px" runat="server" ClientInstanceName="ccmbAltRate" DisplayFormatString="0.0000" MaskSettings-Mask="&lt;0..999999999&gt;.&lt;00..9999&gt;" FocusedStyle-HorizontalAlign="Right" HorizontalAlign="Right"  >
    ...
    <asp:HiddenField ID="hdnADDEditMode" runat="server" />
     <asp:HiddenField ID="EditPricevalue" runat="server" />
    <asp:HiddenField ID="EditAmountvalue" runat="server" />
    <%--Mantis Issue 24395 --%>
