<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ServiceTempleateList.aspx.cs" Inherits="ERP.OMS.Management.Activities.ServiceTempleateList" %>
    ...
    <script>
        ...
        function AllControlInitilize() {
            if (isFirstTime) {
                ...
                //if (localStorage.getItem('JournalCreditorsAdjustFromDate')) {
                //    var fromdatearray = localStorage.getItem('JournalCreditorsAdjustFromDate').split('-');
                //    var fromdate = new Date(fromdatearray[0], parseFloat(fromdatearray[1]) - 1, fromdatearray[2], 0, 0, 0, 0);
                //    cFormDate.SetDate(fromdate);
                //}

                //if (localStorage.getItem('JournalCreditorsAdjustToDate')) {
                //    var todatearray = localStorage.getItem('JournalCreditorsAdjustToDate').split('-');
                //    var todate = new Date(todatearray[0], parseFloat(todatearray[1]) - 1, todatearray[2], 0, 0, 0, 0);
                //    ctoDate.SetDate(todate);
                //}
                if (localStorage.getItem('ServiceTemplateBranch')) {
                    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('ServiceTemplateBranch'))) {
                        ccmbBranchfilter.SetValue(localStorage.getItem('ServiceTemplateBranch'));
                    }
        ...
        function OnViewClick(keyValue) {
            var url = 'ServiceTempleateAdd.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }
        function onEditClick(id) {
            window.location.href = 'ServiceTempleateAdd.aspx?Key=' + id;
        }
        ...
        function updateGridByDate() {
           ...
           // else 
            if (ccmbBranchfilter.GetValue() == null) {
                ...
                //localStorage.setItem("JournalCreditorsAdjustFromDate", cFormDate.GetDate().format('yyyy-MM-dd'));
                //localStorage.setItem("JournalCreditorsAdjustToDate", ctoDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("ServiceTemplateBranch", ccmbBranchfilter.GetValue());
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="pull-left">Service Templeate</h3>
        </div>
    </div>
    <table class="padTab">
        <tr>
    ...
    <div class="form_main">
        ...
        <div class="GridViewArea relative">
            ...
            <dxe:ASPxGridView ID="gridAdvanceAdj" runat="server" KeyFieldName="ServiceTemplate_ID" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <dxe:GridViewDataTextColumn Caption="Service Description" FieldName="Service_Description" Width="200"
                    ...
                    <dxe:GridViewDataDateColumn Caption="Service" FieldName="ProductName" Width="200"
                        VisibleIndex="0" >
                        <CellStyle CssClass="gridcellleft" Wrap="true">
                        </CellStyle>
                        <Settings AllowAutoFilterTextInputTimer="False" />
                    ...
                    <%--<dxe:GridViewDataTextColumn Caption="Items" FieldName="Adjusted_Doc_no" Width="200"
                        VisibleIndex="0">
                        <CellStyle CssClass="gridcellleft" Wrap="true">
                        </CellStyle>
                        <Settings AllowAutoFilterTextInputTimer="False" />
                    ...
                    <dxe:GridViewDataTextColumn Caption="Remarks" FieldName="Service_Remarks" Width="200"
                        VisibleIndex="0">
                        <CellStyle CssClass="gridcellleft" Wrap="true">
                        </CellStyle>
                        <Settings AllowAutoFilterTextInputTimer="False" />
            ...
            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                ContextTypeName="ERPDataClassesDataContext" TableName="v_ServiceTemplate_List" />
