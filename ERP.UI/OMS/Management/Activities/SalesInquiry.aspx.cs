...
{
    public partial class SalesInquiry : System.Web.UI.Page
    {
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Sales Inquiry";
            exporter.FileName = filename;

            exporter.PageHeader.Left = "Sales Inquiry";
            ...
            if (IsFilter == "Y")
            {
                if (strBranchID == "0")
                {
                    ...
                    if (IsUserwise == "Y")
                    {
                        ...
                        //var q = from d in dc.v_SalesInquiryLists
                        ...
                        //        select d;
                        //e.QueryableSource = q;
                        var q = from d in dc.SalesInquiryLists
        ...
        protected void CallbackPanel_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string strBranchID = (Convert.ToString(hfBranchID.Value) == "") ? "0" : Convert.ToString(hfBranchID.Value);
            Task PopulateStockTrialDataTask = new Task(() => GetSalesInquirydata(FROMDATE, TODATE, strBranchID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetSalesInquirydata(string FROMDATE, string TODATE, string BRANCH_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("prc_SalesInquiry_List", con);
