      ...
      //  BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string BackDatedEntryPurchaseReturnManual = cbl.GetSystemSettingsResult("BackDatedEntryPurchaseReturnManual");
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        nettotamt = TotalAmt + othercharges;


                        bnrLblInvValue.Text = nettotamt.ToString();
                        ...
                        if (objPurchaseReturnBL.IsPRExistINAdjtPR(Request.QueryString["key"]))
                        {
                    ...
                    else
                    {
                        ...
                        DataTable dtposTime = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(50),Lock_Fromdate,110) LockCon_Fromdate,convert(varchar(50),Lock_Todate,110) LockCon_Todate,convert(varchar(10),Lock_Fromdate,105) Datafreeze_Fromdate,convert(varchar(10),Lock_Todate,105) Datafreeze_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Add' and Module_Id=9");
        ...
        public DataTable GetProjectEditData(string PurchaseReturnId)
        {
            ...
            proc.AddVarcharPara("@Action", 500, "ProjectEditdataPurchaseReturnManual");
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            foreach (var args in e.InsertValues)
            {
                ...
                if (ProductDetails != "" && ProductDetails != "0")
                {
                  ...
                  //  string Description = Convert.ToString(args.NewValues["Description"]);
                    ...
                    string ReturnDetails_InlineRemarks = (Convert.ToString(args.NewValues["ReturnDetails_InlineRemarks"]) != "") ? Convert.ToString(args.NewValues["ReturnDetails_InlineRemarks"]) : "";
            ...
            if (IsDeleteFrom != "D")
            {
               ...
               .Select(g => g.Key);
                ...
                DataTable dtQuoataionDetails = new DataTable();
                dtQuoataionDetails = tempQuotation;

                if (dtQuoataionDetails.Columns.Contains("DetailsId"))
                {
                    dtQuoataionDetails.Columns.Remove("DetailsId");
                    dtQuoataionDetails.AcceptChanges();
                }
                ...
                if (validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "nullAmount" || validate == "nullQuantity" || validate == "transporteMandatory" || validate == "checkAcurateTaxAmount")
                {
                ...
                else
                {
                    ...
                    ModifyPurchaseReturn(MainInvoiceID, strSchemeType, UniqueQuotation, strInvoiceDate, strCustomer, strContactName,
                                   Reference, strBranch, strStockOutBranch, strAgents, strCurrency, strRate, strTaxType, strTaxCode,
                                   InvoiceComponent, InvoiceComponentDate, strCashBank, strDueDate,addrDesc,
                                   tempQuotation, TaxDetailTable, tempWarehousedt, tempTaxDetailsdt, tempBillAddress,
                                   approveStatus, ActionType, strBr,ProjId, ref strIsComplete, ref strQuoteID, ReasonforReturn, refCreditNoteNo, refCreditNoteNoDate, duplicatedt2);

                    //End of Rev Subhra 20-03-2019
        ...
        public DataTable GetAddLockStatus()
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_PurchaseReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetAddLockForPRM");
        ...
        public void ModifyPurchaseReturn(string QuotationID, string strSchemeType, string strQuoteNo, string strQuoteDate, string strCustomer, string strContactName,
                                   string Reference, string strBranch, string strStockOutBranch, string strAgents, string strCurrency, string strRate, string strTaxType, string strTaxCode,
                                   string strInvoiceComponent, string strInvoiceComponentDate, string strCashBank, string strDueDate,DataTable addrDesc,
        ...
        //End of Rev Subhra 19-03-2019
        {
            try
            {
               ...
               // SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                ...
                SqlCommand cmd = new SqlCommand("prc_CRMPurchaseReturnManual", con);
                //End Rev Rajdip
        ...
        {
            List<MultiUOMPRMConversionPacking> RateLists = new List<MultiUOMPRMConversionPacking>();
            ...
            RateLists = DbHelpers.ToModelList<MultiUOMPRMConversionPacking>(dt);
            if (dt != null && dt.Rows.Count > 0)
            {
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            if (performpara.Split('~')[0] == "EditWarehouse")
            {
                ...
                if (Session["PRMWS_WarehouseData"] != null)
                {
                    ...
                    string strWarehouse = "", strBatchID = "", strSrlID = "", strQuantity = "0", strAltQuantity = "0", strAltUOM="0";
                    ...
                    CallbackPanel.JSProperties["cpEdit"] = strWarehouse + "~" + strBatchID + "~" + strSrlID + "~" + strQuantity + "~" + strAltQuantity + "~" + strAltUOM;
                }
            }
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else
            {
               ...
               // GetVendorGstin.AddVarcharPara("@entityId", 10, Convert.ToString(txtCustName.Value));
        ...
        public class MultiUOMPRMConversionPacking
        {
        ...
        public DataTable GetProjectCode(string Proj_Code)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_PurchaseReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetProjectCodePurchaseReturnManual");
