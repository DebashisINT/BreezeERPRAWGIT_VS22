    ...
    <script type="text/javascript">
        ...
        function SaveTermsConditionData() {
            ...
            if (($("#pnl_TCspecefiFields_Not_PO").is(":visible")) && cdtDeliveryDate.GetDate() == null) {
                ...
                //data += ctxtPaymentTerms.GetValue() == null || ctxtPaymentTerms.GetValue() == '' ? '@' + '|' : ctxtPaymentTerms.GetValue()

                //End By Indranil
                data += ctxtPaymentTerms.GetValue() == null || ctxtPaymentTerms.GetValue() == '' ? '@' + '|' : ctxtPaymentTerms.GetValue() + '|';
                data += $("#txtProject").val() == null || $("#txtProject").val() == '' ? '@' + '|' : $("#txtProject").val()              
...
<body>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#TermsConditionseModal" id="btn_TermsCondition" style="background-image:none !important;background-color: #428bca;">Term&#818;s and Conditions</button>
                            ...
                            <dxe:PanelContent runat="server">
                                ...
                                <asp:Panel runat="server" ID="pnl_TCspecefiFields_Not_PO">
                                    ...
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="Payment-name" class="control-label">Payment Terms</label>
                                            <dxe:ASPxTextBox ID="txtPaymentTerms" runat="server" Width="100%" ClientInstanceName="ctxtPaymentTerms">
                                           </dxe:ASPxTextBox>
                                        </div>
                                     </div>
                                ...
                                <asp:Panel runat="server" ID="PanelBank">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtProject" runat="server" Width="100%" MaxLength="200"></asp:TextBox>
                                        </div>
                                    </div>
                                    <%--Rev work close 09.08.2022 mantise no:0025110: A Text Input field required in the Terms & Condition of the entry Module as "Project"--%>
                               </asp:Panel>
