<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucImportPurchase_BillOfEntry.ascx.cs" 
    Inherits="ERP.OMS.Management.Activities.UserControls.ucImportPurchase_BillOfEntry" %>
