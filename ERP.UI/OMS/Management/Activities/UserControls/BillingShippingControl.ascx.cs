...
{
    public partial class BillingShippingControl : System.Web.UI.UserControl
    {
        ...
        private void SetEditAddressDetails(string DocID, string docType)
        {
            ...
            if (DS_AllDetails != null && DS_AllDetails.Tables[0].Rows.Count > 0)
            {
                ...
                if (DS_AllDetails.Tables.Count > 1)
                {
                    ...
                    hfVendorGSTIN.Value = objCommonBL.GetVendorGSTIN(ucBShfCustID.Value, ucBShfBranchID.Value);
                }
            }
