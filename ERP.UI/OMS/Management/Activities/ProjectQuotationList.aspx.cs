...
{
    public partial class ProjectQuotationList : System.Web.UI.Page
    {
        // BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);

        BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine();
        public EntityLayer.CommonELS.UserRightsForPage rights = new UserRightsForPage();
        ProjectQuotationDtlBL objCRMSalesDtlBL = new ProjectQuotationDtlBL();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(ProjectSelectInEntryModule))
            {
                ...
                {
                    GrdQuotation.Columns[4].Visible = true;


                }
                else if (ProjectSelectInEntryModule.ToUpper().Trim() == "NO")
                {
                    GrdQuotation.Columns[4].Visible = false;
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Project Quotation/Proposal";
            exporter.FileName = filename;

            exporter.PageHeader.Left = "Project Quotation/Proposal";
            ...
            if (IsFilter == "Y")
            {
                if (strBranchID == "0")
                {
                    ...
                    if (IsUserwise == "Y")
                    {
                        ...
                        var q = from d in dc.V_ProjectQuotationLists
