...
function LoadCustomerReceipt() {
    ...
    $.ajax({
        type: "POST",
        url: "/OMS/Management/Activities/Services/CustomerReceiptAdjustment.asmx/GetJournalCreditosVoucharPBList",
...
function showDocumentList() {
    ...
    $.ajax({
        type: "POST",
        url: "/OMS/Management/Activities/Services/CustomerReceiptAdjustment.asmx/GetPurchaseReturnDocumentList",
        data: JSON.stringify(OtherDetails),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
...
function afterSave() {
    ...
    if (saveNewOrExit == 'N') {
        ...
        window.location.href = 'JournalCreditorsAdjustPReturnList.aspx';
    }
}
