...
function UpdatePinIRN(id) {
    ...
    $.ajax({
        type: "POST",
        url: "einvoice.aspx/GetDistancePin",
        data: JSON.stringify(otherdet),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
...
function UpdatePinIRNTSI(id) {
    ...
    $.ajax({
        type: "POST",
        url: "einvoice.aspx/GetDistancePinTSI",
        data: JSON.stringify(otherdet),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
...
function DoownLoadJsonTSI(id) {
    ...
    $.ajax({
        type: "POST",
        url: "einvoice.aspx/generateEinvoiceJSONTSI",
        //data: "{'ProductName':'" + ProductName + "'}",
        data: JSON.stringify(otherdet),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function DoownLoadJsonSR(id) {
    ...
    $.ajax({
        type: "POST",
        url: "einvoice.aspx/generateEinvoiceJSONSR",
        //data: "{'ProductName':'" + ProductName + "'}",
        data: JSON.stringify(otherdet),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function PINtoPINDistanceSubmitTSI() {
    ...
    $.ajax({
        type: "POST",
        url: "einvoice.aspx/UpdatePinTSI",
        data: JSON.stringify(otherdet),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
...
function CancelIRNSubmit() {
    if ($("#hdnCancelIRNType").val() == 'SILine') {
        ...
        $.ajax({
            type: "POST",
            url: "einvoice.aspx/CancelIRNTSI",
            //data: "{'ProductName':'" + ProductName + "'}",
            data: JSON.stringify(otherdet),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function tsiBoxRefresh(frmdate, todate) {
    ...
    $.ajax({
        type: "POST",
        url: "eInvoice.aspx/GetTSITabBox",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(dt),
        dataType: "json",
        success: function (data) {
