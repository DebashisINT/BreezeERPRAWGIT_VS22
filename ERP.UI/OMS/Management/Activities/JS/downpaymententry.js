...
CalculateAmount = function () {
    ...
    var TotalPay = DecimalRoundoff((parseFloat(DPAmount) + parseFloat(AdjAmount) + parseFloat(DivestmentAmt1) + parseFloat(DivestmentAmt2) + parseFloat(DivestmentAmt3) + parseFloat(DbdAmount) + parseFloat(ProcessingFee) + parseFloat(MbdAmount)),2);
    var Balance = DecimalRoundoff((parseFloat(InvoiceAmount) - parseFloat(TotalPay)),2);
