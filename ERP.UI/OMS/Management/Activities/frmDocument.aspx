    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick() {
            ...
            if (startDate != null) {
                ...
                if (difference > 12) {
                    jAlert('End date cannot  12 month later than Start date', 'Document Collection', function () {
                        return false;
                                                ...
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxGridView ID="SalesDetailsGrid" runat="server" KeyFieldName="sls_id" AutoGenerateColumns="False" ClientInstanceName="grid"
                                                            Width="100%" OnDataBinding="SalesDetailsGrid_DataBinding" OnCustomCallback="SalesDetailsGrid_CustomCallback"  OnHtmlRowCreated="SalesDetailsGrid_HtmlRowCreated"   SettingsCookies-Enabled="true" SettingsCookies-StorePaging="true" SettingsCookies-StoreFiltering="true" SettingsCookies-StoreGroupingAndSorting="true" 
                                                             
                                                            SettingsBehavior-AllowFocusedRow="true"   SettingsDataSecurity-AllowEdit="false" SettingsDataSecurity-AllowInsert="false" SettingsDataSecurity-AllowDelete="false"  >
                                                            <Columns>
                                                          ...
                                                          <%--       <dxe:GridViewDataTextColumn FieldName="Address" Caption="Address" VisibleIndex="1" Width="18%">
                                                                ...
                                                                <dxe:GridViewDataTextColumn  ReadOnly="True" FieldName="Name"  VisibleIndex="6" Caption="Customer/Lead Name" Settings-AllowAutoFilterTextInputTimer="False">
                                                                     <DataItemTemplate>
