...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrderAddNew.aspx.cs" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.Activities.SalesOrderAddNew" EnableEventValidation="false" %>
...
<script src="JS/SearchPopupDatatable.js"></script>
    ...
    <script src="JS/SalesOrderAddNew.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            if (hddnCRmVal == "1") {
                ...
                $.ajax({
                    type: "POST",
                    url: "SalesOrderAddNew.aspx/GetCustomerOutStandingAmount",
                ...
                if (Currency != CurrencyId) {
                    if (ActiveCurrency != null) {
                        if (CurrencyId != '0') {
                            $.ajax({
                                type: "POST",
                                url: "SalesOrderAddNew.aspx/GetCurrentConvertedRate",
        ...
        function OnEndCallback(s, e) {
            ...
            if (grid.cpSaveSuccessOrFail == "outrange") {
                ...
                if (IsFromActivity == "Y" && value == "E") {
                    ...
                    if (SalesOrder_Number != "") {
                        ...
                        jAlert(Order_Msg, 'Alert Dialog: [SalesOrder]', function (r) {
                            ...
                            if (r == true) {
                                ...
                                window.location.assign("SalesOrderNewList.aspx");
                    ...
                    // window.location.assign("SalesOrderAddNew.aspx?key=ADD");
...
function BindOrderProjectdata(OrderId, TagDocType) {
    ...
    if ((OrderId != null) && (OrderId != "")) {
        $.ajax({
            type: "POST",
            url: "SalesOrderAddNew.aspx/SetProjectCode",
        ...
        $.ajax({
            type: "POST",
            url: 'SalesOrderAddNew.aspx/getHierarchyID',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <div id="divcross" runat="server" class="crossBtn"><a href="SalesOrderNewList.aspx" id="lnkBack" runat="server"><i class="fa fa-times"></i></a></div>
