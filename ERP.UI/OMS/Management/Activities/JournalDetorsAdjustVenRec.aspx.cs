...
{
    public partial class JournalDetorsAdjustVenRec : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack) 
            {
                ...
                rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Management/Activities/JournalDetorsAdjustVenRecList.aspx");
                ...
                else
                {
                    ...
                    Session["AdjustJournalDetorsVRrDetailTable"] = null;
                }
                if (Request.QueryString["req"] != null && Request.QueryString["req"] == "V")
                {
                    lblHeading.Text = "Adjustment of Documents - Journal with Vendor Receipt(On Account)";
        ...
        private void AddmodeExecuted()
        {
            ...
            DataSet allDetails = blLayer.PopulateJournalDetorsAdjustmentVendorRecDetails();
            ...
            if (Session["schemavalJourCreditorAdjVP"] != null)
            {
                List<string> SaveNewValues = (Session["schemavalJourCreditorAdjVP"]) as List<string>;
            ...
            if (Convert.ToString(Session["SaveModeJourCreditorsAdjVP"]) == "A")
            {
                dtTDate.Focus();
                txtVoucherNo.ClientEnabled = false;
                txtVoucherNo.Text = "Auto";
            }
            else if (Convert.ToString(Session["SaveModeJourCreditorsAdjVP"]) == "M")
            {
        ...
        public void EditModeExecute(string id)
        {
            ...
            DataSet EditedDataDetails = blLayer.GetEditedJounalCreditorVendorRecData(id);
            ...
            Session["AdjustJournalDetorsVRrDetailTable"] = EditedDataDetails.Tables[4];
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            foreach (var args in e.DeleteValues)
            {
                ...
                DataTable AdjTable = (DataTable)Session["AdjustJournalDetorsVRrDetailTable"];
            ...
            blLayer.AddEditJournalAdjustmentVendorRec(hdAddEdit.Value, CmbScheme.Value.ToString().Split('~')[0], txtVoucherNo.Text, dtTDate.Date.ToString("yyyy-MM-dd"),
            ...
            if (hdAddEdit.Value == "Add")
            {
                if (HiddenSaveButton.Value != "E")
                {
                    ...
                    Session["schemavalJourCreditorAdjVP"] = AfterAdd;

                    string schematype = txtVoucherNo.Text;
                    if (schematype == "Auto")
                    {
                        Session["SaveModeJourCreditorsAdjVP"] = "A";
                    }
                    else
                    {
                        Session["SaveModeJourCreditorsAdjVP"] = "M";
                    }
                }
