<%--================================================== Revision History =============================================
1.0   Pallab    V2.0.38      22-05-2023          0026192: Add Adjustment of Documents - Journal with Manual Purchase Return module design modification & check in small device
2.0   Pallab    V2.0.39      27-07-2023          0026626: Add Adjustment of Documents - Journal with Manual Purchase Return module all bootstrap modal outside click event disable
====================================================== Revision History =============================================--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="JournalCreditorsAdjustPReturn.aspx.cs" Inherits="ERP.OMS.Management.Activities.JournalCreditorsAdjustPReturn" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="CSS/SearchPopup.css" rel="stylesheet" />
    <script src="JS/SearchPopup.js?v=0.02"></script>
    <link href="CSS/CustomerReceiptAdjustment.css" rel="stylesheet" />
    <script src="JS/JournalCreditorsAdjustmentPReturn.js?v=2.3"></script>
    <%--Rev 1.0--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <h3 class="pull-left">
            <asp:Label ID="lblHeading" runat="server" Text="Add Adjustment of Documents - Journal with Manual Purchase Return"></asp:Label>
        </h3>
    </div>
        <div id="ApprovalCross" runat="server" class="crossBtn"><a href="JournalCreditorsAdjustPReturnList.aspx"><i class="fa fa-times"></i></a></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" style="top: 20px;">
                        <dxe:ASPxGridView runat="server" ClientInstanceName="grid" ID="grid"
                            ...
                            Settings-VerticalScrollableHeight="250" Width="100%">
