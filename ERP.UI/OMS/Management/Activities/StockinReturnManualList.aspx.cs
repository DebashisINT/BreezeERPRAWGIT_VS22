       ...
       // BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
        ...
        protected void GrdSalesReturn_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (Command == "Delete")
            {
                ...
                int deletecnt = 0;
                deletecnt = objSalesReturnBL.DeleteReceiveAgainstManualReturn(SalesReturnID,CreateUser);
                ...
                else { GrdSalesReturn.JSProperties["cpDelete"] = "The received Stock is adjusted with another documents.Can not delete"; }
