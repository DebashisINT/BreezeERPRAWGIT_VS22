/*****************************************************************************************************************
 * 1.0   Sanchita  V2.0.43      20-02-2024          Views to be converted to Procedures in the Listing Page - Journal With Vendor Payment. Mantis: 27262
 * *********************************************************************************************************************/
...
{
    public partial class JournalCreditorsAdjustVenPayList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Management/Activities/JournalCreditorsAdjustPInvoiceList.aspx");
        ...
        protected void CallbackPanel_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetJournalCreditorsAdjustVenPaydata(FROMDATE, TODATE, strBranchID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetJournalCreditorsAdjustVenPaydata(string FROMDATE, string TODATE, string BRANCH_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("prc_JournalCreditorsAdjustVenPay_List", con);
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                ...
                //    var q = from d in dc.v_JournalAdjustmentVendorPaymentLists
                ...
                var q = from d in dc.JournalCreditorsAdjustVenPayLists
        ...
        protected void gridAdvanceAdj_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int rowsNo = customerReceiptAdjustment.DeleteJournalVendorPayAdj(param.Split('~')[1]);
             if (rowsNo > 0)
             {
        ...
        private void bindexport(int Filter)
        {
            ...
            string filename = "Adjustment of Document- Journal with Vendor Payment";
            exporter.FileName = filename;
            exporter.FileName = "Adjustment of Document- Journal with Vendor Payment";

            exporter.PageHeader.Left = "Adjustment of Document- Journal with Vendor Payment";
