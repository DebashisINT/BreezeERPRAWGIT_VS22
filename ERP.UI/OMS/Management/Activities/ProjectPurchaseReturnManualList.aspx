...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function CallEWayBill_save() {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectPReturnList.aspx/UpdateEWayBill",
                data: JSON.stringify({
        ...
        function OnAddButtonClick() {
            var url = 'ProjectPurchaseReturnManual.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        function OnMoreInfoClick(keyValue) {
            ...
            if (ActiveUser != null) {
                $.ajax({
                    ...
                    success: function (msg) {
                        var status = msg.d;
                        var url = 'ProjectPurchaseReturnManual.aspx?key=' + keyValue + '&Permission=' + status + '&type=PRM';
                        window.location.href = url;
                    }
                });
            }
        ...
        function OnViewClick(keyValue) {
            var url = 'ProjectPurchaseReturnManual.aspx?key=' + keyValue + '&req=V' + '&type=PRM';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading">
        <div class="panel-title">
            <h3>Project Purchase Return Manual</h3>
        </div>
    </div>
    <div class="form_main">
        <div class="clearfix">
