<%--=======================================================Revision History=====================================================    
    1.0   Pallab    V2.0.38   12-05-2023      26108: Warehouse Wise Stock - IN module design modification & check in small device
=========================================================End Revision History===================================================--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="WarehousewiseStockJournalListIN.aspx.cs" Inherits="ERP.OMS.Management.Activities.WarehousewiseStockJournalListIN" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function OnViewClick(id) {
            var url = 'WarehousewiseStockJournalAddIN.aspx?key=' + id + '&req=V';
            window.location.href = url;
        }
        function onEditClick(id) {
            window.location.href = 'WarehousewiseStockJournalAddIN.aspx?Key=' + id;
        }
        ...
        function OnclickViewAttachment(obj) {
            var URL = '/OMS/Management/Activities/EntriesDocuments.aspx?idbldng=' + obj + '&type=WarehouseWiseStockIN';
            window.location.href = URL;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <div class="panel-title clearfix">
            <h3 class="pull-left">Warehouse Wise Stock - IN </h3>
        </div>
    </div>
        <table class="padTab">
        <tr>
                    ...
                    <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="17" Width="0">
                        <DataItemTemplate>
                            <div class='floatedBtnArea'>
                                ...
                                <% if (rights.CanEdit)
                                   { %>
                                <a href="javascript:void(0);" class="" title="" style='<%#Eval("OldStyle")%>' onclick="onEditClick('<%# Container.KeyValue %>')">
                                ...
                                <% if (rights.CanDelete)
                                   { %>
                                <a href="javascript:void(0);" onclick="OnClickDelete('<%# Container.KeyValue %>')" class="" style='<%#Eval("OldStyle")%>' title="" id="a_delete">
