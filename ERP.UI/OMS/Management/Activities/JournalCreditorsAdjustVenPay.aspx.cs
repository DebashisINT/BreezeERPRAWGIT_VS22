...
{
    public partial class JournalCreditorsAdjustVenPay : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack) 
            {
                rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Management/Activities/JournalCreditorsAdjustVenPayList.aspx");
                ...
                else
                {
                    hdAddEdit.Value = "Add";
                    AddmodeExecuted();
                    Session["AdjustJournalCreditorDetailTable"] = null;
                }
                if (Request.QueryString["req"] != null && Request.QueryString["req"] == "V")
                {
                    lblHeading.Text = "View Adjustment of Documents - Journal with Vendor Payment";
        ...
        private void AddmodeExecuted()
        {
            ...
            DataSet allDetails = blLayer.PopulateJournalCreditorsAdjustmentVendorPayDetails();
        ...
        {
            DataSet EditedDataDetails = blLayer.GetEditedJounalCreditorVendorPayData(id);
            ...
            Session["AdjustJournalCreditorDetailTable"] = EditedDataDetails.Tables[4];
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            {
                DataTable AdjTable = (DataTable)Session["AdjustJournalCreditorDetailTable"];
                if (AdjTable != null)
                {
            ...
            blLayer.AddEditJournalAdjustmentVendorPay(hdAddEdit.Value, CmbScheme.Value.ToString().Split('~')[0], txtVoucherNo.Text, dtTDate.Date.ToString("yyyy-MM-dd"),
