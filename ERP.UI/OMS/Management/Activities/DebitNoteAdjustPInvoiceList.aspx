<%--================================================== Revision History =============================================
1.0   Pallab    V2.0.38      22-05-2023          0026196: Adjustment of Documents - Debit Note / Purchase Return with Purchase Invoice module design modification & check in small device
====================================================== Revision History =============================================--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="DebitNoteAdjustPInvoiceList.aspx.cs" Inherits="ERP.OMS.Management.Activities.DebitNoteAdjustPInvoiceList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <div class="panel-title clearfix">
            <h3 class="pull-left">Adjustment of Documents - Debit Note  / Purchase Return with Purchase Invoice</h3>
        </div>
    </div>
        <table class="padTab">
        <tr>
        ...
        <% if (rights.CanAdd)
           { %>
        <a href="javascript:void(0);" onclick="OnAddClick()" id="AddId" class="btn btn-success "><span class="btn-icon"><i class="fa fa-plus" ></i></span><u>A</u>dd Adjustment </a>
        <%} %>
