<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PurchaseRequisition.aspx.cs" Inherits="ERP.OMS.Management.Activities.PurchaseRequisition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-title">
        ...
        <h3>
            <label>Add Purchase Requisition</label>
        </h3>
    ...
    <div class="form_main">
        ...
        <div class="col-md-3">
            ...
            <dxe:ASPxLabel ID="lbl_PIQuoteNo" runat="server" Text="Requisition Number" Width="120px">
            </dxe:ASPxLabel>
        ...
        <div class="col-md-3">
            ...
            <dxe:ASPxDateEdit ID="dt_PLQuote" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy hh:mm tt" ClientInstanceName="cPLQuoteDate" TabIndex="3" Width="100%">
        ...
        <div class="col-md-12">
            ...
            <dxe:ASPxGridView runat="server" OnBatchUpdate="grid_BatchUpdate" KeyFieldName="CashReportID" ClientInstanceName="grid" ID="grid"
                ...
                <Columns>
                    ...
                    <dxe:GridViewDataComboBoxColumn Caption="Product" FieldName="MainAccount1" VisibleIndex="2" Width="100px">
                        <PropertiesComboBox ValueField="CountryID" ClientInstanceName="CountryID" TextField="CountryName">
                        </PropertiesComboBox>
                    </dxe:GridViewDataComboBoxColumn>
                    <dxe:GridViewDataTextColumn FieldName="CashReportID" Caption="Description" VisibleIndex="3" Width="150px">
                        <PropertiesTextEdit>
                        </PropertiesTextEdit>
                    </dxe:GridViewDataTextColumn>
                    ...
                    <dxe:GridViewDataTextColumn FieldName="CashReportID" Caption="UOM(Purchase)" VisibleIndex="5">
                        <PropertiesTextEdit>
                        </PropertiesTextEdit>
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn FieldName="CashReportID" Caption="Warehouse" VisibleIndex="6">
                        <PropertiesTextEdit>
                        </PropertiesTextEdit>
                    </dxe:GridViewDataTextColumn>
                    ...
                    <dxe:GridViewDataTextColumn FieldName="CashReportID" Caption="Stk UOM" VisibleIndex="8">
                        <PropertiesTextEdit>
                        </PropertiesTextEdit>
                    </dxe:GridViewDataTextColumn>
                    ...
                    <dxe:GridViewDataTextColumn FieldName="MainAccount1" Caption="Tax Amount" VisibleIndex="12">
                        <PropertiesTextEdit>
                        </PropertiesTextEdit>
                    </dxe:GridViewDataTextColumn>
