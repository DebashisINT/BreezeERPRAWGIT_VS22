...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="JS/PurchaseInvCumGRN.js?v=4.02"></script>
    ...
    <script>
        ...
        function CmbScheme_ValueChange() {
            ...
            if (val != '0') {
                ...
                if (type == 'PO' || type == 'PC') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "PurchaseInvoiceCumGRN.aspx/BindBranchByParentID",
                ...
                $.ajax({
                    type: "POST",
                    url: 'PurchaseInvoiceCumGRN.aspx/getSchemeType',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
     ...
     document.getElementById('<%= txtVoucherNo.ClientID %>').disabled = true;
            ...
            if (cchallanNoScheme.InCallback())
                lastChallan = 'BindChallanScheme~' + $('#ddl_Branch').val();
            var startDate = new Date();
            startDate = cPLQuoteDate.GetDate().format('yyyy-MM-dd');
            cPanelGRNOverheadCost.PerformCallback('BindOverheadCostGrid' + '~' + startDate);
            clookup_GRNOverhead.gridView.Refresh();
            ...
            if (invtype != 'N') {
                ...
                if (vendorid != null && vendorid != '') {
                    ...
                    if (document.getElementById('hdnAllowDuplicatePartyInvoiceNo').value == 0) {
                        $.ajax({
                            type: "POST",
                            url: "PurchaseInvoiceCumGRN.aspx/CheckUniquePartyNo",
    ...
    if (grid.cpSaveSuccessOrFail == "outrange") {
        ...
        var Order_Msg = "Purchase Invoice Cum GRN No. " + PurchaseOrder_Number + " saved.";
        if (value == "E") {
            cbtn_SaveRecords.SetEnabled(true);
            ...
            if (PurchaseOrder_Number != "") {
                jAlert(Order_Msg, 'Alert Dialog: [Purchase Invoice Cum GRN]', function (r) {
                    if (r == true) {
                        if ($('#<%=hdnPBAutoPrint.ClientID %>').val() == "1") {
                                     ...
                                     window.location.assign("PurchaseInvCumGRNList.aspx");
                                 }
                             }
                         });
                     }
                         ...
                         jAlert(Order_Msg, 'Alert Dialog: [Purchase Invoice Cum GRN]', function (r) {
                             if (r == true) {
                                 if ($('#<%=hdnPBAutoPrint.ClientID %>').val() == "1") {
                                     ...
                                     grid.cpPurchaseOrderNo = null;
                                     grid.cpGeneratedInvoice = null;
                                     window.location.assign("PurchaseInvoiceCumGRN.aspx?key=ADD&&InvType=" + $('#ddlInventory').val());
                                 }
                                 //grid.cpPurchaseOrderNo = null;
                                 //grid.cpGeneratedInvoice = null;
...
function ddl_Currency_Rate_Change() {
    ...
    if (Currency_ID == basedCurrency[0]) {
        ...
        $.ajax({
            type: "POST",
            url: "PurchaseInvoiceCumGRN.aspx/GetRate",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <div class="panel-title clearfix">
            <h3 class="pull-left">
                <span class="">
                    <asp:Label ID="lblHeading" runat="server" Text="Add Purchase Invoice Cum GRN"></asp:Label>
            ...
            <div id="crossdiv" runat="server" class="crossBtn">
                <a href="PurchaseInvCumGRNList.aspx"><i class="fa fa-times"></i></a>
            </div>
            <%--</div>--%>
        </div>
                        ...
                        <ContentCollection>
                            <dxe:ContentControl runat="server">
                                <div class="row">
                                    ...
                                    <div id="divTdsScheme" class="hide" runat="server">
                                        ...
                                        <div class="col-md-2">
                                            <div style="margin-top: 17px;">
                                                ...
                                                <dxe:ASPxCheckBox ID="chkNILRateTDS" ClientInstanceName="chkNILRateTDS" Checked="false" Text="NIL rate TDS ?" TextAlign="Right" runat="server">
                                                </dxe:ASPxCheckBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 lblmTop8" runat="server" id="dvGRNNumb">
                                        <dxe:ASPxLabel ID="ASPxLabel14" runat="server" Text="Challan Numbering Scheme">
                                        </dxe:ASPxLabel>
                                        <span style="color: red;">*</span>
                                        <%-- <asp:DropDownList ID="drdInvNumSchema" runat="server" Width="100%" Enabled="false"
                                        DataTextField="SchemaName" DataValueField="ID">
                                    </asp:DropDownList>--%>

                                        <dxe:ASPxComboBox ID="challanNoScheme" runat="server" ClientInstanceName="cchallanNoScheme" OnCallback="challanNoScheme_Callback" Width="100%" ClientEnabled="false">
                                    ...
                                    <div class="col-md-3 hide" id="divOverheadCost" runat="server">
                                        ...
                                        <div class="makeFullscreen ">
                                            ...
                                            <dxe:ASPxGridView runat="server" OnBatchUpdate="grid_BatchUpdate" KeyFieldName="PurchaseInvoiceDetailID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <%--  Manis 24428--%>
                                                    <dxe:GridViewDataTextColumn Caption="Multi Qty" CellStyle-HorizontalAlign="Right" FieldName="InvoiceDetails_AltQuantity" PropertiesTextEdit-MaxLength="14" VisibleIndex="9" Width="5%" ReadOnly="true">
                                                    ...
                                                    <dxe:GridViewDataTextColumn Caption="Multi Unit" FieldName="InvoiceDetails_AltUOM" ReadOnly="true" VisibleIndex="10" Width="5%">
                                                        <PropertiesTextEdit>
                                                        </PropertiesTextEdit>
                                                    </dxe:GridViewDataTextColumn>
                                                    ...
                                                    <dxe:GridViewCommandColumn Width="5.5%" VisibleIndex="11" Caption="Stk Details">
                                                        <CustomButtons>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="PurchasePrice" Caption="Purc. Price" VisibleIndex="12" Width="7%" HeaderStyle-HorizontalAlign="Right">
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="Discount" Caption="Disc(%)" VisibleIndex="13" Width="4%" HeaderStyle-HorizontalAlign="Right">
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="Discountamt" Caption="Disc Amt" VisibleIndex="14" Width="6%" HeaderStyle-HorizontalAlign="Right">
                                                        <PropertiesTextEdit DisplayFormatString="0.00" Style-HorizontalAlign="Right"></PropertiesTextEdit>
                                                        <PropertiesTextEdit>
                                                            <MaskSettings Mask="&lt;0..999999999&gt;.&lt;00..999&gt;" AllowMouseWheel="false" />
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="Amount" Caption="Amount" VisibleIndex="15" Width="8%" HeaderStyle-HorizontalAlign="Right">
                                                        <PropertiesTextEdit DisplayFormatString="0.00" Style-HorizontalAlign="Right"></PropertiesTextEdit>
                                                        <PropertiesTextEdit>
                                                    ...
                                                    <dxe:GridViewDataButtonEditColumn FieldName="TaxAmount" Caption="Charges" VisibleIndex="16" Width="6%" HeaderStyle-HorizontalAlign="Right" ReadOnly="True">
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="TotalAmount" Caption="Net Amount" VisibleIndex="16" Width="6.5%" HeaderStyle-HorizontalAlign="Right">
                                                        <PropertiesTextEdit DisplayFormatString="0.00" Style-HorizontalAlign="Right"></PropertiesTextEdit>
                                                        <PropertiesTextEdit>
                                                            <MaskSettings Mask="&lt;0..9999999999999999999999&gt;.&lt;00..999&gt;" AllowMouseWheel="false" />
                                                    ...
                                                    <dxe:GridViewCommandColumn ShowDeleteButton="false" ShowNewButtonInHeader="false" Width="3%" VisibleIndex="18" Caption="Add New">
                                                        <CustomButtons>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="UOMNAME" PropertiesTextEdit-ValidationSettings-ErrorImage-IconID="ghg" Caption="hidden Field Id" VisibleIndex="25" ReadOnly="True" Width="0" PropertiesTextEdit-Height="15px" PropertiesTextEdit-Style-CssClass="abcd">
                                                        <CellStyle Wrap="True" CssClass="abcd"></CellStyle>
                                                    </dxe:GridViewDataTextColumn>

                                                    <dxe:GridViewDataTextColumn FieldName="ProductID" PropertiesTextEdit-ValidationSettings-ErrorImage-IconID="ghg" Caption="hidden Field Id" VisibleIndex="26" ReadOnly="True" Width="0" PropertiesTextEdit-Height="15px" PropertiesTextEdit-Style-CssClass="abcd">
                                                        <CellStyle Wrap="True" CssClass="abcd"></CellStyle>
                                                    </dxe:GridViewDataTextColumn>
        ...
        <div>
            ...
            <asp:HiddenField ID="hdfWarehousetype" runat="server" />
            <asp:HiddenField ID="hdfProductSrlNo" runat="server" />
            <asp:HiddenField ID="hdfUOM" runat="server" />
            <asp:HiddenField ID="hdfServiceURL" runat="server" />
            <asp:HiddenField ID="hdfBranch" runat="server" />
            <asp:HiddenField ID="hdfIsRateExists" runat="server" />
                    ...
                    <div class="clearfix  row">
                        <div class="col-md-3">
                            ...
                            <div class="Left_Content" style="padding-top: 14px">
                                ...
                                <dxe:ASPxButton ID="ASPxButton11" ClientInstanceName="cbtn_CommitClose" runat="server" AutoPostBack="False" Text="OK&#818;" CssClass="btn btn-success" meta:resourcekey="btnSaveRecordsResource1" UseSubmitBehavior="False">
        ...
        <ContentCollection>
            <dxe:PopupControlContentControl runat="server">
                <div class=" clearfix">
                    ...
                    <div class="clearfix col-md-12" style="background: #f5f4f3; padding: 8px 0; margin-bottom: 15px; border-radius: 4px; border: 1px solid #ccc; width: 1000px;">
