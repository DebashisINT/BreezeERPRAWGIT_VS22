<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ProjectPurchaseQuotationList.aspx.cs" Inherits="ERP.OMS.Management.Activities.ProjectPurchaseQuotationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function timerTick() {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectPurchaseQuotationList.aspx/GetTotalWatingQuotationCount",
        ...
        function OnClickDelete(keyValue) {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectPurchaseQuotationList.aspx/GetSalesQuoteIsExistInSalesOrder",
        ...
        function CancelSalesOrder(keyValue, Reason) {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectPurchaseQuotationList.aspx/CancelSalesOrderOnRequest",
        ...
        function QuotationWattingOkClick() {
            ...
            if (listKey) {
                if (CwatingQuotegrid.GetRow(index).children[6].innerText != "Advance") {
                    var url = 'ProjectPurchaseQuotation.aspx?key=' + 'ADD&&BasketId=' + listKey;
                    LoadingPanel.Show();
        ...
        function OnApproveClick(keyValue, visibleIndex) {
            ...
            if (IsCancelFlag.trim() != 'Cancelled' && IsCancelFlag.trim() != 'Closed') {
                ...
                if (ActiveUser != null) {
                    $.ajax({
                        type: "POST",
                        url: "ProjectPurchaseQuotationList.aspx/GetEditablePermission",
                        ...
                        success: function (msg) {
                            //debugger;
                            var status = msg.d;
                            var url = 'ProjectPurchaseQuotation.aspx?key=' + keyValue + '&Permission=' + status + '&type=ProjPurQuote' + '&type1=AppProjPurQuote';
                            window.location.href = url;
                        }
                    });
                }
        ...
        function OnViewClick(keyValue) {
            var url = 'ProjectPurchaseQuotation.aspx?key=' + keyValue + '&req=V' + '&type=ProjPurQuote';
            window.location.href = url;
        }
        ...
        function OnclickViewAttachment(obj) {
            ...
            var URL = '/OMS/Management/Activities/EntriesDocuments.aspx?idbldng=' + obj + '&type=ProjPurQuote';
            window.location.href = URL;
        }

        function OnAddButtonClick() {
            var url = 'ProjectPurchaseQuotation.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        var keyval;
        ...
        function OnGetApprovedRowValues(obj) {
            uri = "ProjectPurchaseQuotation.aspx?key=" + obj + "&status=2" + '&type=QO';
        ...
        function OnGetRejectedRowValues(obj) {
            uri = "ProjectPurchaseQuotation.aspx?key=" + obj + "&status=3" + '&type=QO';
            popup.SetContentUrl(uri);
            popup.Show();
        }
        ...
        function OnApprovalEndCall(s, e) {
            $.ajax({
                type: "POST",
                url: "ProjectPurchaseQuotationList.aspx/GetPendingCase",
                contentType: "application/json; charset=utf-8",
            ...
            function OnMoreInfoClick(keyValue) {
                ...
                if (ActiveUser != null) {
                    $.ajax({
                        type: "POST",
                        url: "ProjectPurchaseQuotationList.aspx/GetEditablePermissions",
                        //data: "{'ActiveUser':'" + ActiveUser + "'}",
                        //Rev Rajdip
                        ...
                        success: function (msg) {
                            var status = msg.d;
                            var url = 'ProjectPurchaseQuotation.aspx?key=' + keyValue + '&Permission=' + status + '&type=ProjPurQuote';
                            window.location.href = url;
                        }
                    });
                  }
        ...
        function CloseSalesQuotationQuantity(Quote_Id, Remarks) {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectPurchaseQuotation.aspx/CloseQuotationquantity",
                ...
                success: function (msg) {
                    ...
                    if (status == "1") {
                        ...
                        jAlert("Purchase Quotation is closed successfully.", "Approval", function () {
                            location.reload();
                        });
                        //
                    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading clearfix">
        <div class="panel-title pull-left">
            <h3>Project Purchase Quotation</h3>
        </div>
    ...
    <div class="GridViewArea relative">
        <div class="makeFullscreen ">
             <span class="fullScreenTitle">Project Purchase Quotation</span>
        ...
        <dxe:ASPxGridView ID="GrdQuotation" runat="server" KeyFieldName="Quote_Id" AutoGenerateColumns="False" SettingsBehavior-AllowFocusedRow="true" Settings-VerticalScrollableHeight="250" Settings-VerticalScrollBarMode="Auto"
            Width="100%" ClientInstanceName="cGrdQuotation" OnCustomCallback="GrdQuotation_CustomCallback" DataSourceID="EntityServerModeDataSource" SettingsDataSecurity-AllowEdit="false" SettingsDataSecurity-AllowInsert="false"
             SettingsDataSecurity-AllowDelete="false" OnHtmlRowPrepared="AvailableStockgrid_HtmlRowPrepared" >
             ...
             <Columns>
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="13" Width="1">
                    <DataItemTemplate>
                      ...
                      <%if (rights.CanClose)
                       { %>
                     <a href="javascript:void(0);" onclick="fn_CloseSalesOrder('<%# Container.KeyValue %>')" title="" class="" style='<%#Eval("PurchaseQuotationLastEntry")%>'>
          ...
          <%} %>
                           ...
                           <% if (rights.CanCancel)
                           { %>
                          <a href="javascript:void(0);" onclick="OnCancelClick('<%# Container.KeyValue %>')" class="" title="" style='<%#Eval("PurchaseQuotationLastEntry")%>'>
