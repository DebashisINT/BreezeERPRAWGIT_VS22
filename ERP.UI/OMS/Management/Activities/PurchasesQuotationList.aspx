<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PurchasesQuotationList.aspx.cs" Inherits="ERP.OMS.Management.Activities.PurchasesQuotationList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form_main">
        <div class="clearfix">
            <% if (rights.CanAdd)
               { %>
            <a href="PurchasesQuotation.aspx"  class="btn btn-success btn-radius"><span class="btn-icon"><i class="fa fa-plus" ></i></span><span>New</span> </a><%} %>
        ...
        <dxe:ASPxGridView ID="GrdQuotation" runat="server" KeyFieldName="Quote_Id" AutoGenerateColumns="False" SettingsBehavior-AllowFocusedRow="true" Settings-VerticalScrollableHeight="250" Settings-VerticalScrollBarMode="Auto"
           ...
           <SettingsSearchPanel Visible="True" Delay="5000" />
             <Columns>
                ...
                <%--  <dxe:GridViewDataTextColumn Caption="Remarks" FieldName="Remarks" Visible="false"
                 ...
                 <%-- End Rev Rajdip --%>
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="8" Width="1">
                    <DataItemTemplate>
                        <div class='floatedBtnArea'>
                        <a href="javascript:void(0);" onclick="" class="" title="">
                            <span class='ico editColor'><i class='fa fa-tick'></i></span><span class='hidden-xs'>Approve/Reject</span></a>
                        <% if (rights.CanView)
                           { %>
          ...
          <%} %>
           ...
           <SettingsBehavior ConfirmDelete="true" EnableCustomizationWindow="true" EnableRowHotTrack="true" />
            <SettingsCookies Enabled="true" StorePaging="true"  Version="14.2" />
           <%-- -- End of Rev Sayantani --%>
