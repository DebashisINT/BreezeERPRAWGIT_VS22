...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form_main">
        <div class="clearfix">
            ...
            <button id="btnPrinted" data-toggle="tooltip" title="Click to see the printed details" class="btn btn-badge-color1 btn-radius" type="button" onclick="btn_PrintedClick(this);">Printed <span class="badge" id="spnPrintedlvl">0</span></button>
            <button id="btnReadyforInvoice" data-toggle="tooltip" title="Click to see the ready for invoice details" class="btn btn-badge-color2 btn-radius" type="button" onclick="btn_ReadyforInvoiceClick(this);">Ready for Invoice <span class="badge" id="spnReadyforInvoicelvl">0</span></button>
            <button id="btnPending" data-toggle="tooltip" title="Click to see the pending details" class="btn btn-badge-color3 btn-radius" type="button" onclick="btn_PendingClick(this);">Pending <span class="badge" id="spnPendinglvl">0</span></button>
            <button id="btnAll" data-toggle="tooltip" title="Click to see the all details" class="btn btn-badge-color6 btn-radius" type="button" onclick="btn_AllClick(this);">All <span class="badge" id="spnAlllvl">0</span></button>
