...
{
    public partial class ServiceMaterialIssueAdd : System.Web.UI.Page
    {
        ServiceMaterialIssue blLayer = new ServiceMaterialIssue();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Session["BindGridForEditDetails"] = null;
                Session["BindGridForEditDetailsFinal"] = null;
                Session["BindSOGridForEditDetails"] = null;
                

                if (Request.QueryString["Key"] != "Add")
                {
                    string AdjId = Request.QueryString["Key"];
                    Session["MaterialIssueID"] = AdjId;
                    EditModeExecute(AdjId);
                    hdAddEdit.Value = "Edit";
                    hdAdjustmentId.Value = AdjId;
                    lblHeading.Text = "Edit Material Issue";
                ...
                else
                {
                    hdAddEdit.Value = "Add";
                    AddmodeExecuted();
                    Session["ServiceMateriakDetailTable"] = null;
                }
                if (Request.QueryString["req"] != null && Request.QueryString["req"] == "V")
                {
                    lblHeading.Text = "View Material Issue";
        ...
        public void EditModeExecute(string id)
        {
            ...
            txtVoucherNo.Text = Convert.ToString(HeaderRow["MaterialIssue_Number"]);
            dtTDate.Date = Convert.ToDateTime(HeaderRow["MaterialIssue_Date"]);
            ddlBranch.SelectedValue = Convert.ToString(HeaderRow["BranchId"]);
            ddlBranch.Enabled = false;
            txtReference.Text = Convert.ToString(HeaderRow["MaterialIssue_Reference"]);
            ...
            string MaterialIssueCreatedFromDoc = Convert.ToString(HeaderRow["MaterialIssueCreatedFromDoc"]);
            string MaterialIssueCreatedFromDoc_Ids = Convert.ToString(HeaderRow["MaterialIssueCreatedFromDoc_Ids"]);
            ...
            string MaterialIssue_Date = Convert.ToString(HeaderRow["MaterialIssue_Date"]);
           ...
           // Session["ServiceMateriakDetailTable"] = EditedDataDetails.Tables[4];
            Finalgrid.DataBind();


            TempTableGrid = EditedDataDetails.Tables[5];

            Session["SI_QuotationDetails"] = EditedDataDetails.Tables[5];
            grid.DataBind();


            DataTable dt=EditedDataDetails.Tables[4];
            if (dt != null && dt.Rows.Count>0)
            {
              //  DataTable Quotationdt = (DataTable)Session["BindGridForEditDetails"];
                DataView dvData = new DataView(dt);
                dvData.RowFilter = "ComponentNumber=''";                

                Session["BindGridForEditDetails"] = dvData.ToTable();                
            }

           // Session["BindGridForEditDetails"] = EditedDataDetails.Tables[6];


            Session["BindSOGridForEditDetails"] = EditedDataDetails.Tables[7];
        ...
        public DataTable GetQuotationWarehouseData()
        {
            try
            {
                ...
                proc.AddVarcharPara("@MaterialIssueID", 500, Convert.ToString(Session["MaterialIssueID"]));
        ...
        protected void BindLookUp(string Customer, string OrderDate, string ComponentType, string BranchID)
        {
            ...
            string strInvoiceID = Convert.ToString(Session["MaterialIssueID"]);
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                DataSet dt_QuotationDetails = blLayer.GetSelectedSalesInvoiceComponentProductList(strAction, ComponentDetailsIDs, strInvoiceID);
        ...
        protected void Editgrid_BatchUpdate(object sender, ASPxDataBatchUpdateEventArgs e)
        {
            int id = 0;
            DataRow NewRow;
            if (Session["BindSOGridForEditDetails"] != null)
            {
                string lblActualSrl = Convert.ToString(hdnActualSrlID.Value);
                DataTable Quotationdt = (DataTable)Session["BindSOGridForEditDetails"];

                foreach (DataRow dr in Quotationdt.Rows)
                {
                    string ActualSL = Convert.ToString(dr["ActualSL"]);
                    if (lblActualSrl == ActualSL)
                    {
                        id = 1;
                        break;
                    }
                ...
                if (id == 0)
                {
                    ...
                    ContractTable.Columns.Add("SrlNo", typeof(string));
                    ContractTable.Columns.Add("ComponentNumber", typeof(string));
                    ContractTable.Columns.Add("ProductName", typeof(string));
                    ContractTable.Columns.Add("Description", typeof(string));
                    ContractTable.Columns.Add("Quantity", typeof(decimal));
                    ContractTable.Columns.Add("UOM", typeof(string));
                    ContractTable.Columns.Add("SalePrice", typeof(decimal));
                    ContractTable.Columns.Add("Amount", typeof(decimal));
                    ContractTable.Columns.Add("ServiceTemplate", typeof(string));
                    ContractTable.Columns.Add("ProductID", typeof(string));
                    ContractTable.Columns.Add("ServiceTemplateID", typeof(string));
                    ContractTable.Columns.Add("ComponentID", typeof(string));
                    ContractTable.Columns.Add("DocDetailsID", typeof(string));
                    ContractTable.Columns.Add("ActualSL", typeof(string));

                    ContractTable = (DataTable)Session["BindSOGridForEditDetails"];


                    if (!string.IsNullOrEmpty(Convert.ToString(hdnlblComponentNumber.Value)))
                    {
                        NewRow = ContractTable.NewRow();
                        NewRow["SrlNo"] = Convert.ToString(hdnActualSrlID.Value);
                        NewRow["ComponentNumber"] = Convert.ToString(hdnlblComponentNumber.Value);
                        NewRow["ProductName"] = Convert.ToString(hdnlblProduct.Value);
                        NewRow["Description"] = Convert.ToString(hdnlblDescription.Value);
                        NewRow["Quantity"] = Convert.ToDecimal(hdnlblQuantity.Value);
                        NewRow["UOM"] = Convert.ToString(hdnlblUOM.Value);
                        NewRow["SalePrice"] = Convert.ToDecimal(hdnlblPrice.Value);
                        NewRow["Amount"] = Convert.ToDecimal(hdnlblAmount.Value);
                        NewRow["ServiceTemplate"] = Convert.ToString(txtServiceTemplate.Text);

                        NewRow["ProductID"] = Convert.ToString(hdnlblProductID.Value);
                        NewRow["ServiceTemplateID"] = Convert.ToString(hdnlblServiceTempID.Value);
                        NewRow["ComponentID"] = Convert.ToString(hdnlblComponentID.Value);
                        NewRow["DocDetailsID"] = Convert.ToString(hdnlblDocDetailsID.Value);
                        NewRow["ActualSL"] = Convert.ToString(hdnActualSrlID.Value);
                        ContractTable.Rows.Add(NewRow);
                    }

                    Session["BindSOGridForEditDetails"] = ContractTable.Copy();
                }
            ...
            AdjustmentTable.Columns.Add("ServiceTemplate", typeof(string));
            AdjustmentTable.Columns.Add("Remarks", typeof(string));
            AdjustmentTable.Columns.Add("ProductID", typeof(string));
            AdjustmentTable.Columns.Add("ServiceTemplateID", typeof(string));
            ...
            if (Session["BindGridForEditDetails"] != null)
            {
                AdjustmentTable = (DataTable)Session["BindGridForEditDetails"];
            }
            ...
            foreach (var args in e.InsertValues)
            {
                if (!string.IsNullOrEmpty(Convert.ToString(args.NewValues["ProductName"])))
                {
                    ...
                    NewRow["ServiceTemplate"] = Convert.ToDecimal(args.NewValues["ServiceTemplate"]);
                    NewRow["Remarks"] = Convert.ToString(args.NewValues["Remarks"]);
                    NewRow["ProductID"] = Convert.ToString(args.NewValues["ProductID"]);
                    NewRow["ServiceTemplateID"] = Convert.ToString(args.NewValues["ServiceTemplateID"]);
            ...
            foreach (var args in e.UpdateValues)
            {
                if (!string.IsNullOrEmpty(Convert.ToString(args.NewValues["ProductName"])))
                {
                    ...
                    string ActualSL=Convert.ToString(args.NewValues["ActualSL"]);


                    DataRow[] AdjTableRow = AdjustmentTable.Select("ActualSL='" + ActualSL + "'");
            ...
            TempTableEditGrid = AdjustmentTable.Copy();
            Session["BindGridForEditDetails"] = AdjustmentTable.Copy();

            Editgrid.JSProperties["cpBindFinalGrid"] = "Y";
        }

        protected void Editgrid_DataBinding(object sender, EventArgs e)
        {
            if (Session["BindGridForEditDetailsFinal"] != null)
            {
                DataTable Quotationdt = (DataTable)Session["BindGridForEditDetailsFinal"];
                DataView dvData = new DataView(Quotationdt);
                Editgrid.DataSource = dvData.ToTable();
            }
        }

        protected void Editgrid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            string strSplitCommand = e.Parameters.Split('~')[0];
            if (strSplitCommand == "BindGridForEdit")
            {
                string ComponentID = e.Parameters.Split('~')[1];
                string DocDetailsID = e.Parameters.Split('~')[2];

                if (Session["BindGridForEditDetails"] != null)
                {
                    DataTable Quotationdt = (DataTable)Session["BindGridForEditDetails"];
                    DataView dvData = new DataView(Quotationdt);
                    dvData.RowFilter = "ComponentID=" + ComponentID;
                    dvData.RowFilter = "DocDetailsID=" + DocDetailsID;

                    DataTable dt_Edit = dvData.ToTable();
                    int conut = 1;
                    ...
                    Session["BindGridForEditDetailsFinal"] = dt_Edit;

                    Editgrid.DataSource = dvData.ToTable();
                    Editgrid.DataBind();
                }
            }
            else if (strSplitCommand == "BindGridForServiceTemplate")
            {
                string ID = e.Parameters.Split('~')[1];
                string ComponentID = e.Parameters.Split('~')[2];
                string DocDetailsID = e.Parameters.Split('~')[3];

                DataTable dt_Edit = GetServiceTemplate(ID);


                if (Session["BindGridForEditDetails"] == null)
                {
                    int RowCount = Convert.ToInt32(HiddenRowCount.Value)+1;
                    foreach (DataRow dr in dt_Edit.Rows)
                    {
                        dr["ComponentID"] = ComponentID;
                        dr["DocDetailsID"] = DocDetailsID;
                        dr["ActualSL"] = RowCount;
                        RowCount++;
                    }


                    Session["BindGridForEditDetails"] = dt_Edit;

                    Editgrid.DataSource = dt_Edit;
                    Editgrid.DataBind();
                }
                ...
                else
                {
                    ...
                    {
                        int i = AdjustmentTable.Rows.Count + 1;
                        foreach (DataRow item in dt_Edit.Rows)
                        {

                            AdjustmentTable.Rows.Add(i, item["ComponentNumber"], item["ProductName"], item["Description"], item["Quantity"], item["UOM"], item["SalePrice"], item["Amount"], item["ServiceTemplate"], item["ProductID"], item["ServiceTemplateID"], item["ComponentID"], item["DocDetailsID"], item["ActualSL"]);
                    ...
                    DataTable dtEdit = dvData.ToTable();
                    int conut = 1;
                    ...
                    Session["BindGridForEditDetailsFinal"] = dtEdit;
        ...
        protected void Editgrid_RowInserting(object sender, ASPxDataInsertingEventArgs e)
        {
            e.Cancel = true;
        }

        protected void Editgrid_RowUpdating(object sender, ASPxDataUpdatingEventArgs e)
        {
            e.Cancel = true;
        }

        protected void Editgrid_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            e.Cancel = true;
        }

        protected void Editgrid_CustomJSProperties(object sender, ASPxGridViewClientJSPropertiesEventArgs e)
        {

        }

        protected void Finalgrid_BatchUpdate(object sender, ASPxDataBatchUpdateEventArgs e)
        {
            DataTable AdjustmentTable = new DataTable();
            AdjustmentTable.Columns.Add("SrlNo", typeof(string));
            ...
            foreach (var args in e.UpdateValues)
            {
                if (!string.IsNullOrEmpty(Convert.ToString(args.NewValues["ProductName"])))
                {
                    ...
                    NewRow["SalePrice"] = Convert.ToDecimal(args.NewValues["SalePrice"]);
                    NewRow["Amount"] = Convert.ToDecimal(args.NewValues["Amount"]);
                    NewRow["ServiceTemplate"] = Convert.ToString(args.NewValues["ServiceTemplate"]);
                    NewRow["Remarks"] = Convert.ToString(args.NewValues["Remarks"]);
                    NewRow["ProductID"] = Convert.ToString(args.NewValues["ProductID"]);
                    NewRow["ServiceTemplateID"] = Convert.ToString(args.NewValues["ServiceTemplateID"]);
                    NewRow["ComponentID"] = Convert.ToString(args.NewValues["ComponentID"]);
            ...
            AdjustmentTable.Columns.Remove("ServiceTemplate");
           // AdjustmentTable.Columns.Remove("ActualSL");
            ...
            blLayer.AddEditServiceMaterialIssue(hdAddEdit.Value, CmbScheme.Value.ToString().Split('~')[0], txtVoucherNo.Text, dtTDate.Date.ToString("yyyy-MM-dd"),
            ...
            Finalgrid.JSProperties["cpadjustmentNumber"] = adjustmentNumber;
            Finalgrid.JSProperties["cpErrorCode"] = Convert.ToString(ErrorCode);
            Finalgrid.JSProperties["cpadjustmentId"] = Convert.ToString(adjustmentId);
            e.Handled = true;
        ...
        protected void Finalgrid_DataBinding(object sender, EventArgs e)
        {
            Finalgrid.DataSource = TempTable;
        }

        protected void Finalgrid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            DataTable AdjustmentTable = new DataTable();
            AdjustmentTable.Columns.Add("SrlNo", typeof(string));
            AdjustmentTable.Columns.Add("ComponentNumber", typeof(string));
           ...
           // AdjustmentTable.Columns.Add("Remarks", typeof(string));
            ...
            DataTable BindSOGridForEditDetails = (DataTable)Session["BindSOGridForEditDetails"];
            DataTable BindGridForEditDetails = (DataTable)Session["BindGridForEditDetails"];
            if (BindSOGridForEditDetails != null && BindSOGridForEditDetails.Rows.Count > 0)
            {
                int i = 1;
                foreach (DataRow item in BindSOGridForEditDetails.Rows)
                {

                    AdjustmentTable.Rows.Add(i,item["ComponentNumber"],item["ProductName"],item["Description"],item["Quantity"],item["UOM"],item["SalePrice"],item["Amount"],item["ServiceTemplate"],item["ProductID"],item["ServiceTemplateID"],item["ComponentID"],item["DocDetailsID"],item["ActualSL"]);


                    foreach (DataRow item2 in BindGridForEditDetails.Rows)
                    {
                        if ((Convert.ToString(item["ComponentID"]) == Convert.ToString(item2["ComponentID"])) && (Convert.ToString(item["DocDetailsID"]) == Convert.ToString(item2["DocDetailsID"])))
                        {
                             i++;
                             AdjustmentTable.Rows.Add(i, "", item2["ProductName"], item2["Description"], item2["Quantity"], item2["UOM"], item2["SalePrice"], item2["Amount"], "", item2["ProductID"], item2["ServiceTemplateID"], item2["ComponentID"], item2["DocDetailsID"], item2["ActualSL"]);
            ...
            Session["BindFinalgridData"] = AdjustmentTable.Copy();
            TempTable = AdjustmentTable.Copy();
            Finalgrid.DataSource = AdjustmentTable;
            Finalgrid.DataBind();

            Finalgrid.JSProperties["cpBindFinal"] = "Y";

        }

        protected void Finalgrid_RowInserting(object sender, ASPxDataInsertingEventArgs e)
        {

        }

        protected void Finalgrid_RowUpdating(object sender, ASPxDataUpdatingEventArgs e)
        {

        }

        protected void Finalgrid_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {

        }

        protected void Finalgrid_CustomJSProperties(object sender, ASPxGridViewClientJSPropertiesEventArgs e)
        {

        }

        protected void Editgrid_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            if (e.Column.FieldName == "Quantity")
            {
                e.Editor.ReadOnly = false;
        ...
        protected void Finalgrid_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            //if (e.Column.FieldName == "Quantity")
            //{
            //    e.Editor.ReadOnly = false;
        ...
        public DataTable GetWarehouseData()
        {
            ...
            proc.AddVarcharPara("@QuotationID", 500, Convert.ToString(Session["MaterialIssueID"]));
