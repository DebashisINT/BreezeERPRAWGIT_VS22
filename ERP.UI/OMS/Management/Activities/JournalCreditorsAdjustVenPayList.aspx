<%--================================================== Revision History =============================================
1.0   Pallab    V2.0.38      19-05-2023          0026179: Adjustment of Documents - Journal with Vendor Payment module design modification & check in small device
2.0   Sanchita  V2.0.43      20-02-2024          Views to be converted to Procedures in the Listing Page - Journal With Vendor Payment. Mantis: 27262
====================================================== Revision History =============================================--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="JournalCreditorsAdjustVenPayList.aspx.cs" Inherits="ERP.OMS.Management.Activities.JournalCreditorsAdjustVenPayList" %>
    ...
    <script>
        ...
        function AllControlInitilize() {
            if (isFirstTime) {
                ...
                if (localStorage.getItem('JournalCreditorsAdjustVPFromDate')) {
                    var fromdatearray = localStorage.getItem('JournalCreditorsAdjustVPFromDate').split('-');
                    var fromdate = new Date(fromdatearray[0], parseFloat(fromdatearray[1]) - 1, fromdatearray[2], 0, 0, 0, 0);
                    cFormDate.SetDate(fromdate);
                }

                if (localStorage.getItem('JournalCreditorsAdjustVPToDate')) {
                    var todatearray = localStorage.getItem('JournalCreditorsAdjustVPToDate').split('-');
                    var todate = new Date(todatearray[0], parseFloat(todatearray[1]) - 1, todatearray[2], 0, 0, 0, 0);
                    ctoDate.SetDate(todate);
                }
                if (localStorage.getItem('JournalCreditorsAdjustVPListBranch')) {
                    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('JournalCreditorsAdjustVPListBranch'))) {
                        ccmbBranchfilter.SetValue(localStorage.getItem('JournalCreditorsAdjustVPListBranch'));
                    }
        ...
        function OnViewClick(keyValue) {
            var url = 'JournalCreditorsAdjustVenPay.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }
        function onEditClick(id) {
            window.location.href = 'JournalCreditorsAdjustVenPay.aspx?Key=' + id;
        }
        ...
        function updateGridByDate() {
            ...
            if (cFormDate.GetDate() == null) {
                ...
                localStorage.setItem("JournalCreditorsAdjustVPFromDate", cFormDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("JournalCreditorsAdjustVPToDate", ctoDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("JournalCreditorsAdjustVPListBranch", ccmbBranchfilter.GetValue());
        ...
        function OnAddClick() {
            window.location.href = 'JournalCreditorsAdjustVenPay.aspx?Key=Add';
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <div class="panel-title clearfix">
            <h3 class="pull-left">Adjustment of Documents - Journal with Vendor Payment</h3>
        </div>
    </div>
        <table class="padTab">
        <tr>
        ...
        <div class="GridViewArea relative">
            ...
            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                ContextTypeName="ERPDataClassesDataContext" TableName="v_JournalAdjustmentVendorPaymentList" />
