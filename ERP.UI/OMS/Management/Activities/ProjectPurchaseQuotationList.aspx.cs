...
{
    public partial class ProjectPurchaseQuotationList : System.Web.UI.Page
    {
        ...
        {
            ProjectTermsBL objCRMSalesDtlBL = new ProjectTermsBL();
            GrdQuotation.JSProperties["cpinsert"] = null;
            GrdQuotation.JSProperties["cpEdit"] = null;
            GrdQuotation.JSProperties["cpUpdate"] = null;
            GrdQuotation.JSProperties["cpDelete"] = null;
        ...
        public void PopulateERPDocApprovalPendingListByUserLevel()
        {
            ...
            if (Session["userid"] != null)
            {
                if (Session["userbranchID"] != null)
                {
                    ...
                    dtdata = objERPDocPendingApproval.PopulateERPDocApprovalPendingListByUserLevel(userid, "ProjPurQuote");
                    if (dtdata != null && dtdata.Rows.Count > 0)
                    {
        ...
        public void PopulateApprovalPendingCountByUserLevel()
        {
            ...
            DataTable dtdata = new DataTable();
            dtdata = objERPDocPendingApproval.PopulateERPDocApprovalPendingCountByUserLevel(userid, "ProjPurQuote");
            if (dtdata != null && dtdata.Rows.Count > 0)
            {
        ...
        public void PopulateUserWiseERPDocCreation()
        {
            ...
            if (Session["UserWiseERPDocCreation"] == null)
            {
                ...
                dtdata = objERPDocPendingApproval.PopulateUserWiseERPDocCreation(userid, "ProjPurQuote");
            }
            else
            {
        ...
        public void ConditionWiseShowStatusButton()
        {
            ...
            j = objERPDocPendingApproval.ConditionWiseShowApprovalStatusButton(1, Convert.ToString(Session["userbranchHierarchy"]), Convert.ToString(Session["userid"]), "ProjPurQuote");
            ...
            k = objERPDocPendingApproval.ConditionWiseShowApprovalPendingButton(1, Convert.ToString(Session["userbranchHierarchy"]), Convert.ToString(Session["userid"]), "ProjPurQuote");
            ...
            if (IsFilter == "Y")
            {
                if (strBranchID == "0")
                {
                    ...
                    if (IsUserwise == "Y")
                    {
                        ...
                        var q = from d in dc.V_ProjectPurchaseQuotationLists
        ...
        {
            ProjectTermsBL objCRMSaleDtlBL = new ProjectTermsBL();
            int ispermission = 0;
