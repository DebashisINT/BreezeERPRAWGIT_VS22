...
{
    public partial class SalesOrderListHTML : System.Web.UI.Page
    {
        ...
        {
            ERPDocPendingApprovalBL objERPDocPendingApproval = new ERPDocPendingApprovalBL();
            ApprovalCountHTML cls = new ApprovalCountHTML();
            int userid = Convert.ToInt32(HttpContext.Current.Session["userid"]);
            DataTable dtdata = new DataTable();
            dtdata = objERPDocPendingApproval.PopulateERPDocApprovalPendingCountByUserLevel(userid, "SO");
            if (dtdata != null && dtdata.Rows.Count > 0)
    ...
    public class ApprovalCountHTML
    {
