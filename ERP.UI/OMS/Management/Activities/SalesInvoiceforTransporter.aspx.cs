       ...
       // BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
        ...
        public void SetInvoiceDetails(string strInvoiceId)
        {
            ...
            if (QuotationEditdt != null && QuotationEditdt.Rows.Count > 0)
            {
                ...
                ddl_SaleTransPosGst.DataSource = dsQuotationEditdt.Tables[2];
                ddl_SaleTransPosGst.ValueField = "ID";
                ddl_SaleTransPosGst.TextField = "Name";
                ddl_SaleTransPosGst.DataBind();

                string PosForGst = Convert.ToString(QuotationEditdt.Rows[0]["PosForGst"]);
                ddl_SaleTransPosGst.Value = PosForGst;
                ...
                txtVendorName.Text = Customer_Name;
                ...
                else
                {
                    ...
                    txtVendorName.ClientEnabled = true;
                }
            }
        }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D" && IsDeleteFrom != "C")
            {
                ...
                string PosForGst = Convert.ToString(ddl_SaleTransPosGst.Value);
             ...
             //   BusinessLogicLayer.DBEngine objEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                ...
                if (ddl_SaleTransPosGst.Value.ToString() == "S")
                {
                ...
                else
                {
                    ...
                    ModifyQuatation(strIsInventory, MainInvoiceID, strSchemeType, UniqueQuotation, strInvoiceDate, strCustomer, strContactName,
                                    ...
                                    approveStatus, ActionType, PosForGst, ref strIsComplete, ref strQuoteID, ref strInvoiceNumber);
        ...
        public void ModifyQuatation(string strIsInventory, string QuotationID, string strSchemeType, string strQuoteNo, string strQuoteDate, string strCustomer, string strContactName,
                                    ...
                                    DataTable Productdt, DataTable TaxDetailTable, DataTable Warehousedt, DataTable InvoiceTaxdt, DataTable BillAddressdt, string strSchemeID, string approveStatus, string ActionType,
                                    string PosForGst, ref int strIsComplete, ref int strInvoiceID, ref string strInvoiceNumber)
        {
            try
            {
                // ASPxTextBox txtDriverName = (ASPxTextBox)VehicleDetailsControl.FindControl("txtDriverName");
