...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <h3 class="pull-left">
            <%--<asp:Label ID="lblHeading" runat="server" Text="Adjustment of Documents - Advance With Credit Note"></asp:Label>--%>
            <asp:Label ID="lblHeading" runat="server" Text="Add Adj. of Doc - Payment/Dr. Note with Rec./Cr Note"></asp:Label>
        </h3>
    </div>
        <div id="ApprovalCross" runat="server" class="crossBtn"><a href="VendPaymentAdvanceAdstCrNoteList.aspx"><i class="fa fa-times"></i></a></div>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-2 lblmTop8">
                        ...
                        <div>
                            <dxe:ASPxButtonEdit ID="txtVendName" runat="server" ReadOnly="true" ClientInstanceName="ctxtVendName" Width="100%">
                            ...
                            <span id="MandatoryVendor" class="iconBranch pullleftClass fa fa-exclamation-circle iconRed " style="color: red; position: absolute; right: -7px; top: 34px; display: none" title="Mandatory"></span>
                        </div>
                    </div>


                    <div class="col-md-2 lblmTop8">
                        <label>Adv. Document No.<span style="color: red">*</span></label>
                        <div>
                            <div>
                                <dxe:ASPxButtonEdit ID="btntxtDocNo" runat="server" ReadOnly="true" ClientInstanceName="cbtntxtDocNo" Width="100%">
                                    <Buttons>
                                        <dxe:EditButton>
                                        </dxe:EditButton>
                                    </Buttons>
                                ...
                                <span id="MandatoryDocNo" class="iconBranch pullleftClass fa fa-exclamation-circle iconRed " style="color: red; position: absolute; right: -5px; top: 34px; display: none" title="Mandatory"></span>
                            </div>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="col-md-2 lblmTop8">
                        ...
                        <div>
                            <div>
                                <dxe:ASPxTextBox runat="server" ID="DocAmt" ClientInstanceName="cDocAmt" ClientEnabled="false" Width="100%">
                    ...
                    <div class="col-md-2 lblmTop8">
                        ...
                        <div>
                            <div>
                                <dxe:ASPxTextBox runat="server" ID="ExchRate" ClientInstanceName="cExchRate" ClientEnabled="false" Width="100%">
                                    <MaskSettings Mask="&lt;0..999999999&gt;.&lt;00..99&gt;" />
                                </dxe:ASPxTextBox>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2 lblmTop8">
                        ...
                        <div>
                            <div>
                                <dxe:ASPxTextBox runat="server" ID="BaseAmt" ClientInstanceName="cBaseAmt" ClientEnabled="false" Width="100%">
                                    <MaskSettings Mask="&lt;0..999999999&gt;.&lt;00..99&gt;" />
                                </dxe:ASPxTextBox>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2 lblmTop8">
                        ...
                        <div>
                            <div>
                                <dxe:ASPxTextBox runat="server" ID="OsAmt" ClientInstanceName="cOsAmt" ClientEnabled="false" Width="100%">
                                    <MaskSettings Mask="&lt;0..999999999&gt;.&lt;00..99&gt;" />
                                </dxe:ASPxTextBox>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2 lblmTop8">
                        ...
                        <div>
                            <div>
                                <dxe:ASPxTextBox runat="server" ID="AdjAmt" ClientInstanceName="cAdjAmt" Width="100%">
                                    <MaskSettings Mask="&lt;0..999999999&gt;.&lt;00..99&gt;" />
                    ...
                    <div class="col-md-12" style="top: 20px;">
                        <dxe:ASPxGridView runat="server" ClientInstanceName="grid" Width="100%" ID="grid"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Receipt Document Search</h4>
                </div>
                <div class="modal-body">
