//*************************************************************************************************************
// 1.0   Sanchita   V2.0.43      19-02-2024    27265 : Views to be converted to Procedures in the Listing Page - Journal With Purchase Return      
// **************************************************************************************************************
...
{
    public partial class JournalCreditorsAdjustPReturnList : System.Web.UI.Page
    {
        ...
        protected void CallbackPanel_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetJournalCreditorsAdjustPReturndata(FROMDATE, TODATE, strBranchID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetJournalCreditorsAdjustPReturndata(string FROMDATE, string TODATE, string BRANCH_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("prc_JournalCreditorsAdjustPReturn_List", con);
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                ...
                //    var q = from d in dc.v_JournalAdjustmentPurchaseReturnLists
                ...
                var q = from d in dc.JournalCreditorsAdjustPReturnLists
        ...
        protected void gridAdvanceAdj_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int rowsNo = customerReceiptAdjustment.DeleteJournalPurchaseReturnAdj(param.Split('~')[1]);
             if (rowsNo > 0)
             {
        ...
        private void bindexport(int Filter)
        {
            ...
            string filename = "Adjustment of Document- Journal with Purchase Return";
            exporter.FileName = filename;
            exporter.FileName = "Adjustment of Document- Journal with Purchase Return";

            exporter.PageHeader.Left = "Adjustment of Document- Journal with Purchase Return";
