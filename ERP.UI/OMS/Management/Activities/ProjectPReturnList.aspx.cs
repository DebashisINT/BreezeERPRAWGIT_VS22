...
{
    public partial class ProjectPReturnList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Management/Activities/ProjectPReturnList.aspx");
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Project Purchase Return";
            exporter.FileName = filename;
            //  exporter.FileName = "PurchaseReturnWithStockAndAccount";

            exporter.PageHeader.Left = "Project Purchase Return";
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                if (strBranchID == "0")
                {
                    ...
                    var q = from d in dc.v_ProjectPurchaseReturnLists
