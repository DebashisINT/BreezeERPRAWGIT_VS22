...
{
    public partial class SelfPurchaseInvoice : VSPage //: System.Web.UI.Page
    {
      ...
      //  BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/SelfPurchaseInvoiceList.aspx");
            ...
            if (!IsPostBack)
            {
                ...
                //Session["SPBNonInvProChgforShow"] = null;
                Session.Remove("SPBNonInvProChgforShow");
                #endregion NonInventory Section By Sam on 17052017
                #region Session NUll initialization


                //Session["SPurchaseInvoice_Id"] = null;
                Session.Remove("SPurchaseInvoice_Id");

                //Session["SPurchaseOrderFinalTaxRecord"] = null;
                Session.Remove("SPurchaseOrderFinalTaxRecord");

                Session["SPurchaseInvoiceDetails"] = null;
                Session.Remove("SPurchaseOrderFinalTaxRecord");

                //Session["SPurchaseInvoiceDetails"] = null;
                Session["SPBLoopWarehouse"] = 1;
                //Session.Remove("SPurchaseOrderFinalTaxRecord");
                //Session["SPOCWarehouseData"] = null;
                Session.Remove("SPOCWarehouseData");
                //Session["SPBTaxDetails"] = null;
                Session.Remove("SPBTaxDetails");
                //Session["PBAddressDtl"] = null;
                Session.Remove("SPBAddressDtl");
                //Session["SPBwarehousedetailstemp"] = null;
                Session.Remove("SPBwarehousedetailstemp");
                //Session["SPBwarehousedetailstempUpdate"] = null;
                Session.Remove("SPBwarehousedetailstempUpdate");

                //Session["SPBwarehousedetailstempDelete"] = null;
                Session.Remove("SPBwarehousedetailstempDelete");

                //Session["SPBwarehousedetailstempNew"] = null;
                Session.Remove("SPBwarehousedetailstempNew");

                //Session["SWbranchInEdit"] = null;
                Session.Remove("SWbranchInEdit");

                //Session["SPBNonInvProChg"] = null;
                Session.Remove("SPBNonInvProChg");

                ViewState["SEnteredBranchID"] = null;

                //Session["SEnteredBranchID"] = null;
                Session.Remove("SEnteredBranchID");
                ...
                if (Request.QueryString["key"] == "ADD")
                {
                    ...
                    if (Session["SaveModeSPB"] != null)  // it has been removed from coding side of Quotation list 
                    {
                        ...
                        if (Session["schemavalueSPB"] != null)  // it has been removed from coding side of Quotation list 
                        {
                            ddl_numberingScheme.SelectedValue = Convert.ToString(Session["schemavalueSPB"]); // it has been removed from coding side of Quotation list 
                            string[] selectedbranch = new string[] { };
                            selectedbranch = Convert.ToString(Session["schemavalueSPB"]).Split('~');
                            ddl_Branch.SelectedValue = selectedbranch[1];

                        }


                        if (Convert.ToString(Session["SaveModeSPB"]) == "A")
                        {
                            dt_PLQuote.Focus();
                            txtVoucherNo.Enabled = false;
                            txtVoucherNo.Text = "Auto";
                        }
                        else if (Convert.ToString(Session["SaveModeSPB"]) == "M")
                        {
                ...
                else
                {
                    ...
                    Session["SPurchaseInvoice_Id"] = strPurchaseInvoiceID;
                    ...
                    //Session["SPBwarehousedetailstemp"] = dtwarehouse;
                    Session["SPBwarehousedetailstempNew"] = dtwarehouse;
                    SetWareHouseDataInEditMode();
                    // Code Added By Sam to Bind Warehouse in Edit Mode Section End

                    //FillGrid();
                    //.................Tax..............
                    Session["SPBTaxDetails"] = GetTaxDataWithGST(GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd")));
                    ...
                    {
                        Session["SPurchaseOrderFinalTaxRecord"] = quotetable;
                    }
                    //..........End Tax-----------
                    Session["SPurchaseInvoiceDetails"] = GetPurchaseInvoiceBataData().Tables[0];
                    ...
                    //PopulateBranchForTDS(Convert.ToString(ViewState["SEnteredBranchID"]));
                    ...
                    if (TDSdt.Rows.Count > 0)
                    {
                        ...
                        Session["SPBNonInvProChgforShow"] = TDSdt;
                    }
                    else
                    {
                        Session["SPBNonInvProChgforShow"] = NonInventoryProductChgDtl();
                    }
                    ...
                    {
                        lblHeading.Text = "View Self Purchase Invoice";
        ...
        public DataTable GetPurchaseChallanCalculater()
        {
            ...
            proc.AddIntegerPara("@InvoiceID", Convert.ToInt32(Session["SPurchaseInvoice_Id"]));
            dt = proc.GetTable();
            return dt;
        }
        public IEnumerable GetPurchaseInvoice(DataTable PurchaseInvoicedt)
        {
            ...
            // Session["SPurchaseInvoiceDetails"] = PurchaseInvoiceList;
        ...
        //    proc.AddVarcharPara("@PurchaseOrder_Id", 500, Convert.ToString(Session["SPurchaseInvoice_Id"]));
        ...
        public bool CheckPartyNo(string vendorid, string partyno)
        {
            ...
            if (vendorid != "" && Convert.ToString(partyno).Trim() != "")
            {
                ...
                {
                    pbid = Convert.ToString(Session["SPurchaseInvoice_Id"]);
                }
        ...
        public static string ValidQuantity(string srlno, string previousqty)
        {
            ...
            string status = "1";
            if (HttpContext.Current.Session["SPurchaseInvoiceDetails"] != null)
            {
                DataTable dt = (DataTable)HttpContext.Current.Session["SPurchaseInvoiceDetails"];
                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow dr in dt.Rows)
                    {
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (IsDeleteFrom == "D" || IsCompFrom == "C")
                {
                    ...
                    DataTable POdt = (DataTable)Session["SPurchaseInvoiceDetails"];
            ...
            {
                if (Session["SPurchaseInvoiceDetails"] != null)
                {
                    DataTable PurchaseInvoicedt = (DataTable)Session["SPurchaseInvoiceDetails"];
                    ...
                    Session["SPurchaseInvoiceDetails"] = PurchaseInvoicedt;
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            {
                DataTable dt = new DataTable();
                dt = (DataTable)Session["SPurchaseInvoiceDetails"];
            ...
            if (IsDeleteFrom != "D" && IsCompFrom != "C")
            {
                ...
                string MainPurchaseInvoiceID = Convert.ToString(Session["SPurchaseInvoice_Id"]);
                ...
                if (ViewState["SEnteredBranchID"] == null)
                {
                    ...
                    if (branchdtl.Length > 1)
                    {
                        ...
                        ViewState["SEnteredBranchID"] = strenteredBranchId;
                        Session["SEnteredBranchID"] = strenteredBranchId;
                    }
                }
                else
                {
                    strenteredBranchId = Convert.ToString(ViewState["SEnteredBranchID"]);
                }
                //string[] branchdtl = new string[] { };
                //string branchidsplit=Convert.ToString(ddl_numberingScheme.SelectedValue);
                ...
                if (Session["SPurchaseOrderFinalTaxRecord"] != null)
                {
                    TaxDetailTable = (DataTable)Session["SPurchaseOrderFinalTaxRecord"];
                }
                ...
                if (Session["SPBTaxDetails"] != null)
                {
                    POTaxDetailsdt = (DataTable)Session["SPBTaxDetails"];
                }
                else
                {
               ...
               // BusinessLogicLayer.DBEngine objEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                ...
                if (Session["SPBNonInvProChgforShow"] != null)
                {
                    productcharges = (DataTable)Session["SPBNonInvProChgforShow"];
                ...
                else
                {
                    ...
                    if (ModifyQuatation(MainPurchaseInvoiceID, strSchemeType, UniquePurchaseInvoice, strQuoteDate, IndentRequisitionDate,
                        ...
                        inventorytype, productcharges, partyInvNo, partyInvDate, ReverseTaxtable, strenteredBranchId, entrydate, ProjId) == true)
                    {
                        ...
                        Session.Remove("ShowCustomerInSPB");
                        Session.Remove("SPBNonInvProChgforShow");
                        Session.Remove("SPurchaseInvoice_Id");
                        Session.Remove("SPurchaseOrderFinalTaxRecord");
                        Session.Remove("SPOCWarehouseData");
                        ...
                        if (ActionType == "Add") // session has been removed from quotation list page working good
                        {
                            ...
                            Session["schemavalueSPB"] = schemavalue;        // session has been removed from quotation list page working good
                            ...
                            if (schematype == "Auto")
                            {
                                Session["SaveModeSPB"] = "A";
                            }
                            else
                            {
                                Session["SaveModeSPB"] = "M";
                            }
                        }
                    ...
                    if (udfTable != null)
                        Session["UdfDataOnAdd"] = reCat.insertRemarksCategoryAddMode("SPB", "PurchaseInvoice" + Convert.ToString(strInvoiceID), udfTable, Convert.ToString(Session["userid"]));
                    //if (Session["SPurchaseInvoiceDetails"] != null)
                    //{
                    //    Session["SPurchaseInvoiceDetails"] = null;
        ...
        public bool ModifyQuatation(string PurchaseInvoiceID, string strSchemeType, string strQuoteNo, string strQuoteDate, string strQuoteExpiry, string strCustomer, string strContactName,
            ...
            string partyInvNo, string partyInvDate, DataTable ReverseTaxtable, string strenteredBranchId, string entrydate, Int64 ProjId)
        {
            try
            {
                ...
                {
                    PurchaseInvoicedt.Columns.Remove("Remarks");
                    PurchaseInvoicedt.AcceptChanges();
                }
              ...
              //SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                ...
                SqlCommand cmd = new SqlCommand("prc_SelfPurchaseInvoice", con);
                ...
                //if (Session["SPBwarehousedetailstempNew"] == null)


                //{
                if (Session["SPBwarehousedetailstemp"] != null)
                {
                    DataTable temtable = new DataTable();
                    DataTable Warehousedtssss = (DataTable)Session["SPBwarehousedetailstemp"];
                ...
                //}
                else if (Session["SPBwarehousedetailstempNew"] != null)
                {
                    DataTable temtable = new DataTable();
                    DataTable Warehousedtssss = (DataTable)Session["SPBwarehousedetailstempNew"];
                ...
                cmd.Parameters.AddWithValue("@InvoiceFor", "SDV");
                cmd.Parameters.AddWithValue("@account_code", hdnLedgerId.Value);
                ...
                string ledgerposting = "";
                if(Convert.ToString(ddl_ledgerposting.Value)!="")
                {
                    ledgerposting = Convert.ToString(ddl_ledgerposting.Value);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Notify", "jAlert('You must select Ledger Posting as Yes/No, to proceed');", true);
                    return false;
                }
                //if (chk_LedgerPosting.Checked)
                //{
                //    ledgerposting = "1";
                //}
                cmd.Parameters.AddWithValue("@ledgerposting", ledgerposting); 
        ...
        protected void GrdWarehousePC_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                else if (isserialunique == false)
                {
                    ...
                    if (Session["SPOCWarehouseData"] != null)
                    {
                        Warehousedt = (DataTable)Session["SPOCWarehouseData"];
                    }
                    else
                    {
                    ...
                    if (Session["SPOCWarehouseData"] != null)
                    {
                        DataTable Warehousedts = (DataTable)Session["SPOCWarehouseData"];
                    ...
                    if (inputqnty <= totalopeining || isedited == "true")
                    {
                        ...
                        Session["SPOCWarehouseData"] = Warehousedt;
            ...
            if (strSplitCommand == "Saveall")
            {
                ...
                if (Session["SPOCWarehouseData"] == null && hdnisolddeleted.Value == "false")
                {
                ...
                else if (Session["SPOCWarehouseData"] == null && openingstock != "0.0")
                {
                ...
                else
                {
                    ...
                    if (newrowcount != 0 || updaterows != 0 || Session["SPOWarehouseDataDelete"] != null)
                    {
                        decimal inputqnty = 0;
                        decimal totalopeining = Convert.ToDecimal(hdfopeningstockPC.Value);
                        decimal oldtotalopeining = Convert.ToDecimal(oldopeningqntity.Value);
            ...
            if (strSplitCommand == "checkdataexist")
            {
                ...
                Session["SWarehouseUpdatedData"] = null;
                Session["SPOWarehouseDataDelete"] = null;
            ...
            //        GrdWarehousePC.DataSource = Session["SPOCWarehouseData"];
            //        GrdWarehousePC.DataBind();
            //    }
            //}
            #endregion
            ...
            if (strSplitCommand == "Updatedata")
            {
                ...
                if (Session["SPOCWarehouseData"] != null && isserialunique == false)
                {
                    Warehousedt = (DataTable)Session["SPOCWarehouseData"];
                    ...
                    Session["SWarehouseUpdatedData"] = Warehousedt;
            ...
            if (strSplitCommand == "Delete")
            {
                ...
                if (Session["SPOCWarehouseData"] != null)
                {
                    ...
                    if (drs.Count() != 0)
                    {
                        if (Session["SPOWarehouseDataDelete"] != null)
                        {
                            setdeletedate = drs.CopyToDataTable();
                            DataTable dtmp = (DataTable)Session["SPOWarehouseDataDelete"];
                            dtmp.Merge(setdeletedate);
                            Session["SPOWarehouseDataDelete"] = dtmp;
                        }
                        else
                        {
                            setdeletedate = drs.CopyToDataTable();
                            Session["SPOWarehouseDataDelete"] = setdeletedate;
                        }
        ...
        public bool CheckUniqueSerial(string serial, string slno)
        {
            ...
            if (Session["SPOCWarehouseData"] != null && hdnisserial.Value == "true")
            {
                DataTable Warehousedts = (DataTable)Session["SPOCWarehouseData"];
                //
        ...
        private int Insertupdatedata(string ProductID, string stockid, string branchid)
        {
            ...
            if (Session["SPOCWarehouseData"] != null)
            {
                DataTable Warehousedt = (DataTable)Session["SPOCWarehouseData"];
                ...
                if (Session["SPBwarehousedetailstemp"] != null)
                {
                    temtable23 = (DataTable)Session["SPBwarehousedetailstemp"];
                    DataRow[] rows;
                    ...
                    Session["SPBwarehousedetailstemp"] = temtable23;
                    //Session["SPBwarehousedetailstempNew"] = temtable23;   // To only check if stock has been modified in edit mode or not
                }
                else
                {
                    Session["SPBwarehousedetailstemp"] = temtable;
                    //Session["SPBwarehousedetailstempNew"] = temtable23;   // To only check if stock has been modified in edit mode or not
                }
            ...
            {
                DataTable dt = new DataTable();
                DataTable Warehousedtups = (DataTable)Session["SPOCWarehouseData"];
                DataRow[] dr = Warehousedtups.Select("isnew = 'Updated'");
                if (dr.Count() != 0)
                {
                    dt = dr.CopyToDataTable();
                    if (Session["SPBwarehousedetailstempUpdate"] != null)
                    {
                        temtable23 = (DataTable)Session["SPBwarehousedetailstempUpdate"];
                        DataRow[] rows;
                        rows = temtable23.Select("pcslno = '" + hdnpcslno.Value + "'");  //'UserName' is ColumnName
                        foreach (DataRow row in rows)
                            temtable23.Rows.Remove(row);
                        ...
                        temtable23.Merge(dt);
                        Session["SPBwarehousedetailstempUpdate"] = temtable23;
                    }
                    else
                    {
                        Session["SPBwarehousedetailstempUpdate"] = dt;
                    }
            ...
            {
                DataTable dt = new DataTable();
                DataTable Warehousedtups = (DataTable)Session["SPOWarehouseDataDelete"];
                ...
                {
                    dt = dr.CopyToDataTable();
                    if (Session["SPBwarehousedetailstempDelete"] != null)
                    {
                        temtable23 = (DataTable)Session["SPBwarehousedetailstempDelete"];
                        DataRow[] rows;
                        rows = temtable23.Select("pcslno = '" + hdnpcslno.Value + "'");  //'UserName' is ColumnName
                        foreach (DataRow row in rows)
                            temtable23.Rows.Remove(row);
                        ...
                        temtable23.Merge(dt);
                        Session["SPBwarehousedetailstempDelete"] = temtable23;
                    }
                    else
                    {
                        Session["SPBwarehousedetailstempDelete"] = dt;
                    }
        ...
        public void deleteALL()
        {
            ...
            if (Session["SPBwarehousedetailstempDelete"] != null)
            {
                ...
                DataTable Warehousedtups = (DataTable)Session["SPBwarehousedetailstempDelete"];
        ...
        private int Insertwaredataalldata(string ProductID, string stockid, string branchid)
        {
            ...
            if (Session["SPOWarehouseDataDelete"] != null)
            {
                DataTable Warehousedts = (DataTable)Session["SPOWarehouseDataDelete"];
        ...
        private int updatewarehouse()
        {
            ...
            {
                DataTable dt = new DataTable();
                DataTable Warehousedtups = (DataTable)Session["SPBwarehousedetailstempUpdate"];
                DataRow[] dr = Warehousedtups.Select("isnew = 'Updated'");
                if (dr.Count() != 0)
                {
                    dt = dr.CopyToDataTable();
        ...
        protected DataTable GetTaxDataWithGST(DataTable existing)
        {
            ...
            proc.AddIntegerPara("@PurchaseInvoiceId", Convert.ToInt32(Session["SPurchaseInvoice_Id"]));
            dt = proc.GetTable();
            if (dt.Rows.Count > 0)
            {
        ...
        protected void taxUpdatePanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                DataTable MainTaxDataTable = (DataTable)Session["SPurchaseOrderFinalTaxRecord"];
                ...
                Session["SPurchaseOrderFinalTaxRecord"] = MainTaxDataTable;
                GetStock(Convert.ToString(performpara.Split('~')[2]));
                // DeleteWarehouse(Convert.ToString(performpara.Split('~')[1]));
                DataTable taxDetails = (DataTable)Session["SPBTaxDetails"];
                if (taxDetails != null)
                {
                    ...
                    Session["SPBTaxDetails"] = taxDetails;
                }
            }
        ...
        public void DeleteWarehouse(string SrlNo)
        {
            ...
            if (Session["SPBwarehousedetailstemp"] != null)
            {
                Warehousedt = (DataTable)Session["SPBwarehousedetailstemp"];
                ...
                Session["SPBwarehousedetailstemp"] = Warehousedt;
            }
        }
        ...
        public void CreateDataTaxTable()
        {
            ...
            Session["SPurchaseOrderFinalTaxRecord"] = TaxRecord;
        }
        ...
        public DataSet GetQuotationTaxData()
        {
            ...
            proc.AddVarcharPara("@QuotationID", 500, Convert.ToString(Session["SPBQuotationID"]));
            ds = proc.GetDataSet();
            return ds;
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable TaxRecord = (DataTable)Session["SPurchaseOrderFinalTaxRecord"];
                ...
                else
                {
                    ...
                    foreach (DataRow dr in taxDetail.Rows)
                    {
                        ...
                        else
                        {
                            ...
                            //DataRow[] filtr = databaseReturnTable.Select("ProductTax_ProductId ='" + keyValue + "' and ProductTax_QuoteId=" +Convert.ToString( Session["SPBQuotationID"] )+ " and ProductTax_TaxTypeId=" + obj.Taxes_ID);
                            //if (filtr.Length > 0)
                            //{
                        ...
                        //      DataRow[] filtrIndex = databaseReturnTable.Select("ProductTax_ProductId ='" + keyValue + "' and ProductTax_QuoteId=" + Session["SPBQuotationID"] + " and ProductTax_TaxTypeId=0");
        ...
        protected void cmbGstCstVat_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            CreateDataTaxTable();
            //DataTable taxTableItemLvl = (DataTable)Session["SPurchaseOrderFinalTaxRecord"];
            //foreach (DataRow dr in taxTableItemLvl.Rows)
            //    dr.Delete();
            //taxTableItemLvl.AcceptChanges();
            //Session["SPurchaseOrderFinalTaxRecord"] = taxTableItemLvl;
        }
        ...
        public void DeleteTaxDetails(string SrlNo)
        {
            ...
            if (Session["SPurchaseOrderFinalTaxRecord"] != null)
            {
                ...
                TaxDetailTable.AcceptChanges();
                #endregion Code Added by Sam on 09062017  To arrange Warehouse Data according to serial no Start
                Session["SPurchaseOrderFinalTaxRecord"] = TaxDetailTable;
            }
        }
        ...
        public DataTable GetTaxData(string quoteDate)
        {
            ...
            if (ViewState["SEnteredBranchID"] != null)
            {
                strbranch = Convert.ToString(ViewState["SEnteredBranchID"]);
            }
        ...
        protected void gridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["SPBTaxDetails"] == null)
                {
                    Session["SPBTaxDetails"] = GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd"));
                }

                if (Session["SPBTaxDetails"] != null)
                {
                    TaxDetailsdt = (DataTable)Session["SPBTaxDetails"];
            ...
            else if (strSplitCommand == "SaveGst")
            {
                ...
                else
                {
                    ...
                    Session["SPBTaxDetails"] = TaxDetailsdt;
                }
            }
        }
        ...
        protected void gridTax_DataBinding(object sender, EventArgs e)
        {
            if (Session["SPBTaxDetails"] != null)
            {
                DataTable TaxDetailsdt = (DataTable)Session["SPBTaxDetails"];
        ...
        {
            //if (Session["SPB_ComponentData"] != null)
            //{
            //    lookup_quotation.DataSource = (DataTable)Session["SPB_ComponentData"];
            //}
            //else
            //{
        ...
        public void SetPBDetails() // To Get Main Header Section Detail in Edit Mode
        {
            ...
            if (PBEditdt != null && PBEditdt.Rows.Count > 0)
            {
                ...
                Session["SWbranchInEdit"] = Branch_Id;
                ...
                ViewState["SEnteredBranchID"] = EnteredBranchID;
                Session["SEnteredBranchID"] = EnteredBranchID;
                ...
                string AccountName = Convert.ToString(PBEditdt.Rows[0]["MainAccount_Name"]);
                string AccountCode = Convert.ToString(PBEditdt.Rows[0]["MainAccount_AccountCode"]);
                string isLedgerPosting = Convert.ToString(PBEditdt.Rows[0]["Is_LedgerPostingForSDV"]);

                DataTable dtt = GetProjectEditData(Convert.ToString(Session["SPurchaseInvoice_Id"]));
                ...
                if (invtype == "N")
                {
                    DataTable tdsdt = objPurchaseInvoice.GetTdsMainIdByInvoiceID(Convert.ToString(Session["SPurchaseInvoice_Id"]));
                    if (tdsdt.Rows.Count > 0)
                    {
                ...
                txtLedgerName.Value = AccountName;

                hdnLedgerId.Value = AccountCode;
                if (isLedgerPosting.ToUpper().Trim()=="TRUE" )
                {
                    ddl_ledgerposting.Value = "1";
                }
                else if (isLedgerPosting.ToUpper().Trim() == "FALSE")
                {
                    ddl_ledgerposting.Value = "0";
                }
                else
                {
                    ddl_ledgerposting.Value = "";
                }
        ...
        public DataTable GetPurchaseInvoiceEditData()  // To Get Main Header Section Detail in Edit Mode
        {
            ...
            proc.AddVarcharPara("@PurchaseInvoiceId", 500, Convert.ToString(Session["SPurchaseInvoice_Id"]));
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
        ...
        public DataSet GetPurchaseInvoiceBataData()  // To store Value in    Session["SPurchaseInvoiceDetails"] in Edit Mode product Batch Grid
        {
            DataSet ds = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("prc_PurchaseInvoiceDetail");
        ...
        public DataTable GetStockWarehouseData(string stockid)
        {
            ...
            {
                DataSet dsInst = new DataSet();
                DataTable dtwarehouse = objPurchaseInvoice.PopulateProductWiseWarehouseDetail(Convert.ToInt32(hdfProductIDPC.Value), Convert.ToString(Session["SPurchaseInvoice_Id"]), Convert.ToString(Session["LastCompany"]), Convert.ToInt32(hdbranchIDPC.Value));
                ...
                //cmd.Parameters.AddWithValue("@Finyear", Convert.ToString(Session["LastFinYear"]));
                //cmd.Parameters.AddWithValue("@PONumber", Convert.ToString(Session["SPurchaseInvoice_Id"]));
                //cmd.CommandTimeout = 0;
                ...
                if (dtwarehouse != null)
                {
                    ...
                    if (Session["SPBwarehousedetailstemp"] != null)
                    {
                        DataTable Warehousedtss = (DataTable)Session["SPBwarehousedetailstemp"];
                        ...
                        if (dr.Count() > 0)
                        {
                            ...
                            Session["SPCWarehouseDatabyslno"] = Warehousedtss;

                            dt2 = (DataTable)Session["SPCWarehouseDatabyslno"];
            ...
            else if (Session["SPBwarehousedetailstemp"] != null)  // to filter warehouse data 
            {
                DataTable Warehousedtss = (DataTable)Session["SPBwarehousedetailstemp"];
                ...
                if (dr.Count() > 0)
                {
                    ...
                    dt = (DataTable)Session["SPCWarehouseDatabyslno"];
        ...
        protected void ComponentQuotation_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            else if (e.Parameter.Split('~')[0] == "BindComponentGrid")
            {
                ...
                string strInvoiceID = Convert.ToString(Session["SPurchaseInvoice_Id"]);
                ...
                {
                    Session["SPB_ComponentData"] = ComponentTable;
                    //lookup_quotation.DataSource = ComponentTable;
                    //lookup_quotation.DataBind(); 
                }
                else
                {
                    Session["SPB_ComponentData"] = null;
                    //lookup_quotation.DataSource = ComponentTable;
                    //lookup_quotation.DataBind();
                }
            }
        ...
        //    proc.AddIntegerPara("@PurchaseOrder_Id", Convert.ToInt32(Session["SPurchaseInvoice_Id"]));
        //    //proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
        //    //proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
        //    //proc.AddVarcharPara("@companyId", 500, Convert.ToString(Session["LastCompany"]));
        //    dt = proc.GetTable();
        ...
        public bool BindSessionByDatatable(DataTable dt)
        {
            ...
            Session["SPurchaseInvoiceDetails"] = purChaseDT;
        ...
        public DataTable NonInventoryProductChgDtl()
        {
            if (Session["SPBNonInvProChgforShow"] == null)
            {
                ...
                Session["SPBNonInvProChgforShow"] = NonInventoryProductChgdt;
                return NonInventoryProductChgdt;
            }
            else
            {
                DataTable dt = new DataTable();
                dt = (DataTable)Session["SPBNonInvProChgforShow"];
                return dt;
            }
        ...
        protected void gridinventory_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (Convert.ToString(e.Parameters.Split('~')[2]) == "ShowBindGrid")
            {
                ...
                if (Session["SPBNonInvProChgforShow"] != null)
                {
                    tempTDSdt = (DataTable)Session["SPBNonInvProChgforShow"];
                ...
                Session["SPBNonInvProChg"] = inventorychgdt;
            ...
            else if (e.Parameters.Split('~')[2] == "SaveNonInventoryProductChg")
            {
                ...
                DataTable PBNonInvPro = (DataTable)Session["SPBNonInvProChg"];
                if (Session["SPBNonInvProChgforShow"] != null)
                {
                    storePBNonInvProDt = (DataTable)Session["SPBNonInvProChgforShow"];
                ...
                Session["SPBNonInvProChgforShow"] = storePBNonInvProDt;
                //hdntdschecking.Value = "0";
                //End Here
            ...
            else if (e.Parameters.Split('~')[0] == "ApplicableAmtChecking")
            {
                ...
                //if (hdnADDEditMode.Value != "ADD")
                //{
                //    if (Session["SEnteredBranchID"] != null)
                //    {
                //        PopulateBranchForTDS(Convert.ToString(Session["SEnteredBranchID"]));
                //    }
                //}
                DataTable tempTDSdt = new DataTable();
                int slNo = 0;
        ...
        protected void DeleteNonInventoryDetail(string strDeleteSrlNo)
        {
            ...
            if (Session["SPBNonInvProChgforShow"] != null)
            {
                noninventorydt = (DataTable)Session["SPBNonInvProChgforShow"];
                ...
                Session["SPBNonInvProChgforShow"] = noninventorydt;
        ...
        //    {
        //        DataTable TaxRecord = (DataTable)Session["SPBNonInvProChg"];
        //        int slNo = Convert.ToInt32(HdSerialNo.Value);
        //        //For GST/CST/VAT
        //        if (cmbGstCstVat.Value != null)
        //        {
        ...
        public void SetWareHouseDataInEditMode()
        {
            ...
            if (Session["SPBwarehousedetailstempNew"] != null)
            {
                ...
                //DataTable Warehousedt = new DataTable();
                DataTable Warehousedtnew = new DataTable();
                DataTable whdt = (DataTable)Session["SPBwarehousedetailstempNew"];
                ...
                //string branchid = Convert.ToString(Session["SWbranchInEdit"]);
                ...
                //Session["SPOCWarehouseData"] = Warehousedt;
                //Session["SPBwarehousedetailstemp"] = Warehousedt;
                Session["SPBwarehousedetailstempNew"] = Warehousedt;
