...
{
    public partial class ProjectPReturn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // Rev 1.0
            DataTable dtposTime = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(50),Lock_Fromdate,110) LockCon_Fromdate,convert(varchar(50),Lock_Todate,110) LockCon_Todate,convert(varchar(10),Lock_Fromdate,105) DataFreeze_Fromdate,convert(varchar(10),Lock_Todate,105) DataFreeze_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Add' and Module_Id=66");
            ...
            DataTable dtposTimeEdit = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(10),Lock_Fromdate,105) LockCon_Fromdate,convert(varchar(10),Lock_Todate,105) LockCon_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Edit' and Module_Id=66");
            DataTable dtposTimeDelete = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(10),Lock_Fromdate,105) LockCon_Fromdate,convert(varchar(10),Lock_Todate,105) LockCon_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Delete' and Module_Id=66");
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        lblHeadTitle.Text = "Modify Project Purchase Return";
                        ...
                        {
                            lblHeadTitle.Text = "View Project Purchase Return";
                    ...
                    else
                    {
                        ...
                        Session["PRWS_TaxDetails"] = null;
                        CreateDataTaxTable();
                        lblHeadTitle.Text = "Add Project Purchase Return";
        ...
        protected void EntityServerModeDataProjectPurchaseReturn_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                foreach (DataRow dr in tempQuotation.Rows)
                {
                    ...
                    if (dt != null && dt.Rows.Count > 0 && Convert.ToString(dt.Rows[0]["RV"]) == "1" && IsInventory.ToUpper() !="N")
                    {
               ...
               .Select(g => g.Key);
                ...
                if (validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "duplicateProduct" || validate == "nullAmount" || validate == "nullQuantity" || validate == "transporteMandatory" || validate == "checkAddress")
                {
                ...
                else
                {
                    ...
                    if (lookup_Project.Text != "")
                    {
                        ...
                        DataTable dtSlOrd = objPurchaseReturnBL.GetProjectCode(projectCode);
                    ...
                    ModifyPurchaseReturn(MainInvoiceID, strSchemeType, UniqueQuotation, strInvoiceDate, strCustomer, strContactName,ProjId,
                                   ...
                                   approveStatus, ActionType, strBr, ref strIsComplete, ref strQuoteID, ReasonforReturn, refCreditNoteNo, refCreditNoteNoDate, duplicatedt2);
        ...
        public string GetExistencePCInPurchaseInvoice(string id)
        {
            ...
            SqlCommand cmd = new SqlCommand("prc_ProjectPurchaseReturn_Details", con);
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    else
                    {
                        ...
                        if (!string.IsNullOrEmpty(IdKey))
                        {
                            if (IdKey != "ADD")
                            {
                                dt_QuotationDetails = objPurchaseReturnBL.GetIndentDetailsForPOGridBind(QuoComponent1, IdKey, InvoiceDetails_Id, companyId, fin_year).Tables[0];
                            }
                            else
                            {
                                dt_QuotationDetails = objPurchaseReturnBL.GetIndentDetailsForPOGridBind(QuoComponent1, IdKey, InvoiceDetails_Id, companyId, fin_year).Tables[0];
                                additionaldesc = objPurchaseReturnBL.GetIndentDetailsForPOGridBind(QuoComponent1, IdKey, InvoiceDetails_Id, companyId, fin_year).Tables[2];
                            }
        ...
        public void ModifyPurchaseReturn(string QuotationID, string strSchemeType, string strQuoteNo, string strQuoteDate, string strCustomer, string strContactName,Int64 ProjId,
                                  ...
                                  ref int strIsComplete, ref int strInvoiceID, string ReasonforReturn, string refCreditNoteNo, string refCreditNoteDate, DataTable PurchaseReturnPackingDetailsdt)
        {
            try
            {
                DataSet dsInst = new DataSet();
                ...
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("Prc_Project_PurchaseReturn", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetProjectEditData()
        {
            ...
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["PRWS_key_QutId"]));
            dt = proc.GetTable();
            return dt;
        }
        ...
        public void GetAllDropDownDetailForSalesQuotation(string userbranch)
        {
            ...
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            DataTable Schemadt = objSlaesActivitiesBL.GetNumberingSchema(strCompanyID, userbranchHierarchy, strYear, "121", "Y");
            if (Schemadt != null && Schemadt.Rows.Count > 0)
            {
                ddl_numberingScheme.DataTextField = "SchemaName";
                ddl_numberingScheme.DataValueField = "Id";
        ...
        public static string GetAddLock(DateTime LockDate)
        {
            string rtrnvalue = "0";
            ProcedureExecute proc = new ProcedureExecute("prc_ProjectPurchaseReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetAddLockForPurchaseReturnStatus");
        ...
        public static bool CheckUniqueRefCreditNoteNo(string vendorid, string creditNoteno, string mode, string pID)
        {
            ...
            ProjectPurchaseReturnBL obj = new ProjectPurchaseReturnBL();
