...
namespace ERP.OMS.Management.Activities
{
    public partial class BranchTransferIn : ERP.OMS.ViewState_class.VSPage //System.Web.UI.Page
    {
       ...
       // BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["key"] != null)
                {
                    ...
                    else
                    {
                        ...
                        DataTable dtposTime = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(50),Lock_Fromdate,110) LockCon_Fromdate,convert(varchar(50),Lock_Todate,110) LockCon_Todate,convert(varchar(10),Lock_Fromdate,105) DataFreeze_Fromdate,convert(varchar(10),Lock_Todate,105) DataFreeze_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Add' and Module_Id=51");
        ...
        public class MultiUOMSBTIConversionPacking
        {
        ...
        public DataTable GetAddLockStatus()
        {
            ...
            proc.AddVarcharPara("@Action", 500, "GetAddLockForBTI");
        ...
        public int ModifySalesChallan(string BTInID, string strSchemeType,string SchemeId ,string strOrderNo, string strOrderDate, string strOrderExpiry, string strCustomer, string strContactName,
        ...
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_CRMBranchStockIn");
            ...
            if (Convert.ToString(Request.QueryString["key"]) != "ADD")
            {
                proc.AddVarcharPara("@branchIds", 500, Convert.ToString(ddl_transferTo_Branch.SelectedValue));
            }
            else
            {
                proc.AddVarcharPara("@branchIds", 500, Convert.ToString(hddnBranchNumberingSchemeWise.Value));
            }
            //proc.AddVarcharPara("@companyId", 500, Convert.ToString(Session["LastCompany"]));
            dt = proc.GetTable();
            return dt;
        ...
        public DataTable GetProjectEditData()
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_GetChallanInvoiceDetails");
            proc.AddVarcharPara("@Action", 500, "BRInProjectEditdata");
            proc.AddVarcharPara("@DocId", 500, Convert.ToString(Session["BTInID"]));
            dt = proc.GetTable();
            return dt;
        }
        ...
        {
            List<MultiUOMSBTIConversionPacking> RateLists = new List<MultiUOMSBTIConversionPacking>();
            ...
            DataTable dt = proc.GetTable();
            RateLists = DbHelpers.ToModelList<MultiUOMSBTIConversionPacking>(dt);
            if (dt != null && dt.Rows.Count > 0)
            {
        ...
        public static object SetProjectCode(string OrderId)
        {
            ...
            {
                ProcedureExecute proc = new ProcedureExecute("prc_GetChallanInvoiceDetails");
                proc.AddVarcharPara("@Action", 500, "BrStockOuttaggingProjectdata");
