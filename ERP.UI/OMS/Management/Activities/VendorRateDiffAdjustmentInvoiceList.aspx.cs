//*************************************************************************************************************
// 1.0   Sanchita  V2.0.43      19-02-2024    27264: Views to be converted to Procedures in the Listing Page - Rate difference with Purchase Invoice 
// **************************************************************************************************************
...
{
    public partial class VendorRateDiffAdjustmentInvoiceList : System.Web.UI.Page
    {
        ...
        protected void CallbackPanel_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetVendorRateDiffAdjustmentInvoicedata(FROMDATE, TODATE, strBranchID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetVendorRateDiffAdjustmentInvoicedata(string FROMDATE, string TODATE, string BRANCH_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("prc_VendorRateDiffAdjustmentInvoice_List", con);
        ...
        {
            e.KeyExpression = "AdjRateDiffer_id";
            ...
            if (IsFilter == "Y")
            {
                ...
                //    var q = from d in dc.v_VendorRateDiffAdjustInvoiceLists
                ...
                var q = from d in dc.VendorRateDiffAdjustmentInvoiceLists
        ...
        protected void gridAdvanceAdj_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int rowsNo = VendorPaymentAdjustment.DeleteRateDifferAdj(param.Split('~')[1]);
                if (rowsNo > 0)
                {
        ...
        private void bindexport(int Filter)
        {
            ...
            string filename = "Adjustment of Document- Rate difference With Invoice";
            exporter.FileName = filename;
            exporter.FileName = "Adjustment of Document- Rate difference With Invoice";

            exporter.PageHeader.Left = "Adjustment of Document- Rate difference With Invoice";
