...
{
    public partial class DebitNoteAdjustPInvoiceList : System.Web.UI.Page
    {
        public EntityLayer.CommonELS.UserRightsForPage rights = new UserRightsForPage();
        VendorPaymentAdjustmentBL customerReceiptAdjustment = new VendorPaymentAdjustmentBL();
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                if (strBranchID == "0")
                {
                    ...
                    var q = from d in dc.v_DebitNoteAdjustmentPurchaseInvoiceLists
        ...
        protected void gridAdvanceAdj_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int rowsNo = customerReceiptAdjustment.DeleteDebitNotePurchaseInvoiceAdj(param.Split('~')[1]);
             if (rowsNo > 0)
             {
        ...
        private void bindexport(int Filter)
        {
            ...
            string filename = "Adjustment of Document- Debit Note with Purchase Invoice";
            exporter.FileName = filename;
            exporter.FileName = "Adjustment of Document- Debit Note with Purchase Invoice";

            exporter.PageHeader.Left = "Adjustment of Document- Debit Note with Purchase Invoice";
