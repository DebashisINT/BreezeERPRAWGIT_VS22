/**************************************************************************************************************************************
 * 1.0   Sanchita  V2.0.43      20-02-2024          0027262: Views to be converted to Procedures in the Listing Page - Journal With Vendor Payment    
 * **************************************************************************************************************************************/
...
{
    public partial class JournalDetorsAdjustVenRecList : System.Web.UI.Page
    {
        ...
        protected void CallbackPanel_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetJournalDetorsAdjustVenRecdata(FROMDATE, TODATE, strBranchID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetJournalDetorsAdjustVenRecdata(string FROMDATE, string TODATE, string BRANCH_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("prc_JournalDetorsAdjustVenRec_List", con);
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                ...
                //    var q = from d in dc.v_JournalAdjustmentVendorONAccountLists
                ...
                var q = from d in dc.JournalDetorsAdjustVenRecLists
        ...
        protected void gridAdvanceAdj_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (param.Split('~')[0] == "Del")
            {
                ...
                int rowsNo = customerReceiptAdjustment.DeleteJournalVendorRecAdj(param.Split('~')[1]);
        ...
        private void bindexport(int Filter)
        {
            ...
            string filename = "Adjustment of Document- Journal with Vendor Receipt(On Account)";
            exporter.FileName = filename;
            exporter.FileName = "Adjustment of Document- Journal with Vendor Receipt(On Account)";

            exporter.PageHeader.Left = "Adjustment of Document- Journal with Vendor Receipt(On Account)";
