...
{
    public partial class DebitNoteAdjustReceiptList : System.Web.UI.Page
    {
        public EntityLayer.CommonELS.UserRightsForPage rights = new UserRightsForPage();
        VendorPaymentAdjustmentBL customerReceiptAdjustment = new VendorPaymentAdjustmentBL();
        protected void Page_Load(object sender, EventArgs e)
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Management/Activities/DebitNoteAdjustReceiptList.aspx");
