...
{
    public partial class WarehousewiseStockJournalListIN : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dtposTimeEdit = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(10),Lock_Fromdate,105) LockCon_Fromdate,convert(varchar(10),Lock_Todate,105) LockCon_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Edit' and Module_Id=48");
            DataTable dtposTimeDelete = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(10),Lock_Fromdate,105) LockCon_Fromdate,convert(varchar(10),Lock_Todate,105) LockCon_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Delete' and Module_Id=48");
        ...
        private void bindexport(int Filter)
        {
            ...
            string filename = "Warehouse Wise Stock - IN";
            exporter.FileName = filename;
            exporter.FileName = "Warehouse Wise Stock - IN";

            exporter.PageHeader.Left = "Warehouse Wise Stock - IN";
        ...
        protected void SelectPanel_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (strSplitCommand == "Bindalldesignes")
            {
                ...
                if (ConfigurationManager.AppSettings["IsDevelopedZone"] != null)
                {
                    ...
                    //DesignPath = @"Reports\Reports\RepxReportDesign\WarehoseStockJournal\";
                }
                else
                {
                    DesignPath = @"Reports\RepxReportDesign\WarehouseStockIN\DocDesign\";
                    //DesignPath = @"Reports\RepxReportDesign\WarehoseStockJournal\";
                }
