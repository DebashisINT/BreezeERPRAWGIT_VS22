<%--================================================== Revision History =============================================
1.0   Pallab    V2.0.38      22-05-2023          0026194: Adjustment of Documents - Journal with Purchase Invoice module design modification & check in small device
====================================================== Revision History =============================================--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="JournalCreditorsAdjustPInvoiceList.aspx.cs" Inherits="ERP.OMS.Management.Activities.JournalCreditorsAdjustPInvoiceList" %>
    ...
    <script>
        ...
        function AllControlInitilize() {
            if (isFirstTime) {
                ...
                if (localStorage.getItem('JournalCreditorsAdjustListBranch')) {
                    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('JournalCreditorsAdjustListBranch'))) {
                        ccmbBranchfilter.SetValue(localStorage.getItem('JournalCreditorsAdjustListBranch'));
                    }
        ...
        function OnViewClick(keyValue) {
            var url = 'JournalCreditorsAdjustPInvoice.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }
        function onEditClick(id) {
            window.location.href = 'JournalCreditorsAdjustPInvoice.aspx?Key=' + id;
        }
        ...
        function updateGridByDate() {
            ...
            if (cFormDate.GetDate() == null) {
                ...
                localStorage.setItem("JournalCreditorsAdjustListBranch", ccmbBranchfilter.GetValue());
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <div class="panel-title clearfix">
            <h3 class="pull-left">Adjustment of Documents - Journal with Purchase Invoice</h3>
        </div>
    </div>
        <table class="padTab">
        <tr>
        ...
        <div class="GridViewArea relative">
            ...
            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                ContextTypeName="ERPDataClassesDataContext" TableName="v_JournalAdjustmentPurchaseInvoiceList" />
