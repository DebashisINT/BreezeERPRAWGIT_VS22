/**********************************************************************************************************************************
 1.0      17-07-2023        2.0.39        Sanchita      Listing Views - Invoice Cum GRN. refer: 26587
***********************************************************************************************************************************/
...
{
    public partial class PurchaseInvCumGRNList : System.Web.UI.Page
    {  // BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
        ...
        protected void GrdQuotation_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (WhichCall == "Delete")
            {
                ...
                deletecnt = objPurchaseInvoice.DeletePurchaseInvoiceInvoiceCumGRNDetails(WhichType, Convert.ToInt32(Session["userid"]));
                if (deletecnt == 1)
                {
        ...
        [WebMethod]
        public static string UpdateEWayBillInvCumChallan(string InvoiceID, string UpdateEWayBill, string EWayBillDate, string EWayBillValue, string TransporterGSTIN
                    ...
                    , string TransporterDocDate, string VehicleNo, string VehicleType)
        {
            ...
            int EWayBill = 0;
            EWayBill = objPurchaseInvoiceBL.UpdateEWayBillInvCumChallan(InvoiceID, UpdateEWayBill, EWayBillDate, EWayBillValue, TransporterGSTIN, TransporterName, TransportationMode, TransportationDistance,
        ...
        protected void CallbackPanel_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetPurchaseInvoiceCumGRNdata(FROMDATE, TODATE, strBranchID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetPurchaseInvoiceCumGRNdata(string FROMDATE, string TODATE, string BRANCH_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("prc_PurchaseInvoiceCumGRN_List", con);
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (i)
            {
                if (IsFilter == "Y")
                {
                    ...
                    //    var q = from d in dc.v_PBChallanLists
                    ...
                    ERPDataClassesDataContext dc = new ERPDataClassesDataContext(connectionString);
                    var q = from d in dc.PurchaseInvoiceCumGRNLists
        ...
        public static object EditEWayBill(string DocID)
        {
            ...
            dt = objSalesInvoiceBL.EditEWayBill(DocID, "PurchaseInvoiceCumGRN");
            if (dt != null && dt.Rows.Count > 0)
            {
