    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick() {
            ...
            if (startDate != null) {
                ...
                if (difference > 12) {
                    jAlert('End date cannot  12 month later than Start date', 'Clarification Required', function () {
                        return false;
        ...
        function acpCrossBtnEndCall() {
            ...
            if (cacpCrossBtn.cpSave == "1") {

                cacpCrossBtn.cpSave = null;
                window.close();
                window.parent.popupCbudget.Hide();
                grid.Refresh();
            }
            //  cacpCrossBtn.cpRemoveProductInvoice
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                       ...
                                                       <%--           <dxe:GridViewDataTextColumn FieldName="Address" Caption="Address" VisibleIndex="1" Width="18%">
                                                                ...
                                                                <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="6"  FieldName="Name"   Caption="Customer/Lead Name" Settings-AllowAutoFilterTextInputTimer="False">
                                                                     <DataItemTemplate>
                                                             ...
                                                             <%--   <dxe:GridViewDataTextColumn FieldName="Address" ReadOnly="True" VisibleIndex="7"
                                                                ...
                                                                <dxe:GridViewDataTextColumn FieldName="ProductName" VisibleIndex="12"  Caption="Product(s)" Settings-AllowAutoFilterTextInputTimer="False">
                                                                     <DataItemTemplate>
                                                                         <asp:LinkButton runat="server" ID="LinkButton1" OnClientClick='<%# string.Format("ZoomProduct(\"{0}\"); return false;", Eval("product_id").ToString().Trim()) %>'></asp:LinkButton>
                                                               ...
                                                               <dxe:GridViewDataTextColumn FieldName="ProductClasName" VisibleIndex="11" Caption="Product Class" Settings-AllowAutoFilterTextInputTimer="False">
                                                                ...
                                                                <dxe:GridViewDataTextColumn FieldName="budget" VisibleIndex="16" Caption="Product:Budget Rate/Month" Settings-AllowAutoFilterTextInputTimer="False">
                                                                    <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
                                                                </dxe:GridViewDataTextColumn> 
