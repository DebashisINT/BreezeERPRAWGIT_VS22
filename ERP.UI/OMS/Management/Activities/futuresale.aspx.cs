...
namespace ERP.OMS.Management.Activities
{
    public partial class management_Activities_futuresale : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        void BindGrid(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataTable dt = objAc.GetsalesActivity(cnt_internalId, "3", Convert.ToString(FromDate), Convert.ToString(ToDate));
        ...
        protected void SalesDetailsGrid_HtmlRowCreated(object sender, ASPxGridViewTableRowEventArgs e)
        {
            ...
            if (Session["export"] == null)
            {
                ...
                // Mantis Issue 24913
                string AssignedToName = Convert.ToString(e.GetValue("Assigned To"));
                // Mantis Issue 24913 - change reverted
                //string AssignedToId = Convert.ToString(e.GetValue("sls_assignedTo"));
                // End of Mantis Issue 24913 - change reverted
                ...
                if (containsPhone)
                {
                    ...
                    // Mantis Issue 24913 - change reverted
                    //hpnPh.NavigateUrl = "../CRMPhoneCallWithFrame.aspx?TransSale=" + salesid + "&Assigned=" + AssignedById + "&type=" + type + "&Cid=" + CusId + "&Pid=3" + "&AssignedToId=" + AssignedToId + "&AssignedToName=" + AssignedToName;
                    hpnPh.NavigateUrl = "../CRMPhoneCallWithFrame.aspx?TransSale=" + salesid + "&Assigned=" + AssignedById + "&type=" + type + "&Cid=" + CusId + "&Pid=3" + "&AssignedToName=" + AssignedToName;
                    // End of Mantis Issue 24913 - change reverted
                    // End of Mantis Issue 24913
                }
