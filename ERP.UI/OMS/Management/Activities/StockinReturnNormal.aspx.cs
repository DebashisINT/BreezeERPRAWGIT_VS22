...
namespace ERP.OMS.Management.Activities
{
    public partial class StockinReturnNormal : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MasterSettings obj = new MasterSettings(); // Surojit 12-03-2019
            //  hdnConvertionOverideVisible.Value = objmaster.GetSettings("ConvertionOverideVisible");// Surojit 12-03-2019
            hdnShowUOMConversionInEntry.Value = obj.GetSettings("ShowUOMConversionInEntry");// Surojit 12-03-2019
            ...
            if (!IsPostBack)
            {
                ...
                string Visible = objmaster.GetSettings("ShowUOMConversionInEntry");
                if (Visible!="1")
                {
                    div_AltQuantity.Style.Add("display", "none");
                }
                else
                {
                    div_AltQuantity.Style.Add("display", "block");
                }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D")
            {
               ...
               .Select(g => g.Key);
                ...
                if (validate == "outrange" || validate == "duplicate"  || validate == "duplicateProduct" || validate == "nullAmount" || validate == "nullQuantity")
                {
                                    ...
                                    ref int strIsComplete, ref int strInvoiceID, string ReasonforReturn)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("prc_CRMSalesReturnNormal_StockIn", con);
        ...
        {
            List<MultiUOMSISRNConversionPacking> RateLists = new List<MultiUOMSISRNConversionPacking>();
            ...
            DataTable dt = proc.GetTable();
            RateLists = DbHelpers.ToModelList<MultiUOMSISRNConversionPacking>(dt);
            if (dt != null && dt.Rows.Count > 0)
            {
       ...
       */
        ...
        public class MultiUOMSISRNConversionPacking
        {
        ...
        public DataTable GetReturnManualProjectEditData()
        {
            ...
            proc.AddVarcharPara("@SalesReturnID", 500, Convert.ToString(Session["SISRN_key_QutId"]));
            dt = proc.GetTable();
            return dt;
        }
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (strSplitCommand == "SaveDisplay")
            {
                ...
                else if (Type == "W")
                {
                    ...
                    {
                        var rows = Warehousedt.Select("WarehouseID ='" + WarehouseID + "' AND Convert(TotalQuantity, 'System.Decimal')='" + Qty + "' AND SrlNo='" + editWarehouseID + "' and AltQty='" + AltQty + "'and AltUOM='" + AltUOM + "'");
                        ...
                        if (rows.Length == 0)
                        {
                            ...
                            else if (editWarehouseID != whID)
                            {
                                ...
                                foreach (var row in updaterows)
                                {
                                    ...
                                    row["Quantity"] = (oldQuantity + Convert.ToDecimal(Qty));
                                    row["TotalQuantity"] = (oldQuantity + Convert.ToDecimal(Qty));
                                    row["AltQty"] = (oldAltQuantity + Convert.ToDecimal(AltQty));
                                    row["AltUOM"] = AltUOM;
                                    row["SalesQuantity"] = (oldQuantity + Convert.ToDecimal(Qty)) + " " + Sales_UOM_Name;
                                }
                            }
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            if (performpara.Split('~')[0] == "EditWarehouse")
            {
                ...
                if (Session["SISRN_WarehouseData"] != null)
                {
                    ...
                    string strWarehouse = "", strBatchID = "", strSrlID = "", strQuantity = "0", strAltQuantity = "0", AltUOM = "";
        ...
        public DataTable GetWarehouseData()
        {
            ...
            proc.AddVarcharPara("@PID", 500, Convert.ToString(hdfProductID.Value));
            proc.AddVarcharPara("@branchId", 500, Convert.ToString(Convert.ToString(Request.QueryString["TBID"])));
            proc.AddVarcharPara("@Component_ID", 500, Convert.ToString(hdfComponentID.Value));
            dt = proc.GetTable();
            return dt;
        }
