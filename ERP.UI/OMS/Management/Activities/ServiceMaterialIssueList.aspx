<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ServiceMaterialIssueList.aspx.cs" Inherits="ERP.OMS.Management.Activities.ServiceMaterialIssueList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="pull-left">Material Issue</h3>
        </div>
    </div>
    <table class="padTab">
        <tr>
    ...
    <div class="form_main">
      ...
      <%--  <%} %>--%>
        ...
        <div class="GridViewArea relative">
            ...
            <dxe:ASPxGridView ID="gridAdvanceAdj" runat="server" KeyFieldName="MaterialIssue_ID" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <dxe:GridViewDataTextColumn Caption="Document Number" FieldName="MaterialIssue_Number" Width="200"
                    ...
                    <dxe:GridViewDataDateColumn Caption="Posting Date" FieldName="MaterialIssue_Date" Width="200"
                     ...
                     <dxe:GridViewDataTextColumn Caption="Contract Number" FieldName="Order_Numbers" Width="200"
                        VisibleIndex="0" FixedStyle="Left">
                        <CellStyle CssClass="gridcellleft" Wrap="true">
                        </CellStyle>
                        <Settings AllowAutoFilterTextInputTimer="False" />
                    ...
                    <dxe:GridViewDataDateColumn Caption="Contract Date" FieldName="Order_Dates" Width="200"
                        VisibleIndex="0" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy">
                        <CellStyle CssClass="gridcellleft" Wrap="true">
                        </CellStyle>
                        <Settings AllowAutoFilterTextInputTimer="False" />
            ...
            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                ContextTypeName="ERPDataClassesDataContext" TableName="v_ServiceMaterialIssue_List" />
