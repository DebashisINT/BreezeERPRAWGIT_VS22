...
{
    public partial class ProjectPurchaseReturnManual : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // Rev 1.0
            DataTable dtposTime = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(50),Lock_Fromdate,110) LockCon_Fromdate,convert(varchar(50),Lock_Todate,110) LockCon_Todate,convert(varchar(10),Lock_Fromdate,105) DataFreeze_Fromdate,convert(varchar(10),Lock_Todate,105) DataFreeze_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Add' and Module_Id=68");
            ...
            DataTable dtposTimeEdit = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(10),Lock_Fromdate,105) LockCon_Fromdate,convert(varchar(10),Lock_Todate,105) LockCon_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Edit' and Module_Id=68");
            DataTable dtposTimeDelete = oDBEngine.GetDataTable("SELECT  top 1 convert(varchar(10),Lock_Fromdate,105) LockCon_Fromdate,convert(varchar(10),Lock_Todate,105) LockCon_Todate FROM Trans_LockConfigouration_Details WHERE  Type='Delete' and Module_Id=68");
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        lblHeadTitle.Text = "Modify Project Purchase Return Manual";
                        ...
                        {
                            lblHeadTitle.Text = "View Project Purchase Return Manual";
                    ...
                    else
                    {
                        ...
                        lblHeadTitle.Text = "Add Project Purchase Return  Manual";
        ...
        public DataTable GetProjectEditData()
        {
            ...
            proc.AddVarcharPara("@Action", 500, "ProjectPurchaseManualEditdata");
        ...
        protected void EntityServerModeDataProjectPRManual_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
        ...
        //End of Rev Subhra 19-03-2019
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("prc_Project_ManualPurchaseReturn", con);
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (strSplitCommand == "SaveDisplay")
            {
                ...
                string AltQty = "0";
                 AltQty = Convert.ToString(e.Parameters.Split('~')[9]);
        ...
        public void GetAllDropDownDetailForSalesQuotation(string userbranch)
        {
            ...
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            DataTable Schemadt = objSlaesActivitiesBL.GetNumberingSchema(strCompanyID, userbranchHierarchy, strYear, "122", "Y");
            if (Schemadt != null && Schemadt.Rows.Count > 0)
            {
                ddl_numberingScheme.DataTextField = "SchemaName";
                ddl_numberingScheme.DataValueField = "Id";
        ...
        public static string GetAddLock(DateTime LockDate)
        {
            string rtrnvalue = "0";
            ProcedureExecute proc = new ProcedureExecute("prc_ProjectPurchaseReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetAddLockForProjectPurchaseReturnManualStatus");
