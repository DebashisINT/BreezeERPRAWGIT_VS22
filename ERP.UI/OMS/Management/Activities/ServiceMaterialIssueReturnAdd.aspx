<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ServiceMaterialIssueReturnAdd.aspx.cs" Inherits="ERP.OMS.Management.Activities.ServiceMaterialIssueReturnAdd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="CSS/SearchPopup.css" rel="stylesheet" />
    <script src="JS/SearchPopup.js?v=0.02"></script>
    <link href="CSS/CustomerReceiptAdjustment.css" rel="stylesheet" />
    <script src="JS/ServiceMaterialIssueReturn.js"></script>
    <style>
        .inputTypediv {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-title clearfix" id="myDiv">
        <h3 class="pull-left">
            <asp:Label ID="lblHeading" runat="server" Text="Material Return-Add"></asp:Label>
        </h3>
    </div>
    <div id="ApprovalCross" runat="server" class="crossBtn"><a href="ServiceMaterialIssueReturnList.aspx"><i class="fa fa-times"></i></a></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 lblmTop8">
                        <asp:RadioButtonList ID="rdl_SaleInvoice" runat="server" RepeatDirection="Horizontal" onchange="return selectValue();">
                            <asp:ListItem Text="Material Issue" Value="MI"></asp:ListItem>
                        </asp:RadioButtonList>
                ...
                <div class="row mTop5">
                    <div class="col-md-12 mTop5">
                        <dxe:ASPxGridView runat="server" ClientInstanceName="grid" ID="grid"
                            ...
                            OnCellEditorInitialize="grid_CellEditorInitialize1"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="ProductName" Caption="Product" VisibleIndex="3" Width="160px" ReadOnly="true">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Quantity" Caption="Quantity" VisibleIndex="5" Width="92px" HeaderStyle-HorizontalAlign="Right">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="SalePrice" Caption="Price" VisibleIndex="8" Width="60px" HeaderStyle-HorizontalAlign="Right">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Amount" Caption="Amount" VisibleIndex="9" Width="60px" HeaderStyle-HorizontalAlign="Right" ReadOnly="True">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="UOMID" Caption="UOMID" ReadOnly="True" Width="0">
                                </dxe:GridViewDataTextColumn>
