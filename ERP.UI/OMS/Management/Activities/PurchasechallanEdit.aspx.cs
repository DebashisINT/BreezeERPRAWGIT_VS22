...
// 3.0   V2.0.39    Sanchita    22-09-2023      GST is showing Zero in the TAX Window whereas GST in the Grid calculated. Mantis: 26843
...
{
    public partial class PurchasechallanEdit : ERP.OMS.ViewState_class.VSPage//ERP.OMS.ViewState_class.VSPage//System.Web.UI.Page//PersistViewStateToFileSystem
    {
            ...
            if (Session["userid"] != null)
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        openlink.Style.Add("display", "none");
                        ddl_Currency.Style.Add("display", "none");
                        txtEWayBillNumber.Enabled = false;
        ...
        {
            List<TransactionListEdit> TransactionList = new List<TransactionListEdit>();
            ...
            if (dt != null)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        TransactionListEdit Transactions = new TransactionListEdit();
                        ...
                        if (dtC.Contains("PurchasePriceValue"))
                        {
                            Transactions.PurchasePriceValue = Convert.ToString(dt.Rows[i]["PurchasePriceValue"]);
                        }
                        else
                        {
                            Transactions.PurchasePriceValue = "0.00";
                        }
                        if (dtC.Contains("PurchaseAmountValue"))
                        {
                            Transactions.PurchaseAmountValue = Convert.ToString(dt.Rows[i]["PurchaseAmountValue"]);
                        }
                        else
                        {
                            Transactions.PurchaseAmountValue = "0.00";
                        }
                        // Mantis Issue 24395
        ...
        public class TransactionListEdit
        {
            public string SrlNo { get; set; }
            ...
            public string PurchaseAmountValue { get; set; }
            // Mantis Issue 24395
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            foreach (var args in e.InsertValues)
            {
                ...
                if (Product_ID != "" && Product_ID != "0")
                {
                    ...
                    string PurchasePriceValue = Convert.ToString(args.NewValues["PurchasePriceValue"]);
                    string PurchaseAmountValue = Convert.ToString(args.NewValues["PurchaseAmountValue"]);

                    // Mantis Issue 24395 [Balance_Amount added in Rows.Add]
                    //Mantis Issue 24429
                    ...
                    //    Discount, TotalAmount, TaxAmount, NetAmount, TotalQty, BalanceQty, IsComponentProduct, IsLinkedProduct, ComponentProduct, "I", DetailsId,
                    //    ChallanDetails_InlineRemarks, PurchasePriceValue, PurchaseAmountValue, Balance_Amount);
                    ...
                    if (IsComponentProduct == "Y")
                    {
                        ...
                        foreach (DataRow Comp_dr in ComponentTable.Rows)
                        {
                            ...
                            Transactiondt.Rows.Add(SrlNo, SrlNo, DocNumber, DocID,
                                ...
                                "0.00", "0.00", "0.00", "0.00", "0", "0", "", "Y", ProductID, "I", DetailsId, ChallanDetails_InlineRemarks, "0", "0", "0", ChallanDetails_Id);
                        }
                    }
                }
            }
                    ...
                    if (Product_ID != "" && Product_ID != "0")
                    {
                        ...
                        foreach (DataRow Update_dr in Transactiondt.Rows)
                        {
                            ...
                            if (SrlNo == Old_SrlNo)
                            {
                                ...
                                Update_dr["PurchasePriceValue"] = PurchasePriceValue;
                                Update_dr["PurchaseAmountValue"] = PurchaseAmountValue;
                        ...
                        {
                            // Mantis Issue 24395 [ Balance_amount added in Rows.Add ]
                            // Mantis Issue 24425, 24428 [ Balance_amount removed] 
                            //Mantis Issue 24429
                            //Transactiondt.Rows.Add(SrlNo, RowNo, DocNumber, DocID, ProductID, ProductName, ProductDiscription, Quantity, PurchaseUOM, PurchasePrice,
                            ...
                            //    ChallanDetails_InlineRemarks, PurchasePriceValue, PurchaseAmountValue);
                            Transactiondt.Rows.Add(SrlNo, RowNo, DocNumber, DocID, ProductID, ProductName, ProductDiscription, Quantity, PurchaseUOM, PurchasePrice,
                                Discount, TotalAmount, TaxAmount, NetAmount, TotalQty, BalanceQty, IsComponentProduct, IsLinkedProduct, ComponentProduct, "U", DetailsId,
            ...
            if (IsDeleteFrom != "D" && IsDeleteFrom != "C")
            {
                ...
                List<ProductStockDetailsPCEdit> StockEntryJson = _ser.Deserialize<List<ProductStockDetailsPCEdit>>(StockDetails);
               ...
               .Select(g => g.Key);
                ...
                // Mantis Issue 24395 [ "NetAmountExceed" added in validate check ]
                ...
                else
                {
                    ...
                    //{
                        ...
                        List<ProductTaxDetailsEdit> TaxEntryJson = ser.Deserialize<List<ProductTaxDetailsEdit>>(TaxDetails);
                        ...
                        AddModifyPurchaseOrder(ActionType, PurchaseOrder_Id, strIsInventory, strSchemeType, strPurchaseNumber, strPurchaseDate, strBranch, strVendor, strContactName, Reference, PosGst,
                                              ...
                                              _tempTransactiondt, tempWarehousedt, TaxDetailTable, tempTaxDetailsdt, tempBillAddress, ref strIsComplete, ref strChallanID, ref strChallanNumber, duplicatedt2, ProjId, MultiUOMDetails);
        ...
        public bool AddModifyPurchaseOrder(string ActionType, string PurchaseChallan_ID, string strIsInventory, string strSchemeType, string strPurchaseNumber,
                                           ...
                                           DataTable Transactiondt, DataTable Warehousedt, DataTable TaxDetailTable,
                                           DataTable TaxChargesTable, DataTable BillAddress,
                                           ref int strIsComplete, ref int strChallanID, ref string strChallanNumber, DataTable PurchaseChallanPackingDetailsdt, Int64 ProjId, DataTable MultiUOMDetails)
        {
            try
            {
        ...
        {
            List<MultiUOMPackingEdit> RateLists = new List<MultiUOMPackingEdit>();
            ...
            RateLists = DbHelpers.ToModelList<MultiUOMPackingEdit>(dt);
            if (dt != null && dt.Rows.Count > 0)
            {
        ...
        {
            List<PurchaseOrderDetailsEdit> Detail = new List<PurchaseOrderDetailsEdit>();
            if (HttpContext.Current.Session["userid"] != null)
            {
                ...
                Detail = (from DataRow dr in address.Rows
                          select new PurchaseOrderDetailsEdit()
        ...
        public object GetStock(DataTable dt)
        {
            ...
            List<ProductStockDetailsPCEdit> ProductList = new List<ProductStockDetailsPCEdit>();

            ProductList = (from DataRow dr in dt.Rows
                           select new ProductStockDetailsPCEdit()
                           {
        ...
        {
            List<WareHouseUomConversionEdit> RateLists = new List<WareHouseUomConversionEdit>();
            ...
            proc.AddBigIntegerPara("@PackingProductId", ProductID);
            DataTable dt = proc.GetTable();
            RateLists = DbHelpers.ToModelList<WareHouseUomConversionEdit>(dt);
            if (dt != null && dt.Rows.Count > 0)
            {
                packing_quantity = Convert.ToDecimal(dt.Rows[0]["packing_quantity"]);
                sProduct_quantity = Convert.ToDecimal(dt.Rows[0]["sProduct_quantity"]);
    ...
    public class WareHouseUomConversionEdit
    {
    ...
    public class MultiUOMPackingEdit
    {
        public decimal packing_quantity { get; set; }
        public decimal sProduct_quantity { get; set; }
    ...
    public class ProductTaxDetailsEdit
    {
        public string SrlNo { get; set; }
        public string IsTaxEntry { get; set; }
    }
    public class ProductStockDetailsPCEdit
    {
    ...
    public class PurchaseOrderDetailsEdit
    {
