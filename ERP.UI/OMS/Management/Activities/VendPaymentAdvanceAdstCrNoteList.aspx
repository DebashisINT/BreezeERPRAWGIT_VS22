...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function AllControlInitilize() {
            if (isFirstTime) {
                ...
                if (localStorage.getItem('VendAdvanceAdjCrNoteFromDate')) {
                    var fromdatearray = localStorage.getItem('VendAdvanceAdjCrNoteFromDate').split('-');
                    var fromdate = new Date(fromdatearray[0], parseFloat(fromdatearray[1]) - 1, fromdatearray[2], 0, 0, 0, 0);
                    cFormDate.SetDate(fromdate);
                }

                if (localStorage.getItem('VendAdvanceAdjCrNoteToDate')) {
                    var todatearray = localStorage.getItem('VendAdvanceAdjCrNoteToDate').split('-');
                    var todate = new Date(todatearray[0], parseFloat(todatearray[1]) - 1, todatearray[2], 0, 0, 0, 0);
                    ctoDate.SetDate(todate);
                }
                if (localStorage.getItem('VendAdvanceAdjCrNoteListBranch')) {
                    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('VendAdvanceAdjCrNoteListBranch'))) {
                        ccmbBranchfilter.SetValue(localStorage.getItem('VendAdvanceAdjCrNoteListBranch'));
                    }
        ...
        function OnViewClick(keyValue) {
            var url = 'VendPaymentAdvanceAdstCrNote.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }

        function onEditClick(id) {
            window.location.href = 'VendPaymentAdvanceAdstCrNote.aspx?Key=' + id;
        }
        ...
        function updateGridByDate() {
            ...
            if (cFormDate.GetDate() == null) {
                ...
                localStorage.setItem("VendAdvanceAdjCrNoteFromDate", cFormDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("VendAdvanceAdjCrNoteToDate", ctoDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("VendAdvanceAdjCrNoteListBranch", ccmbBranchfilter.GetValue());
    ...
    <link href="CSS/VendPaymentAdvanceAdstCrNoteList.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <%--<h3 class="pull-left">Adjustment of Documents - Advance With Credit Note</h3>--%>
            <h3 class="pull-left">Adj. of Doc - Payment/Dr. Note with Rec./Cr Note</h3>
        </div>
    </div>
    <table class="padTab">
        <tr>
    ...
    <div class="form_main">
        ...
        <div class="GridViewArea relative">
            ...
            <dxe:ASPxGridView ID="gridAdvanceAdj" runat="server" KeyFieldName="Adj_id" AutoGenerateColumns="False"
                ...
                OnSummaryDisplayText="gridAdvanceAdj_SummaryDisplayText" Settings-VerticalScrollableHeight="280" Settings-VerticalScrollBarMode="Auto"
...
<SettingsSearchPanel Visible="True" Delay="5000" />
                <Columns>
                    ...
                    <dxe:GridViewDataDateColumn Caption="Posting Date" FieldName="Adjustment_Date" Width="200"
                     ...
                     <dxe:GridViewDataTextColumn Caption="Vendor(s)" FieldName="Vendor" Width="200"
                        VisibleIndex="0">
                        <CellStyle CssClass="gridcellleft" Wrap="true">
                        </CellStyle>
                        <Settings AllowAutoFilterTextInputTimer="False" />
            ...
            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                ContextTypeName="ERPDataClassesDataContext" TableName="v_VendorAdvanceAdjustmentWithCrNotes" />
