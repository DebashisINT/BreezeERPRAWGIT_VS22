    ...
    public partial class StockinReturnManual : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
       ...
       // BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                    ...
                    //   Session["SISRM_WarehouseData"] = GetReturnWarehouseData();
                       ...
                       Session["SRMwarehousedetailstemp"] = GetReturnWarehouseData();
                        ...
                        if (Session["TaggingInvoce"] == "1")
                        {
                            ...
                            Productdt = objSalesReturnBL.GetReceiveSalesReturnTaggingProductData(strSalesReturnId, Convert.ToString(Session["LastFinYear"]), Convert.ToString(Session["LastCompany"])).Tables[0];
                        }
                        else
                        {
                          //  Productdt = objSalesReturnBL.GetSalesReturnProductData(strSalesReturnId, Convert.ToString(Session["LastFinYear"]), Convert.ToString(Session["LastCompany"])).Tables[0];
                            Productdt = objSalesReturnBL.GetReceiveSalesReturnProductData(strSalesReturnId, Convert.ToString(Session["LastFinYear"]), Convert.ToString(Session["LastCompany"])).Tables[0];
                        }
        ...
        public class Quotation
        {
            ...
            public string ReturnDetails_CLOSE_RATE { get; set; }
        }
        #endregion
        ...
        public DataTable GetReturnManualProjectEditData()
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesReturn_Details");
            proc.AddVarcharPara("@Action", 500, "ProjectReceiveagainstReturnManualEditdata");
            proc.AddVarcharPara("@SalesReturnID", 500, Convert.ToString(Session["SISRM_ReturnID"]));
            dt = proc.GetTable();
            return dt;
        }
        ...
        public IEnumerable GetQuotation(DataTable Quotationdt)
        {
            ...
            if (Quotationdt != null && Quotationdt.Rows.Count > 0)
            {
                for (int i = 0; i < Quotationdt.Rows.Count; i++)
                {
                    ...
                    Quotations.ReturnDetails_CLOSE_RATE = Convert.ToString(Quotationdt.Rows[i]["ReturnDetails_CLOSE_RATE"]);
                    QuotationList.Add(Quotations);
                }
            }
            return QuotationList;
        ...
        protected void grid_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            ...
            //}
            if (e.Column.FieldName == "ReturnDetails_CLOSE_RATE")
            {
                e.Editor.Enabled = true;
            }
            else
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            else
            {
                ...
                Quotationdt.Columns.Add("ReturnDetails_CLOSE_RATE", typeof(string));
            }
            ...
            foreach (var args in e.InsertValues)
            {
                ...
                if (ProductDetails != "" && ProductDetails != "0")
                {
                    ...
                    string CloseRate = Convert.ToString(args.NewValues["ReturnDetails_CLOSE_RATE"]);
                    Quotationdt.Rows.Add(SrlNo, "0", ProductDetails, Description, Quantity, UOM, Warehouse, StockQuantity, StockUOM, SalePrice, Discount, Amount, TaxAmount, TotalAmount, "I", ProductName, ComponentID, ComponentNumber, TotalQty, BalanceQty, IsComponentProduct, ProductDisID, Product, IsInventory, CloseRate);
                }
            }
            ...
            foreach (var args in e.UpdateValues)
            {
                ...
                if (isDeleted == false)
                {
                    if (ProductDetails != "" && ProductDetails != "0")
                    {
                        ...
                        string ReturnDetails_CLOSE_RATE = Convert.ToString(args.NewValues["ReturnDetails_CLOSE_RATE"]);
                        bool Isexists = false;
                        foreach (DataRow drr in Quotationdt.Rows)
                        {
                            ...
                            if (OldQuotationID == QuotationID)
                            {
                                ...
                                drr["ReturnDetails_CLOSE_RATE"] = ReturnDetails_CLOSE_RATE;
                                break;
                            }
                        }
                        ...
                        if (Isexists == false)
                        {
                            Quotationdt.Rows.Add(SrlNo, QuotationID, ProductDetails, Description, Quantity, UOM, Warehouse, StockQuantity, StockUOM, SalePrice, Discount, Amount, TaxAmount, TotalAmount, "U", ProductName, ComponentID, ComponentNumber, TotalQty, BalanceQty, IsComponentProduct, ProductDisID, Product, IsInventory, ReturnDetails_CLOSE_RATE);
                        }
                    }
                }
            }
                                    ...
                                    ref int strIsComplete, ref int strInvoiceID, string ReasonforReturn)
        {
            ...
            {              
               ...
               // SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                ...
                SqlCommand cmd = new SqlCommand("prc_CRMSalesReturnNew", con);
                ...
                if (Session["SRMwarehousedetailstemp"] != null)
                {
                    ...
                    temtable = Warehousedtssss.DefaultView.ToTable(false, "SrlNo", "BatchWarehouseID", "BatchWarehousedetailsID", "BatchID", "SerialID", "WarehouseID", "WarehouseName", "BatchNo", "SerialNo", "MFGDate", "ExpiryDate", "Quantitysum", "productid", "Inventrytype", "StockID", "isnew", "AltQty", "AltUOM");
        ...
        protected void GrdWarehousePC_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                string AltQty = Convert.ToString(e.Parameters.Split('~')[6]);
                string AltUOM = Convert.ToString(e.Parameters.Split('~')[7]);
                        ...
                        if (inputqnty <= totalopeining || isedited == "true")
                        {
                            ...
                            if (hdniswarehouse.Value == "true" && hdnisbatch.Value == "true" && hidencountforserial.Value == "2" && hdnisserial.Value == "true" && hdnoldwarehousname.Value == WarehouseName && hdnoldbatchno.Value == BatchName)
                            {
                                if (Convert.ToString(dtmgh) != "1/1/0001 12:00:00 AM" && Convert.ToString(dtexp) != "1/1/0001 12:00:00 AM" && Convert.ToString(dtmgh) != "01-01-0001 12:00:00 AM" && Convert.ToString(dtexp) != "01-01-0001 12:00:00 AM")
                                {
                                    ...
                                    Warehousedt.Rows.Add(Warehousedt.Rows.Count + 1, WarehouseID, WarehouseName, BatchName, SerialName, dtmgh, dtexp, openingstock, "0", "0", "0", "0", "", "", "", SerialName, null, null, 0, "new", Convert.ToString(hdfProductIDPC.Value), getinventry(), Convert.ToString(hdfstockidPC.Value), Convert.ToInt32(hdnpcslno.Value), AltQty, AltUOM);
                                    GrdWarehousePC.JSProperties["cpinsertmssgserial"] = Convert.ToString("Inserted.");

                                }
                                else
                                {
                                    Warehousedt.Rows.Add(Warehousedt.Rows.Count + 1, WarehouseID, WarehouseName, BatchName, SerialName, null, null, openingstock, "0", "0", "0", "0", "", "", "", SerialName, null, null, 0, "new", Convert.ToString(hdfProductIDPC.Value), getinventry(), Convert.ToString(hdfstockidPC.Value), Convert.ToInt32(hdnpcslno.Value) ,AltQty, AltUOM);
            ...
            if (strSplitCommand == "Saveall")
            {
                ...
                else
                {
                    ...
                    if (newrowcount != 0 || updaterows != 0 || Session["SISRMWarehouseDataDelete"] != null)
                    {
                        ...
                        //commnet for allowing reduce from main page  24-01-2018
            ...
            if (strSplitCommand == "Updatedata")
            {
                ...
                string AltQty = Convert.ToString(e.Parameters.Split('~')[7]);
                string AltUOM = Convert.ToString(e.Parameters.Split('~')[8]);
                ...
                if (Session["SISRM_WarehouseData"] != null)
                {
                    ...
                    if (dataSet1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (isserialenable == "false" && isviewqntitynull != "false")
                        {
                            ...
                            customerRow[0]["AltQty"] = AltQty;
                            customerRow[0]["AltUOM"] = AltUOM;
                        }
        ...
        private int Insertupdatedata(string ProductID, string stockid, string branchid)
        {
            ...
            if (Session["SISRM_WarehouseData"] != null)
            {
                ...
                temtable = Warehousedt.DefaultView.ToTable(false, "SrlNo", "BatchWarehouseID", "BatchWarehousedetailsID", "BatchID", "SerialID", "WarehouseID", "WarehouseName", "BatchNo", "SerialNo", "MFGDate", "ExpiryDate", "Quantitysum", "isnew", "viewQuantity", "productid", "Inventrytype", "StockID", "pcslno", "AltQty", "AltUOM");
        ...
        public DataTable GetWarehouseData()
        {
            ...
            string strSetting = Convert.ToString(masterBl.GetSettings("IaMultilevelWarehouse"));
            string strBranch = Convert.ToString(Request.QueryString["TBID"]);
            DataTable dt = new DataTable();
            if (strSetting != "1")
            {
        ...
        [WebMethod]
        public static object GetPackingQuantity(Int64 ProductID)
        {
            List<MultiUOMConversionPacking> RateLists = new List<MultiUOMConversionPacking>();
            ...
            DataTable dt = proc.GetTable();
            RateLists = DbHelpers.ToModelList<MultiUOMConversionPacking>(dt);
            if (dt != null && dt.Rows.Count > 0)
            {
        ...
        public class MultiUOMConversionPacking
        {
