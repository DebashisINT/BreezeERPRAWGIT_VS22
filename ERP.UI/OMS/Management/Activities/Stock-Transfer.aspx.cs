...
{
    public partial class Stock_Transfer : ERP.OMS.ViewState_class.VSPage//System.Web.UI.Page
    {
               ...
               // objEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                ...
                else
                {
                    if (!IsPcTransactionExist(PurchaseOrder_Id))
                    {
                        ...
                        List<ProductTaxDetailsstock> TaxEntryJson = ser.Deserialize<List<ProductTaxDetailsstock>>(TaxDetails);
    ...
    public class ProductTaxDetailsstock
    {
        public string SrlNo { get; set; }
        public string IsTaxEntry { get; set; }
    }
    public class ProductStockDetailsstock
    {
