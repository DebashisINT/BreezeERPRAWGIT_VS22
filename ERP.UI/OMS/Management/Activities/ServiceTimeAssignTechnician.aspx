<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ServiceTimeAssignTechnician.aspx.cs" Inherits="ERP.OMS.Management.Activities.ServiceTimeAssignTechnician" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="panel-heading clearfix">
        <div class="panel-title pull-left">
            <h3>Service Time Assign Technician</h3>
        </div>
            ...
            <div class="col-sm-12 " style="padding-top: 15px">
                ...
                <dxe:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" KeyFieldName="DETAILS_ID" TabIndex="6" OnDataBinding="grid_DataBinding" OnCustomCallback="grid_CustomCallback"
                    ...
                    <Columns>
                        ...
                        <dxe:GridViewDataTextColumn FieldName="SCH_CODE" FixedStyle="Left" Caption="Schedule No." VisibleIndex="2" Width="200">
                            <PropertiesTextEdit>
                            </PropertiesTextEdit>
              ...
              <%--           <dxe:GridViewDataTextColumn Caption="Schedule Time" FieldName="SCHEDULE_TIME" Width="150" VisibleIndex="13" PropertiesTextEdit-MaxLength="8" ReadOnly="false">
                            <PropertiesTextEdit Style-HorizontalAlign="Left" DisplayFormatString="hh:mm:ss">
                                <Style HorizontalAlign="Left">
                                        </Style>
                            </PropertiesTextEdit>
                         </dxe:GridViewDataTextColumn>--%>

                         <dxe:GridViewDataTimeEditColumn FieldName="SCHEDULE_TIME" Caption="Schedule Time" PropertiesTimeEdit-EditFormatString="HH:mm:ss" PropertiesTimeEdit-DisplayFormatString="HH:mm:ss" VisibleIndex="14" Width="200">
