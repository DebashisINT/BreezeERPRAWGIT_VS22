...
{
    public partial class ServiceTimeAssignTechnician : System.Web.UI.Page
    {
        ...
        protected void grid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (e.Parameters.Split('~')[0] == "AssignAll")
            {
                ...
                {
                    string times = Convert.ToString(grid.GetSelectedFieldValues("SCHEDULE_TIME")[i]);
                    ...
                    cmd.Parameters.AddWithValue("@SCHEDULE_TIME", times);
        ...
        {
            if (e.Column.FieldName == "SCHEDULE_TIME")
            {
