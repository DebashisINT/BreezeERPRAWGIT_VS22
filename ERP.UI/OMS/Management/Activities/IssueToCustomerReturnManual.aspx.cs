...
{
    public partial class IssueToCustomerReturnManual : System.Web.UI.Page
    {
       ...
       // BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["key"] != null)
                {
                    ...
                    {
                        lblHeadTitle.Text = "Modify Issue To Customer Manual";
                    ...
                    else
                    {
                        ...
                        Session["CRI_TaxDetails"] = null;
                        CreateDataTaxTable();
                        lblHeadTitle.Text = "Add Issue To Customer Manual";
        ...
        protected void grid_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            ...
            else if (e.Column.FieldName == "StockQuantity")
            {
                e.Editor.Enabled = true;
            }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D")
            {
               ...
               // BusinessLogicLayer.DBEngine objEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                ...
                if (validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "duplicateProduct" || validate == "nullQuantity" || validate == "transporteMandatory")
                {
                                    ...
                                    ref int strIsComplete, ref int strInvoiceID, string ReasonforReturn)
        {
            try
            {
                ...
                { cmd.Parameters.AddWithValue("@ComponentType", "CR"); }
                ...
                //Added For Manual issue 
                cmd.Parameters.AddWithValue("@IsManual", 1);
                cmd.Parameters.AddWithValue("@ReturnManual", Convert.ToString(txt_CustomerReturnNumber.Text));
                //End
        ...
        public void SetSalesReturnDetails(string strSalesReturnId)
        {
            ...
            if (SalesReturnEditdt != null && SalesReturnEditdt.Rows.Count > 0)
            {
                ...
                string ManualReturnNumber = Convert.ToString(SalesReturnEditdt.Rows[0]["ManualRetNumber"]);
                txt_CustomerReturnNumber.Text = ManualReturnNumber;
                txt_CustomerReturnNumber.Enabled = false;
        ...
        protected void CmbWarehouse_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (WhichCall == "BindWarehouse")
            {
                ...
                DataTable dt = GetWarehouseDataManual();
                ...
                //    CmbWarehouse.JSProperties["cpwarehouseName"] = Convert.ToString(dtW.Rows[0]["WarehouseName"]);
                //}
            }
        }
        ...
        public DataTable GetWarehouseDataManual()
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_SalesOrder_Details");
            proc.AddVarcharPara("@Action", 500, "GetWareHouseDtlByProductID");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(""));
            proc.AddVarcharPara("@ProductID", 500, Convert.ToString(hdfProductID.Value));
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            //proc.AddVarcharPara("@branchId", 2000, Convert.ToString(Session["userbranchID"]));
            proc.AddVarcharPara("@branchId", 2000, Convert.ToString(ddl_Branch.SelectedValue));
