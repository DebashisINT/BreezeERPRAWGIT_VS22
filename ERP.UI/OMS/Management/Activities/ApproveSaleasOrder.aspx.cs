...
{
    public partial class ApproveSaleasOrder : System.Web.UI.Page
    {
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                ...
                //    //    {
                //    //        var q = from d in dc.TBL_APPROVESALESORDERREPORTs
                ...
                //    //    else
                //    //    {
                //    //        var q1 = from d in dc.TBL_APPROVESALESORDERREPORTs
                //    //                 where d.USER_ID == User_id &&
                //    //                 //d.Order_CheckDate >= Convert.ToDateTime(strFromDate) && d.Order_CheckDate <= Convert.ToDateTime(strToDate)
                //    //                 //&& branchidlist.Contains(Convert.ToInt32(d.Order_BranchId))
        ...
        {
            ShowReadyToInvoice Statuss = new ShowReadyToInvoice();
            int userid = Convert.ToInt32(HttpContext.Current.Session["userid"]);
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("PRC_ReadyToInvoiceInsertUpdate");
        ...
        {
            ApprovedSalesOrderCount cls = new ApprovedSalesOrderCount();
            int userid = Convert.ToInt32(HttpContext.Current.Session["userid"]);
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("PRC_ReadyToInvoiceInsertUpdate");
            proc.AddPara("@ACTION", "ApprovedSalesOrderCount");
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                cls.Printed = dt.Rows[0]["Printed"].ToString();
                cls.ReadyForInvoice = dt.Rows[0]["ReadyForInvoice"].ToString();
                cls.Pending = dt.Rows[0]["Pending"].ToString();
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string strBranchID = (Convert.ToString(hfBranchID.Value) == "") ? "0" : Convert.ToString(hfBranchID.Value);
            Task PopulateStockTrialDataTask = new Task(() => GetApproveSalesOrderdata(FROMDATE, TODATE, strBranchID));
            PopulateStockTrialDataTask.RunSynchronously();
        }

        public void GetApproveSalesOrderdata(string FROMDATE, string TODATE, string BRANCH_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("prc_ApproveSalesOrder_List", con);
    ...
    public class ShowReadyToInvoice
    {
        public String Status { get; set; }
        public String Remarks { get; set; }
    }

    public class ApprovedSalesOrderCount
    {
        public String Printed { get; set; }
        public String ReadyForInvoice { get; set; }
