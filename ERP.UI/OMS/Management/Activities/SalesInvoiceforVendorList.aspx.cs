...
namespace ERP.OMS.Management.Activities
{
    public partial class SalesInvoiceforVendorList : ERP.OMS.ViewState_class.VSPage
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/SalesInvoiceforVendorList.aspx");
            ...
            if (!IsPostBack)
            {
                ...
                Session.Remove("SIDV_schemavalue");  // Use this session to remove default cursor from manual oe auto schema type
                Session.Remove("SIDV_SaveMode"); // Use this session to remove default cursor from manual oe auto schema type
                ...
                if (Session["LastCompany"] != null && Session["LastCompany"] != null)
                {
                    ...
                    //--------This following code is comment out for mantis issue 0019250-------------//
        ...
        protected void GrdQuotation_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (WhichCall == "FilterGridByDate")
            {
                ...
                dtdata = objSalesInvoiceBL.GetQuotationList_GridDataForVendor(userbranch, lastCompany, finyear, BranchID, FromDate, ToDate, "DV");
