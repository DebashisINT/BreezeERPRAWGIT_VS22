...
{
    public partial class ProjectChallanList : System.Web.UI.Page
    {
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Project Sales Challan";
            exporter.FileName = filename;
            exporter.FileName = "GrdChallan";

            exporter.PageHeader.Left = "Project Sales Challan";
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                if (strBranchID == "0")
                {
                    ...
                    var q = from d in dc.v_ProjectChallanLists
