...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <div class="clearfix">
            <% if (rights.CanAdd)
               { %>
            <a href="javascript:void(0);" onclick="OnAddInvoiceButtonClick('Cash')" class="btn btn-success "><span class="btn-icon"><i class="fa fa-plus" ></i></span><span>Add <u>C</u>ash Invoice</span> </a>
            <a href="javascript:void(0);" onclick="OnAddInvoiceButtonClick('Crd')" class="btn btn-success "><span class="btn-icon"><i class="fa fa-plus" ></i></span><span>Add Cre<u>d</u>it Invoice</span> </a>
            <a href="javascript:void(0);" onclick="OnAddInvoiceButtonClick('Fin')" class="btn btn-success "><span class="btn-icon"><i class="fa fa-plus" ></i></span><span>Add <u>F</u>inance Invoice</span> </a>
            <a href="javascript:void(0);" onclick="OnAddInvoiceButtonClick('IST')" class="btn btn-success "><span class="btn-icon"><i class="fa fa-plus" ></i></span><span>Interstate <u>S</u>tock Transfer</span> </a>

            <a href="javascript:void(0);" onclick="ShowReceiptPayment()" class="btn btn-success "><span class="btn-icon"><i class="fa fa-plus" ></i></span><span>Add <u>R</u>eceipt/Payment</span> </a>
            ...
            <% if (rights.CanAssignbranch)
               { %>
            <a id="amassbranch" href="javascript:void(0);" onclick="MassBranchAssign()" class="btn btn-primary "><span><u>M</u>ass Unit Assign</span> </a>
            <%} %>
            <%--<a href="javascript:void(0);" class="btn btn-danger"><span>Delete</span> </a>--%>


            <a href="javascript:void(0);" onclick="InvoiceWatingClick()" class="btn btn-warning  hide"><span><u>I</u>nvoice Waiting </span>
