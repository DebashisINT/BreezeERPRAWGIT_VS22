...
{
    public partial class ProjectPurchaseReturnManualList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Management/Activities/ProjectPurchaseReturnManualList.aspx");
        ...
        {
            GrdPurchaseReturn.Columns[5].Visible = false;
            string filename = "Project Purchase Return Manual";
            exporter.FileName = filename;
            //  exporter.FileName = "PurchaseReturnWithStockAndAccount";

            exporter.PageHeader.Left = "Project Purchase Return Manual";
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                if (strBranchID == "0")
                {
                    ...
                    var q = from d in dc.v_ProjPurchaseReturnManualLists
