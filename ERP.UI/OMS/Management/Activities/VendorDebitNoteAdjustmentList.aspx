<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="VendorDebitNoteAdjustmentList.aspx.cs" Inherits="ERP.OMS.Management.Activities.VendorDebitNoteAdjustmentList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnAddClick() {
            window.location.href = 'VendorDebitNoteAdjustment.aspx?Key=Add';
        }
    ...
    <script>
        ...
        function AllControlInitilize() {
            if (isFirstTime) {
                ...
                if (localStorage.getItem('VendDrNoteAdjFromDate')) {
                    var fromdatearray = localStorage.getItem('VendDrNoteAdjFromDate').split('-');
                    var fromdate = new Date(fromdatearray[0], parseFloat(fromdatearray[1]) - 1, fromdatearray[2], 0, 0, 0, 0);
                    cFormDate.SetDate(fromdate);
                }

                if (localStorage.getItem('VendDrNoteAdjToDate')) {
                    var todatearray = localStorage.getItem('VendDrNoteAdjToDate').split('-');
                    var todate = new Date(todatearray[0], parseFloat(todatearray[1]) - 1, todatearray[2], 0, 0, 0, 0);
                    ctoDate.SetDate(todate);
                }
                if (localStorage.getItem('VendDrNoteAdjBranch')) {
                    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('VendDrNoteAdjBranch'))) {
                        ccmbBranchfilter.SetValue(localStorage.getItem('VendDrNoteAdjBranch'));
                    }
        ...
        function OnViewClick(keyValue) {
            var url = 'VendorDebitNoteAdjustment.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }

        function onEditClick(id) {
            window.location.href = 'VendorDebitNoteAdjustment.aspx?Key=' + id;
        }
        ...
        function updateGridByDate() {
            ...
            if (cFormDate.GetDate() == null) {
                ...
                localStorage.setItem("VendDrNoteAdjFromDate", cFormDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("VendDrNoteAdjToDate", ctoDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("VendDrNoteAdjBranch", ccmbBranchfilter.GetValue());
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="pull-left">Adjustment of Documents - Debit Note With Invoice</h3>
        </div>
    </div>
    <table class="padTab">
        <tr>
...
<SettingsSearchPanel Visible="True" Delay="5000" />
            ...
            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                ContextTypeName="ERPDataClassesDataContext" TableName="v_VendorDrAdjustmentWithInvoices" />
