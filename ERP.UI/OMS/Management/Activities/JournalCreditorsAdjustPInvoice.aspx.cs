...
{
    public partial class JournalCreditorsAdjustPInvoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack) 
            {
                ...
                {
                    lblHeading.Text = "View Adjustment of Documents - Journal with Purchase Invoice";
        ...
        private void AddmodeExecuted()
        {
            ...
            DataSet allDetails = blLayer.PopulateJournalCreditorsAdjustmentDetails();
            ...
            if (Session["schemavalJourCreditorAdj"] != null)
            {
                List<string> SaveNewValues = (Session["schemavalJourCreditorAdj"]) as List<string>;
            ...
            if (Convert.ToString(Session["SaveModeJourCreditorsAdj"]) == "A")
            {
                dtTDate.Focus();
                txtVoucherNo.ClientEnabled = false;
                txtVoucherNo.Text = "Auto";
            }
            else if (Convert.ToString(Session["SaveModeJourCreditorsAdj"]) == "M")
            {
        ...
        {
            DataSet EditedDataDetails = blLayer.GetEditedJounalCreditorData(id);
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            blLayer.AddEditJournalAdjustmentPurchaseInvoice(hdAddEdit.Value, CmbScheme.Value.ToString().Split('~')[0], txtVoucherNo.Text, dtTDate.Date.ToString("yyyy-MM-dd"),
