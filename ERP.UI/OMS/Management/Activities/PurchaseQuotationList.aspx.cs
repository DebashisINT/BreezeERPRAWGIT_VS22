...
{
    public partial class PurchaseQuotationList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(ApprovalReqInq))
            {
                ...
                {
                    IsApprove = true;
                    GrdQuotation.Columns[11].Width = 120;
                    GrdQuotation.Columns[12].Width=180;
                ...
                {
                    IsApprove = false;
                    GrdQuotation.Columns[11].Width=0;
            ...
            if (!String.IsNullOrEmpty(ProjectSelectInEntryModule))
            {
                if (ProjectSelectInEntryModule == "Yes")
                {
                    ...
                    GrdQuotation.Columns[8].Width = 120;

                }
                else if (ProjectSelectInEntryModule.ToUpper().Trim() == "NO")
                {
                    GrdQuotation.Columns[8].Width = 0;
        ...
        protected void GrdQuotation_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (WhichCall == "Edit")
            {
                ...
                DataTable dtQuotationStatus = objCRMSalesDtlBL.GetPurchaseQuotationStatusByQuotationID(WhichType);
            ...
            else if (WhichCall == "update")
            {
                ...
                int dtQuotationStatus = objCRMSalesDtlBL.UpdatePurchaseQuotationStatusByCustomer(Convert.ToInt32(WhichType), Convert.ToInt32(QuoteStatus), remarks);
            ...
            {
                deletecnt = objCRMSalesDtlBL.DeletePurchaseQuotation(WhichType);
                if (deletecnt == 1)
                {
        ...
        public static string GetEditablePermission(string ActiveUser)
        {
            ...
            CRMSalesDtlBL objCRMSalesDtlBL = new CRMSalesDtlBL();
            int ispermission = 0;
            ispermission = objCRMSalesDtlBL.PurchaseQuotationEditablePermission(Convert.ToInt32(ActiveUser));
        ...
        public static string GetEditablePermissions(string ActiveUser, string SalesDocId)
        {
            ...
            CRMSalesDtlBL objCRMSalesDtlBL = new CRMSalesDtlBL();
            int ispermission = 0;
            ispermission = objCRMSalesDtlBL.PurchaseQuotationEditablePermission(Convert.ToInt32(ActiveUser), Convert.ToInt32(SalesDocId));
        ...
        public void PopulateERPDocApprovalPendingListByUserLevel()
        {
            ...
            if (Session["userid"] != null)
            {
                if (Session["userbranchID"] != null)
                {
                    ...
                    dtdata = objERPDocPendingApproval.PopulateERPDocApprovalPendingListByUserLevel(userid, "PurQuote");
                    if (dtdata != null && dtdata.Rows.Count > 0)
                    {
        ...
        public void PopulateApprovalPendingCountByUserLevel()
        {
            ...
            DataTable dtdata = new DataTable();
            dtdata = objERPDocPendingApproval.PopulateERPDocApprovalPendingCountByUserLevel(userid, "PurQuote");
            if (dtdata != null && dtdata.Rows.Count > 0)
            {
        ...
        public void PopulateUserWiseERPDocCreation()
        {
            ...
            if (Session["UserWiseERPDocCreation"] == null)
            {
                ...
                dtdata = objERPDocPendingApproval.PopulateUserWiseERPDocCreation(userid, "PurQuote");
            }
            else
            {
        ...
        public void ConditionWiseShowStatusButton()
        {
            ...
            j = objERPDocPendingApproval.ConditionWiseShowApprovalStatusButton(1, Convert.ToString(Session["userbranchHierarchy"]), Convert.ToString(Session["userid"]), "PurQuote");
            ...
            k = objERPDocPendingApproval.ConditionWiseShowApprovalPendingButton(1, Convert.ToString(Session["userbranchHierarchy"]), Convert.ToString(Session["userid"]), "PurQuote");
        ...
        protected void CallbackPanel_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetPurchaseQuotationdata(FROMDATE, TODATE, strBranchID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetPurchaseQuotationdata(string FROMDATE, string TODATE, string BRANCH_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("prc_PurchaseQuotation_List", con);
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                ...
                //        var q = from d in dc.V_PurchaseQuotationLists
                ...
                //                orderby d.Quote_Date descending
                //                select d;
                //        var q = from d in dc.PurchaseQuotationLists
                //        e.QueryableSource = q;
                //    }
                //}
                //else
                ...
                if (IsUserwise == "Y")
                {
                    ERPDataClassesDataContext dc = new ERPDataClassesDataContext(connectionString);
                      var q = from d in dc.PurchaseQuotationLists
                            where Convert.ToString(d.USERID) == UserID && d.CreatedBy == Convert.ToInt32(UserID)
                            orderby d.SEQ
                            select d;
                    e.QueryableSource = q;
                }
        ...
        public static string GetSalesQuoteIsExistInSalesOrder(string keyValue)
        {
            ...
            int ispermission = 0;
            ispermission = objCRMSaleDtlBL.IsPurchaseQuotationExistsInPurchaseOrder(keyValue);
            return Convert.ToString(ispermission);
        }
        ...
        public static string CancelSalesOrderOnRequest(string keyValue, string Reason)
        {
            ...
            int CancelOrder = 0;
            CancelOrder = objCRMSalesOrderDtlBL.CancelPurchaseQuotation(keyValue, Reason);
