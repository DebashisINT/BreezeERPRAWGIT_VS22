<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ProjectInquiry.aspx.cs" Inherits="ERP.OMS.Management.Activities.ProjectInquiry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function CancelSalesOrder(keyValue, Reason) {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectInquiry.aspx/CancelSalesInquiryOnRequest",
        ...
        function OnClickDelete(keyValue) {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectInquiry.aspx/GetSalesInquiryIsExistInSalesQuotationr",
        ...
        function QuotationWattingOkClick() {
            ...
            if (listKey) {
                if (CwatingQuotegrid.GetRow(index).children[6].innerText != "Advance") {
                    var url = 'ProjectInquiryAdd.aspx?key=' + 'ADD&&BasketId=' + listKey;
                    LoadingPanel.Show();
        ...
        function OnViewClick(keyValue) {
            var url = 'ProjectInquiryAdd.aspx?key=' + keyValue + '&req=V' + '&type=ProSINQ';
            window.location.href = url;
        }
        ...
        function OnclickViewAttachment(obj) {
            ...
            var URL = '/OMS/Management/Activities/EntriesDocuments.aspx?idbldng=' + obj + '&type=ProSINQ';
            window.location.href = URL;
        }

        function OnAddButtonClick() {
            var url = 'ProjectInquiryAdd.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        var keyval;
        ...
        function OnGetApprovedRowValues(obj) {
            uri = "ProjectInquiryAdd.aspx?key=" + obj + "&status=2" + '&type=QO';
        ...
        function OnGetRejectedRowValues(obj) {
            uri = "ProjectInquiryAdd.aspx?key=" + obj + "&status=3" + '&type=QO';
            popup.SetContentUrl(uri);
            popup.Show();
        }
        ...
        function OnApprovalEndCall(s, e) {
            ...
            function OnMoreInfoClick(keyValue) {
                ...
                if (ActiveUser != null) {
                    $.ajax({
                        type: "POST",
                        url: "ProjectInquiry.aspx/GetEditablePermissions",
                        ...
                        success: function (msg) {
                            ...
                            var url = 'ProjectInquiryAdd.aspx?key=' + keyValue + '&Permission=' + status + '&type=ProSINQ';
                            window.location.href = url;
                        }
                    });
                 }
            ...
            function fn_CopySalesQuotation(keyValue) {
                ...
                if (ActiveUser != null) {
                    $.ajax({
                        ...
                        success: function (msg) {
                            var status = msg.d;
                            var url = 'ProjectInquiryAdd.aspx?key=' + keyValue + '&Permission=' + status + '&type=QO&Typenew=Copy';
                            window.location.href = url;
                        }
                    });
                }
            ...
            function OnApproveClick(keyValue, visibleIndex) {
                ...
                if (ActiveUser != null) {
                    $.ajax({
                        type: "POST",
                        url: "ProjectInquiry.aspx/GetEditablePermission",
                        data: "{'ActiveUser':'" + ActiveUser + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,//Added By:Subhabrata
                        success: function (msg) {
                            //debugger;
                            var status = msg.d;
                            var url = 'ProjectInquiryAdd.aspx?key=' + keyValue + '&Permission=' + status + '&type=ProSINQ' + '&type1=AppSINQ';
                            window.location.href = url;
                        }
                    });
                }
        ...
        function fn_CloseSalesOrder(keyValue) {
            var IsCancelFlag = cGrdQuotation.GetRow(cGrdQuotation.GetFocusedRowIndex()).children[7].innerText;
            if (IsCancelFlag.trim() != 'Cancelled' && IsCancelFlag.trim() != 'Closed') {
            jConfirm('Do you want to close the Project Sales Inquiry ?', 'Confirmation Dialog', function (r) {
                debugger;
                if (r == true) {
        ...
        function CloseSalesQuotationQuantity(Quote_Id, Remarks) {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectInquiryAdd.aspx/CloseInquiryquantity",
                ...
                success: function (msg) {
                    ...
                    if (status == "1") {
                        ...
                        jAlert("Project Sales Inquiry is closed successfully.", "Approval", function () {
                            location.reload();
                        });
                        //
                    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea relative">
        <div class="makeFullscreen ">
             <span class="fullScreenTitle">Project Sales Inquiry</span>
        ...
        <dxe:ASPxGridView ID="GrdQuotation" runat="server" KeyFieldName="Quote_Id" AutoGenerateColumns="False" SettingsBehavior-AllowFocusedRow="true" Settings-VerticalScrollableHeight="250" Settings-VerticalScrollBarMode="Auto"
           ...
           <SettingsSearchPanel Visible="True" Delay="5000" />
             <Columns>
                ...
                <%--<dxe:GridViewDataTextColumn FieldName="Quote_Id" Visible="false" SortOrder="Descending">
                 ...
                 <dxe:GridViewDataTextColumn FieldName="Quote_Id" Visible="false" ShowInCustomizationForm="false" SortOrder="Descending" VisibleIndex="0">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                    <Settings AllowAutoFilterTextInputTimer="False" />
                </dxe:GridViewDataTextColumn>
         ...
         <dxe:GridViewDataTextColumn Caption="Revision No." FieldName="RevNo"
                    ...
                    <DataItemTemplate>
                        ...
                        <a href="javascript:void(0);" onclick="OnClickStatus('<%# Container.KeyValue %>')" class="" title="">
                            <span class='ico ColorSeven'><i class='fa fa-check'></i></span><span class='hidden-xs'>Status</span></a><%} %>
                              ...
                              <% if (rights.CanCancel)
                           { %>
                          <a href="javascript:void(0);" onclick="OnCancelClick('<%# Container.KeyValue %>')" class="" title="" style='<%#Eval("InquiryLastEntry")%>'>
                            ...
                            <span class='ico deleteColor'><i class='fa fa-times' aria-hidden='true'></i></span><span class='hidden-xs'>Cancel</span>
                                 ...
                                 <%if (rights.CanClose)
                       { %>
                     <a href="javascript:void(0);" onclick="fn_CloseSalesOrder('<%# Container.KeyValue %>')" title="" class="" style='<%#Eval("InquiryLastEntry")%>'>
           ...
           <SettingsBehavior ConfirmDelete="true" EnableCustomizationWindow="true" EnableRowHotTrack="true" />
            <SettingsCookies Enabled="true" StorePaging="true"  Version="15.5" />
           <%-- -- End of Rev Sayantani --%>
                                ...
                                <table width="">
                                    <tr>
                                        <td style="padding-right: 8px; vertical-align: top">
                                            <strong>
                                                <label style="margin-bottom: 5px">Project Sales Inquiry:-</label></strong>
                                        </td>
