...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form_main">
        <div class="clearfix">
            ...
            <button id="btnPending" data-toggle="tooltip" title="Click to see the pending for invoice details" class="btn btn-badge-color3 btn-radius" type="button" onclick="btn_PendingforInvoiceClick(this);">Pending for Invoice <span class="badge" id="spnPendingforInvoicelvl">0</span></button>
            <button id="btnReadyforInvoice" data-toggle="tooltip" title="Click to see the invoice generated details" class="btn btn-badge-color2 btn-radius" type="button" onclick="btn_InvoiceGeneratedClick(this);">Invoice generated <span class="badge" id="spnInvoiceGeneratedlvl">0</span></button>            
