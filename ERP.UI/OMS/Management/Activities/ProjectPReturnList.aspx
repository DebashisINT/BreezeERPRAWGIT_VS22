...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnAddButtonClick() {
            var url = 'ProjectPReturn.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        function OnMoreInfoClick(keyValue) {
            ...
            if (ActiveUser != null) {
                $.ajax({
                    type: "POST",
                    url: "ProjectPReturnList.aspx/GetEditablePermission",
                    data: "{'ActiveUser':'" + ActiveUser + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
                        var status = msg.d;
                        var url = 'ProjectPReturn.aspx?key=' + keyValue + '&Permission=' + status + '&type=PR';
                        window.location.href = url;
                    }
                });
            }
        ...
        function OnViewClick(keyValue) {
            var url = 'ProjectPReturn.aspx?key=' + keyValue + '&req=V' + '&type=PR';
            window.location.href = url;
        }
