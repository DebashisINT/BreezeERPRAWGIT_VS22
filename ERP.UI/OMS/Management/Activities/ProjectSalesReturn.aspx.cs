...
{
    public partial class ProjectSalesReturn : System.Web.UI.Page
    {
        ...
        ProjectSalesReturnBL objProjectSalesReturnBL = new ProjectSalesReturnBL();
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        lblHeadTitle.Text = "Modify Project Sales Return";
                        ...
                        if (Session["TaggingInvoce"] == "1")
                        {
                            ...
                            DataSet dtProduct = objProjectSalesReturnBL.GetSalesReturnTaggingProductData(strSalesReturnId, Convert.ToString(Session["LastFinYear"]), Convert.ToString(Session["LastCompany"]));
                        ...
                        {
                            DataSet dtProduct = objProjectSalesReturnBL.GetSalesReturnProductData(strSalesReturnId, Convert.ToString(Session["LastFinYear"]), Convert.ToString(Session["LastCompany"]));
                            Productdt = dtProduct.Tables[0];
                            Session["InlineRemarks"] = dtProduct.Tables[1];
                        }
                        ...
                        Session["SR_QuotationAddressDtl"] = objProjectSalesReturnBL.GetSalesReturnBillingAddress(strSalesReturnId); ;
                        ...
                        {
                            lblHeadTitle.Text = "View Project Sales Return";
                    ...
                    else
                    {
                        ...
                        Session["SR_TaxDetails"] = null;
                        CreateDataTaxTable();
                        lblHeadTitle.Text = "Add Project Sales Return";
        ...
        {
            DataTable Dt = new DataTable();
            Dt = objProjectSalesReturnBL.GetSchemaLengthSalesReturn();
            if (Dt != null && Dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in tempQuotation.Rows)
                {
                    ...
                    if (Convert.ToString(dr["IsInventory"]) == "Yes")
                    {
                        if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                        {
                            if (Session["SR_WarehouseData"] != null)
                            {
                                if (strProductQuantity != strWarehouseQuantity && strProductQuantity > 0)
                                {
                ...
                else
                {
                    ...
                    ModifySalesReturn(MainInvoiceID, strSchemeType, UniqueQuotation, strInvoiceDate, strCustomer, strContactName, ProjId,
                        ...
                        /*Rev Work start 13.05.2022 Mantise Issue:0024876: eInvoice enablement in Project Sales Return for EVAC Engineering*/
                                    , drdTransCategory.SelectedValue
            ...
            else if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    if (!string.IsNullOrEmpty(IdKey))
                    {
                        if (IdKey != "ADD")
                        {
                            dt_QuotationDetails = objProjectSalesReturnBL.GetIndentDetailsForPOGridBind(QuoComponent1, IdKey, Product_id1, companyId, fin_year);
                        }
                        else
                        {
                            dt_QuotationDetails = objProjectSalesReturnBL.GetIndentDetailsForPOGridBind(QuoComponent1, IdKey, Product_id1, companyId, fin_year);
            ...
            )
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("prc_ProjectSalesReturn_AddEditNew", con);
        ...
        public void GetAllDropDownDetailForSalesQuotation(string userbranch)
        {
            ...
            dst = objProjectSalesReturnBL.GetAllDropDownDetailForSalesInvoice(userbranchHierarchy, strCompanyID, strBranchID, FinYear);


            ProjectActivitiesBL objSlaesActivitiesBL = new ProjectActivitiesBL();
            DataTable Schemadt = objSlaesActivitiesBL.GetNumberingSchema(strCompanyID, userbranchHierarchy, FinYear, "116", "Y");
        ...
        protected void cmbContactPerson_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (WhichCall == "BindContactPerson")
            {
                ...
                DataTable dtDeuDate = objProjectSalesReturnBL.GetCustomerDetails_InvoiceRelated(InternalId);
                ...
                DataTable OutStandingTable = objProjectSalesReturnBL.GetCustomerOutStanding(InternalId);
                ...
                DataTable GSTNTable = objProjectSalesReturnBL.GetCustomerGSTIN(InternalId);
        ...
        protected void acpContactPersonPhone_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (WhichCall == "ContactPersonPhone")
            {
                ...
                dtContactPersonPhone = objProjectSalesReturnBL.PopulateContactPersonPhone(InternalId);
        ...
        {
            DataSet SalesReturnEdit = objProjectSalesReturnBL.SalesReturnDetailsForEdit(strSalesReturnId);
            ...
            if (SalesReturnEditdt != null && SalesReturnEditdt.Rows.Count > 0)
            {
                ...
                if (Contact_Person_Id != "0")
                {
                    ...
                    DataTable dtContactPersonPhone = new DataTable();
                    dtContactPersonPhone = objProjectSalesReturnBL.PopulateContactPersonPhone(Contact_Person_Id);
                    if (dtContactPersonPhone != null && dtContactPersonPhone.Rows.Count > 0)
                    {
                ...
                DataTable OutStandingTable = objProjectSalesReturnBL.GetCustomerOutStanding(Customer_Id);
                if (OutStandingTable.Rows.Count > 0)
                {
                    pageheaderContent.Attributes.Add("style", "display:block");
                ...
                //gstn
                DataTable GSTNTable = objProjectSalesReturnBL.GetCustomerGSTIN(Customer_Id);
        ...
        protected void ComponentQuotation_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            if (e.Parameter.Split('~')[0] == "BindComponentGrid")
            {
                ...
                DataTable ComponentTable = objProjectSalesReturnBL.GetSRComponent(Customer, SalesReturnDate, strReturnID, branchId);
            ...
            else if (e.Parameter.Split('~')[0] == "BindComponentGridOnSelection")//Subhabrata for binding quotation
            {
                ...
                DataTable dt = objProjectSalesReturnBL.GetNecessaryData(InvoiceIds, strType);
                if (dt != null && dt.Rows.Count > 0)
                {
        ...
        //    DataTable dt = objProjectSalesReturnBL.PopulateCustomerInEditMode(Convert.ToString(Customerid));
        ...
        protected void ComponentDatePanel_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (strSplitCommand == "BindComponentDate")
            {
                ...
                DataTable dt_QuotationDetails = objProjectSalesReturnBL.GetInvoiceDate(Invoice_No);
                ...
                DataTable invoicenumber = objProjectSalesReturnBL.GetInvoiceNumber(Invoice_No);
            ...
            if (strSplitCommand == "BindProductsDetails")
            {
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    if (!string.IsNullOrEmpty(IdKey))
                    {
                        if (IdKey != "ADD")
                        {
                            dt_QuotationDetails = objProjectSalesReturnBL.GetInvoiceDetailsOnly(QuoComponent, "Edit");
                            dtTaxInvoice = objProjectSalesReturnBL.GetTransitSalesInvoiceTaxType(QuoComponent, "Edit");
                        }
                        else
                        {
                            dt_QuotationDetails = objProjectSalesReturnBL.GetInvoiceDetailsOnly(QuoComponent, "Add");
                            dtTaxInvoice = objProjectSalesReturnBL.GetTransitSalesInvoiceTaxType(QuoComponent, "Add");
                        }
        ...
        public IEnumerable GetInvoiceInfo(DataTable SalesInvoicedt1, string Order_Id)
        {
            ...
            for (int i = 0; i < SalesInvoicedt1.Rows.Count; i++)
            {
                ...
                if (eachInvoice.Length == 1)
                {
                    DataTable tempMainTax = objProjectSalesReturnBL.GetTaxDetailsSI(QuoComponent);
        ...
        protected void productLookUp_ItemsRequestedByFilterCondition(object source, ListEditItemsRequestedByFilterConditionEventArgs e)
        {
            if (e.Filter != "")
            {
                ...
                dt = objProjectSalesReturnBL.PopulatePrOnDemand(filter, startindex, EndIndex, Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear1"]));
