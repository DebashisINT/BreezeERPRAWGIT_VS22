...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function CallEWayBill_save() {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectChallanList.aspx/UpdateEWayBillForChallan",
                data: JSON.stringify({
        ...
        function OnGetApprovedRowValues(obj) {
            uri = "ProjectChallan.aspx?key=" + obj + "&status=2" + '&type=SC';
        ...
        function OnGetRejectedRowValues(obj) {
            uri = "ProjectChallan.aspx?key=" + obj + "&status=3" + '&type=SC';
            popup.SetContentUrl(uri);
            popup.Show();
        }
    ...
    <script>
        ...
        function OnMoreInfoClick(keyValue) {
            ...
            if (ActiveUser != null) {
                ...
                //                        if (r == true) {
                //                            var url = 'ProjectChallan.aspx?key=' + keyValue + '&type=SC';
                //                            window.location.href = url;
                //                        }
                //                    });
                //                }
                ...
                //            }
                //        });
                //        var url = 'ProjectChallan.aspx?key=' + keyValue + '&Permission=' + status + '&type=SC';
                //        window.location.href = url;
                //    }
                //});
        ...
        function OnViewClick(keyValue) {
            var url = 'ProjectChallan.aspx?key=' + keyValue + '&req=V' + '&type=SC';
            window.location.href = url;
        }

        function OnAddButtonClick() {
            var url = 'ProjectChallan.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        //});
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <table width="100%">
                                <tr>
                                    <td style="padding-right: 20px">
                                        <label style="margin-bottom: 5px">Project Sales Challan</label>
                                    </td>
                                    <td>
        ...
        <div class="clearfix">
            ...
            <span id="spanStatus" runat="server">
                <a href="javascript:void(0);" onclick="OpenPopUPUserWiseQuotaion()" class="btn btn-info btn-radius">
                    <span>My Project Sales Challan Status</span>
    ...
    <div class="GridViewArea relative">
        ...
        <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
            ContextTypeName="ERPDataClassesDataContext" TableName="v_ProjectChallanList" />
    </div>
    ...
    <div class="PopUpArea">
        ...
        <dxe:ASPxPopupControl ID="PopupUserWiseQuotation" runat="server" ClientInstanceName="cPopupUserWiseQuotation"
            Width="900px" HeaderText="User Wise Project Sales Challan Status" PopupHorizontalAlign="WindowCenter" HeaderStyle-CssClass="wht"
            PopupVerticalAlign="WindowCenter" CloseAction="CloseButton"
            Modal="True" ContentStyle-VerticalAlign="Top" EnableHierarchyRecreation="True"
            ContentStyle-CssClass="pad">
            <ContentCollection>
