<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ServiceContact.aspx.cs" Inherits="ERP.OMS.Management.Activities.ServiceContact" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="JS/OrderCumContractAdd.js?v=10.0"></script>
    <script src="../../Tax%20Details/Js/TaxDetailsItemlevelNew.js?v=2.0" type="text/javascript"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            if (hddnCRmVal == "1") {
                ...
                var AsOnDate = cPLOrderCumContractDate.GetDate().format('yyyy-MM-dd');
                ctxtCustName.SetEnabled(true);
                //Ajax Started
                $.ajax({
                    type: "POST",
                    url: "OrderCumContractAdd.aspx/GetCustomerOutStandingAmount",
            ...
            $('#ddl_numberingScheme').change(function () {
                ...
                cPLOrderCumContractDate.SetDate(dt);

                if (dt < new Date(fromdate)) {
                    cPLOrderCumContractDate.SetDate(new Date(fromdate));
                }

                if (dt > new Date(todate)) {
                    cPLOrderCumContractDate.SetDate(new Date(todate));
                }

                //rev 23903#c18889>>Point#24
                //cdtProjValidFrom.SetMaxDate(dt);
                //cdtProjValidUpto.SetMinDate(dt);
                //if (cPLOrderCumContractDate.GetDate() < cdtProjValidFrom.GetDate()) {
                //    cdtProjValidFrom.Clear();
                //    cdtProjValidFrom.SetMaxDate(dt);
                //}
                //if (cdtProjValidUpto.GetDate() < cPLOrderCumContractDate.GetDate()) {
                ...
                cPLOrderCumContractDate.SetMinDate(new Date(fromdate));
                cPLOrderCumContractDate.SetMaxDate(new Date(todate));
                ...
                if (Currency != CurrencyId) {
                    if (ActiveCurrency != null) {
                        if (CurrencyId != '0') {
                            $.ajax({
                                type: "POST",
                                url: "OrderCumContractAdd.aspx/GetCurrentConvertedRate",
        ...
        function OnEndCallback(s, e) {
            ...
            if (grid.cpSaveSuccessOrFail == "outrange") {
            ...
            else if (grid.cpSaveSuccessOrFail == "PaymentTermsMandatory") {
                grid.cpSaveSuccessOrFail = null;
                jAlert('Cannot proceed. Please enter payment details.', 'Alert', function () {
                    $("#pTermsModel").modal('show');
                });
            }
                ...
                var OrderCumContract_Number = grid.cpOrderCumContractNo;
                var Order_Msg = "Order Cum Contract No. " + OrderCumContract_Number + " saved.";
                if (IsFromActivity == "Y" && value == "E") {
                    $('#hdnRefreshType').val('');
                    if (OrderCumContract_Number != "") {



                        jAlert(Order_Msg, 'Alert Dialog: [OrderCumContract]', function (r) {
                            if (r == true) {
                        ...
                        grid.cpOrderCumContractNo = null;
                    ...
                    if (grid.cpApproverStatus == "approve") {
                        ...
                        $("#Rejectpop").modal('toggle');
                        return
                        //window.parent.popup.Hide();
                        //window.parent.cgridPendingApproval.PerformCallback();
                    }
                    //#endregion Sandip Section For Approval Dtl Section End
                    //window.location.assign("OrderCumContractList.aspx");
                    if (OrderCumContract_Number != "") {
                        ...
                        jAlert(Order_Msg, 'Alert Dialog: [OrderCumContract]', function (r) {
                            ...
                            if (r == true) {
                                ...
                                window.location.assign("OrderCumContractEntityList.aspx");
                    ...
                    // window.location.assign("OrderCumContractAdd.aspx?key=ADD");
...
function BindOrderProjectdata(OrderId, TagDocType) {
    ...
    if ((OrderId != null) && (OrderId != "")) {
        $.ajax({
            type: "POST",
            url: "OrderCumContractAdd.aspx/SetProjectCode",
        ...
        $.ajax({
            type: "POST",
            url: 'OrderCumContractAdd.aspx/getHierarchyID',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function PerformCallToGridBind() {
    ...
    <script>
        function RejectRemarks_click() {
            ...
            var OtherDetail = {};
            OtherDetail.orderid = orderid;
            OtherDetail.RejectRemarks = $("#txtRejectRemarks").val();

            $.ajax({
                type: "POST",
                url: "ServiceContact.aspx/RejectRemarksUpdate",
                data: JSON.stringify(OtherDetail),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-title clearfix">
        ...
        <div id="divcross" runat="server" class="crossBtn"><a href="OrderCumContractEntityList.aspx" id="lnkBack" runat="server"><i class="fa fa-times"></i></a></div>
        ...
        <%-- <div class="crossBtn" id="divcross1" runat="server"><a href="OrderCumContractList.aspx"><i class="fa fa-times"></i></a></div>--%>
    </div>
    <div class="form_main">
                                ...
                                <dxe:ContentControl runat="server">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <dxe:ASPxDateEdit ID="dt_PLSales" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy" DisplayFormatString="dd-MM-yyyy" UseMaskBehavior="True" ClientInstanceName="cPLOrderCumContractDate" Width="100%">
                                                <ButtonStyle Width="13px">
                                                </ButtonStyle>
                                                <ClientSideEvents DateChanged="DateCheck" />
                                                <ClientSideEvents GotFocus="function(s,e){cPLOrderCumContractDate.ShowDropDown();}" />
                                                <%--<ClientSideEvents LostFocus="SetFromToDate" />--%>
                                            </dxe:ASPxDateEdit>
                                            ...
                                            <span id="MandatoryEgSDate" style="display: none" class="validclass">
                                                <img id="3gridHistory_DXPEForm_efnew_DXEFL_DXEditor2114_EI" class="dxEditors_edtError_PlasticBlue" src="/DXR.axd?r=1_36-tyKfc" title="Order Cum Contract date must not be prior date than quotation date" /></span>
                                                    ...
                                                    <dxe:PanelContent runat="server">
                                                        <dxe:ASPxGridLookup ID="lookup_quotation" SelectionMode="Multiple" runat="server" ClientInstanceName="gridquotationLookup"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <dxe:GridViewDataColumn FieldName="Quote_Number" Visible="true" VisibleIndex="1" Caption="Topic" Width="200" Settings-AutoFilterCondition="Contains">
                                                                ...
                                                                <dxe:GridViewDataColumn FieldName="name" Visible="true" VisibleIndex="3" Caption="Customer" Width="200" Settings-AutoFilterCondition="Contains">
                                                                    <Settings AutoFilterCondition="Contains" />
                                                                </dxe:GridViewDataColumn>
                ...
                <div class="col-md-3">
                    ...
                    <dxe:ASPxTextBox ID="txt_Rate" runat="server" TabIndex="11" Width="100%" Enabled="false" Height="28px">
                                        ...
                                        <div class="col-md-2 lblmTop8" id="divposGst">
                                            ...
                                            <span style="color: red">*</span>
                                            <dxe:ASPxComboBox ID="ddl_PosGstOrderCumContract" runat="server" ValueType="System.String" Width="100%" ClientInstanceName="cddl_PosGstOrderCumContract">
                                        ...
                                        <div class="col-md-2 lblmTop8">
                                            <label>
                                                <dxe:ASPxLabel ID="lblprojectValidfrom" runat="server" Text="From" Width="120px" CssClass="inline">
                                                </dxe:ASPxLabel>
                                                <span style="color: red">*</span>
                                            </label>
                                            ...
                                            <%--Mantis Issue 23903#c18889>>Point#24--%>
                                             <span id="MandatorydtProjValidFrom" style="display: none" class="validclass">
                                                <img id="3gridHistory_DXPEForm_efnew_DXEFL_DXEditor2_EI" class="dxEditors_edtError_PlasticBlue" src="/DXR.axd?r=1_36-tyKfc" title="Mandatory" /></span>
                                            <%--End of Mantis Issue 23903#c18889>>Point#24--%>
                                            
                                        </div>
                                        <div class="col-md-2 lblmTop8">
                                            <label>
                                                <dxe:ASPxLabel ID="lblprojectValidUpto" runat="server" Text="To" Width="120px" CssClass="inline">
                                                </dxe:ASPxLabel>
                                                <span style="color: red">*</span>
                                            </label>
                                            ...
                                            <%--Mantis Issue 23903#c18889>>Point#24 --%>
                                          <span id="MandatorydtProjValidUpto" style="display: none" class="validclass">
                                                <img id="3gridHistory_DXPEForm_efnew_DXEFL_DXEditor2_EI" class="dxEditors_edtError_PlasticBlue" src="/DXR.axd?r=1_36-tyKfc" title="Mandatory" /></span>
                                            <%--End of Mantis Issue 23903#c18889>>Point#24--%>
                                        </div>
                                        ...
                                        <div class="col-md-2 lblmTop8">
                                            ...
                                            <dxe:ASPxGridLookup ID="lookup_Project" runat="server" ClientInstanceName="clookup_Project" DataSourceID="EntityServerModeDataOrderCumContract"
                                            ...
                                            <dx:LinqServerModeDataSource ID="EntityServerModeDataOrderCumContract" runat="server" OnSelecting="EntityServerModeDataOrderCumContract_Selecting"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <dxe:ASPxGridView runat="server" KeyFieldName="OrderID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxe:GridViewDataTextColumn Caption="hidden Field Id" EditCellStyle-CssClass="hide" FieldName="ProductID" PropertiesTextEdit-FocusedStyle-CssClass="hide" PropertiesTextEdit-Height="15px" PropertiesTextEdit-Style-CssClass="hide" ReadOnly="True" VisibleIndex="21" Width="0">
                                                    ...
                                                    <dxe:GridViewDataTextColumn Caption="Area" CellStyle-HorizontalAlign="Right" FieldName="Quantity" PropertiesTextEdit-MaxLength="14" VisibleIndex="6" Width="5%">
                                                    ...
                                                    <%--Caption="Warehouse"--%>
<%--                                                    <dxe:GridViewCommandColumn Caption="Stk Details" VisibleIndex="9" Width="4%">
                                                        <CustomButtons>
                                                     ...
                                                     <dxe:GridViewDataComboBoxColumn  Caption="Frequency" FieldName="Frequency" VisibleIndex="7" Width="5%">
                                                        <PropertiesComboBox>
                                                            <Items>
                                                                    <dxe:ListEditItem Value="SELECT" Text="SELECT" Selected="true" />
                                                                    <dxe:ListEditItem Value="DAILY" Text="DAILY" />
                                                                    <dxe:ListEditItem Value="HALF-YEARLY" Text="HALF-YEARLY" />
                                                                    <dxe:ListEditItem Value="MONTHLY ONCE" Text="MONTHLY ONCE" />
                                                                    <dxe:ListEditItem Value="MONTHLY THRICE" Text="MONTHLY THRICE" />
                                                                    <dxe:ListEditItem Value="MONTHLY TWISE" Text="MONTHLY TWISE" />
                                                                    <dxe:ListEditItem Value="QUARTERLY ONCE" Text="QUARTERLY ONCE" />
                                                                    <dxe:ListEditItem Value="SINGLE-ONCE" Text="SINGLE-ONCE" />
                                                                    <dxe:ListEditItem Value="WEEKLY ONCE" Text="WEEKLY ONCE" />
                                                                    <dxe:ListEditItem Value="WEEKLY THRICE" Text="WEEKLY THRICE" />
                                                                    <dxe:ListEditItem Value="WEEKLY TWISE" Text="WEEKLY TWISE" />
                                                                    <dxe:ListEditItem Value="YEARLY THRICE" Text="YEARLY THRICE" />
                                                            </Items>
                                                            
                                                        </PropertiesComboBox>
                                                    </dxe:GridViewDataComboBoxColumn>

                                                    <dxe:GridViewDataTextColumn Caption="# Of Service"  HeaderStyle-HorizontalAlign="Right" CellStyle-HorizontalAlign="Right" FieldName="NoOfService" VisibleIndex="10" Width="7%">
                                                    ...
                                                    <dxe:GridViewDataTextColumn Caption="Sale Price"  HeaderStyle-HorizontalAlign="Right" CellStyle-HorizontalAlign="Right" FieldName="SalePrice" VisibleIndex="11" Width="7%">
                                                    ...
                                                    <dxe:GridViewDataTextColumn Caption="Add/Less Amt"  HeaderStyle-HorizontalAlign="Right" FieldName="Discount"  VisibleIndex="12" Width="4%">
                                                        <PropertiesTextEdit DisplayFormatString="0.00" Style-HorizontalAlign="Right">
                                                    ...
                                                    <dxe:GridViewDataTextColumn Caption="Amount"  HeaderStyle-HorizontalAlign="Right" CellStyle-HorizontalAlign="Right" FieldName="Amount" VisibleIndex="13" Width="8%">
                                                        <PropertiesTextEdit DisplayFormatString="0.00" Style-HorizontalAlign="Right">
                                                            <MaskSettings AllowMouseWheel="False" Mask="&lt;0..999999999&gt;.&lt;00..99&gt;" />
                                                            <Style HorizontalAlign="Right">
                                                            </Style>
                                                    ...
                                                    <dxe:GridViewDataButtonEditColumn Caption="Charges"  HeaderStyle-HorizontalAlign="Right" FieldName="TaxAmount" VisibleIndex="14" Width="7%" ReadOnly="true">
                                                        <PropertiesButtonEdit>
                                                    ...
                                                    <dxe:GridViewDataTextColumn Caption="Net Amount" HeaderStyle-HorizontalAlign="Right" CellStyle-HorizontalAlign="Right" FieldName="TotalAmount" ReadOnly="true" VisibleIndex="15" Width="8%">
                                                        <PropertiesTextEdit DisplayFormatString="0.00" Style-HorizontalAlign="Right" >
                                                            <MaskSettings AllowMouseWheel="False" Mask="&lt;0..999999999&gt;.&lt;00..99&gt;" />
                                                            <Style HorizontalAlign="Right">
                                                            </Style>
                                                    ...
                                                    <dxe:GridViewDataTextColumn Caption="Remarks" FieldName="ProjectRemarks" Width="12%" PropertiesTextEdit-MaxLength="5000" VisibleIndex="16">
                                                    ...
                                                    <dxe:GridViewCommandColumn Caption=" " ShowDeleteButton="false" ShowNewButtonInHeader="false" VisibleIndex="17" Width="2%">
                                                        <CustomButtons>
                                                    ...
                                                    <dxe:GridViewDataTextColumn Caption="Stock Qty" FieldName="StockQuantity" VisibleIndex="18" Width="0">
                                                        <PropertiesTextEdit DisplayFormatString="0.00">
                                                        </PropertiesTextEdit>
                                                        <PropertiesTextEdit>
                                                        </PropertiesTextEdit>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn Caption="Stock UOM" FieldName="StockUOM" ReadOnly="true" VisibleIndex="19" Width="0">
                                                        <PropertiesTextEdit>
                                                        </PropertiesTextEdit>
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn Caption="QuoteDetailsId" FieldName="QuoteDetails_Id" ReadOnly="true" VisibleIndex="20" Width="0">
                                                        <PropertiesTextEdit>
                                                        </PropertiesTextEdit>
                                                    </dxe:GridViewDataTextColumn>
                                                </Columns>
                        ...
                        <settingsediting mode="Batch" newitemrowposition="Bottom">
                            <BatchEditSettings ShowConfirmOnLosingChanges="false"  EditMode="row" />
                                        ...
                                        <div class="col-md-12" id="divSubmitButton" runat="server">
                                            ...
                                            <dxe:ASPxButton ID="ASPxButton8" ClientInstanceName="btn_Extra" runat="server" AccessKey="X" AutoPostBack="False" Text="Other Details" CssClass="btn btn-primary hide" meta:resourcekey="btnSaveRecordsResource1" UseSubmitBehavior="False">
                                                <ClientSideEvents Click="function(s, e) {ShopOtherDetails();}" />
                                            </dxe:ASPxButton>
                                            <button class="btn btn-primary" type="button" style="background-image: none !important;background-color: #428bca;" data-toggle="modal" data-target="#pTermsModel">Payment Terms</button>
                        ...
                        <dxe:TabPage Name="[B]illing/Shipping" Text="Billing/Service">
                            <ContentCollection>
                                <dxe:ContentControl runat="server">
	...
	closeWarehouse(s, e);}" />
            ...
            <div>
                ...
                <asp:HiddenField runat="server" ID="hddnAsOnDate" />
                 <asp:HiddenField runat="server" ID="ServiceContactFromEntity" />
                <%--kaushik 24-2-2017 --%>
    ...
    <%--  <asp:SqlDataSource ID="sqlQuationList" runat="server"  
        SelectCommand="prc_GetQuotationOnOrderCumContract" 
     ...
     <div class="modal fade" id="Segment1Model" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Segment1 Search</h4>
                </div>
                <div class="modal-body">
      ...
      <div class="modal fade" id="Segment2Model" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Segment2 Search</h4>
                </div>
                <div class="modal-body">
      ...
      <div class="modal fade" id="Segment3Model" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Segment3 Search</h4>
                </div>
                <div class="modal-body">
      ...
      <div class="modal fade" id="Segment4Model" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Segment4 Search</h4>
                </div>
                <div class="modal-body">
      ...
      <div class="modal fade" id="Segment5Model" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Segment5 Search</h4>
                </div>
                <div class="modal-body">
...
<div id="tstModel" class="modal fade pmsModal w90" role="dialog">
 <div class="modal-dialog">
   <!-- Modal content-->
   <div class="modal-content">
     <div class="modal-header">
     ...
     <div class="modal-body">
         <table style="width:100%;border:1px solid #333;" class="mtTable">
             <tr>
                 <td>Type of Premises :  </td>
                 <td><span>
                     <dxe:ASPxTextBox ID="txtTypeOfPremises" runat="server" ClientInstanceName="ctxtTypeOfPremises" Width="100%" MaxLength="30">                                               
                     </dxe:ASPxTextBox>

                     </span></td>
                 <td>Industry</td>
                 <td><span>
                     <dxe:ASPxTextBox ID="txtIndustry" runat="server" ClientInstanceName="ctxtIndustry" Width="100%" MaxLength="30">                                               
                     </dxe:ASPxTextBox>
                      </span></td>
             </tr>
             <tr>
                 ...
                 <td><span>
                      <dxe:ASPxTextBox ID="txtTreatmentArea" runat="server" ClientInstanceName="ctxtTreatmentArea" Width="100%" MaxLength="30">                                               
                     </dxe:ASPxTextBox>

                     </span></td>
                 <td>Order Type: New/Return</td>
                 <td>
                     <span>
                     <dxe:ASPxTextBox ID="txtOrderType" runat="server" ClientInstanceName="ctxtOrderType" Width="100%" MaxLength="30">                                               
                     </dxe:ASPxTextBox>
                     </span></td>
             </tr>
             <tr>
                 ...
                 <td >
                     <span>
                     <dxe:ASPxTextBox ID="txtTypeofService" runat="server" ClientInstanceName="ctxtTypeofService" Width="100%" MaxLength="30">                                               
                     </dxe:ASPxTextBox>
             ...
             <tr>
               ...
               <td ><span>
                   <dxe:ASPxTextBox ID="txtServiceFrequency" runat="server" ClientInstanceName="ctxtServiceFrequency" Width="100%" MaxLength="30">                                               
                     </dxe:ASPxTextBox>
             ...
             <tr>
               ...
               <td "><span>
                   <dxe:ASPxTextBox ID="txtServiceInstruction" runat="server" ClientInstanceName="ctxtServiceInstruction" Width="100%" MaxLength="30">                                               
                     </dxe:ASPxTextBox>
             ...
             <tr>
                 <td>Contact Period (From) : </td>
                  <td><span>
                      <dxe:ASPxTextBox ID="txtContactPeriod" runat="server" ClientInstanceName="ctxtContactPeriod" Width="100%" MaxLength="30">                                               
                     </dxe:ASPxTextBox>


                      </span></td>
                 <td>Contact </td>
                  <td><span><input type="text" class="inText" /> </span></td>
             </tr>
             <tr>
                 <td>Contact Period (To) : </td>
                  <td><span><input type="text" class="inText" /> </span></td>
                 <td>(%) </td>
                  <td><span><input type="text" class="inText" /> </span></td>
             </tr>
             ...
             <tr>
                 <td>1st Service date and Time : </td>
                  <td><span><input type="text" class="inText" /> </span></td>
                 <td>Industry </td>
                  <td><span><input type="text" class="inText" /> </span></td>
             </tr>
    ...
    <!-- payment terms modal -->
<div id="pTermsModel" class="modal fade pmsModal w90" role="dialog">
 <div class="modal-dialog">
   <!-- Modal content-->
   <div class="modal-content">
     <div class="modal-header">
     ...
     <div class="modal-body">
         <div class="row">
             <div class="col-sm-2">
                 ...
                 <div>
                     <dxe:ASPxComboBox runat="server" ID="ddlInterval" ClientInstanceName="cddlInterval">
                         <Items>
                             <dxe:ListEditItem Text="Select" Value="Select" Selected="true" />
                             <dxe:ListEditItem Text="Advance" Value="Advance" />
                             <dxe:ListEditItem Text="Monthly" Value="Monthly" />
                             <dxe:ListEditItem Text="Bi-Monthly" Value="Bi-Monthly" />
                             <dxe:ListEditItem Text="Quaterly" Value="Quaterly" />
                             <dxe:ListEditItem Text="Half Yearly" Value="Half Yearly" />
                             <dxe:ListEditItem Text="Yearly" Value="Yearly" />
                             <dxe:ListEditItem Text="On Service Completion" Value="On Service Completion" />
             ...
             <div class="col-sm-2">
                 ...
                 <div>
                     <dxe:ASPxSpinEdit ID="txtPercentage"  MinValue="0" AllowNull="false" AllowMouseWheel="true" DecimalPlaces="2"  UseMaskAsDisplayFormat="true" DisplayFormatString="0.00" MaxValue="100" ClientInstanceName="ctxtPercentage" runat="server" Width="100%">
             ...
             <div class="col-sm-2 hide">
                 <label>Days</label>
                 <div>
                     <dxe:ASPxTextBox ID="txtDays" ClientInstanceName="ctxtDays" runat="server" Width="100%"></dxe:ASPxTextBox>
                 </div>
             </div>
             <div class="col-sm-2">
                 <label>Date</label>
                 <div>
                     <dxe:ASPxDateEdit ID="dtDate" ClientInstanceName="cdtDate" EditFormatString="dd-MM-yyyy" DisplayFormatString="dd-MM-yyyy" runat="server" Width="100%"></dxe:ASPxDateEdit>
                 </div>
             </div>
             <div class="col-sm-2">
                 <label>No of Service</label>
                 <div>
                     <dxe:ASPxTextBox ID="txtNoOfService" ClientInstanceName="ctxtNoOfService" runat="server" Width="100%"></dxe:ASPxTextBox>
                 </div>
             </div>
             <div class="col-sm-2" style="padding-top:15px">
                 <button type="button" class="btn btn-success" onclick="AddPaymentTerms()">Add</button>
             </div>
         </div>
         <div class="row">
             <div class="col-md-12">                
                 ...
                 <dxe:ASPxGridView ID="GridPaymentSchedule" runat="server" KeyFieldName="ID" AutoGenerateColumns="False"
                            Width="100%" ClientInstanceName="cGridPaymentSchedule" OnCustomCallback="GridPaymentSchedule_CustomCallback" OnDataBinding="GridPaymentSchedule_DataBinding"
                            SettingsPager-Mode="ShowAllRecords" Settings-VerticalScrollBarMode="auto" Settings-VerticalScrollableHeight="200" SettingsBehavior-AllowSort="false">
                            <Columns>
                                <dxe:GridViewDataTextColumn Caption="Interval" FieldName="Interval"
                                    VisibleIndex="0" HeaderStyle-HorizontalAlign="Right">
                                    <PropertiesTextEdit Style-HorizontalAlign="Right"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Day(s)" FieldName="Days" Visible="false"
                                    VisibleIndex="2">
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" Caption="Date" FieldName="Date"
                                    VisibleIndex="3">
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="No. Of Service" FieldName="PaymentNoOfService"
                                    VisibleIndex="3" HeaderStyle-HorizontalAlign="Right">
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="10" Width="80px" Caption="Action">
                                    <DataItemTemplate>
                                        <a href="javascript:void(0);" onclick="Delete_PaymentTermLine('<%# Container.KeyValue %>')" title="Delete">
                                            <img src="/assests/images/crs.png" /></a>
                                    </DataItemTemplate>
                                </dxe:GridViewDataTextColumn>
                            </Columns>
                            <ClientSideEvents EndCallback="PayementTermEndCallBack" />
                            <SettingsPager Visible="false"></SettingsPager>
                            <SettingsLoadingPanel Text="Please Wait..." />
                        </dxe:ASPxGridView>
         ...
         <div class="row">
             <div class="col-md-12">
                 <label>Remarks</label>
                 <div>
                     <dxe:ASPxMemo class="form-control" ID="txtPaymentRemarks" ClientInstanceName="ctxtPaymentRemarks" style="height:70px" Width="100%" runat="server" MaxLength="500"></dxe:ASPxMemo>
                 </div>
             </div>
         </div>
     </div>
     <div class="modal-footer">
       <button type="button" class="btn btn-success"  onclick="SavePaymentTerms()">Save & Close</button>
     </div>
   </div>
 </div>
</div>
     ...
     <div class="modal fade pmsModal w30" id="Rejectpop" role="dialog" aria-labelledby="assignpop" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row ">
                        <div class="col-md-12 mTop5">
                            ...
                            <div class="fullWidth">
                                <textarea class="form-control" id="txtRejectRemarks" maxlength="500" rows="5"></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" onclick="RejectRemarks_click();">Confirm</button>
                </div>
            </div>
        </div>
    </div>
