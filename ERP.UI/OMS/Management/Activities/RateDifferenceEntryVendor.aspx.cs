...
{
    public partial class RateDifferenceEntryVendor : System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/RateDifferenceEntryVendor.aspx");
            ...
            if (!IsPostBack)
            {
                ...
                string BackDatedEntryPurchaseReturnManual = cbl.GetSystemSettingsResult("BackDatedEntryRDEV");
               ...
               // ddl_AmountAre.ClientEnabled = false;
                ...
                this.Session["LastCompanyRDEV"] = Session["LastCompany"];
                this.Session["LastFinYearRDEV"] = Session["LastFinYear"];
                ...
                Session["RDEV_BillingAddressLookup"] = null;
                Session["RDEV_ShippingAddressLookup"] = null;
                ...
                Session["RDEV_ReturnID"] = "";
                Session["RDEV_CustomerDetail"] = null;
                Session["RDEV_ReturnDetails"] = null;
                Session["RDEV_WarehouseData"] = null;
                Session["RDEV_QuotationTaxDetails"] = null;
                Session["LoopRDEVWarehouse"] = 1;
                Session["RDEV_TaxDetails"] = null;
                Session["RDEV_FinalTaxRecord"] = null;
                Session["RDEV_ActionType"] = "";
                Session["RDEV_ComponentData"] = null;
                Session["TaggingRateDifferenceEntryVendorWithSTK"] = "";

                Session["RDEVwarehousedetailstemp"] = null;
                Session["RDEVwarehousedetailstempUpdate"] = null;
                Session["RDEVwarehousedetailstempDelete"] = null;

                

                Session["RateDifferenceEntryVendorWithStkAddressDtl"] = null;
                ...
                Session["RDEV_QuotationAddressDtl"] = null;
                ...
                if (Request.QueryString["key"] != null)
                {
                    ...
                    //  ComponentQuotationPanel.Enabled = false;
                      //  rdl_PurchaseInvoice.SelectedValue = "SIN";
                        ...
                        Keyval_internalId.Value = "RateDifferenceEntryVendor" + strPurchaseReturnId;
                        #region Subhra Section
                        Session["RDEV_key_QutId"] = strPurchaseReturnId;
                        ...
                        Session["RDEV_ReturnID"] = strPurchaseReturnId;
                        Session["RDEV_ActionType"] = "Edit";
                        SetPurchaseReturnDetails(strPurchaseReturnId);
                        //  DateTime quoteDate = Convert.ToDateTime(dt_PLQuote.Date.ToString("dd/MM/yyyy"));
                        Session["RDEV_TaxDetails"] = GetTaxDataWithGST(GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd")));

                        DataSet ProducDts = new DataSet();
                        DataTable Productdt = new DataTable();

                        DataTable Calculate_dt = new DataTable();

                        DataTable Closed_dt = new DataTable();
                        if (Session["TaggingRateDifferenceEntryVendorWithSTK"] == "1")
                        {

                            if (Convert.ToString(Session["DocType"]) == "TPI")
                            {
                            ProducDts = objPurchaseReturnBL.GetPurchaseReturnTransitIssueTaggingProductData(strPurchaseReturnId, Convert.ToString(Session["LastFinYear"]), Convert.ToString(Session["LastCompany"]));
                            
                        Productdt=ProducDts.Tables[0];
                            Calculate_dt = ProducDts.Tables[2];

                            Closed_dt = ProducDts.Tables[3];
                            }
                            else {
                             ProducDts = objPurchaseReturnBL.GetPurchaseReturnIssueTaggingProductData(strPurchaseReturnId, Convert.ToString(Session["LastFinYear"]), Convert.ToString(Session["LastCompany"]));
                        ...
                        {
                            ProducDts = objPurchaseReturnBL.GetPurchaseReturnProductData(strPurchaseReturnId, Convert.ToString(Session["LastFinYear"]), Convert.ToString(Session["LastCompany"]));
                        ...
                        CalculateReturnAmount(Calculate_dt);
                        
                        Session["RDEV_ReturnDetails"] = Productdt;
                        grid.DataSource = GetQuotation(Productdt);
                        grid.DataBind();

                        DataTable dt = GetQuotationWarehouseData();
                        Session["RDEV_WarehouseData"] = dt;

                        Session["RDEV_QuotationAddressDtl"] = objPurchaseReturnBL.GetPurchaseReturnBillingAddress(strPurchaseReturnId); ;
                        ...
                        if (GetQuotationTaxData().Tables[0] != null)
                            Session["RDEV_QuotationTaxDetails"] = GetQuotationTaxData().Tables[0];
                        ...
                        if (GetQuotationEditedTaxData().Tables[0] != null)
                        {
                            ...
                            {
                                Session["RDEV_FinalTaxRecord"] = quotetable;
                            }
                        }
                        ...
                        {
                            lblHeadTitle.Text = "View Rate Difference Entry Vendor";
                    ...
                    else
                    {
                        ...
                        if (Session["RDEV_SaveMode"] != null)  // it has been removed from coding side of Quotation list 
                        {
                            if (Session["RDEV_schemavalue"] != null)  // it has been removed from coding side of Quotation list 
                            {
                                ddl_numberingScheme.SelectedValue = Convert.ToString(Session["RDEV_schemavalue"]); // it has been removed from coding side of Quotation list 
                            }
                            if (Convert.ToString(Session["RDEV_SaveMode"]) == "A")
                            {
                                dt_PLQuote.Focus();
                                txt_PLQuoteNo.Enabled = false;
                                txt_PLQuoteNo.Text = "Auto";
                            }
                            else if (Convert.ToString(Session["RDEV_SaveMode"]) == "M")
                            {
                        ...
                        Session["RDEV_ActionType"] = "Add";
                        //ASPxButton2.Enabled = false;
                        Session["RDEV_TaxDetails"] = null;
                        CreateDataTaxTable();
                        lblHeadTitle.Text = "Add Rate Difference Entry Vendor";
        ...
        #endregion
        public void CalculateReturnAmount(DataTable dt)
        {
            if (dt != null && dt.Rows.Count > 0)
            {
                string PurchasePrice = Convert.ToString(dt.Rows[0]["PurchasePrice"]);
                ...
                txt_TotalNPrice.Text = PurchasePrice;
                txt_TotalNCharges.Text = ProductTaxAmount;
                txt_TotalNAmount.Text = ProductAmount;
                txt_TotalNAmt.Text = NetAmount;
        ...
        public void SetPurchaseReturnDetails(string strPurchaseReturnId)
        {
            ...
            if (PurchaseReturnEditdt != null && PurchaseReturnEditdt.Rows.Count > 0)
            {
                ...
                string DocType = Convert.ToString(PurchaseReturnEditdt.Rows[0]["DocType"]);
                ...
                hdnRDVendGSTIN.Value = Convert.ToString(PurchaseReturnEditdt.Rows[0]["GSTIN"]);
                ...
                if (DocType != "") rdl_PurchaseInvoice.SelectedValue = DocType;
                //if (InvoiceCreatedFromDoc != "") rdl_SaleInvoice.SelectedValue = InvoiceCreatedFromDoc;
                if (string.IsNullOrEmpty(InvoiceCreatedFromDocDate))
                {
                    txt_InvoiceDate.Text = "Multiple Dates"; 
                   
                }
                else { txt_InvoiceDate.Text = InvoiceCreatedFromDocDate; }
                ...
                if (!String.IsNullOrEmpty(InvoiceCreatedFromDoc_Ids))
                {
                    ...
                    if (eachQuo.Length > 1)//More tha one quotation
                    {
                        ...
                        else { BindLookUp(Customer_Id, Convert.ToDateTime(Quote_Date).ToString("yyyy-MM-dd"), StockOutBranch_Id, DocType); }

                        foreach (string val in eachQuo)
                        {
                            lookup_quotation.GridView.Selection.SelectRowByKey(Convert.ToInt32(val));
                        }
                        Session["TaggingRateDifferenceEntryVendorWithSTK"] = "1";
                    }
                    ...
                    else//No Quotation selected
                    {
                        ...
                        //  BindLookUp(Customer_Id, Convert.ToDateTime(Quote_Date).ToString("yyyy-MM-dd"), Branch_Id);
                        Session["TaggingRateDifferenceEntryVendorWithSTK"] = "0";
                    }
                }
                ...
                DataTable dtt = GetProjectEditData(strPurchaseReturnId);
        ...
        public DataTable GetProjectEditData(string PurchaseReturnId)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_CRMPurchaseReturnRD");
            proc.AddVarcharPara("@Action", 500, "ProjectEditdataRateDifference");
            proc.AddVarcharPara("@DeletePurchaseReturnId", 500, PurchaseReturnId);
            dt = proc.GetTable();
            return dt;
        }
        public DataTable GetInvoiceWarehouse(string strInvoiceList)
        {
            try
            {
                ...
                Session["LoopRDEVWarehouse"] = Convert.ToString(Convert.ToInt32(strNewVal) + 1);
                return tempdt;
            }
            catch
            {
        ...
        protected void BindLookUp(string Customer, string SalesReturnDate, string branchId,string doctype)
        {
            //   string branchId = Convert.ToString(ddl_Branch.SelectedValue);
            string strReturnID = Convert.ToString(Session["RDEV_ReturnID"]);
            string RequestNo = Convert.ToString(cmbRequest.Value);
            ...
            {
                if (doctype=="TPI")
                { ComponentTable = objPurchaseReturnBL.GetTransitPurchaseRDEVInvoice(Customer, SalesReturnDate, strReturnID, branchId, type); }
                else { ComponentTable = objPurchaseReturnBL.GetPurchaseRDEVInvoice(Customer, SalesReturnDate, strReturnID, branchId, type); }
               
            }

            lookup_quotation.GridView.Selection.CancelSelection();
            Session["RDEV_ComponentData"] = ComponentTable;
        ...
        public bool CheckrefCreditNoteNo(string vendorid, string RefCreditNoteno)
        {
            ...
            if (vendorid != "" && Convert.ToString(RefCreditNoteno).Trim() != "")
            {
                ...
                else if (hdnADDEditMode.Value == "Edit")
                {
                    ...
                    PurchaseReturnID = Convert.ToString(Session["RDEV_ReturnID"]);
                }
        ...
        {
            Boolean inUse = false;
            DataTable taxTable = (DataTable)Session["RDEV_FinalTaxRecord"];
            ...
            Session["RDEV_FinalTaxRecord"] = taxTable;
        ...
        public void ImplementTaxonTaggingTRDEV(int id, int slno)
        {
            Boolean inUse = false;
          //  DataTable taxTable = (DataTable)Session["RDEV_FinalTaxRecord"];
            ProcedureExecute proc = new ProcedureExecute("prc_taxReturnTable");
            proc.AddVarcharPara("@Module", 80, "TransitPurchaseInvoiceRDEV");
            proc.AddIntegerPara("@id", id);
            proc.AddIntegerPara("@slno", slno);
            proc.AddBooleanPara("@inUse", true, QueryParameterDirection.Output);
            ...
            Session["RDEV_FinalTaxRecord"] = returnedTable;

           
        }

        public bool ImplementTaxonTaggingRDEV(int id, int slno)
        {
            Boolean inUse = false;
            DataTable taxTable = (DataTable)Session["RDEV_FinalTaxRecord"];
            ProcedureExecute proc = new ProcedureExecute("prc_taxReturnTable");
        ...
        public IEnumerable GetInvoiceInfo(DataTable SalesInvoicedt1, string Order_Id)
        {
            ...
            for (int i = 0; i < SalesInvoicedt1.Rows.Count; i++)
            {
                ...
                var SelectedPurchaseInvoiceType = rdl_PurchaseInvoice.SelectedValue;

                if (SelectedPurchaseInvoiceType=="PI")
                { 
                ...
                else  if (SelectedPurchaseInvoiceType == "TPI")
                {
                    if (ImplementTaxonTaggingRDEV(Convert.ToInt32(strQuoteDetails_Id), Convert.ToInt32(Orders.SrlNo)))
                    {
                        Orders.TaxAmount = "0.00";
                    }
                }
                ...
                if (eachPurchaseChallan.Length == 1)
                {
                    ...
                    {
                        Session["RDEV_TaxDetails"] = tempMainTax;

                    }

                }
                else { Session["RDEV_TaxDetails"] = null; }
                ...
                //    Session["RDEV_WarehouseData"] = tempWarehouse;
        ...
        public DataSet GetQuotationData()
        {
            ...
            proc.AddVarcharPara("@QuotationID", 500, Convert.ToString(Session["RDEV_ReturnID"]));
            ds = proc.GetDataSet();
            return ds;
        }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (Session["RDEV_ReturnDetails"] != null)
            {
                Quotationdt = (DataTable)Session["RDEV_ReturnDetails"];
            }
            else
            {
            ...
            Session["RDEV_ReturnDetails"] = Quotationdt;
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                string ActionType = Convert.ToString(Session["RDEV_ActionType"]);
                string MainInvoiceID = Convert.ToString(Session["RDEV_ReturnID"]);
                ...
                string strComponenyType = Convert.ToString(rdl_PurchaseInvoice.SelectedValue);
                ...
                foreach (DataRow dr in tempQuotation.Rows)
                {
                    ...
                    if (Status == "I")
                    {
                        ...
                        string[] listDis = Convert.ToString(dr["ProductDisID"]).Split(new string[] { "||@||" }, StringSplitOptions.None);
                        ...
                        dr["ProductDisID"] = Convert.ToString(listDis[0]);
                    }
                ...
                if (Session["RDEV_FinalTaxRecord"] != null)
                {
                    TaxDetailTable = (DataTable)Session["RDEV_FinalTaxRecord"];

                    string incluexclutype = "N";
                    if (ddl_AmountAre.Value == "1")
                    {
                        incluexclutype = "E";
                    }
                    else if (ddl_AmountAre.Value == "2")
                    {
                        incluexclutype = "I";
                    }
                    ...
                    //TaxDetailTable = gstTaxDetails.SetTaxTableDataWithProductSerialForPurchaseRoundOff(
                    //    ref tempQuotation, 
                    //    "SrlNo", "ProductID", "Amount", "TaxAmount", "TotalAmount", TaxDetailTable, "P",
                    //    dt_PLQuote.Date.ToString("yyyy-MM-dd"), ddl_Branch.SelectedValue, ShippingState, 
                    //    incluexclutype, Convert.ToString(hdnCustomerId.Value));


                    TaxDetailTable = gstTaxDetails.SetTaxTableDataWithProductSerialForPurchaseRoundOffWithException(
                       ref tempQuotation,
                       "SrlNo", "ProductID", "Amount", "TaxAmount", "TotalAmount", TaxDetailTable, "P",
                       dt_PLQuote.Date.ToString("yyyy-MM-dd"), ddl_Branch.SelectedValue, ShippingState,
                       incluexclutype, Convert.ToString(hdnCustomerId.Value), "Quantity", "PO");   
                ...
                if (Session["RDEV_TaxDetails"] != null)
                {
                           

                    TaxDetailsdt = (DataTable)Session["RDEV_TaxDetails"];
                }
                else
                {
                ...
                ////DataTable tempBillAddress = new DataTable();
                ////if (Session["RDEV_QuotationAddressDtl"] != null)
                ////{
                ////    tempBillAddress = (DataTable)Session["RDEV_QuotationAddressDtl"];
                ////}
                ////else
                ////{
               ...
               .Select(g => g.Key);
                ...
                DataTable taxexceltioncheck = new DataTable();
                taxexceltioncheck = tempQuotation;
                if (taxexceltioncheck.Columns.Contains("DetailsId"))
                {
                    taxexceltioncheck.Columns.Remove("DetailsId");
                    taxexceltioncheck.AcceptChanges();
                }

                if (taxexceltioncheck.Columns.Contains("ReturnDetails_InlineRemarks"))
                {
                    taxexceltioncheck.Columns.Remove("ReturnDetails_InlineRemarks");
                    taxexceltioncheck.AcceptChanges();
                }
                ...
                procT.AddVarcharPara("@Action", 500, "RDEVGetTaxDetailsByProductID");
                procT.AddPara("@RDEVProductDEtails", taxexceltioncheck);
                ...
                if (validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "duplicateProduct" || validate == "nullAmount" || validate == "nullQuantity" || validate == "transporteMandatory" || validate == "checkAddress" || validate == "checkAcurateTaxAmount")
                {
                ...
                else
                {
                    ...
                    #region To Show By Default Cursor after SAVE AND NEW
                    if (Convert.ToString(Session["RDEV_ActionType"]) == "Add") // session has been removed from quotation list page working good
                    {
                        string[] schemaid = new string[] { };
                        string schemavalue = ddl_numberingScheme.SelectedValue;
                        Session["RDEV_schemavalue"] = schemavalue;        // session has been removed from quotation list page working good
                        ...
                        if (hdnRefreshType.Value == "N")
                        {
                            if (schematype == "1")
                            {
                                Session["RDEV_SaveMode"] = "A";
                            }
                            else
                            {
                                Session["RDEV_SaveMode"] = "M";
                            }
                        }
                    }
                    ...
                    ModifyPurchaseReturn(MainInvoiceID, strSchemeType, UniqueQuotation, strInvoiceDate, strCustomer, strContactName,
                                    Reference, strBranch, strStockOutBranch, strAgents, strCurrency, strRate, strTaxType, strTaxCode, strComponenyType,
                                    ...
                                    approveStatus, ActionType, strBr,ProjId, ref strIsComplete, ref strQuoteID, ReasonforReturn, refCreditNoteNo, refCreditNoteNoDate);



                    grid.JSProperties["cpRateDiffVendID"] = strQuoteID;
        ...
        public void GetQuantityBaseOnProduct(string strProductSrlNo, ref decimal WarehouseQty)
        {
            ...
            if (Session["RDEV_WarehouseData"] != null)
            {
                Warehousedt = (DataTable)Session["RDEV_WarehouseData"];
        ...
        protected void grid_DataBinding(object sender, EventArgs e)
        {
            ...
            if (Session["RDEV_ReturnDetails"] != null)
            {
                DataTable Quotationdt = (DataTable)Session["RDEV_ReturnDetails"];
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (strSplitCommand == "RemoveDisplay")
            {
                ...
                if (Session["RDEV_ReturnDetails"] != null)
                {
                    purchaseReturndt = (DataTable)Session["RDEV_ReturnDetails"];
                }
                ...
                Session["RDEV_ReturnDetails"] = purchaseReturndt;
                grid.DataBind();
            ...
            else if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    DataSet dts_QuotationDetails = new DataSet();
                    DataSet dtTs_QuotationDetails = new DataSet();
                    string RequestNo = Convert.ToString(cmbRequest.Value);
                    DataTable ComponentTable = new DataTable();
                    DataTable Calculate_dt = new DataTable();
                    if (RequestNo != "")
                    ...
                    else
                    {
                        ...
                        if (Quote_Type == "PI")
                        {
                             dts_QuotationDetails = objPurchaseReturnBL.GetIndentDetailsForDSPOGridBind(QuoComponent1, IdKey, InvoiceDetails_Id, companyId, fin_year);
                            if (!string.IsNullOrEmpty(IdKey))
                            {
                                if (IdKey != "ADD")
                                {
                                    dt_QuotationDetails = dts_QuotationDetails.Tables[0];

                                     Calculate_dt = dts_QuotationDetails.Tables[1];

                                     _Amount = CalculateInvoiceAmount(Calculate_dt);
                                ...
                                else
                                {
                                  ...
                                  //  dt_QuotationDetails = objPurchaseReturnBL.GetIndentDetailsForPOGridBind(QuoComponent1, IdKey, InvoiceDetails_Id, companyId, fin_year);
                                    ...
                                    var PIVID = QuoComponent1.Split(',')[0];
                                    string strType = "PI";
                                    DataTable dt = objPurchaseReturnBL.GetNecessaryData(PIVID, strType);
                            ...
                            grid.JSProperties["cpInvoiceRunningBalance"] = _Amount;
                        }
                        else  if (Quote_Type == "TPI")
                        {
                            dtTs_QuotationDetails = objPurchaseReturnBL.GetIndentDetailsForDSTPRGridBind(QuoComponent1, IdKey, InvoiceDetails_Id, companyId, fin_year);
                            if (!string.IsNullOrEmpty(IdKey))
                            {
                                if (IdKey != "ADD")
                                {
                                    dt_QuotationDetails = dtTs_QuotationDetails.Tables[0];

                                    Calculate_dt = dtTs_QuotationDetails.Tables[1];
                                    _Amount = CalculateInvoiceAmount(Calculate_dt);
                                   // dt_QuotationDetails = objPurchaseReturnBL.GetIndentDetailsForTPRGridBind(QuoComponent1, IdKey, InvoiceDetails_Id, companyId, fin_year);
                                }
                                else
                                {
                ...
                //Session["RDEV_QuotationAddressDtl"] = GetComponentEditedAddressData(InvoiceDetails_Id, "PC");
                //if (Session["RDEV_QuotationAddressDtl"] != null)
                //{
                //    DataTable dt = (DataTable)Session["RDEV_QuotationAddressDtl"];
                //    if (dt != null && dt.Rows.Count > 0)
                //    {
                //        if (dt.Rows.Count == 2)
                //        {
        ...
        public void ModifyPurchaseReturn(string QuotationID, string strSchemeType, string strQuoteNo, string strQuoteDate, string strCustomer, string strContactName,
                                    string Reference, string strBranch, string strStockOutBranch, string strAgents, string strCurrency, string strRate, string strTaxType, string strTaxCode, string strComponenyType,
                                    string strInvoiceComponent, string strInvoiceComponentDate, string strCashBank, string strDueDate,
                                    DataTable Productdt, DataTable TaxDetailTable, DataTable Warehousedt, DataTable SalesReturnTaxdt, DataTable BillAddressdt, string approveStatus, string ActionType, string StrBr,Int64 ProjId,
                                    ref int strIsComplete, ref int strInvoiceID, string ReasonforReturn, string refCreditNoteNo, string refCreditNoteDate)
        {
            try
            {
                ...
                if(Productdt.Columns.Contains("DetailsId"))
                {
                    Productdt.Columns.Remove("DetailsId");
                    Productdt.AcceptChanges();
                }
                if (Productdt.Columns.Contains("ReturnDetails_InlineRemarks"))
                {
                    Productdt.Columns.Remove("ReturnDetails_InlineRemarks");
                    Productdt.AcceptChanges();
                }
               ...
               // SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                ...
                SqlCommand cmd = new SqlCommand("prc_CRMPurchaseReturnRD", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                bool isPRClosed = false;
                if (chk_Isclosed.Checked)
                {
                    isPRClosed = true;
                }

                cmd.Parameters.AddWithValue("@IsClosed", isPRClosed);
                //if (String.IsNullOrEmpty(strInvoiceComponent))
                //{ cmd.Parameters.AddWithValue("@ComponentType", ""); }
                //else { cmd.Parameters.AddWithValue("@ComponentType", "RDEV"); }

                cmd.Parameters.AddWithValue("@ComponentType", "RDEV");               
                ...
                if (Session["RDEVwarehousedetailstemp"] != null)
                {
                    DataTable temtable = new DataTable();
                    DataTable Warehousedtssss = (DataTable)Session["RDEVwarehousedetailstemp"];
        ...
        public DataTable GetTaxData(string quoteDate)
        {
            ...
            proc.AddVarcharPara("@PurchaseReturnID", 500, Convert.ToString(Session["RDEV_ReturnID"]));
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            // proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
        ...
        protected void gridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["RDEV_TaxDetails"] == null)
                {
                    Session["RDEV_TaxDetails"] = GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd"));
                }
            ...
            else if (strSplitCommand == "SaveGst")
            {
                ...
                else
                {
                    ...
                    Session["RDEV_TaxDetails"] = TaxDetailsdt;
                }
            }
        }
        ...
        protected void gridTax_DataBinding(object sender, EventArgs e)
        {
            if (Session["RDEV_TaxDetails"] != null)
            {
                DataTable TaxDetailsdt = (DataTable)Session["RDEV_TaxDetails"];
        ...
        public DataTable GetSerialata(string WarehouseID, string BatchID, string BranchSerialNumber, string RequestNo)
        {
            ...
            proc.AddVarcharPara("@PurchaseReturnID", 20, Convert.ToString(Session["RDEV_ReturnID"]));
            proc.AddVarcharPara("@PID", 500, Convert.ToString(hdfProductID.Value));
        ...
        public DataTable GetQuotationWarehouseData()
        {
            try
            {
                ...
                if (Session["RDEV_ReturnDetails"] != null)
                {
                    DataTable SalesInvoicedt1 = (DataTable)Session["RDEV_ReturnDetails"];
        ...
        protected void CmbSerial_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (WhichCall == "BindSerial")
            {
                ...
                if (WarehouseID != "null")
                {
                    ...
                    if (Session["RDEV_WarehouseData"] != null)
                    {
                        DataTable Warehousedt = (DataTable)Session["RDEV_WarehouseData"];
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int loopId = Convert.ToInt32(Session["LoopRDEVWarehouse"]);
                ...
                Session["RDEV_WarehouseData"] = Warehousedt;
                changeGridOrder();

                GrdWarehouse.DataSource = Warehousedt.DefaultView;
                GrdWarehouse.DataBind();

                Session["LoopRDEVWarehouse"] = loopId + 1;
        ...
        protected void taxUpdatePanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string performpara = e.Parameter;
            if (performpara.Split('~')[0] == "DelQtybySl")
            {
                DataTable MainTaxDataTable = (DataTable)Session["RDEV_FinalTaxRecord"];
                ...
                Session["RDEV_FinalTaxRecord"] = MainTaxDataTable;
                GetStock(Convert.ToString(performpara.Split('~')[1]));
                // DeleteWarehouse(Convert.ToString(performpara.Split('~')[1]));
                DataTable taxDetails = (DataTable)Session["RDEV_TaxDetails"];
                if (taxDetails != null)
                {
                    ...
                    Session["RDEV_TaxDetails"] = taxDetails;
                }
            }
        ...
        public void CreateDataTaxTable()
        {
            ...
            Session["RDEV_FinalTaxRecord"] = TaxRecord;
        }
        public static void CreateDataTaxTableAjax()
        {
            ...
            TaxRecord.Columns.Add("Percentage", typeof(System.Decimal));
            TaxRecord.Columns.Add("Amount", typeof(System.Decimal));
            HttpContext.Current.Session["RDEV_FinalTaxRecord"] = TaxRecord;
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable TaxRecord = (DataTable)Session["RDEV_FinalTaxRecord"];
            ...
            else
            {
              ...
              //  ImplementTaxonTaggingTRDEV

                int slNo = Convert.ToInt32(HdSerialNo.Value);



                DataRow[] SlNoRow = MainTaxDataTable.Select("SlNo=" + slNo.ToString());
                if (SlNoRow.Length == 0) {
                    ...
                    DataTable RDEV_ReturnDetails = (DataTable)Session["RDEV_ReturnDetails"];

                    DataRow[] prodId = RDEV_ReturnDetails.Select("SrlNo=" + slNo.ToString());

                    string pro = Convert.ToString(prodId[0]["ProductID"]).Replace("||", "").Split('@')[0];

                    ProcedureExecute procstateTable = new ProcedureExecute("Prc_taxForpurchase");
                    procstateTable.AddVarcharPara("@action", 500, "GetGSTINByBranch");
                    procstateTable.AddIntegerPara("@BranchId", Convert.ToInt32(ddl_Branch.SelectedValue));
                    procstateTable.AddVarcharPara("@companyintId", 50, Convert.ToString(HttpContext.Current.Session["LastCompany"]));
                    procstateTable.AddVarcharPara("@vendInternalId", 20, hdnCustomerId.Value);
                    DataSet taxForpurchase = procstateTable.GetDataSet();
                    ...
                    DataTable fetchedData = oDBEngine.GetDataTable("select TaxRates_ID from Config_TaxRates config inner join Master_Taxes masterTax on config.TaxRates_TaxCode = masterTax.Taxes_ID  where  TaxRates_RoundingOff='R+' and Taxes_ApplicableFor in ('B','P')");
                    if (fetchedData.Rows.Count > 0)
                        roundOfPlus = Convert.ToString(fetchedData.Rows[0][0]).Trim();

                    fetchedData = oDBEngine.GetDataTable("select TaxRates_ID from Config_TaxRates config inner join Master_Taxes masterTax on config.TaxRates_TaxCode = masterTax.Taxes_ID  where  TaxRates_RoundingOff='R-' and Taxes_ApplicableFor in ('B','P')");
                    if (fetchedData.Rows.Count > 0)
                    ...
                    if (TaxType == "UTGST")
                    {
                        foreach (DataRow dr in taxDetailRV.Rows)
                        {
                            if (Convert.ToString(dr["TaxTypeCode"]).Trim() == "IGST" || Convert.ToString(dr["TaxTypeCode"]).Trim() == "SGST")
                            {
                                dr.Delete();
                    ...
                    taxDetailRV.AcceptChanges();



                    foreach (DataRow taxexistingRow in taxDetailRV.Rows)
                        {
                            if (Convert.ToString(taxexistingRow["TaxTypeCode"]).Trim() != "O")
                            {
                                DataRow txRecordRow = MainTaxDataTable.NewRow();
                                txRecordRow["SlNo"] = slNo;
                                txRecordRow["TaxCode"] = taxexistingRow["Taxes_ID"];
                                txRecordRow["AltTaxCode"] = "0";
                                txRecordRow["Percentage"] = taxexistingRow["TaxRates_Rate"];
                                txRecordRow["Amount"] = Math.Round(Convert.ToDecimal(HdProdGrossAmt.Value) * (Convert.ToDecimal(taxexistingRow["TaxRates_Rate"]) / 100), 2);
                                MainTaxDataTable.Rows.Add(txRecordRow);
                ...
                //    TaxRecord = (DataTable)Session["RDEV_FinalTaxRecord"];
        ...
        public void DeleteTaxDetails(string SrlNo)
        {
            ...
            if (Session["RDEV_FinalTaxRecord"] != null)
            {
                ...
                Session["RDEV_FinalTaxRecord"] = TaxDetailTable;
            }
        }
        ...
        public void GetAllDropDownDetailForSalesQuotation(string userbranch)
        {
            ...
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            DataTable Schemadt = objSlaesActivitiesBL.GetNumberingSchema(strCompanyID, userbranchHierarchy, strYear, "57", "Y");
            if (Schemadt != null && Schemadt.Rows.Count > 0)
            {
                ddl_numberingScheme.DataTextField = "SchemaName";
                ddl_numberingScheme.DataValueField = "Id";
        ...
        //{
        //    if (Session["RDEV_CustomerDetail"] == null)
        //    {
        ...
        //            Session["RDEV_CustomerDetail"] = dtCustomer;
        //        }
        //    }
        //    else
        //    {
        //        lookup_Customer.DataSource = (DataTable)Session["RDEV_CustomerDetail"];
        //        lookup_Customer.DataBind();
        //    }
        ...
        public static bool CheckUniqueCode(string ReturnNo)
        {
            ...
            try
            {
                ...
                flag = objShortNameChecking.CheckUnique(ReturnNo, "0", "RateDifferenceEntryVendor");
            }
            catch (Exception ex)
            {
        ...
        protected void ComponentQuotation_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            if (e.Parameter.Split('~')[0] == "BindComponentGrid")
            {
                ...
                string strPurchaseReturnID = Convert.ToString(Session["RDEV_ReturnID"]);
                ...
                else
                {
                    ...
                    if (e.Parameter.Split('~')[4] == "PI")
                    {
                        ComponentTable = objPurchaseReturnBL.GetPurchaseRDEVInvoice(Customer, PurchaseReturnDate, strPurchaseReturnID, branchId, ComponentType);
                    }
                    else if (e.Parameter.Split('~')[4] == "TPI")
                    {
                        ComponentTable = objPurchaseReturnBL.GetTransitPurchaseRDEVInvoice(Customer, PurchaseReturnDate, strPurchaseReturnID, branchId, ComponentType);
                    }
                }
                lookup_quotation.GridView.Selection.UnselectAll();
                lookup_quotation.GridView.Selection.CancelSelection();
            ...
            else if (e.Parameter.Split('~')[0] == "BindComponentGridOnSelection")//Subhabrata for binding quotation
            {
                if (grid_Products.GetSelectedFieldValues("ComponentDetailsID").Count != 0)
                {
                    for (int i = 0; i < grid_Products.GetSelectedFieldValues("ComponentDetailsID").Count; i++)
                    {
                        ...
                        InvoiceNumbers += "," + grid_Products.GetSelectedFieldValues("Quotation_Num")[i];
                    }
                    InvoiceIds = InvoiceIds.TrimStart(',');

                    InvoiceNumbers = InvoiceNumbers.TrimStart(',');
                    lookup_quotation.GridView.Selection.UnselectAll();
                    if (!String.IsNullOrEmpty(InvoiceIds))
                    {
                        ...
                        {
                            string Invoice_No = Convert.ToString(InvoiceNumbers);
                            DataTable dt_QuotationDetails = new DataTable();
                            string Type = rdl_PurchaseInvoice.SelectedValue;
                            if (Type == "PI")
                            {
                                dt_QuotationDetails = objPurchaseReturnBL.GetPurchaseInvoiceDate(Invoice_No);
                            }
                            else if (Type == "TPI")
                            {
                                dt_QuotationDetails = objPurchaseReturnBL.GetTransitPurchaseInvoiceDate(Invoice_No);
                            }


                            if (dt_QuotationDetails != null && dt_QuotationDetails.Rows.Count > 0)
                            {
                                string invoicedate = Convert.ToString(dt_QuotationDetails.Rows[0]["Invoice_Date"]);
                                if (!string.IsNullOrEmpty(invoicedate))
                                {


                                    ComponentQuotationPanel.JSProperties["cpDate"] = Convert.ToString(invoicedate);
                                }
                            }
                ...
                string strType = rdl_PurchaseInvoice.SelectedValue;//"PC";
        ...
        {
            if (Session["RDEV_ComponentData"] != null)
            {
                lookup_quotation.DataSource = (DataTable)Session["RDEV_ComponentData"];
            }
        }
            ...
            if (strSplitCommand == "BindProductsDetails")
            {
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    else
                    {
                        ...
                        else if (Quote_Type == "TPI")
                        {
                            ...
                            if (!string.IsNullOrEmpty(IdKey))
                            {
                                if (IdKey != "ADD")
                                {
                                    dt_QuotationDetails = objPurchaseReturnBL.GetTransitPurchaseInvoiceDetailsOnly(QuoComponent, "Edit");
                                    // dt_QuotationDetails = objPurchaseChallanBL.GetInvoiceDetailsOnly(QuoComponent, IdKey, "");
                                }
                                else
                                {
                                    dt_QuotationDetails = objPurchaseReturnBL.GetTransitPurchaseInvoiceDetailsOnly(QuoComponent, "Add");
                                }
                    ...
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        DataTable Transaction_dt = (DataTable)Session["RDEV_ReturnDetails"];
        ...
        public bool BindSessionByDatatable(DataTable dt)
        {
            ...
            Session["RDEV_ReturnDetails"] = SlsOreturnDT;
        ...
        public static bool CheckUniqueRefCreditNoteNo(string vendorid, string creditNoteno, string mode, string pID)
        {
            ...
            PurchaseReturnBL obj = new PurchaseReturnBL();
            // strPurchaseReturnId = Convert.ToString(Session["RDEV_ReturnID"]);
        ...
        public string CalculateInvoiceAmount(DataTable dt)
        {
            decimal SUM_Amount = 0, SUM_TotalAmount = 0, SUM_TaxAmount = 0, SUM_ProductQuantity = 0, SUM_PurchasePrice = 0;
           

            if (dt != null && dt.Rows.Count > 0)
            {
                string ProductPrice = Convert.ToString(dt.Rows[0]["NPurchasePrice"]);
                string ProductTotalAmount = Convert.ToString(dt.Rows[0]["NTotalAmount"]);
                string NetAmount = Convert.ToString(dt.Rows[0]["NAmount"]);
               
                string ProductTaxAmount = Convert.ToString(dt.Rows[0]["NTaxAmount"]);
                string ProductQuantity = Convert.ToString(dt.Rows[0]["NQuantity"]);


                SUM_PurchasePrice = Convert.ToDecimal(ProductPrice);
                ...
                SUM_TaxAmount = Convert.ToDecimal(ProductTaxAmount);


                SUM_ProductQuantity = Convert.ToDecimal(ProductQuantity);
            }

            return Convert.ToString(SUM_PurchasePrice + "~" + SUM_Amount + "~" + SUM_TotalAmount + "~" + SUM_TaxAmount + "~" + SUM_ProductQuantity);
        }
        ...
        public DataTable GetProjectCode(string Proj_Code)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_CRMPurchaseReturnRD");
            proc.AddVarcharPara("@Action", 500, "GetProjectCodeRateDifference");
        ...
        public static object DocWiseSimilarProjectCheck(string quote_Id, string Doctype)
        {
            ...
            if (HttpContext.Current.Session["userid"] != null)
            {
                ...
                proc.AddVarcharPara("@ReturnProjectValue", 50, "0", QueryParameterDirection.Output);
                proc.RunActionQuery();
                returnValue = Convert.ToString(proc.GetParaValue("@ReturnProjectValue"));
        ...
        public static object SetProjectCode(string OrderId, string TagDocType)
        {
            ...
            {
                ProcedureExecute proc = new ProcedureExecute("prc_PurchaseReturn_Details");
                proc.AddVarcharPara("@Action", 500, "RDECtaggingProjectdata");
                proc.AddVarcharPara("@Order_Id", 100, OrderId);
        ...
        public static object taxUpdatePanel_Callback(string Action, string srl, string prodid)
        {
            ...
            try
            {
                ...
                if (Action == "DeleteAllTax")
                {
                    ...
                    DataTable taxDetails = (DataTable)HttpContext.Current.Session["RDEV_TaxDetails"];
                    ...
                    if (taxDetails != null)
                    {
                        ...
                        HttpContext.Current.Session["RDEV_TaxDetails"] = taxDetails;
                    }
                ...
                {
                    DataTable MainTaxDataTable = (DataTable)HttpContext.Current.Session["RDEV_FinalTaxRecord"];
                    ...
                    HttpContext.Current.Session["RDEV_FinalTaxRecord"] = MainTaxDataTable;
                    //GetStock(Convert.ToString(performpara.Split('~')[1]));
