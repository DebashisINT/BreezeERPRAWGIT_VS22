<%--================================================== Revision History =============================================
1.0   Pallab    V2.0.38      18-05-2023          0026172: Adjustment of Documents - Journal with Vendor Receipt(On Account) module design modification & check in small device
2.0   Sanchita  V2.0.43      20-02-2024          0027262: Views to be converted to Procedures in the Listing Page - Journal With Vendor Payment    
====================================================== Revision History =============================================--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="JournalDetorsAdjustVenRecList.aspx.cs" Inherits="ERP.OMS.Management.Activities.JournalDetorsAdjustVenRecList" %>
    ...
    <script>
        ...
        function AllControlInitilize() {
            if (isFirstTime) {
                ...
                if (localStorage.getItem('JournalDetorAdjustVRFromDate')) {
                    var fromdatearray = localStorage.getItem('JournalDetorAdjustVRFromDate').split('-');
                ...
                if (localStorage.getItem('JournalDetorAdjustVRToDate')) {
                    var todatearray = localStorage.getItem('JournalDetorAdjustVRToDate').split('-');
                    var todate = new Date(todatearray[0], parseFloat(todatearray[1]) - 1, todatearray[2], 0, 0, 0, 0);
                    ctoDate.SetDate(todate);
                }
                if (localStorage.getItem('JournalDetorAdjustVRListBranch')) {
                    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('JournalDetorAdjustVRListBranch'))) {
                        ccmbBranchfilter.SetValue(localStorage.getItem('JournalDetorAdjustVRListBranch'));
        ...
        function OnViewClick(keyValue) {
            ...
            var url = 'JournalDetorsAdjustVenRec.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }
        function onEditClick(id) {
            window.location.href = 'JournalDetorsAdjustVenRec.aspx?Key=' + id;
        ...
        function updateGridByDate() {
            ...
            if (cFormDate.GetDate() == null) {
                ...
                localStorage.setItem("JournalDetorAdjustVRFromDate", cFormDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("JournalDetorAdjustVRToDate", ctoDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("JournalDetorAdjustVRListBranch", ccmbBranchfilter.GetValue());
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <div class="panel-title clearfix">
            ...
            <h3 class="pull-left">Adjustment of Documents - Journal with Vendor Receipt(On Account)</h3>
        ...
        <div class="GridViewArea relative">
            ...
            <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                ...
                ContextTypeName="ERPDataClassesDataContext" TableName="v_JournalAdjustmentVendorONAccountList" />
