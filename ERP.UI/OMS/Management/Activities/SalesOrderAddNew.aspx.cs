...
namespace ERP.OMS.Management.Activities
{
    ...
    public partial class SalesOrderAddNew : ERP.OMS.ViewState_class.VSPage 
    {
        ...
        public static object GetContactPersonafterBillingShipping(string Key)
        {
            ...
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            List<ContactPersonNew> ContactPersonNew = new List<ContactPersonNew>();
            ...
            if (dtContactPerson != null && dtContactPerson.Rows.Count > 0)
            {
                ...
                if (dtContactPerson != null && dtContactPerson.Rows.Count > 0)
                {
                    ...
                    {
                        ContactPersonNew.Add(new ContactPersonNew
                        {
