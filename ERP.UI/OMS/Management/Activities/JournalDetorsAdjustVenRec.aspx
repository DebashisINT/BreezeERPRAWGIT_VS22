...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <h3 class="pull-left">
            ...
            <asp:Label ID="lblHeading" runat="server" Text="Add Adjustment of Documents - Journal with Vendor Receipt(On Account)"></asp:Label>
        </h3>
    </div>
        <div id="ApprovalCross" runat="server" class="crossBtn"><a href="JournalDetorsAdjustVenRecList.aspx"><i class="fa fa-times"></i></a></div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Journal Detors Search</h4>
