...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     ...
     <style>
      ...
      <script>
          ...
          function onInfluencerCommissionReturn(id) {
              ...
              $.ajax({
                  type: "POST",
                  url: "ProjectSalesReturnList.aspx/GetInfluencerDetails",
          ...
          function SaveInfluencerdetails() {
              ...
              $.ajax({
                  type: "POST",
                  url: "ProjectSalesReturnList.aspx/SaveInfluencer",
                  contentType: "application/json; charset=utf-8",
    ...
    <script>
        ...
        function CallEWayBill_save() {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectSalesReturnList.aspx/UpdateEWayBill",
                data: JSON.stringify({
        ...
        function OnAddButtonClick() {
            var url = 'ProjectSalesReturn.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        function OnMoreInfoClick(keyValue) {
            ...
            if (ActiveUser != null) {
                $.ajax({
                    type: "POST",
                    url: "ProjectSalesReturnList.aspx/GetEditablePermission",
                    data: "{'ActiveUser':'" + ActiveUser + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
                        var status = msg.d;
                        var url = 'ProjectSalesReturn.aspx?key=' + keyValue + '&Permission=' + status + '&type=SR';
                        window.location.href = url;
                    }
                });
            }
        ...
        function OnViewClick(keyValue) {
            var url = 'ProjectSalesReturn.aspx?key=' + keyValue + '&req=V' + '&type=SR';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea relative">
        ...
        <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
            ContextTypeName="ERPDataClassesDataContext" TableName="v_ProjectSalesReturnList" />
