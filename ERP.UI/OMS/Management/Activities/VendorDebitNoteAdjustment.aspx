<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="VendorDebitNoteAdjustment.aspx.cs" Inherits="ERP.OMS.Management.Activities.VendorDebitNoteAdjustment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="JS/VendorDrAdjustment.js?v=1.0.004"></script>
     ...
     <dxe:ASPxGlobalEvents ID="GlobalEvents" runat="server">
      ...
      <div class="panel-title clearfix" id="myDiv">
                <h3 class="pull-left">
                    <label>Adjustment of Documents - Debit Note With Invoice</label>
                 </h3>
        </div>
    ...
    <%--Debit Note Selection Model--%>
     <div class="modal fade" id="DebitNoteModel" role="dialog">
        <div class="modal-dialog">
    ...
    <asp:HiddenField ID="hdDebitNoteDocNo" runat="server" /> 
