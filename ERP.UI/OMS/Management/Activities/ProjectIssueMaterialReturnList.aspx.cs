...
{
    public partial class ProjectIssueMaterialReturnList : System.Web.UI.Page
    {

        BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine();

        public EntityLayer.CommonELS.UserRightsForPage rights = new UserRightsForPage();
        ProjectIssueMaterialReturnBL objIssueMaterialReturnBL = new ProjectIssueMaterialReturnBL();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/ProjectIssueMaterialReturnList.aspx");
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Material Issue Return";
            ...
            exporter.PageHeader.Left = "Material Issue Return";
        ...
        public static string UpdateEWayBill(string ReturnID, string UpdateEWayBill, string EWayBillDate, string EWayBillValue)
        {
            ProjectIssueMaterialReturnBL objIssueMaterialReturnBL = new ProjectIssueMaterialReturnBL();
            int EWayBill = 0;
            EWayBill = objIssueMaterialReturnBL.UpdateEWayBillForSalesReturn(ReturnID, UpdateEWayBill, EWayBillDate, EWayBillValue);
        ...
        protected void GrdSalesReturn_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (Command == "Delete")
            {
                ...
                int deletecnt = 0;
                deletecnt = objIssueMaterialReturnBL.DeleteSalesReturnDetails(SalesReturnID, Convert.ToString(HttpContext.Current.Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), "SR", Convert.ToString(Session["userbranchID"]));
                ...
                if (deletecnt == 1)
                {
                    ...
                    dtdata = objIssueMaterialReturnBL.GetSalesReturnListGridData(Convert.ToString(HttpContext.Current.Session["userbranchHierarchy"]), Convert.ToString(HttpContext.Current.Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), BranchID, FromDate, ToDate);
            ...
            else if (Command == "FilterGridByDate")
            {
                ...
                DataTable dtdata = new DataTable();
                // dtdata = objIssueMaterialReturnBL.GetCustomerReturnListGridData(userbranch, lastCompany, finyear, BranchID, FromDate, ToDate, "SC");

                dtdata = objIssueMaterialReturnBL.GetSalesReturnListGridData(userbranch, lastCompany, finyear, BranchID, FromDate, ToDate);
        ...
        //{
        //    DataTable dtdata = new DataTable();
        //    dtdata = objIssueMaterialReturnBL.GetSalesReturnListGridData(userbranch, lastCompany, FinyearStartDate, FinYearEndDate);
        //    if (dtdata != null && dtdata.Rows.Count > 0)
        //    {
        //        GrdSalesReturn.DataSource = dtdata;
        //        GrdSalesReturn.DataBind();
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                if (strBranchID == "0")
                {
                    ...
                    var q = from d in dc.v_ProjectIssueMaterialReturnLists
