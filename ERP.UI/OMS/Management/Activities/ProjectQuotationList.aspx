<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ProjectQuotationList.aspx.cs" Inherits="ERP.OMS.Management.Activities.ProjectQuotationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function timerTick() {
            ...
            $.ajax({
                type: "POST",
                url: "ProjectQuotationList.aspx/GetTotalWatingQuotationCount",
        ...
        function QuotationWattingOkClick() {
            ...
            if (listKey) {
                if (CwatingQuotegrid.GetRow(index).children[6].innerText != "Advance") {
                    var url = 'ProjectQuotation.aspx?key=' + 'ADD&&BasketId=' + listKey;
                    LoadingPanel.Show();
        ...
        function OnMoreInfoClick(keyValue) {
            ...
            if (ActiveUser != null) {
                $.ajax({
                    type: "POST",
                    url: "ProjectQuotationList.aspx/GetEditablePermission",
                    data: "{'ActiveUser':'" + ActiveUser + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
                        var status = msg.d;
                        var url = 'ProjectQuotation.aspx?key=' + keyValue + '&Permission=' + status + '&type=QO';
                        window.location.href = url;
                    }
                });
            }
        ...
        function OnViewClick(keyValue) {
            var url = 'ProjectQuotation.aspx?key=' + keyValue + '&req=V' + '&type=QO';
            window.location.href = url;
        }

        function OnclickViewAttachment(obj) {
            //var URL = '/OMS/Management/Activities/Quotation_Document.aspx?idbldng=' + obj + '&type=Quotation';
            var URL = '/OMS/Management/Activities/EntriesDocuments.aspx?idbldng=' + obj + '&type=ProjectQuotation';
            window.location.href = URL;
        }

        function OnAddButtonClick() {
            var url = 'ProjectQuotation.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        var keyval;
        ...
        function OnGetApprovedRowValues(obj) {
            uri = "ProjectQuotation.aspx?key=" + obj + "&status=2" + '&type=QO';
        ...
        function OnGetRejectedRowValues(obj) {
            uri = "ProjectQuotation.aspx?key=" + obj + "&status=3" + '&type=QO';
            popup.SetContentUrl(uri);
            popup.Show();
        }
        ...
        function OnApprovalEndCall(s, e) {
            $.ajax({
                type: "POST",
                url: "ProjectQuotationList.aspx/GetPendingCase",
                contentType: "application/json; charset=utf-8",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading clearfix">
        <div class="panel-title pull-left">
            <h3>Project Quotation/Proposal</h3>
        </div>
    ...
    <div class="form_main">
        <div class="clearfix">
          ...
          <%--  <a href="javascript:void(0);" onclick="OnAddButtonClick()" class="btn btn-success btn-radius"><span class="btn-icon"><i class="fa fa-plus" ></i></span><span>Proposal</span> </a>--%>
            <%} %>
           ...
           <%-- <dxe:ASPxButton ID="btn_WaitQuote" ClientInstanceName="Cbtn_WaitQuote" runat="server" AutoPostBack="False" Text="Edit" CssClass="btn btn-primary" >
            ...
            <a href="javascript:void(0);" onclick="OpenWaitingQuote()" class="btn btn-warning typeNotificationBtn btn-radius" style="display:none"><span><u>Q</u>uotation Waiting </span>
            ...
            <span id="spanStatus" runat="server" style="display:none">
            ...
            <span id="divPendingWaiting" runat="server" style="display:none">
    ...
    <div class="GridViewArea relative">
        <div class="makeFullscreen ">
             <span class="fullScreenTitle">Project Quotation/Proposal</span>
        ...
        <dxe:ASPxGridView ID="GrdQuotation" runat="server" KeyFieldName="Quote_Id" AutoGenerateColumns="False" SettingsBehavior-AllowFocusedRow="true" Settings-VerticalScrollableHeight="250" Settings-VerticalScrollBarMode="Auto"
            Width="100%" ClientInstanceName="cGrdQuotation" OnCustomCallback="GrdQuotation_CustomCallback" DataSourceID="EntityServerModeDataSource" SettingsDataSecurity-AllowEdit="false" SettingsDataSecurity-AllowInsert="false" SettingsDataSecurity-AllowDelete="false" >
             ...
             <Columns>
                ...
                <dxe:GridViewDataTextColumn Caption="Customer" FieldName="CustomerName"
                  ...
                  <dxe:GridViewDataTextColumn Caption="Project Name" FieldName="Proj_Name"
                    VisibleIndex="3" Width="250px" Settings-ShowFilterRowMenu="True" Settings-AllowAutoFilter="True">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="7" Width="0%">
                    <DataItemTemplate>
