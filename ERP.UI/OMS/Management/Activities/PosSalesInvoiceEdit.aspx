...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddcustomerClick() {
            ...
            debugger;
            if (isLighterPage == 1) {
                var url = '/OMS/management/Master/customerPopup.html?var=1.1.6.1';
    ...
    <script>
        ...
        function AllControlInitilize() {
            ...
            if (canCallBack) {
                ...
                grid.AddNewRow();
                var slno = grid.GetVisibleRowsOnPage();
                var tbQuotation = grid.GetEditor("SrlNo");
                tbQuotation.SetValue(parseInt(slno));
                grid.batchEditApi.EndEdit();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="JS/PosSalesInvoice.js?var=2.1"></script>
                                ...
                                <dxe:ContentControl runat="server">
                                    <div class="">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td id="oldunitButton" runat="server">
                                                            <button type="button"  onclick="OldUnitButtonOnClick()" class="btn btn-small btn-primary" style="display: none" id="OldUnitSelectionButton" >Old Unit Selection</button>
                                                        </td>
                                                        ...
                                                        <td class="hd" id="lblAdvnceRecptNo" runat="server">
                                                            <button type="button"  onclick="AdvanceReceiptOnClick()" class="btn btn-small btn-primary" >Advance / Return<//button>
                                        ...
                                        <div class="col-md-12" id="divSubmitButton">
                                            ...
                                            <%--<dxe:ASPxButton ID="ASPxButton7" ClientInstanceName="cbtn_SaveRecordsEdit"  runat="server" AutoPostBack="false" Text="Save & Ex&#818;it" CssClass="btn btn-primary" UseSubmitBehavior="False">
                                                <ClientSideEvents Click="SaveExit_ButtonClick" />
                                            </dxe:ASPxButton>--%>

                                            <button type="button" Class="btn btn-primary" onclick="SaveExit_ButtonClick();">Save & Exit</button>
                ...
                <div class="ProductMainContaint">
                        ...
                        <div class="col-md-4" style="display: none">
                            <div class="">
                                ...
                                <div class="Left_Content">
                                    ...
                                    <dxe:ASPxButton ID="btnUpload" UseSubmitBehavior="false" runat="server" AutoPostBack="False" Text="Upload" ClientInstanceName="btnUpload" CssClass="pull-right btn btn-primary btn-small blll hide">
                                        <ClientSideEvents Click="function(s, e) {
                                                     upload1.Upload(); 
                                                    }"></ClientSideEvents>
                                    </dxe:ASPxButton>
                    ...
                    <div class="ContentDiv" style="height: auto">
                        ...
                        <div class="Footer clearfix" style="padding-left: 16px">
                            ...
                            <dxe:ASPxButton ID="ASPxButton6" CausesValidation="true" UseSubmitBehavior="false" ClientInstanceName="cbtnSave_Product" runat="server" ValidationGroup="product" EncodeHtml="false"
                                AutoPostBack="False" Text="<u>S</u>ave" CssClass="btn btn-primary">
                                <ClientSideEvents Click="function (s, e) {btnSave_citys();}" />
                            </dxe:ASPxButton>


                            <dxe:ASPxButton ID="btnCancel_citys" UseSubmitBehavior="false" runat="server" AutoPostBack="False" Text="<u>C</u>ancel" CssClass="btn btn-danger" EncodeHtml="false">
                                <ClientSideEvents Click="function (s, e) {fn_btnCancel();}" />
                            </dxe:ASPxButton>
                            <asp:Button ID="btnUdf" UseSubmitBehavior="false" runat="server" Text="UDF" CssClass="btn btn-primary dxbButton" OnClientClick="if(OpenUdf()){ return false;}" />
                                                ...
                                                <Templates>
                                                    <StatusBar>
                                                        <table class="OptionsTable" style="float: right">
                                                            <tr>
                                                                <td>
                                                                    <dxe:ASPxButton ID="Close" UseSubmitBehavior="false" runat="server" AutoPostBack="false" Text="Close" ClientSideEvents-Click="CloseGridLookup" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </StatusBar>
