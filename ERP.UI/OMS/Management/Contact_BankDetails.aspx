<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.management_Contact_BankDetails" CodeBehind="Contact_BankDetails.aspx.cs" %>
                                        ...
                                        <dxe:ContentControl runat="server">
                                            <dxe:ASPxPageControl runat="server" Width="929px" ActiveTabIndex="0" ID="ASPxPageControl2"
                                                ...
                                                <TabPages>
                                                    <dxe:TabPage Name="Bank">
                                                        <TabTemplate>
                                                            <span style="font-size: x-small">Bank Details</span>&nbsp;<span style="color: Red;">*</span>
                                                        </TabTemplate>
                                                        <ContentCollection>
...
Emailcheck(s.cpHeight,s.cpWidth);
                                                                    ...
                                                                    <Columns>
                                                                       ...
                                                                       <%-- <dxe:GridViewCommandColumn VisibleIndex="11">
                                                                            <EditButton Visible="True"></EditButton>
                                                                            <HeaderTemplate>
                                                                                <a href="javascript:void(0);" onclick="gridBank.AddNewRow();"><span style="color: #000099; text-decoration: underline">Add New</span> </a>
	 ...
	 popup.Hide();
                                                                                        ...
                                                                                        <table>
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>Status: </td>
                                                                                                    <td>
                                                                                                        <asp:DropDownList runat="server" Width="100px" ID="cmbStatus" __designer:wfdid="w43">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>Date: </td>
                                                                                                    <td>
                                                                                                        <dxe:ASPxDateEdit runat="server" UseMaskBehavior="True" EditFormat="Custom" Width="99px" ClientInstanceName="StDate" Font-Size="12px" TabIndex="21" ID="StDate" __designer:wfdid="w44">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>Reason: </td>
                                                                                                    <td>
                                                                                                        <asp:TextBox runat="server" TextMode="MultiLine" Width="250px" ID="txtReason" __designer:wfdid="w45"></asp:TextBox>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="gridcellleft">
                                                                                                        <input style="width: 60px" id="Button2" class="btnUpdate" tabindex="41" onclick="btnSave_Click()" type="button" value="Save" />
                                                                                                        <input style="width: 60px" id="Button3" class="btnUpdate" tabindex="42" onclick="btnCancel_Click()" type="button" value="Cancel" />
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                    ...
                                                    <dxe:TabPage Name="Investment" Text="Investment">
                                                        <ContentCollection>
                                                            <dxe:ContentControl runat="server">
