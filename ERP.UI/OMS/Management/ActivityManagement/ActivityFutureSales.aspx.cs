...
namespace ERP.OMS.Management.ActivityManagement
{
    public partial class ActivityFutureSales : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        {
            SalesDetailsGridDataSource.ConnectionString = Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]);//Chinmoy added for connectionstring purpose
        }
