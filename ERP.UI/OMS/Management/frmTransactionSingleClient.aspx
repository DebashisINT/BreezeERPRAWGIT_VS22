<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.management_frmTransactionSingleClient" Codebehind="frmTransactionSingleClient.aspx.cs" %>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" align="center">
                    <strong><span style="color: #000099;">CDSL Transction Report </span></strong>
                        ...
                        <tr id="t1" style="display: none;">
                            <td colspan="2">
                                <table>
                                    <tr>
                                        <td>
                                            <span class="Ecoheadtxt" style="color: blue"><strong>From:</strong></span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="Ecoheadtxt" style="color: blue"><strong>To:</strong></span>
                                        </td>
                                        <td>
                        ...
                        <tr id="t2" style="display: none;">
                            <td colspan="2" style="text-align: center">
                                <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="validateDates"
                                    ErrorMessage="Please Enter Valid Date Range."></asp:CustomValidator>
                            </td>
                            <td>
                            </td>
                            <td>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td class="gridcellleft" style="vertical-align: top; text-align: left" id="TdFilter1">
                                                        ...
                                                        </span><a id="A3" href="javascript:void(0);" onclick="btnAddEmailtolist_click()"><span
                                                        ...
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td height='10' width='100%' align='center' bgcolor='#FFFFFF'>
                                                                    <font size='2' face='Tahoma'><strong align='center'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Loading..</strong></font>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <span style="color: red; text-align: center" id="norecord" class="Ecoheadtxt" runat="server">
                                            <strong>No Transction Found</strong></span>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody style="width: 100%">
                                                            <tr style="font-size: 12px; font-family: Calibri">
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="boid" runat="server" Font-Bold="True"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    Category:
                                                                </td>
