<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" Inherits="ERP.OMS.Management.management_frmAllot_sales" CodeBehind="frmAllot_sales.aspx.cs" %>
    ...
    <div>
        <table class="TableMain100">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtInstruction" runat="Server" TextMode="MultiLine" Width="787px" Height="200px" Font-Size="12px"></asp:TextBox></td>
            </tr>
            <tr>
