<%@ Page Title="Bank Deposit Slips" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true"
    Inherits="ERP.OMS.Management.DailyTask.management_DailyTask_frm_BankDepositSlip" CodeBehind="frm_BankDepositSlip.aspx.cs" %>
            ...
            <tr id="MainFilter" runat="server">
                <td align="Center">
                    <table width="500px">
                        ...
                        <tr>
                            <td class="gridcellleft">Deposit Date
                            </td>
                            <td class="gridcellleft">
