<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_ManualBRSListEntity.aspx.cs" 
    Inherits="ERP.OMS.Management.DailyTask.frm_ManualBRSListEntity" MasterPageFile="~/OMS/MasterPage/ERP.Master" EnableEventValidation="false" %>
    ...
    <script>
        ...
        function updateGridByDate() {
            ...
            if (cFormDate.GetDate() == null) {
                ...
                $("#hfBankID").val(ccmbBankfilter.GetValue());

                $.ajax({
                    type: "POST",
                    url: "frm_ManualBRSListEntity.aspx/SolveRepeat",
                    data: JSON.stringify({ Fromdate: $("#hfFromDate").val(), ToDate: $("#hfToDate").val(), BankId: $("#hfBankID").val() }),
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="grdmanualBRS" runat="server" AutoGenerateColumns="False" KeyFieldName="SlNo" DataSourceID="EntityServerModeDataSource"
            ...
            <columns>
                    ...
                    <dxe:GridViewDataTextColumn Caption="Instrument No" VisibleIndex="5" FieldName="cashbankdetail_instrumentnumber">
                     ...
                     <dxe:GridViewDataTextColumn Caption="Instrument Type" VisibleIndex="6" FieldName="type1" >
                    </dxe:GridViewDataTextColumn>
        ...
        <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
            ContextTypeName="ERPDataClassesDataContext" TableName="v_GetManualBRSCleared" />
    </div>
