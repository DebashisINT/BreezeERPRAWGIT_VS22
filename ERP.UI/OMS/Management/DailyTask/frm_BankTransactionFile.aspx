<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true"
    Inherits="ERP.OMS.Management.DailyTask.management_DailyTask_frm_BankTransactionFile" CodeBehind="frm_BankTransactionFile.aspx.cs" %>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Bank Transaction Files</span></strong>
                </td>
            </tr>
            <tr id="MainFilter" runat="server">
                <td align="Center" style="display: inline;">
                    <table width="500px">
                        <tr>
                            <td class="gridcellleft">Select Bank
                            </td>
                        ...
                        <tr>
                            <td class="gridcellleft">Transaction Date
                            </td>
                            <td class="gridcellleft">
                        ...
                        <tr>
                            <td class="gridcellleft">Narration </td>
                            <td class="gridcellleft">
                                <asp:TextBox ID="txtNarration" runat="server" Font-Size="12px" Width="250px" TabIndex="4" Height="41px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                        <tr id="trSummary">
                            <td>Select Transaction To Print :
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="gridcellleft">
                                <span id="spanShow">
                                    <asp:Button ID="btnGenerate" Text="Show" runat="server" CssClass="btnUpdate" OnClick="btnGenerate_Click"
                                        TabIndex="6" />
                                </span><span id="spanBtn" style="display: none"><a href="#" style="font-weight: bold; color: Blue"
                                    onclick="javascript:ForFilterOff();">Cancel</a></span>
                            </td>
                        </tr>
                    ...
                    <table width="100%">
                        <tr>
                            <td align="left"><span id="SpanPrint" style="display: none">
                                <asp:Button ID="btnShow" Text="Export" runat="server" CssClass="btnUpdate" OnClick="btnShow_Click"
                                    TabIndex="6" /></span>
                            </td>
            ...
            <tr id="txtSelect">
                <td>
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="GridSelect" runat="server" AutoGenerateColumns="False"
                                BackColor="PeachPuff" BorderColor="Blue" BorderStyle="Solid" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAmonut" runat="server" Text='<%# Eval("CASHBANKDETAIL_PAYMENTAMOUNT") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Account Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("CilentName") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle ForeColor="Black" />
                                    </asp:TemplateField>
