<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" 
    Inherits="ERP.OMS.Management.ToolsUtilities.management_utilities_frmshowtemplate_rfa" Codebehind="frmshowtemplate_rfa.aspx.cs" %>
          ...
          for (var x = 0; x <= str.length-1; x++)
             {
              ...
              window.opener.document.aspnetForm.ctl00_ContentPlaceHolder3_txt_content.value=msg; 
              if  (document.getElementById('HREC').value=='0')
              {                 
              //window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_lst_createdfor.disabled = false;
              //window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_lst_createdfor.focus();
              }
              else
              {              
              //window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_lst_createdfor.disabled = true;
              //window.opener.document.aspnetForm.ctl00_ContentPlaceHolder3_btn_save.focus();
