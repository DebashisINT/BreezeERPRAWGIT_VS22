<%--================================================== Revision History =============================================
1.0   Pallab    V2.0.38      23-05-2023          0026203: Report Header Footer Template design modification & check in small device
====================================================== Revision History =============================================--%>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" EnableEventValidation="false"
    Inherits="ERP.OMS.Management.ToolsUtilities.management_utilities_frmHeaderFooterTempl" CodeBehind="frmHeaderFooterTempl.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(function () {
            ...
            $.ajax({
                type: "POST",
                url: "frmHeaderFooterTempl.aspx/FetchHeaderFooterTagsByStage",
            ...
            $("#drpSenderType").change(function () {
                ...
                var editor2 = CKEDITOR.instances['footer_id'];
        ...
        function GenerateKeyWords(HFTags) {
            ...
            CKEDITOR.plugins.add(KeyWordName,
             {
                 ...
                 init: function (editor) {
                     ...
                     var strings = [];
                     $.each(JSON.parse(HFTags), function (index, value) {
             
                         strings.push([value.HFTags]);
            ...
            CKEDITOR.plugins.add(KeyWordName,
            {
                ...
                init: function (editor1) {
                    var config = editor1.config,
                    lang = editor1.lang.format;
                    ...
                    editor1.ui.addRichCombo('keywords',
                    {
                        label: "Insert Field Code",
                        title: "Insert Field Code",
                        voiceLabel: "Insert Field Code",
                        ...
                        panel:
                        {
                            css: [editor1.config.contentsCss, CKEDITOR.skin.getPath('editor1')],
                            voiceLabel: lang.panelVoiceLabel
                        },
                        ...
                        onClick: function (value) {
                            editor1.focus();
                            editor1.fire('saveSnapshot');
                            editor1.insertHtml(value);
                            editor1.fire('saveSnapshot');
                        }
                    });
            ...
            //    CKEDITOR.replace('footer_id', CKEDITOR.config);
            CKEDITOR.replace('footer_id', {
    ...
    <script type="text/ecmascript">
        ...
        function btnAdd_Click() {
          ...
          //  document.getElementById("Trgrd").style.display = 'none';
            ...
            document.getElementById("IsDefault_Chk").checked = false;
        ...
        function btnSave_Click() {
            ...
            var ModuleID = document.getElementById("ddlModuleName").value;

            var name = document.getElementById("txt_description").value;

            var HeaderText = CKEDITOR.instances['text_id'].getData();

            var FooterText = CKEDITOR.instances['footer_id'].getData();
            
            if (name=="") {
                jAlert("Name canot be blank ");
            }
            else if (HeaderText == "" && FooterText=="") {
                jAlert("Either Header or Footer is needed. ");
            }
            ...
            else
            {
                $.ajax({
                    type: "POST",
                    url: "frmHeaderFooterTempl.aspx/CheckRecExist",
                    data: JSON.stringify({ ModuleID: ModuleID, name: name }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    // async:false,
                    success: function (msg) {

                        if (msg.d == 1 && $("#hdnIsEditMode").val()=='Add') {
                            jAlert("Template name already exist for this module");
                        }
                        else {
                            var data = 'AddSave';

                            if ($("#hdnIsEditMode").val() == 'Edit') {
                                data = 'EditSave'
                            }

                            cmb = document.getElementById("ddlModuleName");
                            data += '~' + cmb.value;
                            cmb = CKEDITOR.instances['text_id'].getData();
                            data += '~' + cmb;
                            cmb = CKEDITOR.instances['footer_id'].getData();
                            data += '~' + cmb;
                            cmb = document.getElementById("txt_description").value;
                            data += '~' + cmb;
                            var chk_default = document.getElementById("IsDefault_Chk").checked;
                            data += '~' + chk_default;
                            CallServer(data, "");
                            grid.PerformCallback();
                            Page_Load();
            ...
            //            $.ajax({
            //                type: "POST",
            //                url: "frmHeaderFooterTempl.aspx/AddEmailTemplateDefaultInfo",
           ...
           var DATA = rValue.split('~');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (DATA[0] == "Edit") {
                        document.getElementById("ddlModuleName").value = DATA[1];
                        CKEDITOR.instances["text_id"].setData(DATA[2]);
                        CKEDITOR.instances["footer_id"].setData(DATA[3]);
                        document.getElementById("txt_description").value = DATA[5];
                        ...
                        CKEDITOR.instances["footer_id"].setData("");
    ...
    <script type="text/javascript">
        ...
        function BindRecipients() {
            ...
            $.ajax({
                type: "POST",
                url: 'frmHeaderFooterTempl.aspx/GetRecipients',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main clearfix">
        ...
        <div class="panel-title">
            <h3>Report Header Footer Template</h3>
                            ...
                            <td colspan="2" valign="top">
                                <dxe:ASPxGridView ID="GrdTemplate" ClientInstanceName="grid" runat="server" KeyFieldName="tem_id"
                                    ...
                                    <Columns>
                                        ...
                                        <dxe:GridViewDataTextColumn FieldName="Module_Name" VisibleIndex="0" Caption="Module Name">
                                            <CellStyle CssClass="gridcellleft">
                                            </CellStyle>
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn FieldName="Name" VisibleIndex="0" Caption="Template Name">
                                            <CellStyle CssClass="gridcellleft">
                                            </CellStyle>
                                        </dxe:GridViewDataTextColumn>
                            ...
                            <td style="vertical-align: top; width: 47px;">
                                ...
                                <div>
                                    ...
                                    <div class="col-md-3 simple-select" id="TrReserveWord" >
                                        ...
                                        <div class="relative">
                                            <asp:DropDownList ID="ddlModuleName" runat="server" Width="100%">
                                            </asp:DropDownList>
                                         </div>
                                    </div>
                                    <div class="col-md-3" >
                                        <label>
                                            ...
                                            <span class="Ecoheadtxt">Name :</span>
                                        </label>
                                        <div>
                                            ...
                                            <td>
                                                <dxe:ASPxGridView ID="grduser" runat="server" AutoGenerateColumns="true" ClientInstanceName="grid1"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxe:GridViewDataTextColumn FieldName="UNAME" Caption="Recipient Name" VisibleIndex="0">
                                                            <CellStyle CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxe:GridViewDataTextColumn>
                                                    </Columns>
                                ...
                                <div class="col-md-9" id="TrMessage">
                                    ...
                                    <label class="Ecoheadtxt">Header :</label>
                                    <div>
                                 ...
                                 <div class="col-md-9" id="TrMessage">
                                    <%--<label class="Ecoheadtxt">Message :</label>--%>
                                    <label class="Ecoheadtxt">Footer :</label>
                                    <div>
                                        <%--<asp:TextBox ID="txt_msg" runat="server" Height="160px" TextMode="MultiLine" Width="100%" MaxLength="3000"></asp:TextBox>--%>
                                        <%--  <CKEditor:CKEditorControl ID="CKEditor1" BasePath="/ckeditor/" runat="server" ClientIDMode="Static">
                                        </CKEditor:CKEditorControl>--%>

                                        <asp:TextBox ID="footer_id" runat="server"></asp:TextBox>
                                    </div>
                                    <div style="text-align: right; display: none;">
                                        <%--  <a href="#" onclick="frmOpenNewWindow_custom('frmreservedword.aspx?type=receipent,sender&control=window.opener.document.aspnetForm.txt_msg.value','200','400','200','300')">
                                            <span style="color: #000099; text-decoration: underline">Use Reserved Word</span></a>--%>
    ...
    <dxe:ASPxPopupControl ID="ASPXPopupControl_Bulk" runat="server" ContentUrl="frmHeaderFooterTempl.aspx"
