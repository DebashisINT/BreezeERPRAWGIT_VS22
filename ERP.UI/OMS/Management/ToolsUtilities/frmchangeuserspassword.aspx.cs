        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["uid"] != null)
                {
                    ...
                    if (strisactive[0] == "0")
                    {
                        oDBEngine.SetFieldValue("tbl_master_user", "user_password='" + Encryptpass_New + "',PassStrength="+hdPassstrength.Value.ToString(), " user_id='" + Convert.ToString(Request.QueryString["uid"]) + "'");
