<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.ToolsUtilities.management_toolsutilities_OfferLetter_VarifyCandidate" CodeBehind="OfferLetter_VarifyCandidate.aspx.cs" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <dxe:ASPxGridView ID="GridMessage" ClientInstanceName="grid" runat="server" Width="100%"
                               ...
                               <%-- BeginCallback="function(s, e) { callheight(s.cpHeight); }"--%>
                                ...
                                <Columns>
                                    ...
                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="11" FieldName="VarifyUser" Caption="Verified By">
                                        <EditFormSettings Visible="False"></EditFormSettings>
                                    </dxe:GridViewDataTextColumn>
                                    <dxe:GridViewDataTextColumn ReadOnly="True" VisibleIndex="12" FieldName="VaryfyDate" Caption="Verify Date">
                                        <EditFormSettings Visible="False"></EditFormSettings>
                                    </dxe:GridViewDataTextColumn>
...
<EditFormSettings Visible="False"></EditFormSettings>
                                    ...
                                    <dxe:GridViewDataTextColumn VisibleIndex="12" Caption="Details">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <DataItemTemplate>
                                            ...
                                            <a href="javascript:void(0);" onclick="OnMoreAccessCick('<%# Container.KeyValue %>')" title="Verify" class="pad" style="text-decoration: none;">
