<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true"
    Inherits="ERP.OMS.Management.management_Frm_SendEmailWithTemlate" ValidateRequest="false" CodeBehind="Frm_SendEmailWithTemlate.aspx.cs" %>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Generate Template </span></strong>
                </td>
            </tr>
        </table>
        <table class="TableMain100">
                ...
                <td valign="top">
                    <table style="margin: 0px 0px 0px 0px;" width="500px"
                       >
                        ...
                        <tr>
                            <td class="gridcellleft">
                                <span class="Ecoheadtxt">Sender Type:</span>
                            </td>
            ...
            <tr>
                <td colspan="2">
                    <table style="margin: 0px 0px 0px 0px; background-color: #9EBEF5;" width="500px"
                        border="#ffffff">
                        <tr id="trEmail">
                            <td class="gridcellleft">
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:Button ID="btnSend" runat="server" Text="Send Mail" CssClass="btnUpdate" OnClick="btnSend_Click" />
                                    </ContentTemplate>
                                    <Triggers>
