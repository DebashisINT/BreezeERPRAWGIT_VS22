<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Management.management_frmshowtemplate_popup" Codebehind="frmshowtemplate_popup.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">          
     ...
     function setvalue()
     {
       ...
       window.opener.document.form1.txtContent.value=msg;
                                                  
         if  (document.getElementById('HREC').value=='0')
              {                 
                  window.opener.document.form1.txtRelplyUser.disabled = false;
                  window.opener.document.form1.txtRelplyUser.focus();
              }
         else
              {              
                window.opener.document.form1.txtRelplyUser.disabled = true;
                //window.opener.document.aspnetForm.txtSaveTemplate.focus();
                window.opener.document.form1.HREC.value= document.getElementById('HREC').value;          
              }
         window.close();                      
     }
