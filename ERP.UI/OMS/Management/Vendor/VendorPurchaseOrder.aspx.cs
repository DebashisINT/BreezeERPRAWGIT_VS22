...
{
    public partial class VendorPurchaseOrder : System.Web.UI.Page
    {
        ...
        protected void Page_PreInit(object sender, EventArgs e) // lead add
        {
            ...
            {
                this.Page.MasterPageFile = "~/OMS/MasterPage/Vendor.Master";
        ...
        public void BindBranch()
        {
            ...
            DS_Branch.SelectCommand = "SELECT BRANCH_id AS BANKBRANCH_ID , RTRIM(BRANCH_DESCRIPTION)+' ['+ISNULL(RTRIM(BRANCH_CODE),'')+']' AS BANKBRANCH_NAME  FROM TBL_MASTER_BRANCH ";
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                else
                {
                    if (IsPOExist(IndentRequisitionNo))
                    {
                        ...
                        tempWarehousedt, TaxDetaildt, tempTaxDetailsdt, tempBillAddress, approveStatus) == false)
                        {
        ...
        public bool AddModifyPurchaseOrder(string PurchaseOrder_Id, string UniquePurchaseNumber, string strPurchaseDate, string IndentRequisitionNo, string IndentRequisitionDate,
            ...
            string strTaxCode, string CompanyID, int BaseCurrencyId, DataTable PurchaseOrderdt,
                                    string ActionType, DataTable Warehousedt, DataTable TaxDetaildt, DataTable PurchaseOrderTaxdt, DataTable tempBillAddress, string approveStatus)
        {
            try
            {
