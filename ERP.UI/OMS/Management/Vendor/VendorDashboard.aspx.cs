...
namespace ERP.OMS.Management.Vendor
{
    public partial class VendorDashboard : System.Web.UI.Page
    {
       // BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(string.Empty);
        ...
        {
            string VendorId = Convert.ToString(Session["usercontactID"]);

            DataTable dtdata = GetPurchaseOrderListForVendor(VendorId);
        ...
        public DataTable GetPurchaseOrderListForVendor(string VendorId)
        {

            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_PurchaseOrderDetailsList");
            proc.AddVarcharPara("@Action", 500, "PurchaseOrderListForVendor");
