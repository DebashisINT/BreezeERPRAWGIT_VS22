<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="EinvoiceWebTel.aspx.cs" Inherits="ERP.OMS.Management.EinvoiceWebTel" %>
<%@ Register Assembly="DevExpress.Web.v15.1, Version=15.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Data.Linq" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta name="csrf-token" content="XYZ123" />
    <script src="Activities/JS/EinvoiceWebTel.js"></script>    
