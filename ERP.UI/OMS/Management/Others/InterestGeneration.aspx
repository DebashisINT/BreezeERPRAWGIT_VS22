<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.Others.management_Others_InterestGeneration" Codebehind="InterestGeneration.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Interest & Penalty Generation</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Interest & Penalty Generation</span></strong>
                </td>
            </tr>
        </table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="gridcellleft">
                                            <dxe:ASPxDateEdit ID="DtFrom" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                Font-Size="12px" Width="108px" ClientInstanceName="cDtFrom" TabIndex="0">
                                        ...
                                        <td class="gridcellleft">
                                            <dxe:ASPxDateEdit ID="DtTo" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                Font-Size="12px" Width="108px" ClientInstanceName="cDtTo" TabIndex="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtMainAccount" TabIndex="0" runat="server" Width="250px" Font-Size="12px"
                                                onkeyup="FnAjaxListCall(this,'AcSearchClientOnly',event)"></asp:TextBox>
                                        </td>
                                                    ...
                                                    <td>
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlGroup" TabIndex="0" runat="server" Width="100px" Font-Size="12px"
                                                    ...
                                                    <td>
                                                        <table border="10" cellpadding="1" cellspacing="1">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:RadioButton ID="rdbClientALL" TabIndex="0" runat="server" Checked="True" GroupName="c"
                                                                        onclick="fnClients('a')" />
                                                                    All
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:RadioButton ID="rdbClientSelected" TabIndex="0" runat="server" GroupName="c"
                                                                        onclick="fnClients('b')" />
                                                                    Selected
                                                                </td>
                                                            </tr>
                        ...
                        <tr id="tr_BtnCF">
                            <td valign="top" class="gridcellleft">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <asp:Button ID="btnGenerateposition" runat="server" Text="Generate Interest" CssClass="btnUpdate"
                                                        ...
                                                        <table>
                                                            <tr>
                                                                <td height='25' align='center' bgcolor='#FFFFFF'>
                                                                    <img src='/assests/images/progress.gif' width='18' height='18'>
                                                                </td>
