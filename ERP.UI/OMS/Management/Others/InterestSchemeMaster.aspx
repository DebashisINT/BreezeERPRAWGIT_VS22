<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Management.Others.Management_Others_InterestSchemeMaster" Codebehind="InterestSchemeMaster.aspx.cs" %>
    ...
    <div id="content" >
       ...
       <div style="font-size:small;">
        <asp:GridView ID="gvInresetMaster" runat="server" AutoGenerateColumns="false" Width="98%" PageSize="10" AllowPaging="true" OnPageIndexChanged="gvInresetMaster_PageIndexChanged" OnPageIndexChanging="gvInresetMaster_PageIndexChanging" OnRowCommand="gvInresetMaster_RowCommand" HeaderStyle-BackColor="#B7CEEC" EmptyDataRowStyle-Font-Size="Large">
         ...
         <EmptyDataTemplate>
           No Record Found.Click  <asp:LinkButton  ID="lbtnAdds" ForeColor="blue" Text="here" runat="server" OnClientClick="clearFields();ShowPopUp();return false;"></asp:LinkButton> to add new record
         </EmptyDataTemplate>
      </asp:GridView>
        </div>
