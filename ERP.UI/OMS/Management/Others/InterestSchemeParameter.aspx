<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.Others.Management_Others_InterestSchemeParameter" Codebehind="InterestSchemeParameter.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <col width="33%">
        <tr>
            <td colspan="2" align="center" style="font-size: medium; font-weight: bold; padding: 5px 0 5px 0;">
                Interest Scheme Configuration
            </td>
        </tr>
        <tr>
            <td align="left">
                ...
                <b>Interest Scheme :</b>
                <asp:TextBox ID="txtInterestScheme" runat="server" Width="270" onkeyup="CallInterestScheme(this,'GenericAjaxList',event)"
                    onblur="Schemeblur();"></asp:TextBox>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="gvInterestSchemeParameter" runat="server" AllowPaging="true" AutoGenerateColumns="false"
                    OnPageIndexChanged="gvInterestSchemeParameter_PageIndexChanged" OnPageIndexChanging="gvInterestSchemeParameter_PageIndexChanging"
                    OnRowCommand="gvInterestSchemeParameter_RowCommand" Width="98%" EmptyDataText="No Record Founds"
                    EmptyDataRowStyle-Font-Bold="true" EmptyDataRowStyle-VerticalAlign="Middle" EmptyDataRowStyle-HorizontalAlign="Center"
                    HeaderStyle-BorderColor="Black" HeaderStyle-BackColor="#B7CEEC" RowStyle-BorderColor="Black">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <asp:LinkButton ID="lbtn" runat="server" Text="Add New" CommandName="newAdd" ForeColor="blue"
                                    Font-Underline="true"></asp:LinkButton>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnMore" runat="server" Text="Main Parameter Details......"
                                    CommandName="Info" CommandArgument='<%#Eval("IntRates_ID") %>'>
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnDetails" runat="server" Text="Slab and rate details......"
                                    CommandName="details" CommandArgument='<%#Eval("IDAndCycle") %>'>
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnDelete" runat="server" Text="Delete" OnClientClick="return DeleteConfirmation();"
                                    CommandName="Del" CommandArgument='<%#Eval("IdAndDateto") %>'>
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                ...
                <asp:Panel ID="pnlEmpty" runat="server">
                    <div style="font-size: small; font-weight: bold; padding: 5px 0 0 10px;">
                        No&nbsp;Record&nbsp;Found&nbsp;<asp:LinkButton ID="lbtn1" ForeColor="Blue" runat="server"
                            Text="Click" CommandName="newadd" OnClick="Add_empty"></asp:LinkButton>&nbsp;here
                        to add new details
                    </div>
                </asp:Panel>
            </td>
    ...
    <div id="divOverlapping" style="position: fixed; height: 100%; width: 100%; background-color: #000;
        top: 0px; left: 0px; opacity: 0.4; filter: alpha(opacity=40); z-index: 50; display: none;">
    </div>
    <div id="divPopUp" style="background-color: #B7CEEC; height: 320px; left: 11px; position: absolute;
        top: 10px; width: 970px; z-index: 75; display: none; padding-bottom: 5px;">
        <div style="background-color: #B7CEEC; height: 12px; font-size: small; color: White;
            padding-bottom: 27px; padding-left: 0px;">
            ...
            <div style="background-color: #B7CEEC; color: Black; padding-left: 0px; background-color: White;">
                <table border="1" style="border-collapse: collapse; background-color: #B7CEEC;" width="100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:RadioButtonList ID="rbtnCalculateOn" runat="server" RepeatDirection="Horizontal"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:RadioButtonList ID="rlstCycle" runat="server" RepeatDirection="Horizontal" TabIndex="0"
                        ...
                        <td align="left">
                            <asp:RadioButtonList ID="rlstDays" runat="server" RepeatDirection="Horizontal" TabIndex="0"
                                CssClass="radioButtonList">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtExAmount" runat="server" TabIndex="0" onkeypress="return isNumber(event)"
                        ...
                        <td align="left">
                            <asp:RadioButtonList ID="rlstBalanceType" runat="server" RepeatDirection="Horizontal"
                                TabIndex="0" CssClass="radioButtonList">
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="0">
                            <asp:TextBox ID="txtNarration" runat="server" TextMode="MultiLine" Width="316px"
                                Rows="2" TabIndex="0"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="font-weight: bold;">
                            Service&nbsp;Tax&nbsp;Main&nbsp;Account
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td colspan="4">
                            ...
                            <asp:Button ID="btnSave" Text="Save" runat="server" TabIndex="0" OnClick="btnSave_Click"
    ...
    <div id="divDetailsPopUp" style="background-color: #B7CEEC; height: 230px; left: 481px;
        position: absolute; top: 25px; width: 800px; left: 90px; z-index: 75; display: none;
        padding-bottom: 10px;">
        <div style="background-color: Black; height: 12px; font-size: small; color: White;
            font-weight: bold; padding-bottom: 27px; padding-left: 2px;">
            ...
            <div style="background-color: #B7CEEC; color: Black; padding-left: 0px;">
                    ...
                    <table border="5" style="border-collapse: collapse; background-color: #B7CEEC;" width="97%">
                        <tr>
                            ...
                            <td>
                                <div>
                                    <div style="float: left;">
                                        <asp:TextBox ID="txtDateFromDetails" runat="server" ValidationGroup="details" TabIndex="0"
                                            Enabled="false" onkeypress="return isNumber(event)"></asp:TextBox>
                                    </div>
                                    <div style="float: left;">
                                        <asp:RequiredFieldValidator ID="reqDaysFromDetails" runat="server" ControlToValidate="txtDateFromDetails"
                                            ErrorMessage="Enter&nbsp;Days&nbsp;From" ValidationGroup="details" ForeColor="red"
                                            Font-Bold="true">
                            ...
                            <td>
                                <div>
                                    <div style="float: left;">
                                        <asp:TextBox ID="txtDateToDetails" runat="server" ValidationGroup="details" TabIndex="0"
                                            MaxLength="2" onkeypress="return isNumber(event)"></asp:TextBox>
                                    </div>
                                    <div style="float: left;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDateToDetails"
                                            ErrorMessage="Enter&nbsp;Days&nbsp;To" ValidationGroup="details" Display="Dynamic"
                        ...
                        <tr>
                            ...
                            <td colspan="1">
                                <div>
                                    <div style="float: left;">
                                        <asp:TextBox ID="txtAmountFrom" runat="server" ValidationGroup="details" TabIndex="0"
                                            Enabled="false" onkeypress="return isNumber(event)"></asp:TextBox>
                                    </div>
                                    <div style="float: left;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAmountFrom"
                                            ErrorMessage="Enter&nbsp;Amount&nbsp;From" ValidationGroup="details" ForeColor="yellow"
                                            Font-Bold="true">
                                        </asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            ...
                            <td colspan="1">
                                <div>
                                    <div style="float: left;">
                                        <asp:TextBox ID="txtAmountTo" runat="server" ValidationGroup="details" TabIndex="0"
                                            MaxLength="15" onkeypress="return isNumber(event)"></asp:TextBox>
                                    </div>
                                    <div style="float: left;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtAmountTo"
                                            ErrorMessage="Enter&nbsp;Amount&nbsp;To" ValidationGroup="details" Display="Dynamic"
                                            ForeColor="red" Font-Bold="true">
                                        </asp:RequiredFieldValidator>
                        ...
                        <tr>
                            ...
                            <td colspan="1">
                                <div>
                                    <div style="float: left;">
                                        <asp:TextBox ID="txtRate" runat="server" ValidationGroup="details" TabIndex="0" MaxLength="9"
                                    ...
                                    <div style="float: left;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtRate"
                                            ErrorMessage="Enter&nbsp;Rate" ValidationGroup="details" ForeColor="red" Font-Bold="true">
                                        </asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </td>
                ...
                <div style="height: 100px; padding-top: 10px; overflow-y: scroll; background-color: #B7CEEC;
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnSaveDetails" runat="server" Text="Save" OnClick="btnSaveDetails_Click"
                                OnClientClick="alert('Detailed parameters saved successfully');" />
                        </td>
                        <td>
