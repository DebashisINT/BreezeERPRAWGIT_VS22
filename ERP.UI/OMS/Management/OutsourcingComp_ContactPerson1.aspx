<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" Inherits="ERP.OMS.Management.management_OutsourcingComp_ContactPerson1" CodeBehind="OutsourcingComp_ContactPerson1.aspx.cs" %>
    ...
    <div>
        <table class="TableMain100">
            <tr>
                <td>
                    <br />
                    <dxe:ASPxGridView ID="GridContactPerson" ClientInstanceName="GridContactPerson" KeyFieldName="ContactId" runat="server" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css"
