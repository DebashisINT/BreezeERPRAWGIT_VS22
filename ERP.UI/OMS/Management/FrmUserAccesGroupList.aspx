<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.management_FrmUserAccesGroupList" CodeBehind="FrmUserAccesGroupList.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading">
        <div class="panel-title">
            <h3>User Access Group Members</h3>
        </div>
    </div>
    <div class="form_main">
                            ...
                            <td valign="top">
                                <table cellspacing="1" cellpadding="2" style=" border: solid 1px  #ffffff"
                                        ...
                                        <td>
                                            <table id="ShowSelectUser">
                                                <tr>
                                                    ...
                                                    <td valign="top">
                                                        <asp:RadioButton ID="rbClientUser" runat="server" GroupName="h" /><span style="font-size: 8pt; color: #009900"> </span>Selected
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                            ...
                                                            <tr>
                                                                <td style="text-align: left">
                                                                    <table cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td>
                                                                                <a id="AA2" href="javascript:void(0);" onclick="clientselection()" class="btn btn-primary btn-small"><span>Done</span></a>
                                                                                <a id="AA1" href="javascript:void(0);" onclick="btnRemoveEmailFromlist_click()" class="btn btn-danger btn-small"><span>Remove</span></a>
                                                                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             <asp:Button ID="Button1" runat="server" CssClass="btnUpdate btn btn-primary" OnClick="Button1_Click"
                                                Text="Show" />
                                            <asp:Button ID="btnExoprt" runat="server" CssClass="btnUpdate btn btn-primary" OnClick="btnExoprt_Click"
