<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorLogin.aspx.cs" Inherits="ERP.OMS.VendorLogin" %>
            ...
            <div class="loginArea">
                <form action="" method="post" runat="server" novalidate="novalidate">
                    ...
                    <div class="form-group" style="text-align: center">
                        ...
                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" TabIndex="4" CssClass="compemail" OnClick="LinkButton1_Click1" Visible="false" >Forgot  Password?</asp:LinkButton>
                    </div>
