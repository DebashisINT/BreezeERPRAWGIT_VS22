...
{
    public partial class PurchaseIndentRegister : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/PurchaseIndentRegister.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Purchase Indent Register";
                ...
                Session["IsPrINDRegDetSumFilter"] = null;
                BranchHoOffice();
        ...
        public void cmbExport_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsPrINDRegDetSumFilter"]) == "Y")
            {
                if (Filter != 0)
                {
                    bindexport(Filter);
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "PurchaseIndentRegister";
            ...
            if (Filter == 1 || Filter == 2)
            {
                ...
                con.Open();
                string selectQuery = "SELECT BRANCHNAME,PROJ_NAME,INDNO,INDDATE,QONO,QODATE,ORDNO,ORDDATE,PRODUCTDESC,PRODUCTCLASS_NAME,QTY,STOCKUOM,MULTIUOM,MULTQTY,CONVFACTOR,RATE,GROSAMOUNT,CREATEDBY FROM PURCHASEINDENTREGISTERDETSUM_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SEQ<>999999999999 AND BRANCHNAME<>'Total :' order by SEQ";
                SqlDataAdapter myCommand = new SqlDataAdapter(selectQuery, con);

                // Create and fill a DataSet.
                DataSet ds = new DataSet();
                myCommand.Fill(ds, "Main");
                myCommand = new SqlDataAdapter("Select BRANCHNAME,QTY,MULTQTY,GROSAMOUNT from PURCHASEINDENTREGISTERDETSUM_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SEQ=999999999999 AND BRANCHNAME='Total :'", con);
                myCommand.Fill(ds, "GrossTotal");
                myCommand.Dispose();
                con.Dispose();
                Session["exportindregsumdetdataset"] = ds;
                ...
                foreach (DataRow dr1 in ds.Tables[0].Rows)
                {
                    ...
                    row2["Indent No."] = dr1["INDNO"];
                    row2["Date"] = dr1["INDDATE"];
                    ...
                    row2["Rate"] = dr1["RATE"];
                    row2["Total Value"] = dr1["GROSAMOUNT"];
                ...
                dtExport.Columns.Remove("INDNO");
                dtExport.Columns.Remove("INDDATE");
                ...
                row3["Total Value"] = ds.Tables[1].Rows[0]["GROSAMOUNT"].ToString();
                ...
                HeaderRow6[0] = "Purchase Indent Register";
            ...
            {
                case 1:
                    objExcel.ExportToExcelforExcel(dtExport, "PurchaseIndentRegister", "ZZZZZZZZZZZZZZZZ", "ZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    break;
                case 2:
                    objExcel.ExportToPDF(dtExport, "PurchaseIndentRegister", "ZZZZZZZZZZZZZZZZ", "ZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    break;
                case 3:
        ...
        #region Purchase Indent Register Details/Summary grid
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            string returnPara = Convert.ToString(e.Parameter);
            string HEAD_BRANCH = returnPara.Split('~')[1];

            string IsPrINDRegDetSumFilter = Convert.ToString(hfIsPrINDRegDetSumFilter.Value);
            Session["IsPrINDRegDetSumFilter"] = IsPrINDRegDetSumFilter;
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetPurchaseINDRegisterdata(FROMDATE, TODATE, BRANCH_ID, HEAD_BRANCH, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetPurchaseINDRegisterdata(string FROMDATE, string TODATE, string BRANCH_ID, string HEAD_BRANCH, string PROJECT_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("PRC_PURCHASEINDENTREGISTERDETSUM_REPORT", con);
        ...
        protected void ShowGrid_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            if (Convert.ToString(Session["IsPrINDRegDetSumFilter"]) == "Y")
            {
                dtINQTotal = oDBEngine.GetDataTable("Select BRANCHNAME,QTY,MULTQTY,GROSAMOUNT from PURCHASEINDENTREGISTERDETSUM_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SEQ=999999999999 AND BRANCHNAME='Total :'");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsPrINDRegDetSumFilter"]) == "Y")
            {
                var q = from d in dc.PURCHASEINDENTREGISTERDETSUM_REPORTs
