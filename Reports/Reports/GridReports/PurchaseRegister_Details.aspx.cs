    ...
    public partial class PurchaseRegister_Details : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Purchase Invoice Register - Detail";
                ...
                Session["IsPurchaseRegDetFilter"] = null;
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsPurchaseRegDetFilter = Convert.ToString(hfIsPurchaseRegDetFilter.Value);
            Session["IsPurchaseRegDetFilter"] = IsPurchaseRegDetFilter;
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsPurchaseRegDetFilter"]) == "Y")
            {
                var q = from d in dc.PURCHASEREGISTERPRODUCTDETAILS_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.TRAN_TYPE) == "PB"
                        orderby d.SEQ
                        select d;
                e.QueryableSource = q;
            }
