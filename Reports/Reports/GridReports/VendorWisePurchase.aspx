...
2.0                28-04-2023        2.0.38           Pallab              25975: Vendor Wise Purchase module zoom popup upper part visible issue fix
====================================================== Revision History =============================================--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="VendorWisePurchase.aspx.cs" Inherits="Reports.Reports.GridReports.VendorWisePurchase" %>
   ...
   <%-- For Vendor multiselection--%>    
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsVendwisePurchaseSumFilter").val("Y");
        ...
        function OpenPartyDetails(partyid) {
            $("#hfIsVendwisePurchaseDetFilter").val("Y");
        ...
        function OpenDocDetails(docid, doctype) {
            var url = '';
            if (doctype == 'PI') {
                url = '/OMS/Management/Activities/PurchaseInvoice.aspx?key=' + docid + '&IsTagged=1&req=V&type=PB';
            }
            else if (doctype == 'TPI') {
                url = '/OMS/Management/Activities/TPurchaseInvoice.aspx?key=' + docid + '&IsTagged=1&req=V&type=' + doctype;
            }
            else if (doctype == 'PR') {
                url = '/OMS/Management/Activities/PReturn.aspx?key=' + docid + '&IsTagged=1&req=V&type=PR';
            }
            else if (doctype == 'CR' || doctype == 'DR') {
                url = '/OMS/Management/Activities/VendorDrCrNoteAdd.aspx?key=' + docid + '&IsTagged=1&req=V&type=CDCN';
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="PARTYNAME" Width="250px" VisibleIndex="2" Caption="Vendor Name" FixedStyle="Left">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="TAXABLEAMT" Width="120px" Caption="Net Purc. Value" VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                    <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
    ...
    <dxe:ASPxPopupControl ID="popupDetails" runat="server" ClientInstanceName="cpopupDetails"
        Width="1200px" Height="600px" ScrollBars="Vertical" HeaderText="Vendor Details" PopupHorizontalAlign="WindowCenter" HeaderStyle-CssClass="wht"
                    ...
                    <div class="col-md-12">
                        <dxe:ASPxGridView ID="ShowGridDet" runat="server" AutoGenerateColumns="False" Width="100%" ClientInstanceName="cShowGridDet" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Vendor Name" Width="200px" FieldName="PARTYNAME" VisibleIndex="2" >
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Document No" FieldName="DOCNO" VisibleIndex="3" Width="120px">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Document Date" FieldName="DOCDATE" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" VisibleIndex="4" Width="100px">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>                                

                                <dxe:GridViewDataTextColumn Caption="Document Type" FieldName="TRAN_TYPE" VisibleIndex="5" Width="100px">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="TAXABLEAMT" Width="100px" Caption="Net Purc. Value" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                    <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="IGSTAMT" Width="100px" Caption="IGST" VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="CGSTAMT" Width="100px" Caption="CGST" VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="SGSTAMT" Width="100px" Caption="SGST" VisibleIndex="9" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="OTHER_TAX" Width="100px" Caption="Chrg After GST" VisibleIndex="10" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="TOTAL" Width="100px" Caption="Total Invoice Value" VisibleIndex="11" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsVendwisePurchaseSumFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanelDetail" ClientInstanceName="cCallbackPanelDetail" OnCallback="CallbackPanelDetail_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsVendwisePurchaseDetFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
