...
{
    public partial class CustomerAgeingDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/CustomerAgeingDetail.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Customer Ageing - Detail";
                ...
                BranchHoOffice();
                Session["IsCustAgeDetFilter"] = null;
        ...
        public void cmbExport_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            if (Convert.ToString(Session["IsCustAgeDetFilter"]) == "Y")
            {
                if (Filter != 0)
                {
                    bindexport(Filter);
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Customer Ageing-Detail";
            ...
            //FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Customer Ageing-Detail" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxAsOnDate.Date).ToString("dd-MM-yyyy");
            ////Rev Subhra 24-12-2018   0017670
            ...
            if (Filter == 1 || Filter == 2)
            {
                ...
                HeaderRow6[0] = "Customer Ageing-Detail";
            ...
            switch (Filter)
            {
                case 1:
                    ...
                    objExcel.ExportToExcelforExcel(dtExport, "Customer Ageing-Detail", "Party Total:", "ZZZZZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    //End of Rev Debashis
                    break;
                case 2:
                    //Rev Debashis
                    //exporter.WriteXlsxToResponse(new XlsxExportOptionsEx() { ExportType = ExportType.WYSIWYG });
                    objExcel.ExportToPDF(dtExport, "Customer Ageing-Detail", "Party Total:", "ZZZZZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    //End of Rev Debashis
                    break;
                //Rev Debashis
                //case 3:
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsCustAgeDetFilter = Convert.ToString(hfIsCustAgeDetFilter.Value);
            Session["IsCustAgeDetFilter"] = IsCustAgeDetFilter;
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetCustAgeingDetaildata(ASONDATE, BRANCH_ID, HEAD_BRANCH, PARTY_TYPE, ALLPARTY, CBVOUCHER, JVOUCHER, DNCNNOTE, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
            //ShowGridCustAgeing.ExpandAll();
        }
        public void GetCustAgeingDetaildata(string ASONDATE, string BRANCH_ID, string HEAD_BRANCH, string PARTY_TYPE, string ALLPARTY, string CBVOUCHER, string JVOUCHER, string DNCNNOTE, string PROJECT_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                ...
                cmd.Parameters.AddWithValue("@SHOWORDNODATE", (chkPartyOrdNoDt.Checked) ? "1" : "0");
        ...
        protected void ShowGridCustAgeing_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            if (Convert.ToString(Session["IsCustAgeDetFilter"]) == "Y")
            {
                ...
                dtPartyTotal = oDBEngine.GetDataTable("Select DOC_TYPE,DOC_AMOUNT,DAYS30,DAYS60,DAYS90,DAYS120,DAYS150,DAYS180,DAYS180A,CUMBAL_AMOUNT from PARTYWISEAGEINGSUMDET_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SLNO=999999999 AND DOC_TYPE='Net Total:' AND REPORT_TYPE='Detail' AND PARTYTYPE='C'");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsCustAgeDetFilter"]) == "Y")
            {
                var q = from d in dc.PARTYWISEAGEINGSUMDET_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.SLNO) != "999999999" && Convert.ToString(d.REPORT_TYPE) == "Detail" && Convert.ToString(d.PARTYTYPE)== "C"
                        //orderby d.PARTYID ascending, d.DOC_ID ascending, d.SLNO ascending
            ...
            if (ddldays.SelectedValue == "All")
            {
                ...
                //ShowGridCustAgeing.Columns[13].Visible = true;
                //ShowGridCustAgeing.Columns[14].Visible = true;
                //ShowGridCustAgeing.Columns[15].Visible = true;
                //ShowGridCustAgeing.Columns[16].Visible = true;
                //ShowGridCustAgeing.Columns[17].Visible = true;
                ShowGridCustAgeing.Columns[12].Visible = true;
                ShowGridCustAgeing.Columns[13].Visible = true;
                ShowGridCustAgeing.Columns[14].Visible = true;
                ShowGridCustAgeing.Columns[15].Visible = true;
                ShowGridCustAgeing.Columns[16].Visible = true;
                ShowGridCustAgeing.Columns[17].Visible = true;
                ShowGridCustAgeing.Columns[18].Visible = true;
                //End of Rev 1.0 Mantis: 0027273
            }
            else if (ddldays.SelectedValue == "D30")
            {
                ...
                //ShowGridCustAgeing.Columns[13].Visible = false;
                //ShowGridCustAgeing.Columns[14].Visible = false;
                //ShowGridCustAgeing.Columns[15].Visible = false;
                //ShowGridCustAgeing.Columns[16].Visible = false;
                //ShowGridCustAgeing.Columns[17].Visible = false;
                ShowGridCustAgeing.Columns[12].Visible = true;
                ShowGridCustAgeing.Columns[13].Visible = false;
                ShowGridCustAgeing.Columns[14].Visible = false;
                ShowGridCustAgeing.Columns[15].Visible = false;
                ShowGridCustAgeing.Columns[16].Visible = false;
                ShowGridCustAgeing.Columns[17].Visible = false;
                ShowGridCustAgeing.Columns[18].Visible = false;
                //End of Rev 1.0 Mantis: 0027273
            }
