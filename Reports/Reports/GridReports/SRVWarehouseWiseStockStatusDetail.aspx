<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="SRVWarehouseWiseStockStatusDetail.aspx.cs" Inherits="Reports.Reports.GridReports.SRVWarehouseWiseStockStatusDetail" %>
   ...
   <%-- For Product multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsSrvWHWStkStatDetFilter").val("Y");
            ...
            <dxe:PanelContent runat="server">
                 ...
                 <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                    ...
                    <Columns>
                        ...
                        <dxe:GridViewDataTextColumn Caption="Item Code" Width="200px" FieldName="PRODCODE" VisibleIndex="2" HeaderStyle-CssClass="colDisable">
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>

                        <dxe:GridViewDataTextColumn Caption="Item Name" Width="200px" FieldName="PRODDESC" VisibleIndex="3" HeaderStyle-CssClass="colDisable">
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>

                        <dxe:GridViewDataTextColumn Caption="Document No." Width="130px" FieldName="DOCNO" VisibleIndex="4" HeaderStyle-CssClass="colDisable">
                            <CellStyle HorizontalAlign="Center"> </CellStyle>
                            <HeaderStyle HorizontalAlign="Center" />
                            <DataItemTemplate>
                                <a href="javascript:void(0)" onclick="OpenModuleDetails('<%#Eval("DOC_ID") %>','<%#Eval("MODULE_TYPE") %>')">
                                    <%#Eval("DOCNO")%>
                                </a>
                            </DataItemTemplate>
                        ...
                        <dxe:GridViewDataTextColumn Caption="Date" Width="100px" FieldName="DOCDATE" VisibleIndex="5" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" HeaderStyle-CssClass="colDisable">
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>

                        <dxe:GridViewDataTextColumn Caption="Document Type" FieldName="TRANS_TYPE" Width="200px" VisibleIndex="6" HeaderStyle-CssClass="colDisable">
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>

                        <dxe:GridViewDataTextColumn Caption="Challan No." FieldName="CHALLAN_NO" Width="130px" VisibleIndex="7" HeaderStyle-CssClass="colDisable">
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>

                        <dxe:GridViewDataTextColumn Caption="Challan Type" FieldName="CHALLAN_TYPE" Width="100px" VisibleIndex="8" HeaderStyle-CssClass="colDisable">
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>

                        <dxe:GridViewDataTextColumn Caption="Remarks" FieldName="REMARKS" Width="100px" VisibleIndex="9" HeaderStyle-CssClass="colDisable">
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>
                               
                        <dxe:GridViewDataTextColumn FieldName="OP_QTY" Caption="Opening Qty." Width="100px" VisibleIndex="10" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False" HeaderStyle-CssClass="colDisable">
                                <HeaderStyle HorizontalAlign="Right" />
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>

                            <dxe:GridViewDataTextColumn FieldName="IN_QTY" Caption="Received Qty." Width="100px" VisibleIndex="11" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False" HeaderStyle-CssClass="colDisable">
                                <HeaderStyle HorizontalAlign="Right" />
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>

                        <dxe:GridViewDataTextColumn FieldName="OUT_QTY" Caption="Issued Qty" Width="100px" VisibleIndex="12" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False" HeaderStyle-CssClass="colDisable">
                                <HeaderStyle HorizontalAlign="Right" />
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>

                        <dxe:GridViewDataTextColumn FieldName="BAL_QTY" Caption="Balance Qty" Width="100px" VisibleIndex="13" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False" HeaderStyle-CssClass="colDisable">
                                <HeaderStyle HorizontalAlign="Right" />
                            <Settings AutoFilterCondition="Contains" />
                        </dxe:GridViewDataTextColumn>
                    </Columns>
                    ...
                    <TotalSummary>
                        <dxe:ASPxSummaryItem FieldName="PRODDESC" SummaryType="Custom" Tag="Det_ProdDesc"/>
                        ...
                        <dxe:ASPxSummaryItem FieldName="BAL_QTY" SummaryType="Custom" Tag="Det_BalQty"/>
                    </TotalSummary>
                 </dxe:ASPxGridView>
                 <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                     ContextTypeName="ReportSourceDataContext" TableName="SRVWAREHOUSEWISESTOCKSTATUS_REPORT"></dx:LinqServerModeDataSource>

            <asp:HiddenField ID="hfIsSrvWHWStkStatDetFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
