...
<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="VendorAgeingDetail.aspx.cs" Inherits="Reports.Reports.GridReports.VendorAgeingDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <td colspan="2">
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGridVendAgeing" ClientInstanceName="GridVendAgeing" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            OnSummaryDisplayText="ShowGridVendAgeing_SummaryDisplayText" Settings-HorizontalScrollBarMode="Visible" AllowSort="False"
                            ...
                            <columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Vendor Name"  FieldName="PARTYNAME" GroupIndex="1"
                                    VisibleIndex="0" >
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn Caption="Unit" FieldName="BRANCH_DESCRIPTION" Width="200px" VisibleIndex="1" FixedStyle="Left" HeaderStyle-CssClass="colDisable">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="DOC_TYPE" Width="100px" Caption="Doc. Type" HeaderStyle-CssClass="colDisable">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="PARTYINVOICENO" Width="140px" Caption="Party Inv. No" VisibleIndex="7" HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                 <dxe:GridViewDataTextColumn Caption="Party Inv. Date" Width="100px" FieldName="PARTYINVOICEDATE" VisibleIndex="8" HeaderStyle-CssClass="colDisable">
                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DOC_AMOUNT" Caption="Doc. Amt." Width="120px" VisibleIndex="10" HeaderStyle-CssClass="colDisable">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DAYS30" Caption="0-30 Days" Width="110px" VisibleIndex="11" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn FieldName="DAYS60" Caption="31-60 Days" Width="110px" VisibleIndex="12" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn FieldName="DAYS90" Caption="61-90 Days" Width="110px" VisibleIndex="13" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn FieldName="DAYS120" Caption="91-120 Days" Width="110px" VisibleIndex="14" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DAYS180A" Caption="181 & Above" Width="110px" VisibleIndex="17" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="CUMBAL_AMOUNT" Caption="Balance" Width="110px" VisibleIndex="18" HeaderStyle-CssClass="colDisable">
                                     <CellStyle HorizontalAlign="Right">
                                     </CellStyle>
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DAYS" Caption="Days" Width="90px" VisibleIndex="19" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
    ...
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsVendAgeDetFilter" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
