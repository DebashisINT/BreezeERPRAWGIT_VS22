...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-lg-2 lblmTop8">
                <label style="color: #b5285f; font-weight: bold;" class="clsTo">
            ...
            <div class="col-md-3 col-lg-2">
                <span style="display: inline-block;"><dxe:ASPxLabel ID="lbl_Customer" style="color: #b5285f;" runat="server" Text="Customer:">
                </dxe:ASPxLabel></span>                        
        ...
        <table class="TableMain100">
            <tr>
                <td colspan="2">
                       ...
                       <div>
                           <dxe:ASPxGridView runat="server" ID="ShowGridCustOut" ClientInstanceName="GridCustOut" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                               OnSummaryDisplayText="ShowGridCustOut_SummaryDisplayText" Settings-HorizontalScrollBarMode="Visible" 
                               DataSourceID="GenerateEntityServerModeDataSource" ClientSideEvents-BeginCallback="CallbackCustOut_BeginCallback" 
                            ...
                            <Columns>
                               ...
                               <%--  <dxe:GridViewDataTextColumn Caption="Sl."  FieldName="SEQ" GroupIndex="0"
                                ...
                                <dxe:GridViewDataTextColumn Caption="Unit" FieldName="BRANCH_DESCRIPTION" Width="350px" VisibleIndex="1" FixedStyle="Left" HeaderStyle-CssClass="colDisable">
                                 ...
                                 <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="DOC_TYPE" Width="250px" Caption="Doc. Type" FixedStyle="Left" HeaderStyle-CssClass="colDisable">
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="5" FieldName="DOC_NO" Width="150px" Caption="Doc. No." FixedStyle="Left" HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Doc. Date" Width="130px" FieldName="DOC_DATE" VisibleIndex="6" HeaderStyle-CssClass="colDisable">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Salesman" FieldName="SALESMAN" Width="200px" VisibleIndex="10" HeaderStyle-CssClass="colDisable">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                            
                                <dxe:GridViewDataTextColumn FieldName="DOC_AMOUNT" Caption="Doc. Amt." Width="100px" VisibleIndex="11" HeaderStyle-CssClass="colDisable">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="RETENTIONBLKAMT" Caption="Ret. Block Amt." Width="100px" VisibleIndex="12" HeaderStyle-CssClass="colDisable">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn FieldName="AFTRETENTIONAMT" Caption="After Retention" Width="100px" VisibleIndex="13" HeaderStyle-CssClass="colDisable">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn FieldName="BAL_AMOUNT" Caption="Balance Amount" Width="100px" VisibleIndex="14" HeaderStyle-CssClass="colDisable">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DAYS" Caption="Days" Width="50px" VisibleIndex="15" HeaderStyle-CssClass="colDisable">
                                   <%-- <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>--%>
                                      <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
