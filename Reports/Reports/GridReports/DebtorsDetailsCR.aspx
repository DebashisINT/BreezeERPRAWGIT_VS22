...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <td colspan="2">
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                <dxe:GridViewDataTextColumn FieldName="BRANCH_DESC" Caption="Unit and Warehouse Details" Width="50%" VisibleIndex="1" HeaderStyle-CssClass="colDisable"/>
                                <dxe:GridViewDataTextColumn FieldName="Over_120_Days" Caption="Over 120 days" Width="25%" VisibleIndex="2" HeaderStyle-CssClass="colDisable" PropertiesTextEdit-DisplayFormatString="0.00" />
                                <dxe:GridViewDataTextColumn FieldName="Within_120_Days" Caption="Within 120 days" Width="20%" VisibleIndex="3" HeaderStyle-CssClass="colDisable" PropertiesTextEdit-DisplayFormatString="0.00"/>
                                <dxe:GridViewDataTextColumn FieldName="Total" Caption="Total" Width="25%" VisibleIndex="4" HeaderStyle-CssClass="colDisable" PropertiesTextEdit-DisplayFormatString="0.00"/>
                            </Columns>
    ...
    <dxe:ASPxPopupControl ID="ASPXPopupControl2" runat="server"
     ...
     <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsDebtorsDetCRFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
