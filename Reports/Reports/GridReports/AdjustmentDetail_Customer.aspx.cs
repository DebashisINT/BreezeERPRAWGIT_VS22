...
{
    public partial class AdjustmentDetail_Customer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Adjustment Listing - Customers";
                ...
                Session["IsAdjDocCustFilter"] = null;
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Adjustment Listing - Customers";
            exporter.FileName = filename;
            string FileHeader = "";

            BusinessLogicLayer.Reports RptHeader = new BusinessLogicLayer.Reports();

            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Adjustment Listing - Customers" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
            //Rev Subhra 24-12-2018   0017670
        ...
        {
            string IsAdjDocCustFilter = Convert.ToString(hfIsAdjDocCustFilter.Value);
            Session["IsAdjDocCustFilter"] = IsAdjDocCustFilter;
            ...
            //End of Rev
            Task PopulateStockTrialDataTask = new Task(() => GetAdjDocCustomerdata(BRANCH_ID, FROMDATE, TODATE));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetAdjDocCustomerdata(string BRANCH_ID, string FROMDATE, string TODATE)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@WHICHMODULE", "ADJDOCCUST");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsAdjDocCustFilter"]) == "Y")
            {
                var q = from d in dc.INTERESTCALCULATION_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.PARTYTYPE) == "C" && Convert.ToString(d.WHICHMODULE) == "ADJDOCCUST"
                        orderby d.SEQ
                        select d;
                e.QueryableSource = q;
            }
