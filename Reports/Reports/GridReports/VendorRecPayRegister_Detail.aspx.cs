...
{
    public partial class VendorRecPayRegister_Detail : System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/VendorRecPayRegister_Detail.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Vendor Payment/Receipt Register - Details";
                ...
                Session["IsVendRecPayDetail"] = null;
                BranchHoOffice();
                dtFrom = DateTime.Now;
                dtTo = DateTime.Now;
        ...
        {
            string filename = "Vendor Payment/Receipt Register - Details";
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsVendRecPayDetail = Convert.ToString(hfIsVendRecPayDetail.Value);
            Session["IsVendRecPayDetail"] = IsVendRecPayDetail;
        ...
        public void GetVendRecPayRegisterdata(string FROMDATE, string TODATE, string BRANCH_ID, string HEAD_BRANCH, string CUSTVENDID, string PROJECT_ID)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@PARTYTYPE", "DV");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsVendRecPayDetail"]) == "Y")
            {
                var q = from d in dc.CUSTVENDRECEIPTPAYMENTREGISTERDET_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.PARTYTYPE) == "DV"
                        orderby d.SRLNO
                        select d;
                e.QueryableSource = q;
            }
