    ...
    public partial class PurchaseReturnRegister_Details : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Purchase Return Register - Detail";
                ...
                Session["IsPurchaseRetRegDetFilter"] = null;
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsPurchaseRetRegDetFilter = Convert.ToString(hfIsPurchaseRetRegDetFilter.Value);
            Session["IsPurchaseRetRegDetFilter"] = IsPurchaseRetRegDetFilter;
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsPurchaseRetRegDetFilter"]) == "Y")
            {
                var q = from d in dc.PURCHASEREGISTERPRODUCTDETAILS_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.TRAN_TYPE) == "PR"
                        orderby d.SEQ
                        select d;
                e.QueryableSource = q;
            }
