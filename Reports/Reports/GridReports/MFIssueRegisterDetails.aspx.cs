...
{
    public partial class MFIssueRegisterDetails : System.Web.UI.Page
    {
        ...
        DataTable dtMITotal = null;
        DataTable dtMIDetTotal = null;
        string MITotalBalDesc = "";
        string MIDetTotalBalDesc = "";
        string MIFGQty = "";
        string MIMatQty = "";
        string MIAmt = "";
        string MIFGAmt = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/MFIssueRegisterDetails.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Issue Register - Detail";
                ...
                Session["IsMFMIRegSumFilter"] = null;
                Session["IsMFMIRegDetFilter"] = null;
                BranchHoOffice();
        ...
        public void cmbExport_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsMFMIRegSumFilter"]) == "Y")
            {
                if (Filter != 0)
                {
                    bindexport(Filter);
        ...
        public void bindexport(int Filter)
        {
            ...
            if (Filter == 1 || Filter == 2)
            {
                ...
                con.Open();
                string selectQuery = "SELECT BRANCHDESC,PROJ_NAME,MINO,MIDATE,WCDESC,MATCODE,MATDESC,MATQTY,MATUOM,MATRATE,MATAMT,WAREHOUSENAME,ORDNO,ORDDT,REFFGNO,REFFGDT,CREATEDBY FROM MFISSUEREGISTERDETAIL_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND BRANCHID<>999999999999 AND REPORTTYPE='Summary' AND BRANCHDESC<>'Total :' order by SEQ";
                SqlDataAdapter myCommand = new SqlDataAdapter(selectQuery, con);

                // Create and fill a DataSet.
                DataSet ds = new DataSet();
                myCommand.Fill(ds, "Main");
                myCommand = new SqlDataAdapter("Select BRANCHDESC,MATQTY,MATAMT from MFISSUEREGISTERDETAIL_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND BRANCHID=999999999999 AND REPORTTYPE='Summary' AND BRANCHDESC='Total :'", con);
                myCommand.Fill(ds, "GrossTotal");
                myCommand.Dispose();
                con.Dispose();
                Session["exportmiregsumdataset"] = ds;
                ...
                dtExport.Columns.Add(new DataColumn("Ref. FG Rec. No.", typeof(string)));
                dtExport.Columns.Add(new DataColumn("Rec. Date", typeof(string)));
                ...
                foreach (DataRow dr1 in ds.Tables[0].Rows)
                {
                    ...
                    row2["Issue No."] = dr1["MINO"];
                    row2["Date"] = dr1["MIDATE"];
                    ...
                    row2["Ref. FG Rec. No."] = dr1["REFFGNO"];
                    row2["Rec. Date"] = dr1["REFFGDT"];
                ...
                dtExport.Columns.Remove("MINO");
                dtExport.Columns.Remove("MIDATE");
                ...
                dtExport.Columns.Remove("REFFGNO");
                dtExport.Columns.Remove("REFFGDT");
                ...
                HeaderRow6[0] = "Issue Register - Summary";
            ...
            {
                case 1:
                    objExcel.ExportToExcelforExcel(dtExport, "MIRegisterSummary", "ZZZZZZZZZZZZZZZZ", "ZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    break;
                case 2:
                    objExcel.ExportToPDF(dtExport, "MIRegisterSummary", "ZZZZZZZZZZZZZZZZ", "ZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    break;
                case 3:
        ...
        public void cmbExport1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsMFMIRegDetFilter"]) == "Y")
            {
                if (Filter != 0)
                {
        ...
        public void bindexportDetails(int Filter)
        {
            ...
            if (Filter == 1 || Filter == 2)
            {
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                con.Open();
                string selectQuery = "SELECT BRANCHDESC,MINO,MIDATE,FGCODE,FGDESC,FGQTY,FGRATE,FGAMT,FGUOM,FGWHDESC FROM MFISSUEREGISTERDETAIL_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND BRANCHID<>999999999999 AND REPORTTYPE='Details' AND BRANCHDESC<>'Total :' order by SEQ";
                SqlDataAdapter myCommand = new SqlDataAdapter(selectQuery, con);

                // Create and fill a DataSet.
                DataSet ds = new DataSet();
                myCommand.Fill(ds, "Main");
                myCommand = new SqlDataAdapter("Select BRANCHDESC,FGQTY,FGAMT from MFISSUEREGISTERDETAIL_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND BRANCHID=999999999999 AND REPORTTYPE='Details' AND BRANCHDESC='Total :'", con);
                myCommand.Fill(ds, "GrossTotal");
                myCommand.Dispose();
                con.Dispose();
                Session["exportmiregdetdataset"] = ds;
                ...
                dtReportHeader.Rows.Add(HeaderRow5);
                DataRow HeaderRow6 = dtReportHeader.NewRow();
                HeaderRow6[0] = "Issue Register - Detail";
                dtReportHeader.Rows.Add(HeaderRow6);
                DataRow HeaderRow7 = dtReportHeader.NewRow();
                HeaderRow7[0] = "For the period: " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
                dtReportHeader.Rows.Add(HeaderRow7);
            ...
            {
                case 1:
                    objExcel.ExportToExcelforExcel(dtExport, "MIRegisterDetails", "ZZZZZZZZZZZZZZZZ", "ZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    break;
                case 2:
                    objExcel.ExportToPDF(dtExport, "MIRegisterDetails", "ZZZZZZZZZZZZZZZZ", "ZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    break;
                case 3:
                    exporter.WriteCsvToResponse();
                    break;
        ...
        #region MI Register Summary grid
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            string returnPara = Convert.ToString(e.Parameter);
            string HEAD_BRANCH = returnPara.Split('~')[1];

            string IsMFMIRegSumFilter = Convert.ToString(hfIsMFMIRegSumFilter.Value);
            Session["IsMFMIRegSumFilter"] = IsMFMIRegSumFilter;
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetMIRegisterSumdata(FROMDATE, TODATE, BRANCH_ID, WH_ID, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetMIRegisterSumdata(string FROMDATE, string TODATE, string BRANCH_ID, string WH_ID, string PROJECT_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("PRC_MFISSUEREGISTERDETAIL_REPORT", con);
        ...
        protected void ShowGrid_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            if (Convert.ToString(Session["IsMFMIRegSumFilter"]) == "Y")
            {
                dtMITotal = oDBEngine.GetDataTable("Select BRANCHDESC,MATQTY,MATAMT from MFISSUEREGISTERDETAIL_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND BRANCHID=999999999999 AND REPORTTYPE='Summary' AND BRANCHDESC='Total :'");
                MITotalBalDesc = dtMITotal.Rows[0][0].ToString();
                MIMatQty = dtMITotal.Rows[0][1].ToString();
                MIAmt = dtMITotal.Rows[0][2].ToString();
            }
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsMFMIRegSumFilter"]) == "Y")
            {
                var q = from d in dc.MFISSUEREGISTERDETAIL_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.REPORTTYPE)=="Summary" && Convert.ToString(d.BRANCHID) != "999999999999" && Convert.ToString(d.BRANCHDESC) != "Total :"
                        orderby d.SEQ
                        select d;
                e.QueryableSource = q;
            }
        ...
        #region =====================MI Register Details===========================
        protected void CallbackPanelDetail_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            string IsMFMIRegDetFilter = Convert.ToString(hfIsMFMIRegDetFilter.Value);
            Session["IsMFMIRegDetFilter"] = IsMFMIRegDetFilter;
            ...
            {                
                GetMIRegisterDetdata(FROMDATE, TODATE, docid, docno, WH_ID);
            }

        }

        public void GetMIRegisterDetdata(string FROMDATE, string TODATE, string docid, string docno, string WH_ID)
        {
            try
            {
                DataSet ds = new DataSet();
        ...
        protected void ShowGridDetail_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            if (Convert.ToString(Session["IsMFMIRegDetFilter"]) == "Y")
            {
                dtMIDetTotal = oDBEngine.GetDataTable("Select BRANCHDESC,FGQTY,FGAMT from MFISSUEREGISTERDETAIL_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND BRANCHID=999999999999 AND REPORTTYPE='Details' AND BRANCHDESC='Total :'");
                MIDetTotalBalDesc = dtMIDetTotal.Rows[0][0].ToString();
                MIFGQty = dtMIDetTotal.Rows[0][1].ToString();
                MIFGAmt = dtMIDetTotal.Rows[0][2].ToString();
            }
        ...
        protected void GenerateEntityServerDetailsModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            {
                var q = from d in dc.MFISSUEREGISTERDETAIL_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.REPORTTYPE) == "Details" && Convert.ToString(d.BRANCHID) != "999999999999" && Convert.ToString(d.BRANCHDESC) != "Total :"
                        orderby d.SEQ
                        select d;
                e.QueryableSource = q;
            }
