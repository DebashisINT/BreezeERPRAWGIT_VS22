   ...
   <%-- For multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            $("#drdExport").val(0);
            $("#hfIsVendAnalysisDetFilter").val("Y");
    ...
    <script>
        ...
        function CallbackVendAnalysis_BeginCallback() {
            $("#drdExport").val(0);
        }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            if ($('body').hasClass('mini-navbar')) {
                ...
                GridVendAnalysis.SetWidth(cntWidth);
            } else {
                var windowWidth = $(window).width();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table class="TableMain100">
            <tr>
                <td colspan="2">
                       ...
                       <div>
                           <dxe:ASPxGridView runat="server" ID="ShowGridVendAnalysis" ClientInstanceName="GridVendAnalysis" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                               OnSummaryDisplayText="ShowGridVendAnalysis_SummaryDisplayText" Settings-VerticalScrollBarMode="Auto" Settings-HorizontalScrollBarMode="Auto"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Party Inv. No." Width="120px" FieldName="PARTYINVOICENO" VisibleIndex="7" HeaderStyle-CssClass="colDisable">
                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Party Inv. Date" Width="90px" FieldName="PARTYINVOICEDATE" VisibleIndex="8" HeaderStyle-CssClass="colDisable">
                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Due Date" Width="80px" FieldName="DUE_DATE" VisibleIndex="9" HeaderStyle-CssClass="colDisable">
                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                            
                                <dxe:GridViewDataTextColumn FieldName="DOC_AMOUNT" Caption="Doc. Amt." Width="110px" VisibleIndex="10" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" HeaderStyle-CssClass="colDisable">
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="11" FieldName="ADJ_DOC_TYPE" Width="180px" Caption="Adj. Doc. Type" HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn VisibleIndex="12" FieldName="ADJ_DOC_NO" Width="120px" Caption="Adj. Doc. No." HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Adj. Doc. Date" Width="90px" FieldName="ADJ_DOC_DATE" VisibleIndex="13" HeaderStyle-CssClass="colDisable">
                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="ADJ_AMOUNT" Caption="Adj. Amt." Width="90px" VisibleIndex="14" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" HeaderStyle-CssClass="colDisable">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <%--<PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>--%>
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn FieldName="BAL_AMOUNT" Caption="Balance Amount" Width="110px" VisibleIndex="15" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" HeaderStyle-CssClass="colDisable">
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <%--<PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>--%>
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DAYS" Caption="Days" Width="50px" VisibleIndex="16" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
    ...
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsVendAnalysisDetFilter" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
