...
<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="LocationWiseSellableStock.aspx.cs" Inherits="Reports.Reports.GridReports.LocationWiseSellableStock" %>
   ...
   <%-- For Brand multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            else if (gridwarehouseLookup.GetValue() == null && CchkIsWHWise.GetChecked() == true) {
                jAlert('Please select atleast one Warehouse for generate the report.');
            }
            else {
                cShowGridLocationwiseStockStatus.PerformCallback(data);
            }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            if ($('body').hasClass('mini-navbar')) {
                ...
                cShowGridLocationwiseStockStatus.SetWidth(cntWidth);
            } else {
                var windowWidth = $(window).width();
    ...
    <div class="outer-div-main">
        ...
        <div class="clearfix row">
            ...
            <div class="col-md-2" style="margin-top:22px;color: #b5285f; font-weight: bold;">
                <dxe:ASPxCheckBox runat="server" ID="chkIsWHWise" Checked="false" Text="Consider Warehouse" ClientInstanceName="CchkIsWHWise">
                    <ClientSideEvents CheckedChanged="CheckIsWHWise" />
                </dxe:ASPxCheckBox>
            </div>

            <div class="col-md-2" style="margin-top:22px;color: #b5285f; font-weight: bold;">
                <dxe:ASPxCheckBox runat="server" ID="chkExcludeZero" Checked="false" Text="Exclude Zero">
                </dxe:ASPxCheckBox>
            </div>
            <%--<div class="clear"></div>--%>
        ...
        <table class="TableMain100">
            <tr>
                <td colspan="2">
                    <div>
                        <dxe:ASPxGridView ID="ShowGridLocationwiseStockStatus" runat="server" ClientInstanceName="cShowGridLocationwiseStockStatus" 
                            Width="100%" Settings-HorizontalScrollBarMode="Auto" KeyFieldName="SEQ" SettingsBehavior-ColumnResizeMode="Control" Settings-VerticalScrollableHeight="400" 
                            Settings-VerticalScrollBarMode="Auto" Theme="PlasticBlue" OnCustomCallback="ShowGridLocationwiseStockStatus_CustomCallback" 
                            OnDataBinding="ShowGridLocationwiseStockStatus_DataBinding"
                            Settings-ShowFilterRow="true" Settings-ShowFilterRowMenu="true" OnHtmlFooterCellPrepared="ShowGridLocationwiseStockStatus_HtmlFooterCellPrepared">
                            <Columns>
