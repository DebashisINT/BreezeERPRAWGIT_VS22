<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="MFIssueRegisterDetails.aspx.cs" Inherits="Reports.Reports.GridReports.MFIssueRegisterDetails" %>
   ...
   <%-- For Product multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsMFMIRegSumFilter").val("Y");
            $("#hfIsMFMIRegDetFilter").val("N");
            $("#drdExport").val(0);
        ...
        function CallbackPanelDetEndCall(s, e) {
            ...
            ctxtIssueNo2ndLevel.SetText(cCallbackPanelDetail.cpDocNo);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <dxe:PanelContent runat="server">
                 ...
                 <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="MINO" Width="130px" Caption="Issue No." >
                                ...
                                <dxe:GridViewDataDateColumn Caption="Date" Width="100px" FieldName="MIDATE" VisibleIndex="4" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="6" FieldName="FGDESC" Width="150px" Caption="FG Details">
                                    ...
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>
                                        <a href="javascript:void(0)" onclick="OpenFGDetails('<%#Eval("MIID") %>','<%#Eval("MINO") %>','<%#Eval("MIDATE") %>')" class="pad">
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="13" FieldName="WAREHOUSENAME" Width="130px" Caption="Warehouse">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="16" FieldName="REFFGNO" Width="130px" Caption="Ref. FG Rec. No.">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataDateColumn Caption="Rec. Date" Width="100px" FieldName="REFFGDT" VisibleIndex="17" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>
                    ...
                    <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                            ContextTypeName="ReportSourceDataContext" TableName="MFISSUEREGISTERDETAIL_REPORT"></dx:LinqServerModeDataSource>

            <asp:HiddenField ID="hfIsMFMIRegSumFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
                        ...
                        <tr>
                            <td style="padding-top: 10px;padding-right:5px">
                                <label style="color: #b5285f; font-weight: bold; margin-top: 5px;" class="clsTo">
                                    <asp:Label ID="Label4" runat="Server" Text="Issue No. :" CssClass="mylabel1"></asp:Label>
                                </label>
                            </td>
                            <td style="padding-top: 10px;padding-right:5px">
                                <dxe:ASPxTextBox ID="txtIssueNo2ndLevel" ClientInstanceName="ctxtIssueNo2ndLevel" runat="server" ReadOnly="true" Width="300px"></dxe:ASPxTextBox>
                            </td>
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanelDetail" ClientInstanceName="cCallbackPanelDetail" OnCallback="CallbackPanelDetail_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsMFMIRegDetFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
