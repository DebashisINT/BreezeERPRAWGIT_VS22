<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="BSStatementProject.aspx.cs" Inherits="Reports.Reports.GridReports.BSStatementProject" %>
...
<%--                                <dxe:GridViewDataTextColumn FieldName="OP_DR_AMT" Caption="Opening (Dr.)" Width="8%" VisibleIndex="4" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;(#####,##,##,###0.00)" Settings-AllowAutoFilter="False">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="OP_CR_AMT" Caption="Opening (Cr.)" Width="8%" VisibleIndex="5" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;(#####,##,##,###0.00)" Settings-AllowAutoFilter="False">
                                 ...
                                 <dxe:GridViewDataTextColumn FieldName="Proj_Code" Caption="Project Code" Width="12%" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;(#####,##,##,###0.00)" Settings-AllowAutoFilter="False">
                                </dxe:GridViewDataTextColumn>
