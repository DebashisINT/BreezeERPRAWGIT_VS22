...
{
    public partial class AdjustmentDetail_Vendor : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Adjustment Listing - Vendors";
                ...
                Session["IsAdjDocVendFilter"] = null;
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Adjustment Listing - Vendors";
            exporter.FileName = filename;
            string FileHeader = "";

            BusinessLogicLayer.Reports RptHeader = new BusinessLogicLayer.Reports();

            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Adjustment Listing - Vendors" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
            //Rev Subhra 24-12-2018   0017670
        ...
        {
            string IsAdjDocVendFilter = Convert.ToString(hfIsAdjDocVendFilter.Value);
            Session["IsAdjDocVendFilter"] = IsAdjDocVendFilter;
            ...
            //End of Rev
            Task PopulateStockTrialDataTask = new Task(() => GetAdjDocVendordata(BRANCH_ID, FROMDATE, TODATE));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetAdjDocVendordata(string BRANCH_ID, string FROMDATE, string TODATE)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@NOOFDAYSEXCEED", 0);
                cmd.Parameters.AddWithValue("@INTPERCENTAGE", 0);
                cmd.Parameters.AddWithValue("@PARTYTYPE", "V");
                cmd.Parameters.AddWithValue("@WHICHMODULE", "ADJDOCVEND");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsAdjDocVendFilter"]) == "Y")
            {
                var q = from d in dc.INTERESTCALCULATION_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.PARTYTYPE) == "V" && Convert.ToString(d.WHICHMODULE) == "ADJDOCVEND"
                        orderby d.SEQ
                        select d;
                e.QueryableSource = q;
            }
