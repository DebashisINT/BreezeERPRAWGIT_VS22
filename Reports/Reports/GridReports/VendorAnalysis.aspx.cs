...
namespace Reports.Reports.GridReports
{
    public partial class VendorAnalysis : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/VendorAnalysis.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Vendor Analysis - Detail";
                ...
                BranchHoOffice();
                Session["IsVendAnalysisDetFilter"] = null;
        ...
        public void cmbExport_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            if (Convert.ToString(Session["IsVendAnalysisDetFilter"]) == "Y")
            {
                if (Filter != 0)
                {
                    bindexport(Filter);
        ...
        {
            string filename = "Vendor Analysis-Detail";
            ...
            //FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Vendor Analysis-Detail" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxAsOnDate.Date).ToString("dd-MM-yyyy");
            //FileHeader = ReplaceFirst(FileHeader, "\r\n", Convert.ToString(Session["BranchNames"]));
            //exporter.PageHeader.Left = FileHeader;
            //exporter.PageHeader.Font.Size = 10;
            //exporter.PageHeader.Font.Name = "Tahoma";

            //exporter.GridViewID = "ShowGridVendAnalysis";
            ...
            if (Filter == 1 || Filter == 2)
            {
                ...
                myCommand = new SqlDataAdapter("Select DOC_TYPE,TOT_BAL_AMOUNT AS BAL_AMOUNT from PARTYWISEANALYSISDET_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SLNO=999999 AND DOC_TYPE='Gross Total :' AND PARTYTYPE='V'", con);
                myCommand.Fill(ds, "GrossTotal");
                myCommand.Dispose();
                con.Dispose();
                Session["exportvendanadetdataset"] = ds;
                ...
                HeaderRow6[0] = "Vendor Analysis-Detail";
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsVendAnalysisDetFilter = Convert.ToString(hfIsVendAnalysisDetFilter.Value);
            Session["IsVendAnalysisDetFilter"] = IsVendAnalysisDetFilter;
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetVendAnalysisDetdata(ASONDATE, BRANCH_ID, HEAD_BRANCH, PARTY_TYPE, DUEDATE, ALLPARTY, PRINT_DAYS, CBVOUCHER, JVOUCHER, DNCNNOTE, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetVendAnalysisDetdata(string ASONDATE, string BRANCH_ID, string HEAD_BRANCH, string PARTY_TYPE, string DUEDATE, string ALLPARTY, string PRINT_DAYS, string CBVOUCHER, string JVOUCHER, string DNCNNOTE, string PROJECT_ID)
        {
            try
            {
                DataSet ds = new DataSet();
        ...
        protected void ShowGridVendAnalysis_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            if (Convert.ToString(Session["IsVendAnalysisDetFilter"]) == "Y")
            {
                //dtPartyTotal = oDBEngine.GetDataTable("Select DOC_TYPE,BAL_AMOUNT from PARTYWISEANALYSISDET_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SLNO=999999 AND DOC_TYPE='Gross Total :' AND PARTYTYPE='V'");
                dtPartyTotal = oDBEngine.GetDataTable("Select DOC_TYPE,TOT_BAL_AMOUNT from PARTYWISEANALYSISDET_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SLNO=999999 AND DOC_TYPE='Gross Total :' AND PARTYTYPE='V'");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsVendAnalysisDetFilter"]) == "Y")
            {
                var q = from d in dc.PARTYWISEANALYSISDET_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.SLNO) != "999999" && Convert.ToString(d.PARTYTYPE) == "V"
                        orderby d.SEQ
                        select d;
                e.QueryableSource = q;
            }
        ...
        #endregion
        protected void ShowGridVendAnalysis_HtmlFooterCellPrepared(object sender, ASPxGridViewTableFooterCellEventArgs e)
        {
        ...
        protected void ShowGridVendAnalysis_HtmlDataCellPrepared(object sender, ASPxGridViewTableDataCellEventArgs e)
        {
