...
<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="CashBankBookDetail_Subledgerwise.aspx.cs" 
    Inherits="Reports.Reports.GridReports.CashBankBookDetail_Subledgerwise" %>
  ...
  <%-- For multiselection when click on ok button--%>
    ...
    <script>
        ...
        function btn_ShowRecordsClick(e) {
            ...
            $("#drdExport").val(0);
            $("#hfIsSubledgerCashBankDet").val("Y");
            var partyledgerid = hdnSelectedPartyLedger.value;

            //if (ctxtPartyLedger.GetValue() == null) {
            if (ctxtPartyLedger.GetValue() == null & chkallparties.checked==false) {
                ...
                if (ProjectSelectionInReport == "Yes" && gridprojectLookup.GetValue() == null) {
                    ...
                    cCallbackPanel.PerformCallback($("#ddlbranchHO").val() + '~' + partyledgerid);
                }
            }
            else {
        ...
        function AllParties(obj) {
            if (obj == 'allparties') {
                if (chkallparties.checked == true) {
                    ctxtPartyLedger.SetText('');
                    GetObjectID('hdnSelectedPartyLedger').value = '';
        ...
        function OpenDocDetails(Uniqueid, type, docno) {
            ...
            if (type == 'VP' || type == 'VR') {
                ...
                url = '/OMS/Management/dailytask/ContraVoucher.aspx?key=' + Uniqueid + '&IsTagged=1&req=V';
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="row">
                                        ...
                                        <StatusBar>
                                            <table class="OptionsTable" style="float: right">
                                                <tr>
                                                    <td>
                                                        <%--<div class="hide">--%>
                                                            <dxe:ASPxButton ID="ASPxButton2" runat="server" AutoPostBack="false" Text="Select All" ClientSideEvents-Click="_selectAll" UseSubmitBehavior="False"/>
                                                        <%--</div>--%>
                                                        <dxe:ASPxButton ID="ASPxButton1" runat="server" AutoPostBack="false" Text="Deselect All" ClientSideEvents-Click="_unselectAll" UseSubmitBehavior="False"/>
            ...
            <div class="col-md-2">
                <label style="color: #b5285f; font-weight: bold;" class="clsTo">
                <asp:Label ID="Label6" runat="Server" Text="Party : " CssClass="mylabel1"></asp:Label></label>
                <div>
            ...
            <div class="col-md-2" style="padding-top: 24px">
                ...
                <div style="color: #b5285f;" class="clsTo">
                    <asp:CheckBox runat="server" ID="chkallparties" Checked="false" Text="All Parties" />
                </div>
            </div>
                                        ...
                                        <StatusBar>
                                            <table class="OptionsTable" style="float: right">
                                                <tr>
                                                    <td>
                                                        <%--<div class="hide">--%>
                                                            <dxe:ASPxButton ID="ASPxButton6" runat="server" AutoPostBack="false" Text="Select All" ClientSideEvents-Click="selectAll" UseSubmitBehavior="False" />
                                                        <%--</div>--%>
                                                        <dxe:ASPxButton ID="ASPxButton7" runat="server" AutoPostBack="false" Text="Deselect All" ClientSideEvents-Click="unselectAll" UseSubmitBehavior="False" />
            ...
            <div class="col-md-2" style="padding-top: 24px">
                <%--Rev end 1.0--%>
                <div style="color: #b5285f;" class="clsTo">
                    <asp:CheckBox ID="chkCBwise" runat="server" Checked="false"></asp:CheckBox>
                    <asp:Label ID="Label2" runat="Server" Text="Cash/Bank wise" CssClass="mylabel1"></asp:Label>
                </div>
            </div>
        ...
        <div class="clearfix">
            <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="cShowGrid" Width="100%" EnableRowsCache="False" AutoGenerateColumns="False" KeyFieldName="SEQ"
                ...
                <Columns>
                    <dxe:GridViewDataTextColumn FieldName="LEDG_DESC" Caption="Cash/Bank Name" Width="150" VisibleIndex="0" GroupIndex="0" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>

                    <dxe:GridViewDataComboBoxColumn FieldName="BRANCH_DESC" Caption="Unit" Width="200px" VisibleIndex="1" HeaderStyle-CssClass="colDisable">
                    ...
                    <dxe:GridViewDataTextColumn FieldName="LEDG_DESC" Caption="Ledger Desc." Width="150px" VisibleIndex="2" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn FieldName="SUBLEDGER" Caption="Party" Width="250px" VisibleIndex="3" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn FieldName="SUBLEDGERTYPE" Caption="Party Type" Width="100px" VisibleIndex="4" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>
                     <dxe:GridViewDataTextColumn FieldName="DOCUMENT_NO" Caption="Voucher No." Width="150px" VisibleIndex="5" HeaderStyle-CssClass="colDisable">
                        <CellStyle HorizontalAlign="Center">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                        <DataItemTemplate>

                            <a href="javascript:void(0)" onclick="OpenDocDetails('<%#Eval("DOC_ID") %>','<%#Eval("MODULE_TYPE") %>' ,'<%#Eval("DOCUMENT_NO") %>')" class="pad">
                                <%#Eval("DOCUMENT_NO")%>
                            </a>
                        </DataItemTemplate>
                    ...
                    <dxe:GridViewDataTextColumn FieldName="TRAN_DATE" Caption="Voucher Date" Width="80px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn FieldName="INSTRUMENT_NO" Caption="Cheque Number" Width="130px" VisibleIndex="7" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn FieldName="INSTRUMENT_DATE" Caption="Cheque Date" Width="80px" VisibleIndex="8" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn FieldName="DRAWEE_BANK" Caption="Cheque On Bank" Width="100px" VisibleIndex="9" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn FieldName="TRAN_TYPE" Caption="Doc. Type" Width="150px" VisibleIndex="10" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn FieldName="PROJ_NAME" Caption="Project Name" Width="200px" VisibleIndex="11" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn FieldName="PAYEE_INFO" Caption="Recv. From/Paid To" Width="150px" VisibleIndex="12" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn FieldName="HEADER_NARRATION" Caption="Header Narration" Width="200px" VisibleIndex="13" HeaderStyle-CssClass="colDisable">
                    </dxe:GridViewDataTextColumn>                    
                    ...
                    <dxe:GridViewDataTextColumn FieldName="CLOSING_BALANCE" Caption="Balance" Width="130px" VisibleIndex="16" FooterCellStyle-HorizontalAlign="Right" GroupFooterCellStyle-HorizontalAlign="Right" HeaderStyle-CssClass="colDisable">
                         <PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="0.00"></PropertiesTextEdit>
                        <CellStyle HorizontalAlign="Right"></CellStyle>
                        <HeaderStyle HorizontalAlign="Right" />
                    </dxe:GridViewDataTextColumn>
                ...
                <TotalSummary>
                    <dxe:ASPxSummaryItem FieldName="PAYEE_INFO" SummaryType="Custom" />
             ...
             <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                        ContextTypeName="ReportSourceDataContext" TableName="SUBLEDGERWISECASHBANKBOOK_REPORT"></dx:LinqServerModeDataSource>
        </div>
    </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="text" onkeydown="PartyLedgerkeydown(event)" id="txtPartyLedgerSearch" autofocus width="100%" placeholder="Search By Party Name or Contact No." />
  ...
  <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsSubledgerCashBankDet" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
