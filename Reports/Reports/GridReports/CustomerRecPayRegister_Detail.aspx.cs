...
{
    public partial class CustomerRecPayRegister_Detail : System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/CustomerRecPayRegister_Detail.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Customer Payment/Receipt Register - Details";
                ...
                Session["IsCustRecPayDetail"] = null;
                BranchHoOffice();
                dtFrom = DateTime.Now;
                dtTo = DateTime.Now;
        ...
        {
            string filename = "Customer Receipt/Payment Register - Detail";
            ...
            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Customer Receipt/Payment Register - Detail" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsCustRecPayDetail = Convert.ToString(hfIsCustRecPayDetail.Value);
            Session["IsCustRecPayDetail"] = IsCustRecPayDetail;
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetCustRecPayRegisterDetaildata(FROMDATE, TODATE, BRANCH_ID, HEAD_BRANCH, CUSTVENDID, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();

        }

        public void GetCustRecPayRegisterDetaildata(string FROMDATE, string TODATE, string BRANCH_ID, string HEAD_BRANCH, string CUSTVENDID,string PROJECT_ID)
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("PRC_CUSTVENDRECEIPTPAYMENTREGISTERDET_REPORT", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                cmd.Parameters.AddWithValue("@PARTY_ID", CUSTVENDID);
                cmd.Parameters.AddWithValue("@CHKALLCUSTVEND", (chkallcustomers.Checked) ? "1" : "0");
                cmd.Parameters.AddWithValue("@PARTYTYPE", "CL");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsCustRecPayDetail"]) == "Y")
            {
                var q = from d in dc.CUSTVENDRECEIPTPAYMENTREGISTERDET_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.PARTYTYPE) == "CL"
                        orderby d.SRLNO
                        select d;
                e.QueryableSource = q;
            }
