    ...
    public partial class CashBankBookRegister_Details : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Cash/Bank Register - Detail";
                ...
                Session["IsCashBankBookRegDet"] = null;
        ...
        public void bindexport(int Filter)
        {
            ...
            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true,true, true, true, true) + Environment.NewLine + "Cash/Bank Register - Detail" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
            //Rev Subhra 20-12-2018   0017670
        ...
        protected void CallbackPanel_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsCashBankBookRegDet = Convert.ToString(hfIsCashBankBookRegDet.Value);
            Session["IsCashBankBookRegDet"] = IsCashBankBookRegDet;
            ...
            //End of Rev
            Task PopulateStockTrialDataTask = new Task(() => GetCashBankBookRegisterdata(FROMDATE, TODATE, BRANCH_ID, HEAD_BRANCH,PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetCashBankBookRegisterdata(string FROMDATE, string TODATE, string BRANCH_ID, string HEAD_BRANCH, string PROJECT_ID)
        {
            try
            {
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsCashBankBookRegDet"]) == "Y")
            {
                var q = from d in dc.CASHBANKBOOKREGDET_REPORTs
