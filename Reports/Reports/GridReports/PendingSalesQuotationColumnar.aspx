...
<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PendingSalesQuotationColumnar.aspx.cs" Inherits="Reports.Reports.GridReports.PendingSalesQuotationColumnar" %>
   ...
   <%-- For multiselection--%>
    ...
    <script type="text/javascript">
        function btn_ShowRecordsClick(e) {
            ...
            $("#hfIsPendSaleQuotationColumnarFilter").val("Y");
        ...
        function OpenPendSaleQuoteDetails(quoteid, type) {
            if (type == 'SQO') {
                url = '/OMS/Management/Activities/SalesQuotation.aspx?key=' + quoteid + '&req=V&type=QO';
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="row">
            ...
            <div class="col-md-2" style="padding-top: 18px; padding-bottom: 15px;">
            <table>
                <tr>
                       ...
                       <div>
                           <dxe:ASPxGridView runat="server" ID="ShowGridList" ClientInstanceName="GridList" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Quotation Number" FieldName="QUOTENO" Width="130px" VisibleIndex="2" HeaderStyle-CssClass="colDisable">
                                   <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <DataItemTemplate>
                                        <a href="javascript:void(0)" onclick="OpenPendSaleQuoteDetails('<%#Eval("QUOTEID") %>','<%#Eval("REPORTTYPE") %>')" class="pad">
                                            <%#Eval("QUOTENO")%>
                                        </a>
                                    </DataItemTemplate>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Quotation Date" FieldName="QUOTE_DATE" Width="100px" VisibleIndex="3" HeaderStyle-CssClass="colDisable">
                            ...
                            <TotalSummary>
                                <dxe:ASPxSummaryItem FieldName="PRODNAME" SummaryType="Custom" Tag="SQOItem_Name"/>
                                <dxe:ASPxSummaryItem FieldName="ACTUALPCSMULTQTY" SummaryType="Custom" Tag="ASQO_Pcs"/>
                                <dxe:ASPxSummaryItem FieldName="ACTUALMETERMULTQTY" SummaryType="Custom" Tag="ASQO_Meter"/>
                                <dxe:ASPxSummaryItem FieldName="ACTUALSTOCKQTY" SummaryType="Custom" Tag="ASQO_Wt"/>
                                <dxe:ASPxSummaryItem FieldName="MATUREPCSQTY" SummaryType="Custom" Tag="MSQO_Pcs"/>
                                <dxe:ASPxSummaryItem FieldName="MATUREMETERQTY" SummaryType="Custom" Tag="MSQO_Meter"/>
                                <dxe:ASPxSummaryItem FieldName="MATURESTOCKQTY" SummaryType="Custom" Tag="MSQO_Wt"/>
                                <dxe:ASPxSummaryItem FieldName="BALPCSQTY" SummaryType="Custom" Tag="BSQO_Pcs"/>
                                <dxe:ASPxSummaryItem FieldName="BALMETERQTY" SummaryType="Custom" Tag="BSQO_Meter"/>
                                <dxe:ASPxSummaryItem FieldName="BALSTOCKQTY" SummaryType="Custom" Tag="BSQO_Wt"/>
                                <dxe:ASPxSummaryItem FieldName="ACTUAL_VALUES" SummaryType="Custom" Tag="ASQO_Value"/>
                                <dxe:ASPxSummaryItem FieldName="MATURE_VALUES" SummaryType="Custom" Tag="MSQO_Value"/>
                                <dxe:ASPxSummaryItem FieldName="BALANCE_VALUES" SummaryType="Custom" Tag="BSQO_Value"/>
                            </TotalSummary>

                        </dxe:ASPxGridView>

                      <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                        ContextTypeName="ReportSourceDataContext" TableName="PENDINGSALESPURCHASEQUOTATIONCOLUMNAR_REPORT" ></dx:LinqServerModeDataSource>
                    </div>
                </td>
            </tr>
        </table>
   ...
   <!--Customer Modal -->
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsPendSaleQuotationColumnarFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
