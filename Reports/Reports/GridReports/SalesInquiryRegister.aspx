<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="SalesInquiryRegister.aspx.cs" Inherits="Reports.Reports.GridReports.SalesInquiryRegister" %>
   ...
   <%-- For Product multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsSaleINQRegDetSumFilter").val("Y");
            $("#drdExport").val(0);
        ...
        function OpenDocDetails(docid,doctype) {
            var url = '';
            if (doctype == "Sales Inquiry") {
                url = '/OMS/Management/Activities/SalesInquiryAdd.aspx?key=' + docid + '&req=V&type=SINQ';
            }
            else if(doctype == "Project Sales Inquiry")
            {
                url = '/OMS/Management/Activities/ProjectInquiryAdd.aspx?key=' + docid + '&req=V&type=ProSINQ';
            }
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div style="color: #b5285f;" class="clsTo">
                    <asp:Label ID="Label4" runat="Server" Text="Customer : " CssClass="mylabel1" Width="100px"></asp:Label>
                </div>                                   
                <div>
            ...
            <dxe:PanelContent runat="server">
                 ...
                 <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Customer Name" Width="250px" FieldName="PARTYNAME" VisibleIndex="3">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="8" FieldName="INQNO" Width="130px" Caption="Inquiry No." >
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>

                                        <a href="javascript:void(0)" onclick="OpenDocDetails('<%#Eval("INQ_ID") %>','<%#Eval("TRANTYPE") %>')">
                                            <%#Eval("INQNO")%>
                                        </a>
                                    </DataItemTemplate>
                                ...
                                <dxe:GridViewDataDateColumn Caption="Date" Width="100px" FieldName="INQDATE" VisibleIndex="9" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn Caption="Reference" Width="200px" FieldName="REFERENCE" VisibleIndex="11" >
                                 ...
                                 <dxe:GridViewDataTextColumn VisibleIndex="12" FieldName="QONO" Width="130px" Caption="Pro./Quo. No." >
                                ...
                                <dxe:GridViewDataDateColumn Caption="Pro./Quo. Date" Width="100px" FieldName="QODATE" VisibleIndex="13" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>
                                ...
                                <dxe:GridViewDataDateColumn Caption="Order Date" Width="100px" FieldName="ORDDATE" VisibleIndex="15" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="QTY" Caption="Qty." Width="100px" VisibleIndex="18" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.000;">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Multi UOM" FieldName="MULTIUOM" Width="100px" VisibleIndex="20">
                                 ...
                                 <dxe:GridViewDataTextColumn FieldName="MULTQTY" Caption="Multi Qty." Width="80px" VisibleIndex="21" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.000;">
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                 <dxe:GridViewDataTextColumn FieldName="CONVFACTOR" Caption="Conv. Factor" Width="80px" VisibleIndex="22" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.0000;">
                                      <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="RATE" Caption="Rate" Width="100px" VisibleIndex="23" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="GROSAMOUNT" Caption="Value" Width="100px" VisibleIndex="24" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="CGST_AMT" Caption="CGST" Width="100px" VisibleIndex="25" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="SGST_AMT" Caption="SGST" Width="100px" VisibleIndex="26" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="IGST_AMT" Caption="IGST" Width="100px" VisibleIndex="27" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="UTGST_AMT" Caption="UTGST" Width="100px" VisibleIndex="28" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="OTHER_AMT" Caption="Other Charges(Line)" Width="130px" VisibleIndex="29" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="TAX_MISC" Caption="Tax Misc.(Global)" Width="100px" VisibleIndex="30" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                               
                                <dxe:GridViewDataTextColumn FieldName="TOTALAMOUNT" Caption="Total Value" Width="100px" VisibleIndex="31" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                    ...
                    <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                            ContextTypeName="ReportSourceDataContext" TableName="SALESINQUIRYREGISTERDETSUM_REPORT"></dx:LinqServerModeDataSource>

            <asp:HiddenField ID="hfIsSaleINQRegDetSumFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
