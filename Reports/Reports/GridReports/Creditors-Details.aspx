    ...
    <script type="text/javascript">
        function btn_ShowRecordsClick(e) {
            ...
            if (gridbranchLookup.GetValue() != null) {
                ...
                jAlert('Select at least one Branch for generate the report.');
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <table class="pull-left">
            <tr>
                <td style="">
                    <div style="color: #b5285f; font-weight: bold;padding-right:8px;" class="clsTo">
                ...
                <td colspan="2">
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            DataSourceID="GenerateEntityServerModeDataSource" ClientSideEvents-BeginCallback="Callback2_BeginCallback" OnSummaryDisplayText="ShowGrid_SummaryDisplayText"
                            Settings-HorizontalScrollBarMode="Visible">
                            <%--OnCustomCallback="Grid_CustomCallback" OnDataBinding="grid2_DataBinding"--%>
                            <Columns>
                                <dxe:GridViewDataTextColumn FieldName="Particulars" Caption="Particular" Width="50%" VisibleIndex="1" HeaderStyle-CssClass="colDisable" />
                                <dxe:GridViewDataTextColumn FieldName="Debit" Caption="Debit(Rs.)" Width="25%" VisibleIndex="2" HeaderStyle-CssClass="colDisable" CellStyle-HorizontalAlign="Right" PropertiesTextEdit-DisplayFormatString="0.00" Settings-AllowAutoFilter="False" >
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="Credit" Caption="Credit(Rs.)" Width="25%" VisibleIndex="3" HeaderStyle-CssClass="colDisable" CellStyle-HorizontalAlign="Right" PropertiesTextEdit-DisplayFormatString="0.00" Settings-AllowAutoFilter="False" >
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                            </Columns>
                        ...
                        ContextTypeName="ReportSourceDataContext" TableName="CREDITORSDETAILS_REPORT" ></dx:LinqServerModeDataSource>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <dxe:ASPxGridViewExporter ID="exporter" runat="server" Landscape="false" PaperKind="A4" PageHeader-Font-Size="Larger" PageHeader-Font-Bold="true">
     ...
     <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsCreditorsDetFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
