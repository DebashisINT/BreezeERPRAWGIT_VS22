...
2.0                03-05-2023        2.0.38           Pallab              26015 : Customer Receipt/Payment Register module zoom popup upper part visible issue fix for small device
====================================================== Revision History ================================================--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <%--<div class="panel-title">
            <h3>Customer Receipt/Payment Register</h3>
        </div>--%>
...
<%--                    <dxe:ASPxCallbackPanel runat="server" ID="ComponentCustomerPanel" ClientInstanceName="cCustomerComponentPanel" OnCallback="ComponentCustomer_Callback">
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsCustRecPay" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
