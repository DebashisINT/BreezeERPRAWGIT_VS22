...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="row">
            ...
            <div class="col-md-3 branch-selection-box">
                    <div style="color: #b5285f; font-weight: bold;" class="clsTo">
                ...
                <td colspan="2">
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SrlNo" 
                            ...
                            <%--OnDataBound="Showgrid_Htmlprepared" Settings-VerticalScrollableHeight="180" Settings-VerticalScrollBarMode="Auto" OnCustomCallback="Grid_CustomCallback" --%>
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="CustomerVendor" Caption="Customer(s)" VisibleIndex="7" Width="150px"/>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="CVRPTax_Amount" Caption="Taxable" VisibleIndex="11" PropertiesTextEdit-DisplayFormatString="0.00" Width="80px">
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsPaymentCollection" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
