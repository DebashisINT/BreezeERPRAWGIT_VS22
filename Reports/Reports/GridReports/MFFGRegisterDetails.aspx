<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="MFFGRegisterDetails.aspx.cs" Inherits="Reports.Reports.GridReports.MFFGRegisterDetails" %>
   ...
   <%-- For Product multiselection--%>
    ...
    <script type="text/javascript">
        ...
        document.onkeyup = function (e) {
            if (event.keyCode == 27 && cpopupMATDetails.GetVisible() == true) { //run code for alt+N -- ie, Save & New  
                popupHide();
            }
        }
        function popupHide(s, e) {
            cpopupMATDetails.Hide();
            Grid.Focus();
            $("#drdExport").val(0);
        }
        ...
        function btn_ShowRecordsClick(e) {
            ...
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsFGRegSumFilter").val("Y");
            $("#hfIsFGRegDetFilter").val("N");
            $("#drdExport").val(0);
        ...
        function CallbackPanelDetEndCall(s, e) {
            ...
            ctxtFgNo2ndLevel.SetText(cCallbackPanelDetail.cpDocNo);
    ...
    <script>
        ...
        function OpenMATDetails(docid, docno, docdate) {
            $("#hfIsFGRegDetFilter").val("Y");
            $("#ddldetails").val(0);
            cCallbackPanelDetail.PerformCallback('BndPopupgrid~' + docid + '~' + docno + '~' + docdate);
            cpopupMATDetails.Show();
            return true;
        }
        function popupHide(s, e) {
            cpopupMATDetails.Hide();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <dxe:PanelContent runat="server">
                 ...
                 <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="FGNO" Width="130px" Caption="FG No." >
                                ...
                                <dxe:GridViewDataDateColumn Caption="Date" Width="100px" FieldName="FGDATE" VisibleIndex="4" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn FieldName="FGRATE" Caption="FG Price" Width="100px" VisibleIndex="9" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                      <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="FGAMT" Caption="FG Amount" Width="100px" VisibleIndex="10" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                      <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn VisibleIndex="11" FieldName="FGUOM" Width="100px" Caption="FG UOM" >
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="13" FieldName="MATDESC" Width="150px" Caption="Material Details">
                                    <CellStyle HorizontalAlign="Center"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>
                                        <a href="javascript:void(0)" onclick="OpenMATDetails('<%#Eval("FGID") %>','<%#Eval("FGNO") %>','<%#Eval("FGDATE") %>')" class="pad">
                                            <dxe:ASPxLabel ID="ASPxTextBox2" runat="server" Text='Material Details' ToolTip="Material Details">
                                            </dxe:ASPxLabel>
                                        </a>
                                    </DataItemTemplate>
                                    <EditFormSettings Visible="False" />
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="14" FieldName="ORDNO" Width="130px" Caption="Order No.">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataDateColumn Caption="Order Date" Width="100px" FieldName="ORDDT" VisibleIndex="15" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>

                                <dxe:GridViewDataTextColumn VisibleIndex="16" FieldName="REFMINO" Width="130px" Caption="Ref. Issue No.">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataDateColumn Caption="Issue Date" Width="100px" FieldName="REFMIDT" VisibleIndex="17" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>

                                <dxe:GridViewDataTextColumn Caption="Created by" Width="130px" FieldName="CREATEDBY" VisibleIndex="18">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                            </Columns>
                    ...
                    <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                            ContextTypeName="ReportSourceDataContext" TableName="MFFGREGISTERDETAIL_REPORT"></dx:LinqServerModeDataSource>

            <asp:HiddenField ID="hfIsFGRegSumFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
        <ClientSideEvents EndCallback="CallbackPanelEndCall" />
    </dxe:ASPxCallbackPanel>

    <dxe:ASPxPopupControl ID="popupMATDetails" runat="server" ClientInstanceName="cpopupMATDetails"
        Width="1270px" Height="600px" ScrollBars="Vertical" HeaderText="Material Details" PopupHorizontalAlign="WindowCenter" HeaderStyle-CssClass="wht"
                        ...
                        <tr>
                            <td style="padding-top: 10px;padding-right:5px">
                                <label style="color: #b5285f; font-weight: bold; margin-top: 5px;" class="clsTo">
                                    <asp:Label ID="Label6" runat="Server" Text="FG No. :" CssClass="mylabel1"></asp:Label>
                                </label>
                            </td>
                            <td style="padding-top: 10px;padding-right:5px">
                                <dxe:ASPxTextBox ID="txtFgNo2ndLevel" ClientInstanceName="ctxtFgNo2ndLevel" runat="server" ReadOnly="true" Width="300px"></dxe:ASPxTextBox>
                            </td>
                    ...
                    <div class="col-md-12">
                        <dxe:ASPxGridView ID="ShowGridDetail" runat="server" AutoGenerateColumns="False" Width="100%" ClientInstanceName="cShowGridDetail" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Material Code" FieldName="MATCODE" Width="200px" VisibleIndex="2">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Description" FieldName="MATDESC" Width="200px" VisibleIndex="3">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="MATQTY" Caption="Mat. Qty." Width="100px" VisibleIndex="4" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.000;">
                                      <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn Caption="UOM" FieldName="MATUOM" Width="100px" VisibleIndex="5">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="MATRATE" Caption="Rate" Width="100px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="MATAMT" Caption="Value" Width="100px" VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn VisibleIndex="8" FieldName="MATWHDESC" Width="200px" Caption="Warehouse" >
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="9" FieldName="DETREMARKS" Width="200px" Caption="Remarks" >
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                            ...
                            <TotalSummary>
                                ...
                                <dxe:ASPxSummaryItem FieldName="MATAMT" SummaryType="Sum" Tag="MatAmt"/>
                            </TotalSummary>
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanelDetail" ClientInstanceName="cCallbackPanelDetail" OnCallback="CallbackPanelDetail_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsFGRegDetFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
