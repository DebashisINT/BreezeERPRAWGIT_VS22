	...
	public partial class CustomerRecPayRegister : System.Web.UI.Page
	{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Customer Receipt/Payment Register";
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsCustRecPay = Convert.ToString(hfIsCustRecPay.Value);
            Session["IsCustRecPay"] = IsCustRecPay;
            ...
            //End of Rev
            Task PopulateStockTrialDataTask = new Task(() => GetCustRecPayRegisterdata(FROMDATE, TODATE, BRANCH_ID, HEAD_BRANCH, CUSTVENDID, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();

        }

        public void GetCustRecPayRegisterdata(string FROMDATE, string TODATE, string BRANCH_ID, string HEAD_BRANCH, string CUSTVENDID, string PROJECT_ID)
        {
            try
            {
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsCustRecPay"]) == "Y")
            {
