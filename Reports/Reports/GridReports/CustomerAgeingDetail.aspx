...
<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="CustomerAgeingDetail.aspx.cs" Inherits="Reports.Reports.GridReports.CustomerAgeingDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="row">
            ...
            <div class="col-md-1" style="padding: 0; padding-top: 21px; width: 115px;">
            ...
            <div class="clear"></div>
            <div class="col-md-12">
            <div class="col-md-2 lblmTop8" style="padding-left:0;padding-top: 1px;" id="divProj">
            ...
            <div class="col-md-9 marginTop8 divPad" style="padding-top: 20px; padding-left:0;">
                ...
                <td colspan="2">
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGridCustAgeing" ClientInstanceName="GridCustAgeing" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            OnSummaryDisplayText="ShowGridCustAgeing_SummaryDisplayText" Settings-HorizontalScrollBarMode="Visible" AllowSort="False"
                            ...
                            <columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Customer Name"  FieldName="PARTYNAME" GroupIndex="1"
                                    VisibleIndex="0" >
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Unit" FieldName="BRANCH_DESCRIPTION" Width="250px" VisibleIndex="1" HeaderStyle-CssClass="colDisable">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                 <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="DOC_TYPE" Width="200px" Caption="Doc. Type" HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                            
                                 <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="ISOPENING" Width="80px" Caption="Opening?" HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="4" FieldName="PROJ_NAME" Width="200px" Caption="Project Name" HeaderStyle-CssClass="colDisable">
                                 ...
                                 <dxe:GridViewDataTextColumn VisibleIndex="5" FieldName="DOC_NO" Width="140px" Caption="Doc. No" HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Due Date" Width="100px" FieldName="DUE_DATE" VisibleIndex="7" HeaderStyle-CssClass="colDisable">
                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn VisibleIndex="8" FieldName="PARTYORD_NO" Width="120px" Caption="Party Order No." HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Party Order Date" Width="120px" FieldName="PARTYORD_DATE" VisibleIndex="9" HeaderStyle-CssClass="colDisable">
                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                            
                                <dxe:GridViewDataTextColumn FieldName="DOC_AMOUNT" Caption="Doc. Amt." Width="140px" VisibleIndex="10" HeaderStyle-CssClass="colDisable">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DAYS30" Caption="0-30 Days" Width="120px" VisibleIndex="11" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn FieldName="DAYS60" Caption="31-60 Days" Width="120px" VisibleIndex="12" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn FieldName="DAYS90" Caption="61-90 Days" Width="120px" VisibleIndex="13" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn FieldName="DAYS120" Caption="91-120 Days" Width="120px" VisibleIndex="14" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                 <dxe:GridViewDataTextColumn FieldName="DAYS150" Caption="121-150 Days" Width="120px" VisibleIndex="15" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="DAYS180" Caption="151-180 Days" Width="120px" VisibleIndex="16" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn FieldName="DAYS180A" Caption="181 & Above" Width="120px" VisibleIndex="17" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                      <CellStyle HorizontalAlign="Right">
                                      </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="CUMBAL_AMOUNT" Caption="Balance" Width="120px" VisibleIndex="18" HeaderStyle-CssClass="colDisable">
                                     <CellStyle HorizontalAlign="Right">
                                     </CellStyle>
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DAYS" Caption="Days" Width="110px" VisibleIndex="19" HeaderStyle-CssClass="colDisable">
                                      <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
    ...
    <%--<asp:HiddenField ID="hfIsCustAgeDetFilter" runat="server" />--%>
