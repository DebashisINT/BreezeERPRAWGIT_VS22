<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="EstimateRegisterSummary.aspx.cs" Inherits="Reports.Reports.GridReports.EstimateRegisterSummary" %>
  ...
  <%-- For multiselection when click on ok button--%>
   <%-- For multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function popupEMRegDetAfterHide(s, e) {
            popupEMRegDet.Hide();
        }
    </script>
    ...
    <script type="text/javascript">
        function btn_ShowRecordsClick(e) {
            ...
            $("#drdExport").val(0);
            $("#hfIsEstimateRegSumFilter").val("Y");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                       ...
                       <div>
                           <dxe:ASPxGridView runat="server" ID="ShowGridList" ClientInstanceName="GridList" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="8" FieldName="REFORDER"  Width="170px" Caption="Ref. Order">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn VisibleIndex="9" FieldName="REFQO"  Width="170px" Caption="Ref. Quotation">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn VisibleIndex="10" FieldName="REFINDENT"  Width="170px" Caption="Ref. Indent">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn VisibleIndex="11" FieldName="REFSI"  Width="170px" Caption="Ref. Invoice">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                               <dxe:GridViewDataTextColumn VisibleIndex="12" FieldName="INITIALMCOST" Width="110px" Caption="Initial Material Cost" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False">
                                   <CellStyle HorizontalAlign="Right"></CellStyle>
                                   <HeaderStyle HorizontalAlign="Right" />
                                   <Settings AutoFilterCondition="Contains" />
                               </dxe:GridViewDataTextColumn>

                               <dxe:GridViewDataTextColumn VisibleIndex="13" FieldName="INITIALSCOST" Width="110px" Caption="Initial Service Cost" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False">
                                   <CellStyle HorizontalAlign="Right"></CellStyle>
                                   <HeaderStyle HorizontalAlign="Right" />
                                   <Settings AutoFilterCondition="Contains" />
                               </dxe:GridViewDataTextColumn>

                               <dxe:GridViewDataTextColumn VisibleIndex="14" FieldName="INITIALTCOST" Width="110px" Caption="Initial Total Cost" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False">
                                   <CellStyle HorizontalAlign="Right"></CellStyle>
                                   <HeaderStyle HorizontalAlign="Right" />
                                   <Settings AutoFilterCondition="Contains" />
                               </dxe:GridViewDataTextColumn>

                               <dxe:GridViewDataTextColumn VisibleIndex="15" FieldName="INITIALMNETAMT" Width="160px" Caption="Initial Material Net Amount" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False">
                                   <CellStyle HorizontalAlign="Right"></CellStyle>
                                   <HeaderStyle HorizontalAlign="Right" />
                                   <Settings AutoFilterCondition="Contains" />
                               </dxe:GridViewDataTextColumn>

                               <dxe:GridViewDataTextColumn VisibleIndex="16" FieldName="INITIALSNETAMT" Width="160px" Caption="Initial Service Net Amount" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False">
                                   <CellStyle HorizontalAlign="Right"></CellStyle>
                                   <HeaderStyle HorizontalAlign="Right" />
                                   <Settings AutoFilterCondition="Contains" />
                               </dxe:GridViewDataTextColumn>

                               <dxe:GridViewDataTextColumn VisibleIndex="17" FieldName="REVMCOST" Width="130px" Caption="Revised Material Cost" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False">
                                   <CellStyle HorizontalAlign="Right"></CellStyle>
                                   <HeaderStyle HorizontalAlign="Right" />
                                   <Settings AutoFilterCondition="Contains" />
                               </dxe:GridViewDataTextColumn>

                               <dxe:GridViewDataTextColumn VisibleIndex="18" FieldName="REVSCOST" Width="130px" Caption="Revised Service Cost" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False">
                                   <CellStyle HorizontalAlign="Right"></CellStyle>
                                   <HeaderStyle HorizontalAlign="Right" />
                                   <Settings AutoFilterCondition="Contains" />
                               </dxe:GridViewDataTextColumn>

                               <dxe:GridViewDataTextColumn VisibleIndex="19" FieldName="REVTCOST" Width="130px" Caption="Revised Total Cost" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False">
                                   <CellStyle HorizontalAlign="Right"></CellStyle>
                                   <HeaderStyle HorizontalAlign="Right" />
                                   <Settings AutoFilterCondition="Contains" />
                               </dxe:GridViewDataTextColumn>

                               <dxe:GridViewDataTextColumn VisibleIndex="20" FieldName="REVMNETAMT" Width="160px" Caption="Revised Material Net Amount" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False">
                                   <CellStyle HorizontalAlign="Right"></CellStyle>
                                   <HeaderStyle HorizontalAlign="Right" />
                                   <Settings AutoFilterCondition="Contains" />
                               </dxe:GridViewDataTextColumn>

                               <dxe:GridViewDataTextColumn VisibleIndex="21" FieldName="REVSNETAMT" Width="160px" Caption="Revised Service Net Amount" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;" Settings-AllowAutoFilter="False">
                                   <CellStyle HorizontalAlign="Right"></CellStyle>
                                   <HeaderStyle HorizontalAlign="Right" />
                                   <Settings AutoFilterCondition="Contains" />
                               </dxe:GridViewDataTextColumn>
                            ...
                            <TotalSummary>
                                ...
                                <dxe:ASPxSummaryItem FieldName="INITIALMCOST" SummaryType="Sum" Tag="EM_IMC"/>
                                <dxe:ASPxSummaryItem FieldName="INITIALSCOST" SummaryType="Sum" Tag="EM_ISC"/>
                                <dxe:ASPxSummaryItem FieldName="INITIALTCOST" SummaryType="Sum" Tag="EM_ITC"/>
                                <dxe:ASPxSummaryItem FieldName="INITIALMNETAMT" SummaryType="Sum" Tag="EM_IMNetAmt"/>
                                <dxe:ASPxSummaryItem FieldName="INITIALSNETAMT" SummaryType="Sum" Tag="EM_ISNetAmt"/>
                                <dxe:ASPxSummaryItem FieldName="REVMCOST" SummaryType="Sum" Tag="EM_RMC"/>
                                <dxe:ASPxSummaryItem FieldName="REVSCOST" SummaryType="Sum" Tag="EM_RSC"/>
                                <dxe:ASPxSummaryItem FieldName="REVTCOST" SummaryType="Sum" Tag="EM_RTC"/>
                                <dxe:ASPxSummaryItem FieldName="REVMNETAMT" SummaryType="Sum" Tag="EM_RMNetAmt"/>
                                <dxe:ASPxSummaryItem FieldName="REVSNETAMT" SummaryType="Sum" Tag="EM_RSNetAmt"/>
                            </TotalSummary>

                        </dxe:ASPxGridView>

                      <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                        ContextTypeName="ReportSourceDataContext" TableName="ESTIMATEREGISTERSUMDET_REPORT" ></dx:LinqServerModeDataSource>
                    </div>
                </td>
            </tr>
        </table>
   ...
   <!--Customer Modal -->
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsEstimateRegSumFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
    ...
    CloseAction="CloseButton" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ClientInstanceName="popupEMRegDet" Height="500px"
    Width="1310px" HeaderText="Details" Modal="true" AllowResize="true" ResizingMode="Postponed">
    <ContentCollection>
        <dxe:PopupControlContentControl runat="server">
        </dxe:PopupControlContentControl>
    </ContentCollection>
    <ClientSideEvents CloseUp="popupEMRegDetAfterHide" />
