...
{
    public partial class VendorAgeingDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/VendorAgeingDetail.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Vendor Ageing - Detail";
                ...
                BranchHoOffice();
                Session["IsVendAgeDetFilter"] = null;
        ...
        public void cmbExport_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            if (Convert.ToString(Session["IsVendAgeDetFilter"]) == "Y")
            {
                if (Filter != 0)
                {
                    bindexport(Filter);
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Vendor Ageing-Detail";
            ...
            //FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Vendor Ageing-Detail" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxAsOnDate.Date).ToString("dd-MM-yyyy");
            ////Rev Subhra 24-12-2018   0017670
            ...
            //exporter.GridViewID = "ShowGridVendAgeing";
            ...
            if (Filter == 1 || Filter == 2)
            {
                ...
                HeaderRow6[0] = "Vendor Ageing-Detail";
            ...
            switch (Filter)
            {
                case 1:
                    ...
                    objExcel.ExportToExcelforExcel(dtExport, "Vendor Ageing-Detail", "Party Total:", "ZZZZZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    //End of Rev Debashis
                    break;
                case 2:
                    //Rev Debashis
                    //exporter.WriteXlsxToResponse(new XlsxExportOptionsEx() { ExportType = ExportType.WYSIWYG });
                    objExcel.ExportToPDF(dtExport, "Vendor Ageing-Detail", "Party Total:", "ZZZZZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    //End of Rev Debashis
                    break;
                //Rev Debashis
                //case 3:
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsVendAgeDetFilter = Convert.ToString(hfIsVendAgeDetFilter.Value);
            Session["IsVendAgeDetFilter"] = IsVendAgeDetFilter;
            ...
            //End of Rev
            Task PopulateStockTrialDataTask = new Task(() => GetVendAgeingDetaildata(ASONDATE, BRANCH_ID, HEAD_BRANCH, PARTY_TYPE, ALLPARTY, CBVOUCHER, JVOUCHER, DNCNNOTE, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetVendAgeingDetaildata(string ASONDATE, string BRANCH_ID, string HEAD_BRANCH, string PARTY_TYPE, string ALLPARTY, string CBVOUCHER, string JVOUCHER, string DNCNNOTE, string PROJECT_ID)
        {
            try
            {
                DataSet ds = new DataSet();
                ...
                cmd.Parameters.AddWithValue("@REPORT_TYPE", "Detail");
        ...
        protected void ShowGridVendAgeing_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            if (Convert.ToString(Session["IsVendAgeDetFilter"]) == "Y")
            {

                dtPartyTotal = oDBEngine.GetDataTable("Select DOC_TYPE,DOC_AMOUNT,DAYS30,DAYS60,DAYS90,DAYS120,DAYS150,DAYS180,DAYS180A,CUMBAL_AMOUNT from PARTYWISEAGEINGSUMDET_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SLNO=999999999 AND DOC_TYPE='Net Total:' AND REPORT_TYPE='Detail' AND PARTYTYPE='V'");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsVendAgeDetFilter"]) == "Y")
            {
                var q = from d in dc.PARTYWISEAGEINGSUMDET_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.SLNO) != "999999999" && Convert.ToString(d.REPORT_TYPE) == "Detail" && Convert.ToString(d.PARTYTYPE) == "V"
            ...
            {
                var q = from d in dc.PARTYWISEAGEINGSUMDET_REPORTs
                        where Convert.ToString(d.SLNO) == "0" && Convert.ToString(d.REPORT_TYPE) == "Detail"
                        orderby d.SEQ ascending
                        select d;
                e.QueryableSource = q;
            }
            ...
            if (ddldays.SelectedValue == "All")
            {
                ...
                //ShowGridVendAgeing.Columns[13].Visible = true;
                //ShowGridVendAgeing.Columns[14].Visible = true;
                //ShowGridVendAgeing.Columns[15].Visible = true;
                //ShowGridVendAgeing.Columns[16].Visible = true;
                //ShowGridVendAgeing.Columns[17].Visible = true;
                ShowGridVendAgeing.Columns[12].Visible = true;
                ShowGridVendAgeing.Columns[13].Visible = true;
                ShowGridVendAgeing.Columns[14].Visible = true;
                ShowGridVendAgeing.Columns[15].Visible = true;
                ShowGridVendAgeing.Columns[16].Visible = true;
                ShowGridVendAgeing.Columns[17].Visible = true;
                ShowGridVendAgeing.Columns[18].Visible = true;
                //End of Rev 1.0 Mantis: 0027273
            }
            else if (ddldays.SelectedValue == "D30")
            {
                ...
                //ShowGridVendAgeing.Columns[13].Visible = false;
                //ShowGridVendAgeing.Columns[14].Visible = false;
                //ShowGridVendAgeing.Columns[15].Visible = false;
                //ShowGridVendAgeing.Columns[16].Visible = false;
                //ShowGridVendAgeing.Columns[17].Visible = false;
                ShowGridVendAgeing.Columns[12].Visible = true;
                ShowGridVendAgeing.Columns[13].Visible = false;
                ShowGridVendAgeing.Columns[14].Visible = false;
                ShowGridVendAgeing.Columns[15].Visible = false;
                ShowGridVendAgeing.Columns[16].Visible = false;
                ShowGridVendAgeing.Columns[17].Visible = false;
                ShowGridVendAgeing.Columns[18].Visible = false;
                //End of Rev 1.0 Mantis: 0027273
            }
        ...
        protected void ShowGridVendAgeing_HtmlFooterCellPrepared(object sender, ASPxGridViewTableFooterCellEventArgs e)
        {
        ...
        protected void ShowGridVendAgeing_HtmlDataCellPrepared(object sender, ASPxGridViewTableDataCellEventArgs e)
        {
            ...
            if (e.DataColumn.FieldName == "DAYS")
            {
                Session["chk_presenttotal"] = 0;
            }
        }
