        ...
        public void bindexport(int Filter)
        {
            ...
            switch (Filter)
            {
                case 1:
                    ...
                    objExcel.ExportToExcelforExcel(dtExport, "Vendor Ageing-Detail", "Party Total:", "", dtReportHeader, dtReportFooter);
                    //End of Rev Debashis
                    break;
                case 2:
                    //Rev Debashis
                    //exporter.WriteXlsxToResponse(new XlsxExportOptionsEx() { ExportType = ExportType.WYSIWYG });
                    objExcel.ExportToPDF(dtExport, "Vendor Ageing-Detail", "Party Total:", "", dtReportHeader, dtReportFooter);
                    //End of Rev Debashis
                    break;
                //Rev Debashis
                //case 3:
