   ...
   <%-- For Product multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsSalePQRegDetSumFilter").val("Y");
        ...
        function OpenDocDetails(docid) {
            var url = '';
            url = '/OMS/Management/Activities/SalesQuotation.aspx?key=' + docid + '&req=V&type=QO';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="row">
            ...
            <div class="col-md-3" style="padding:0;padding-top: 12px;">
            <table>
                <tr>
            ...
            <dxe:PanelContent runat="server">
                 ...
                 <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Customer Name" Width="250px" FieldName="PARTYNAME" VisibleIndex="2" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="10" FieldName="SQNO" Width="130px" Caption="Pro. / Quo. No." >
                                    ...
                                    <DataItemTemplate>
                                        ...
                                        <a href="javascript:void(0)" onclick="OpenDocDetails('<%#Eval("SQ_ID") %>','<%#Eval("TRANTYPE") %>')">
                                            <%#Eval("SQNO")%>
                                        </a>
                                    </DataItemTemplate>
                    ...
                    <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                            ContextTypeName="ReportSourceDataContext" TableName="SALESQUOTATIONREGISTERDETSUM_REPORT"></dx:LinqServerModeDataSource>

            <asp:HiddenField ID="hfIsSalePQRegDetSumFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
