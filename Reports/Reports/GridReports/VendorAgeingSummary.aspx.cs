...
{
    public partial class VendorAgeingSummary : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/VendorAgeingSummary.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Vendor Ageing - Summary";
                ...
                BranchHoOffice();
                Session["IsVendAgeSummFilter"] = null;
        ...
        public void cmbExport_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            if (Convert.ToString(Session["IsVendAgeSummFilter"]) == "Y")
            {
                if (Filter != 0)
                {
                    bindexport(Filter);
        ...
        {
            string filename = "Vendor Ageing-Summary";
            ...
            //FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Vendor Ageing-Summary" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxAsOnDate.Date).ToString("dd-MM-yyyy");
            ////Rev Subhra 24-12-2018   0017670
            ...
            if (Filter == 1 || Filter == 2)
            {
                ...
                HeaderRow6[0] = "Vendor Ageing-Summary";
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsVendAgeSummFilter = Convert.ToString(hfIsVendAgeSummFilter.Value);
            Session["IsVendAgeSummFilter"] = IsVendAgeSummFilter;
            ...
            //End of Rev
            Task PopulateStockTrialDataTask = new Task(() => GetVendAgeingSummarydata(ASONDATE, BRANCH_ID, HEAD_BRANCH, PARTY_TYPE, ALLPARTY, CBVOUCHER, JVOUCHER, DNCNNOTE, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetVendAgeingSummarydata(string ASONDATE, string BRANCH_ID, string HEAD_BRANCH, string PARTY_TYPE, string ALLPARTY, string CBVOUCHER, string JVOUCHER, string DNCNNOTE, string PROJECT_ID)
        {
            try
            {
                DataSet ds = new DataSet();
        ...
        protected void ShowGridVendAgeing_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            if (Convert.ToString(Session["IsVendAgeSummFilter"]) == "Y")
            {
                ...
                dtPartyTotal = oDBEngine.GetDataTable("Select DOC_TYPE,DOC_AMOUNT,DAYS30,DAYS60,DAYS90,DAYS120,DAYS150,DAYS180,DAYS180A,CUMBAL_AMOUNT from PARTYWISEAGEINGSUMDET_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SLNO=999999999 AND DOC_TYPE='Net Total:' AND REPORT_TYPE='Summary' AND PARTYTYPE='V'");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsVendAgeSummFilter"]) == "Y")
            {
                var q = from d in dc.PARTYWISEAGEINGSUMDET_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.SLNO) != "999999999" && Convert.ToString(d.REPORT_TYPE) == "Summary" && Convert.ToString(d.PARTYTYPE) == "V"
