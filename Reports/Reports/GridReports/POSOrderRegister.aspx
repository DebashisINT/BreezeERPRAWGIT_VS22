<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="POSOrderRegister.aspx.cs" Inherits="Reports.Reports.GridReports.POSOrderRegister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenPOSORDDetails(branch) {

            $("#drdExport").val(0);
            //cgridposorderdetails.PerformCallback('BndPopupgrid~' + branch);
            cCallbackPanelDetail.PerformCallback('BndPopupgrid~' + branch);
            cPOSorddetails.Show();
            return true;
        }
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Serial" Caption="SL#" Width="4%" VisibleIndex="1" />
                                <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="Branch" Caption="Unit" Width="35%">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>

                                        <a href="javascript:void(0)" onclick="OpenPOSORDDetails('<%#Eval("Branch_Id") %>')" class="pad">
                                            <%#Eval("Branch")%>
                                        </a>
                                    </DataItemTemplate>
                             ...
                             <%--   <dxe:GridViewDataTextColumn FieldName="POSOrder_No" Caption="Total Bill Count" Width="10%" VisibleIndex="3">

                                    <PropertiesTextEdit DisplayFormatString="0"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>--%>

                                <dxe:GridViewDataTextColumn FieldName="POSOrder_Value" Caption="Value" Width="15%" VisibleIndex="4">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="SalesPromotion" Caption="Sales Promotion" Width="12%" VisibleIndex="11">

                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>


                                <dxe:GridViewDataTextColumn FieldName="DeliveryCharges" Caption="Delivery Charges" Width="12%" VisibleIndex="12">

                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>


                                <dxe:GridViewDataTextColumn FieldName="Total_Value" Caption="Total Value" Width="12%" VisibleIndex="13">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                            </Columns>
                            ...
                            <TotalSummary>
                                ...
                                <dxe:ASPxSummaryItem FieldName="POSOrder_Value" SummaryType="Sum" />
                                ...
                                <dxe:ASPxSummaryItem FieldName="SalesPromotion" SummaryType="Sum" />
                                <dxe:ASPxSummaryItem FieldName="DeliveryCharges" SummaryType="Sum" />
                        ...
                        ContextTypeName="ReportSourceDataContext" TableName="POSORDERREGISTER_REPORT" ></dx:LinqServerModeDataSource>
    ...
    <dxe:ASPxPopupControl ID="POSorddetails" runat="server" ClientInstanceName="cPOSorddetails"
        Width="1300px" Height="700px" ScrollBars="Vertical" HeaderText="POS Order Register Report Details" PopupHorizontalAlign="WindowCenter" HeaderStyle-CssClass="wht"
        ...
        <ContentCollection>
            <dxe:PopupControlContentControl runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <dxe:ASPxGridView ID="gridposorderdetails" runat="server" KeyFieldName="SLNO" AutoGenerateColumns="False"
                            DataSourceID="GenerateEntityServerModeDataSourceDetails"  Width="1300px" ClientInstanceName="cgridposorderdetails"
                            ClientSideEvents-BeginCallback="Callback2_EndCallback"
                            OnSummaryDisplayText="grid_SummaryDisplayText">
                            <Columns>
                                <dxe:GridViewDataTextColumn Caption="SL#" FieldName="SLNO" Width="40px"
                                    VisibleIndex="1" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn Caption="Unit" FieldName="Branch"  Width="100px"
                                    VisibleIndex="2" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn Caption="Customer"  FieldName="Customer_Name" Width="210px" 
                                    VisibleIndex="3" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Address"  FieldName="CUST_ADDRESS" Width="450px"
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="5" FieldName="POSOrder_No"  Caption="Order No" FixedStyle="Left" Width="150px">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>
                                 ...
                                 <dxe:GridViewDataTextColumn Caption="Order Type"  FieldName="OrderType" Width="100px"
                                    VisibleIndex="6" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Order Date"  FieldName="POSOrder_Date" Width="100px"
                                    VisibleIndex="7">

                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Value" FieldName="POSOrder_Value" Width="100px" 
                                    VisibleIndex="8">

                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="CGST_Amt" Caption="CGST Amt"  VisibleIndex="9" Width="80px">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="SGST_Amt" Caption="SGST Amt"  VisibleIndex="10" Width="80px">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="IGST_Amt" Caption="IGST Amt"  VisibleIndex="11" Width="80px">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="UTGST_Amt" Caption="UTGST Amt"  VisibleIndex="12" Width="80px">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Others Charges" FieldName="Others_Charges" Width="110px" 
                                    VisibleIndex="13">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Sales Promotion" FieldName="SalesPromotion" Width="110px"
                                    VisibleIndex="14">

                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Delivery Charges" FieldName="DeliveryCharges"  Width="110px"
                                    VisibleIndex="15">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Order Amt" FieldName="Total_Value" Width="110px"
                                    VisibleIndex="16">
                        ...
                        ContextTypeName="ReportSourceDataContext" TableName="POSORDERDETAILSREGISTER_REPORT" ></dx:LinqServerModeDataSource>
                    </div>
                    <div class="clear"></div>
                </div>
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanelDetail" ClientInstanceName="cCallbackPanelDetail" OnCallback="CallbackPanelDetail_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsTransDetailsFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
