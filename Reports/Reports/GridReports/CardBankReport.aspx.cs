    ...
    public partial class CardBankReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Card/Bank Book - Detail";
                ...
                //    ASPxToDate.Value = DateTime.Now;
                //}
                dtAsOnDate = DateTime.Now;
                ASPxASondate.Value = dtAsOnDate;
                Date_finyearwise(Convert.ToString(Session["LastFinYear"]));
                Session["IsCardBank"] = null;
        ...
        public void Date_finyearwise(string Finyear)
        {
            ...
            if (stbill.Rows.Count > 0)
            {
                ...
                ASPxASondate.MaxDate = Convert.ToDateTime((stbill.Rows[0]["FinYear_EndDate"]));
                ASPxASondate.MinDate = Convert.ToDateTime((stbill.Rows[0]["FinYear_StartDate"]));

                hfIsMaxDate.Value = Convert.ToString((stbill.Rows[0]["FinYear_EndDate"]));
                hfIsMinDate.Value = Convert.ToString((stbill.Rows[0]["FinYear_StartDate"]));
        ...
        protected void CallbackPanel_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsCardBank = Convert.ToString(hfIsCardBank.Value);
            Session["IsCardBank"] = IsCardBank;

            Task PopulateStockTrialDataTask = new Task(() => GetCardBankBook());
            PopulateStockTrialDataTask.RunSynchronously();

        }

        public void GetCardBankBook()
        {
            //Rev Debashis && Implement Head Branch
            //string branchList = "", cashbankList = "", userList = "", ledgerList = "";
            string branchList = "", cardbankList = "";
            //End of Rev Debashis && Implement Head Branch
            ...
            List<object> CardBankList = lookupCardBank.GridView.GetSelectedFieldValues("ID");
            foreach (object cardbankIDs in CardBankList)
            {
                cardbankList += "," + cardbankIDs;
            }
            cardbankList = cardbankList.TrimStart(',');
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@FROMDATE", strToDate);
                ...
                cmd.Parameters.AddWithValue("@CASHBANKID", cardbankList);
                cmd.Parameters.AddWithValue("@MODULE_TYPE", "Card_Bank");
                cmd.Parameters.AddWithValue("@ISSUBLEDGER", (chksubledger.Checked) ? "1" : "0");
                cmd.Parameters.AddWithValue("@SORTONDATE", "0");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsCardBank"]) == "Y")
            {
                var q = from d in dc.CASHCARDBANKBOOK_REPORTs
                        where Convert.ToString(d.USERID) == Userid && d.REPMODULE_TYPE == "Card_Bank"
        ...
        {
            string filename = "Card Bank Report";
            ...
            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true,true, true, true, true) + Environment.NewLine + "Card/Bank Book Report" + Environment.NewLine + "As on " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
            //Rev Subhra 11-12-2018   0017670
