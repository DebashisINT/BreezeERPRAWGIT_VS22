...
{
    public partial class PendingSaleOrderRegister : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/PendingSaleOrderRegister.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Pending Sales Order Register";
                ...
                Session["IsPendSaleOrdRegFilter"] = null;
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Pending Sales Order Register";
        ...
        {
            string IsPendSaleOrdRegFilter = Convert.ToString(hfIsPendSaleOrdRegFilter.Value);
            Session["IsPendSaleOrdRegFilter"] = IsPendSaleOrdRegFilter;
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsPendSaleOrdRegFilter"]) == "Y")
            {
