<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="WorkOrderRegisterDetails.aspx.cs" Inherits="Reports.Reports.GridReports.WorkOrderRegisterDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        // Rev Sanchita_Debashis_DEbashis
        function OpenFGDetails(JWOID, JWORDERNO, JWODATE) {
            $("#hfIsJWORegDetFilter").val("Y");
            cCallbackPanelFGDetail.PerformCallback('BndPopupgrid~' + JWOID + '~' + JWORDERNO + '~' + JWODATE);
        ...
        // End of Rev Sanchita_Debashis_Debashis
  </script>
  <%-- For multiselection when click on ok button--%>
   ...
   <%-- For Product multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsJWORegSumFilter").val("Y");
            $("#hfIsJWORegDetFilter").val("N");
            $("#drdExport").val(0);
        ...
        function CallbackPanelFGDetEndCall(s, e) {
            cgridFGdetails.Focus();
            cgridFGdetails.SetFocusedRowIndex(0);
            ctxtOrderNo2ndLevel.SetText(cCallbackPanelFGDetail.cpDocNo);
            ctxtDate2ndLevel.SetText(cCallbackPanelFGDetail.cpDocDate);

            $("#lblFromDate2ndLevel")[0].innerHTML = "From " + cCallbackPanelFGDetail.cpFromDate;
            $("#lblToDate2ndLevel")[0].innerHTML = " To " + cCallbackPanelFGDetail.cpToDate;

            cgridFGdetails.Refresh();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                 ...
                 <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                               ...
                               <%-- Rev Sanchita_Debashis--%>
                                <%--<dxe:GridViewDataTextColumn VisibleIndex="6" FieldName="FGCODE" Width="200px" Caption="FG Code" >
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="7" FieldName="FGDESC" Width="200px" Caption="FG Description" >
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn FieldName="FGQTY" Caption="FG Qty." Width="100px" VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.0000;">
                                      <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn VisibleIndex="9" FieldName="FGUOM" Width="100px" Caption="FG Prod. UOM" >
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="10" FieldName="FGWHDESC" Width="200px" Caption="FG Warehouse" >
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="6" Width="200px" Caption="FG Details" >
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                     <DataItemTemplate>
                               ...
                               <%-- End of Rev Sanchita_Debashis--%>
                                ...
                                <%-- Rev Sanchita_Debashis [Visible index chnged ] --%>
                                ...
                                <%-- Rev Sanchita_Debashis [Visible index chnged ] --%>
                                <dxe:GridViewDataTextColumn FieldName="MATQTY" Caption="Mat. Qty." Width="100px" VisibleIndex="9" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.000;">
                                      <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                
                                <%-- Rev Sanchita_Debashis [Visible index chnged ] --%>
                                <dxe:GridViewDataTextColumn Caption="UOM" FieldName="MATUOM" Width="100px" VisibleIndex="10">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <%-- Rev Sanchita_Debashis [Visible index chnged ] --%>
                                <dxe:GridViewDataTextColumn FieldName="MATRATE" Caption="Rate" Width="100px" VisibleIndex="11" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <%-- Rev Sanchita_Debashis [Visible index chnged ] --%>
                                <dxe:GridViewDataTextColumn FieldName="MATAMT" Caption="Value" Width="100px" VisibleIndex="12" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <%-- Rev Sanchita_Debashis [Visible index chnged ] --%>
                                 <dxe:GridViewDataTextColumn VisibleIndex="13" FieldName="REFISSUENO" Width="130px" Caption="Ref. Issue No.">
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <%-- Rev Sanchita_Debashis [Visible index chnged ] --%>
                                <dxe:GridViewDataDateColumn Caption="Ref. Issue Date" Width="100px" FieldName="REFISSUEDT" VisibleIndex="14" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>

                                <%-- Rev Sanchita_Debashis [Visible index chnged ] --%>
                                <dxe:GridViewDataTextColumn Caption="Created by" Width="130px" FieldName="CREATEDBY" VisibleIndex="15">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                            </Columns>
                            ...
                            <TotalSummary>
                                ...
                                <dxe:ASPxSummaryItem FieldName="MATQTY" SummaryType="Sum" Tag="MatQty"/>
                                <dxe:ASPxSummaryItem FieldName="MATAMT" SummaryType="Sum" Tag="Amt"/>
                            </TotalSummary>
                        </dxe:ASPxGridView>
                    <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                            ContextTypeName="ReportSourceDataContext" TableName="WORKORDERREGISTERDETAIL_REPORT"></dx:LinqServerModeDataSource>

            <asp:HiddenField ID="hfIsJWORegSumFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
    ...
    <dxe:ASPxPopupControl ID="popupFGDetails" runat="server" ClientInstanceName="cpopupFGDetails"
        Width="1200px" Height="600px" ScrollBars="Vertical" HeaderText="FG Details" PopupHorizontalAlign="WindowCenter" HeaderStyle-CssClass="wht"
        ...
        <ContentCollection>
            <dxe:PopupControlContentControl runat="server">
                ...
                <div class="col-md-12">
                    <div class="row clearfix">
                        ...
                        <tr>
                            <td style="padding-top: 10px;padding-right:5px">
                                <label style="color: #b5285f; font-weight: bold; margin-top: 5px;" class="clsTo">
                                    <asp:Label ID="Label4" runat="Server" Text="Order No. :" CssClass="mylabel1"></asp:Label>
                                </label>
                            </td>
                            <td style="padding-top: 10px;padding-right:5px">
                            ...
                            <td style="padding-top: 10px;padding-right:5px">
                                <label style="color: #b5285f; font-weight: bold; margin-top: 5px;" class="clsTo">
                                    <asp:Label ID="Label6" runat="Server" Text="Date :" CssClass="mylabel1"></asp:Label>
                                </label>
                            </td>
                        ...
                        <div class="pull-right" style="padding-top: 26px;">
                            <% if (rights.CanExport)
                            { %> 
                                <asp:DropDownList ID="ddldetails" runat="server" CssClass="btn btn-sm btn-primary" AutoPostBack="true" OnSelectedIndexChanged="cmbExportFG_SelectedIndexChanged">
                                    <asp:ListItem Value="0">Export to</asp:ListItem>
                                    <asp:ListItem Value="1">EXCEL</asp:ListItem>
                                    <asp:ListItem Value="2">PDF</asp:ListItem>
                                    <asp:ListItem Value="3">CSV</asp:ListItem>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <dxe:ASPxGridView ID="griFGDetails" runat="server" AutoGenerateColumns="False" Width="100%" ClientInstanceName="cgridFGdetails" KeyFieldName="SEQ"
                            DataSourceID="GenerateEntityServerDetailsModeDataSource"  OnSummaryDisplayText="ShowGrid1_FGSummaryDisplayText" 
                          ...
                          <%--  OnCustomCallback="gridPendingApproval_CustomCallback" OnDataBinding="grid_DataBinding"--%>
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="FG Code" FieldName="FGCODE" VisibleIndex="2" Width="150px">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="FG Description" FieldName="FGDESC" VisibleIndex="3" Width="120px">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="FGQTY" Caption="FG Qty." Width="120px" VisibleIndex="4" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.0000;">
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn Caption="FG Prod. UOM" FieldName="FGUOM" VisibleIndex="7" Width="150px">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn Caption="FG Warehouse" FieldName="FGWHDESC" VisibleIndex="8" Width="150px">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                            </Columns>
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanelFGDetail" ClientInstanceName="cCallbackPanelFGDetail" OnCallback="CallbackPanelFGDetail_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsJWORegDetFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
          <ClientSideEvents EndCallback="CallbackPanelFGDetEndCall" />
    </dxe:ASPxCallbackPanel>
    <%--End of Rev Sanchita_Debashis--%>
