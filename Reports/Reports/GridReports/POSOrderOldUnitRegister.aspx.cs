...
{
    public partial class POSOrderOldUnitRegister : System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/master/POSOrderOldUnitRegister.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "POS Order Old Unit Register";
        ...
        {
            string filename = "POS Order Old Unit Register Report";
            exporter.FileName = filename;
            string FileHeader = "";

            BusinessLogicLayer.Reports RptHeader = new BusinessLogicLayer.Reports();

            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true,true, true, true) + Environment.NewLine + "POS Order Old Unit Register Report" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
            //Rev Subhra 24-12-2018   0017670
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            {
                var q = from d in dc.POSORDEROLDUNITREGISTER_REPORTs
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string PosOrdOldUnitComponent = "";
            List<object> PosOrdOldUnitList = lookup_branch.GridView.GetSelectedFieldValues("ID");
            foreach (object PosOrd in PosOrdOldUnitList)
            {
                PosOrdOldUnitComponent += "," + PosOrd;
            }
            BRANCH_ID = PosOrdOldUnitComponent.TrimStart(',');
            //Rev Subhra 24-12-2018   0017670
            string BRANCH_NAME = "";
            ...
            //End of Rev
            Task PopulatePosOrderOldUnitTask = new Task(() => GetPOSOrderOldUnitRegisterdata(FROMDATE, TODATE, BRANCH_ID, HEAD_BRANCH));
            PopulatePosOrderOldUnitTask.RunSynchronously();
        }
        public void GetPOSOrderOldUnitRegisterdata(string FROMDATE, string TODATE, string BRANCH_ID, string HEAD_BRANCH)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("prc_POSOrderOldUnitRegisterDetails_Report", con);
