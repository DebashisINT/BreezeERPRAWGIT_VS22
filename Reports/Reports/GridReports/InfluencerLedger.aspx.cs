...
{
    public partial class InfluencerLedger : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/InfluencerLedger.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Influencer Ledger";
                ...
                Session["IsInfluencerFilter"] = null;
                dtFrom = DateTime.Now;
                dtTo = DateTime.Now;
        ...
        {
            string filename = "Influencer Ledger";
            ...
            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Influencer Ledger " + "A/C- " + Session["INFLUENCERNM"] + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
        ...
        public void GetInfluencerLedgerdata(string FROMDATE, string TODATE, string BRANCH_ID, string INFLUENCERID)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("PRC_INFLUENCERLEDGER_REPORT", con);
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsInfluencerFilter"]) == "Y")
            {
                var q = from d in dc.INFLUENCERLEDGER_REPORTs
        ...
        {
            string IsInfluencerFilter = Convert.ToString(hfIsInfluencerFilter.Value);
            Session["IsInfluencerFilter"] = IsInfluencerFilter;
