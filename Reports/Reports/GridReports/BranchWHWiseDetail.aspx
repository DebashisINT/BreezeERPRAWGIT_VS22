   ...
   <%-- For Brand multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function OpenDetailsDocuments(Doc_ID, TransType) {
            ...
            //}
            else if (TransType == 'WHSJIN') {
                url = '/OMS/Management/Activities/WarehousewiseStockJournalAddIN.aspx?key=' + Doc_ID + '&IsTagged=1&req=V&type=' + TransType;
            }
            else if (TransType == 'WHSJOUT') {
    ...
    <div class="outer-div-main">
        ...
        <div class="clearfix row">
           ...
           <div class="col-md-2" style="margin-top: 7px;">
            ...
            <div class="col-md-2" style="margin-top:28px;color: #b5285f; font-weight: bold;">
                <dxe:ASPxCheckBox runat="server" ID="chkAltQtyUOM" Checked="false" Text="Show Alt. Qty & UOM" ClientInstanceName="CchkAltQtyUOM">
                </dxe:ASPxCheckBox>
            </div>
            <div class="col-md-2" style="margin-top:28px;color: #b5285f; font-weight: bold;">
                <dxe:ASPxCheckBox runat="server" ID="chkEntity" Checked="false" Text="Show Entity Code & Name" ClientInstanceName="CchkEntity">
                </dxe:ASPxCheckBox>
            </div>
            ...
            <div class="clear"></div>
            <div class="col-md-2" style="margin-top:28px;color: #b5285f; font-weight: bold;">
                <dxe:ASPxCheckBox runat="server" ID="chkEmp" Checked="false" Text="Show Employee" ClientInstanceName="CchkEmp">
                </dxe:ASPxCheckBox>
            </div>
            <div class="col-md-2" style="margin-top:28px;color: #b5285f; font-weight: bold;">
                <dxe:ASPxCheckBox runat="server" ID="chkTechnician" Checked="false" Text="Show Technician" ClientInstanceName="CchkTechnician">
                </dxe:ASPxCheckBox>
            </div>
            <div class="col-md-2" style="margin-top:28px;color: #b5285f; font-weight: bold;">
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="PRODCODE" Width="300px" Caption="Item Code" VisibleIndex="4" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="PRODDESC" Width="200px" Caption="Item Name" VisibleIndex="5" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                                                 
                                <dxe:GridViewDataTextColumn FieldName="CLASSDESC" Width="150px" Caption="Class" VisibleIndex="6" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="ALTSTOCKUOM" Width="90px" Caption="Alternate Unit" VisibleIndex="9" HeaderStyle-CssClass="colDisable">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="DOCNO" Width="150px" Caption="Document No" VisibleIndex="10" HeaderStyle-CssClass="colDisable">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="DOCDATE" Width="100px" Caption="Date" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" VisibleIndex="11" HeaderStyle-CssClass="colDisable">
