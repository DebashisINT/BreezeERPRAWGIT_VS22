...
<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" CodeBehind="PartyLedgerCustomerWithSegment.aspx.cs" Inherits="Reports.Reports.GridReports.PartyLedgerCustomerWithSegment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          cSegmentComponentPanel.SetEnabled(false);
      ...
      function SetCustomer(Id, Name) {
          ...
          if (key != null && key != '') {
              ...
              ctxtCustName.Focus();
              cSegmentComponentPanel.PerformCallback('BindSegmentGridwithCustomer' + '~' + key);
          }
          else {
              ctxtCustName.SetText('');
              GetObjectID('hdnCustomerId').value = '';
   ...
   <%-- For Customer multiselection--%>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            //cSegmentComponentPanel.PerformCallback('BindSegmentGrid');
            cSegmentComponentPanel.SetEnabled(false);
        });
        ...
        $(document).ready(function () {
            ...
            $("#ListBoxSegment").chosen().change(function () {
                var Ids = $(this).val();

                $('#<%=hdnSelectedSegment.ClientID %>').val(Ids);
                $('#MandatoryActivityType').attr('style', 'display:none');
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            var data = "OnDateChanged";
            $("#hfIsPartyLedgerCustSegmentFilter").val("Y");
            $("#drdExport").val(0);
            ...
            else if (ctxtCustName.GetValue() == null) {
                jAlert('Please select atleast one Customer for generate the report.');
            }
            else {
                if (gridsegmentLookup.GetValue() == null) {
                    jAlert('Please select atleast one Segment for generate the report.');
                }
                else {
                    cCallbackPanel.PerformCallback(data + '~' + $("#ddlbranchHO").val());
                }
        ...
        function selectAllSG() {
            gridsegmentLookup.gridView.SelectRows();
        }
        function unselectAllSG() {
            gridsegmentLookup.gridView.UnselectRows();
        }

        function CloseLookupsegment() {
            gridsegmentLookup.ConfirmCurrentSelection();
            gridsegmentLookup.HideDropDown();
            gridsegmentLookup.Focus();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                 <div style="color: #b5285f;" class="clsTo">
                    <asp:Label ID="Label2" runat="Server" Text="Segment : " CssClass="mylabel1"
                        Width="92px"></asp:Label>
                </div>
                <div>
                    <asp:ListBox ID="ListBoxSegment" Visible="false" runat="server" SelectionMode="Multiple" Font-Size="12px" Height="90px" Width="253px" CssClass="mb0 chsnProduct  hide" data-placeholder="--- ALL ---"></asp:ListBox>
                    <span id="MandatoryActivityType" style="display: none" class="validclass">
                        <img id="3gridHistory_DXPEForm_efnew_DXEFL_DXEditor1112_EI" class="dxEditors_edtError_PlasticBlue" src="/DXR.axd?r=1_36-tyKfc" title="Mandatory"></span>
                    <asp:HiddenField ID="hdnSelectedSegment" runat="server" />
                    <dxe:ASPxCallbackPanel runat="server" ID="ASPxCallbackPanel2" ClientInstanceName="cSegmentComponentPanel" OnCallback="Componentsegment_Callback">
                        <PanelCollection>
                            <dxe:PanelContent runat="server">
                                <dxe:ASPxGridLookup ID="lookup_segment" SelectionMode="Multiple" runat="server" ClientInstanceName="gridsegmentLookup"
                                    OnDataBinding="lookup_segment_DataBinding"
                                    KeyFieldName="CODE" Width="100%" TextFormatString="{0}" AutoGenerateColumns="False" MultiTextSeparator=", ">
                                    <Columns>
                                        <dxe:GridViewCommandColumn ShowSelectCheckbox="True" VisibleIndex="0" Width="60" Caption=" " />
                                        <dxe:GridViewDataColumn FieldName="CUSTOMER" Visible="true" VisibleIndex="1" width="300px" Caption="Customer" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dxe:GridViewDataColumn>
                                        <dxe:GridViewDataColumn FieldName="CODE" Visible="true" VisibleIndex="2" width="100px" Caption="Code" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dxe:GridViewDataColumn>
                                        <dxe:GridViewDataColumn FieldName="SEGNM" Visible="true" VisibleIndex="3" width="200px" Caption="Segment Name" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dxe:GridViewDataColumn>
                                    </Columns>
                                    <GridViewProperties Settings-VerticalScrollBarMode="Auto" SettingsPager-Mode="ShowAllRecords">
                                            ...
                                            <StatusBar>
                                                <table class="OptionsTable" style="float: right">
                                                    <tr>
                                                        <td>
                                                            <%--<div class="hide">--%>
                                                                <dxe:ASPxButton ID="ASPxButton6" runat="server" AutoPostBack="false" Text="Select All" ClientSideEvents-Click="selectAllSG"  UseSubmitBehavior="False" />
                                                            <%--</div>--%>
                                                            <dxe:ASPxButton ID="ASPxButton7" runat="server" AutoPostBack="false" Text="Deselect All" ClientSideEvents-Click="unselectAllSG"  UseSubmitBehavior="False" />
                                                            <dxe:ASPxButton ID="ASPxButton8" runat="server" AutoPostBack="false" Text="Close" ClientSideEvents-Click="CloseLookupsegment" UseSubmitBehavior="False" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </StatusBar>
            ...
            <div class="col-md-2" style="padding-top: 1px;color: #141414;max-width: 135px;padding-right: 0;">
                <div style="padding-right: 10px; vertical-align: middle; padding-top: 22px">
            ...
            <%--<div class="clear"></div>--%>
            <div class="col-md-4" style="padding: 1px; padding-top: 20px;">
                <div>
                    ...
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyboardSupport="true" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="SUBLEDGER" Caption="Customer" Width="170px" VisibleIndex="2" HeaderStyle-CssClass="colDisable"/>
                        ...
                        ContextTypeName="ReportSourceDataContext" TableName="PARTYLEDGERSEGMENTWISE_REPORT" ></dx:LinqServerModeDataSource>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
                <asp:HiddenField ID="hfIsPartyLedgerCustSegmentFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
