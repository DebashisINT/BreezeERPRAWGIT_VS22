...
2.0                27-04-2023        2.0.38           Pallab              25952: Vendor Payment/Receipt Register - Details 
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SRLNO" 
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="PARTYNAME" Caption="Vendor(s)" VisibleIndex="7" Width="200px"/>
                                <dxe:GridViewDataTextColumn FieldName="PROJ_NAME" Caption="Project Name" VisibleIndex="8" Width="150px"/>
                                <dxe:GridViewDataTextColumn FieldName="CASHBANK_NAME" Caption="Cash/Bank" VisibleIndex="9" Width="200px"/>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="TRAN_TYPE" Caption="Doc. Type" VisibleIndex="13" Width="100px"/>
                                <dxe:GridViewDataTextColumn FieldName="DOC_NO" Caption="Doc. No." VisibleIndex="14" Width="160px"/>
                                <dxe:GridViewDataTextColumn FieldName="DOC_DATE" Caption="Doc. Date" Width="160px" VisibleIndex="15" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy" />
                                <dxe:GridViewDataTextColumn FieldName="REAMRKS" Caption="Remarks" VisibleIndex="16" Width="200px"/>
                                <dxe:GridViewDataTextColumn FieldName="TAXABLE_AMOUNT" Caption="Taxable" VisibleIndex="17" PropertiesTextEdit-DisplayFormatString="0.00" Width="100px">
