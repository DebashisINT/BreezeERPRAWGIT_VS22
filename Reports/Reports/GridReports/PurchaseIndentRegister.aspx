...
2.0                28-04-2023        2.0.38           Pallab              25976: Purchase Indent Register module zoom popup upper part visible issue fix
====================================================== Revision History =============================================--%>

<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PurchaseIndentRegister.aspx.cs" Inherits="Reports.Reports.GridReports.PurchaseIndentRegister" %>
   ...
   <%-- For Product multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsPrINDRegDetSumFilter").val("Y");
            $("#drdExport").val(0);
    ...
    align-items: flex-start;
        ...
        #ASPXPopupControl2_PW-1 , #popupApproval_PW-1 , #ASPXPopupControl1_PW-1 , #popupDetails_PW-1
        {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="row">
            ...
            <div class="col-md-2" style="padding:0;padding-top: 15px;">
            <table>
                <tr>
            ...
            <dxe:PanelContent runat="server">
                 ...
                 <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="INDNO" Width="130px" Caption="Indent No." >
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>

                                        <a href="javascript:void(0)" onclick="OpenDocDetails('<%#Eval("IND_ID") %>','<%#Eval("TRANTYPE") %>','<%#Eval("INDNO") %>')">
                                            <%#Eval("INDNO")%>
                                        </a>
                                    </DataItemTemplate>
                                ...
                                <dxe:GridViewDataDateColumn Caption="Date" Width="100px" FieldName="INDDATE" VisibleIndex="4" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>

                                 <dxe:GridViewDataTextColumn VisibleIndex="5" FieldName="QONO" Width="130px" Caption="Pro./Quo. No." >
                                ...
                                <dxe:GridViewDataDateColumn Caption="Pro./Quo. Date" Width="100px" FieldName="QODATE" VisibleIndex="6" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>

                                <dxe:GridViewDataTextColumn VisibleIndex="7" FieldName="ORDNO" Width="130px" Caption="Order No." >
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <EditFormSettings Visible="False" />
                                    <Settings AutoFilterCondition="Contains" />
                                ...
                                <dxe:GridViewDataDateColumn Caption="Order Date" Width="100px" FieldName="ORDDATE" VisibleIndex="8" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>

                                <dxe:GridViewDataTextColumn Caption="Item Name" FieldName="PRODUCTDESC" Width="300px" VisibleIndex="9">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Item Class" FieldName="PRODUCTCLASS_NAME" Width="200px" VisibleIndex="10">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="QTY" Caption="Qty." Width="100px" VisibleIndex="11" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.000;">
                                      <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn Caption="UOM" FieldName="STOCKUOM" Width="100px" VisibleIndex="12">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Multi UOM" FieldName="MULTIUOM" Width="100px" VisibleIndex="13">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                
                                 <dxe:GridViewDataTextColumn FieldName="MULTQTY" Caption="Multi Qty." Width="80px" VisibleIndex="14" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.000;">
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                 <dxe:GridViewDataTextColumn FieldName="CONVFACTOR" Caption="Conv. Factor" Width="80px" VisibleIndex="15" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.0000;">
                                      <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="RATE" Caption="Rate" Width="100px" VisibleIndex="16" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="GROSAMOUNT" Caption="Total Value" Width="100px" VisibleIndex="17" PropertiesTextEdit-DisplayFormatString="#####,##,##,###0.00;">
                                     <HeaderStyle HorizontalAlign="Right" />
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Created by" Width="160px" FieldName="CREATEDBY" VisibleIndex="18">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                            </Columns>
                    ...
                    <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                            ContextTypeName="ReportSourceDataContext" TableName="PURCHASEINDENTREGISTERDETSUM_REPORT"></dx:LinqServerModeDataSource>

            <asp:HiddenField ID="hfIsPrINDRegDetSumFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
