   ...
   <%-- For Batch multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsBatchwiseBalanceSumFilter").val("Y");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <td colspan="2">
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                 <dxe:GridViewDataTextColumn Caption="Unit" FieldName="BRANCH_DESCRIPTION" Width="300" VisibleIndex="1" HeaderStyle-CssClass="colDisable">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Product" Width="200" FieldName="PRODUCT_DESCRIPTION" VisibleIndex="4" HeaderStyle-CssClass="colDisable">
                                </dxe:GridViewDataTextColumn>                               
                                <dxe:GridViewDataTextColumn Caption="Uom" FieldName="STOCKUOM" Width="80" VisibleIndex="5" HeaderStyle-CssClass="colDisable">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>                               
                                <dxe:GridViewDataTextColumn FieldName="IN_QTY_OP" Caption="Opening Qty." Width="110" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="0.00" HeaderStyle-CssClass="colDisable">
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                 </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="IN_QTY" Caption="Received Qty." Width="110" VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="0.00" HeaderStyle-CssClass="colDisable"> 
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                 </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="OUT_QTY" Caption="Delivered Qty." Width="110" VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="0.00" HeaderStyle-CssClass="colDisable">  
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                 </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="CLOSE_QTY" Caption="Closed Qty." Width="110" VisibleIndex="9" PropertiesTextEdit-DisplayFormatString="0.00" HeaderStyle-CssClass="colDisable">  
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                 </dxe:GridViewDataTextColumn>
    ...
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsBatchwiseBalanceSumFilter" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
