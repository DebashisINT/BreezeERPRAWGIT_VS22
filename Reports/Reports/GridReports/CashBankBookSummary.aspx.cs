    ...
    public partial class CashBankBookSummary : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Cash/Bank Book - Summary";
                ...
                Session["IsCashBankBookSum"] = null;
        ...
        public void bindexport(int Filter)
        {
            ...
            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true,true, true, true, true) + Environment.NewLine + "Cash/Bank Book - Summary" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
            //Rev Subhra 20-12-2018   0017670
        ...
        {            
            ...
            string IsCashBankBookSum = Convert.ToString(hfIsCashBankBookSum.Value);
            Session["IsCashBankBookSum"] = IsCashBankBookSum;
            ...
            //End of Rev
            Task PopulateStockTrialDataTask = new Task(() => GetCashBankBookSummarydata(FROMDATE, TODATE, BRANCH_ID, HEAD_BRANCH, strType, cashbankList));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetCashBankBookSummarydata(string FROMDATE, string TODATE, string BRANCH_ID, string HEAD_BRANCH, string strType, string cashbankList)
        {
            try
            {
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsCashBankBookSum"]) == "Y")
            {
                var q = from d in dc.CASHBANKBOOKSUM_REPORTs
                        where Convert.ToString(d.USERID) == Userid
                        //orderby d.BRANCH_ID ascending,d.BRANCH_DESC ascending,d.AC_ID ascending,d.AC_NAME ascending
