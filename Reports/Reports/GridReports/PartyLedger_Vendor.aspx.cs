...
//2.0   v2 .0.42    Debashis    26/03/2024      Vendor code column is required in various reports.Refer: 0027273
...
{
    public partial class PartyLedger_Vendor : System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/PartyLedger_Vendor.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Party Ledger - Vendor";
                ...
                Session["IsPLedgVendFilter"] = null;
                ...
                dtLedgerSelection = oDBEngine.GetDataTable("SELECT A.MainAccount_ReferenceID AS ID FROM Master_MainAccount A WHERE MainAccount_AccountCode='SYSTM00006'");
        ...
        {
            string filename = "Party Ledger - Vendor";
            ...
            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Party Ledger - Vendor" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsPLedgVendFilter = Convert.ToString(hfIsPLedgVendFilter.Value);
            Session["IsPLedgVendFilter"] = IsPLedgVendFilter;
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsPLedgVendFilter"]) == "Y")
            {
                var q = from d in dc.PARTYLEDGERCUSTVEND_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.PARTY_TYPE) == "V"
                        orderby d.SEQ
                        select d;
                e.QueryableSource = q;
            }
