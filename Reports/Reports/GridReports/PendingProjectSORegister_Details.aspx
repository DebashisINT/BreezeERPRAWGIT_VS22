<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PendingProjectSORegister_Details.aspx.cs" Inherits="Reports.Reports.GridReports.PendingProjectSORegister_Details" %>
   ...
   <%-- For multiselection--%>
    ...
    <script type="text/javascript">
        function btn_ShowRecordsClick(e) {
            ...
            $("#hfIsPendSaleOrdRegDetFilter").val("Y");
        ...
        function OpenPendSaleOrdDetails(invoice, type) {
            if (type == 'PSO') {
                url = '/OMS/Management/Activities/ProjectOrder.aspx?key=' + invoice + '&IsTagged=1&req=V&type=PSO';
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <table>
                <tr>
                    ...
                    <td >
                     ...
                     <%--REV SAYANTANI--%> <%--IMPLEMENTING EXPORT ACCORDING TO SETTING BASED --%>
                         <% if (rights.CanExport)
                     { %> 
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="1" FieldName="BRANCH_DESCRIPTION" Width="110px" Caption="Unit" >
                                 ...
                                 <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="ORDER_NUMBER" Width="130px" Caption="Order Number" >
                                    ...
                                    <DataItemTemplate>
                                        <a href="javascript:void(0)" onclick="OpenPendSaleOrdDetails('<%#Eval("ORDER_ID") %>','PSO')">
                                            <%#Eval("ORDER_NUMBER")%>
                                        </a>
                                    </DataItemTemplate>
                               ...
                               <%-- Rev Sayantani--%>
                                <%--<dxe:GridViewDataTextColumn Caption="Customer Name" FieldName="CUSTOMER_NAME" Width="310px" VisibleIndex="6" >
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                     <HeaderStyle HorizontalAlign="Left" />
                                </dxe:GridViewDataTextColumn>--%>
                                <dxe:GridViewDataTextColumn Caption="Customer Name" FieldName="PARTYNAME" Width="310px" VisibleIndex="6" >
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                     <HeaderStyle HorizontalAlign="Left" />
                                </dxe:GridViewDataTextColumn>
                               <%-- End of Rev Sayantani--%>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Salesman Name" FieldName="SALESMAN_NAME" Width="170px"
                                    VisibleIndex="8" >
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                ...
                                <%--Rev Sayantani--%>
                                <%-- <dxe:GridViewDataTextColumn Caption="Rate" FieldName="ORDERDETAILS_SALEPRICE" Width="110px"
                                    VisibleIndex="12" >
   ...
   <!--Customer Modal -->
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
            <asp:HiddenField ID="hfIsPendSaleOrdRegDetFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
