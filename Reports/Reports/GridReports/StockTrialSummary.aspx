   ...
   <%-- For Brand multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            ...
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsStockTrialSummaryFilter").val("Y");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table class="pull-left">
            <tr>
                ...
                <td class="simple-select">
                    <asp:DropDownList ID="ddlbranchHO" runat="server" Width="210px"></asp:DropDownList>
                </td>
            ...
            <tr>
                ...
                <td style="padding-top: 15px; padding-bottom: 10px">
                   <dxe:ASPxButtonEdit ID="txtBrandName" runat="server" ReadOnly="true" ClientInstanceName="ctxtBrandName" Width="210px" TabIndex="5">
                    <Buttons>
                        <dxe:EditButton>
                        </dxe:EditButton>
                    </Buttons>
                ...
                <td style="padding-left: 15px; padding-top: 15px; padding-bottom: 10px">
                    <div style="color: #b5285f; font-weight: bold;" class="clsFrom">
                        <asp:Label ID="lblFromDate" runat="Server" Text="From Date : " CssClass="mylabel1"
                            Width="92px"></asp:Label>
                    </div>
                </td>
                <td class="for-cust-icon" style="padding-top: 15px; padding-bottom: 10px">
               ...
               <%-- <td style="padding-left: 15px;" colspan="3">
                 ...
                 <td style="padding-left: 15px; padding-top: 15px; padding-bottom: 10px" colspan="3">
            ...
            <tr>
                <td colspan="2">
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SL"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="branch_description" Caption="Unit" Width="200" VisibleIndex="6" />
                        ...
                        ContextTypeName="ReportSourceDataContext" TableName="STOCKTRIALSUMMARY_REPORT" ></dx:LinqServerModeDataSource>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsStockTrialSummaryFilter" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
