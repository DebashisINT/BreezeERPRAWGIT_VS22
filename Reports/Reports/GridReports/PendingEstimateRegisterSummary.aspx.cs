...
{
    public partial class PendingEstimateRegisterSummary : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/PendingEstimateRegisterSummary.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Pending Estimate Register - Summary";
                ...
                Session["IsPEstimateRegSumFilter"] = null;
        ...
        public void cmbExport_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsPEstimateRegSumFilter"]) == "Y")
            {
                if (Filter != 0)
                {
                    bindexport(Filter);
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "PendingEstimateRegisterSummary";
            ...
            if (Filter == 1 || Filter == 2)
            {
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                con.Open();
                string selectQuery = "SELECT BRANCHDESC,PROJ_NAME,PARTYNAME,DOCNO,DOCDATE,REV_NO,REV_DATE,REFORDER,REFQO,REFINDENT,STKQTY,PENDQTY,AMOUNT,PENDAMT,CHARGES,NETAMOUNT FROM PENDINGESTIMATEREGISTERSUMDET_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND BRANCH_ID<>9999999999 AND PARTYNAME<>'Total :' AND REPORTTYPE='Summary' order by SEQ";
                SqlDataAdapter myCommand = new SqlDataAdapter(selectQuery, con);

                // Create and fill a DataSet.
                DataSet ds = new DataSet();
                myCommand.Fill(ds, "Main");
                myCommand = new SqlDataAdapter("Select PARTYNAME,STKQTY,PENDQTY,AMOUNT,PENDAMT,CHARGES,NETAMOUNT from PENDINGESTIMATEREGISTERSUMDET_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND BRANCH_ID=9999999999 AND PARTYNAME='Total :' AND REPORTTYPE='Summary'", con);
                myCommand.Fill(ds, "GrossTotal");
                myCommand.Dispose();
                con.Dispose();
                Session["exportpemregsumdataset"] = ds;
                ...
                HeaderRow6[0] = "Pending Estimate Register - Summary";
            ...
            {
                case 1:
                    objExcel.ExportToExcelforExcel(dtExport, "PendingEstimateRegisterSummary", "ZZZZZZZZZZZZZZZZ", "ZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    break;
                case 2:
                    objExcel.ExportToPDF(dtExport, "PendingEstimateRegisterSummary", "ZZZZZZZZZZZZZZZZ", "ZZZZZZZZZZZZZZZZ", dtReportHeader, dtReportFooter);
                    break;
                case 3:
        ...
        {
            string IsPEstimateRegSumFilter = Convert.ToString(hfIsPEstimateRegSumFilter.Value);
            Session["IsPEstimateRegSumFilter"] = IsPEstimateRegSumFilter;
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetPendingESMRegSumdata(BRANCH_ID, FROMDATE, TODATE, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetPendingESMRegSumdata(string BRANCH_ID, string FROMDATE, string TODATE, string PROJECT_ID)
        {
            try
            {
                DataSet ds = new DataSet();
