...
{
    public partial class PendingPurchaseOrderRegister : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/PendingPurchaseOrderRegister.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Pending Purchase Order Register";
                ...
                Session["IsPendPurchaseOrdRegFilter"] = null;
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Pending Purchase Order Register";
            exporter.FileName = filename;
            string FileHeader = "";

            BusinessLogicLayer.Reports RptHeader = new BusinessLogicLayer.Reports();

            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Pending Purchase Order Register" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
            //Rev Subhra 24-12-2018   0017670
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsPendPurchaseOrdRegFilter = Convert.ToString(hfIsPendPurchaseOrdRegFilter.Value);
            Session["IsPendPurchaseOrdRegFilter"] = IsPendPurchaseOrdRegFilter;
            ...
            //End of Rev
            Task PopulateStockTrialDataTask = new Task(() => GetPENDPURORDRegdata(BRANCH_ID, FROMDATE, TODATE, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetPENDPURORDRegdata(string BRANCH_ID, string FROMDATE, string TODATE, string PROJECT_ID)
        {
            try
            {
                ...
                //SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                SqlConnection con = new SqlConnection(Convert.ToString(System.Web.HttpContext.Current.Session["ErpConnection"]));
                SqlCommand cmd = new SqlCommand("prc_Pending_SalePurchaseOrderReg_Report", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            if (e.Item.FieldName == "CUSTVEND_NAME")
            {
                e.Text = "Total";
            }
            else
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsPendPurchaseOrdRegFilter"]) == "Y")
            {
                var q = from d in dc.PENDING_SALEPURCHASE_ORDER_REPORTs
