...
2.0                26-04-2023        2.0.38           Pallab              25939 : Purchase Register - Summary module zoom popup upper part visible issue fix
====================================================== Revision History =============================================--%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenBillDetails(branch) {
            ...
            $("#drdExport").val(0);
            $("#hfIsPurRegdetFilter").val("Y");
            //cgridPurchRegDetail.PerformCallback('BndPopupgrid~' + branch);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-md-12">
                <table>
                    <tr>
                        ...
                        <td style="padding-left:15px; width:220px; padding-top: 15px;">
                ...
                <td colspan="2">
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            DataSourceID="GenerateEntityServerModeDataSource"   Settings-HorizontalScrollBarMode="Auto" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="BRANCH_DESCRIPTION" Caption="Unit" Width="10%">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="PURCHASE_VALUE" Caption="Purchase Value" Width="15%" VisibleIndex="4">
    ...
    <dxe:ASPxPopupControl ID="popupApproval" runat="server" ClientInstanceName="cpopupApproval"
        Width="1300px" Height="600px" ScrollBars="Vertical" HeaderText="Purchase Register - Details" PopupHorizontalAlign="WindowCenter" HeaderStyle-CssClass="wht"
            ...
            <dxe:PopupControlContentControl runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <dxe:ASPxGridView ID="gridPurchRegDetail" runat="server" KeyFieldName="SEQ" AutoGenerateColumns="False"
                            Width="100%" ClientInstanceName="cgridPurchRegDetail" Settings-HorizontalScrollBarMode="Visible"
                            DataSourceID="GenerateEntityServerModeDetailsDataSource"   ClientSideEvents-BeginCallback="Callback2_EndCallback"
                            OnSummaryDisplayText="grid_SummaryDisplayText">

                          <%-- OnCustomCallback="gridPurchRegDetail_CustomCallback" OnDataBinding="grid_DataBinding" --%>
                            <Columns>
                                <dxe:GridViewDataTextColumn Caption="Serial" FieldName="SEQ" Width="50px"
                                    VisibleIndex="0" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn Caption="Unit" FieldName="BRANCH_DESCRIPTION" Width="250px"
                                    VisibleIndex="1" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn Caption="Vendor Name" Width="350px" FieldName="VENDOR_NAME"
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="7" FieldName="BILL_NO" Width="200px" Caption="Document No" >
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Vendor's Invoice No" FieldName="VENDOR_INVOICE" Width="200px"
                                    VisibleIndex="10">
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Invoice Date." Width="200px" FieldName="VENDOR_DATE"
                                    VisibleIndex="11">

                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Purchase Value" FieldName="PURCHASE_VALUE" Width="200px"
                                    VisibleIndex="12">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Tax Misc." FieldName="TAX_MISC" Width="100px"
                                    VisibleIndex="18">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Bill Amount" FieldName="TOTAL_VALUE" Width="200px"
                                    VisibleIndex="19">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                            </Columns>
                         ...
                         <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDetailsDataSource" runat="server" OnSelecting="GenerateEntityServerModelDetailDataSource_Selecting"
                            ContextTypeName="ReportSourceDataContext" TableName="PURCHASEREGISTERDETAILS_REPORT"></dx:LinqServerModeDataSource>
                    </div>
                    <div class="clear"></div>
                </div>
 ...
 <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsPurRegSummFilter" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
 ...
 <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanelDetails" ClientInstanceName="cCallbackPanelDetails" OnCallback="CallbackPanelDetails_Callback">
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsPurRegdetFilter" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
