<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="SRVWarehouseWiseStockStatusSummary.aspx.cs" Inherits="Reports.Reports.GridReports.SRVWarehouseWiseStockStatusSummary" %>
   ...
   <%-- For Product multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsSrvWHWStkStatSumFilter").val("Y");
    ...
    <div>
     ...
     <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            ...
            <asp:HiddenField ID="hfIsSrvWHWStkStatSumFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
