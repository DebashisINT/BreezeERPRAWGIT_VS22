<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ListingOfMaster_Transporter.aspx.cs" Inherits="Reports.Reports.GridReports.ListingOfMaster_Transporter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#TransporterModel').on('shown.bs.modal', function () {
                $('#txtTransporterSearch').focus();
            })
        ...
        function SetSelectedValues(Id, Name, ArrName) {
            if (ArrName == 'TransporterSource') {
                ...
                if (key != null && key != '') {
                    ...
                    ctxtTransporter.SetText(Name);
                    GetObjectID('hdnTransporterId').value = key;
                }
                else {
                    ctxtTransporter.SetText('');
   ...
   <%-- For multiselection--%>
     <script type="text/javascript">
         ...
         function Transporterkeydown(e) {
             ...
             if ($.trim($("#txtTransporterSearch").val()) == "" || $.trim($("#txtTransporterSearch").val()) == null) {
                 return false;
             }
             OtherDetails.SearchKey = $("#txtTransporterSearch").val();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form_main">
        ...
        <div class="row">
            <div class="col-md-2 col-lg-2">
             <dxe:ASPxLabel ID="lbl_Transporter" style="color: #b5285f;" runat="server" Text="Transporter:">
                </dxe:ASPxLabel>                   
                <dxe:ASPxButtonEdit ID="txtTransporter" runat="server" ReadOnly="true" ClientInstanceName="ctxtTransporter" Width="100%" TabIndex="5">
                    <Buttons>
                        <dxe:EditButton>
                        </dxe:EditButton>
                    </Buttons>
                           ...
                           <dxe:ASPxGridView runat="server" ID="ShowGridList" ClientInstanceName="GridList" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                               ...
                               <dxe:GridViewDataTextColumn Caption="Name" FieldName="Name" Width="250px"
                                    ...
                                    <DataItemTemplate>
                                        <a href="javascript:void(0)" onclick="ClickOnView('<%#Eval("CODE") %>')" class="pad">
                                            <%#Eval("Name")%>
                                        </a>
                                    </DataItemTemplate>
                               ...
                               <%-- <dxe:GridViewDataTextColumn VisibleIndex="4" FieldName="credit_Days" Width="80px" Caption="Cr. Days" >
                                ...
                                <dxe:GridViewDataTextColumn Caption="Ledger" FieldName="Map_Ledger" Width="200px"
                                    VisibleIndex="5" >
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
    ...
    <div>
        ...
        <!--Transporter Modal -->
    <div class="modal fade" id="TransporterModel" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="text" onkeydown="Transporterkeydown(event)" id="txtTransporterSearch" width="100%" placeholder="Search By Transporter Name" />
