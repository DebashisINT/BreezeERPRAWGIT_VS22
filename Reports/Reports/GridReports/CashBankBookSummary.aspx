...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
                ...
                <td colspan="2">
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SLNO"
                            Settings-HorizontalScrollBarMode="Auto" DataSourceID="GenerateEntityServerModeDataSource" 
                            OnSummaryDisplayText="ShowGrid_SummaryDisplayText" ClientSideEvents-BeginCallback="Callback_EndCallback" SettingsBehavior-ColumnResizeMode="Control"
                            Settings-VerticalScrollableHeight="280" Settings-VerticalScrollBarMode="Auto">
                            <%--OnCustomCallback="Grid_CustomCallback" --%>
                            <%--OnDataBinding="ShowGrid_DataBinding" --%>
                            <Columns>
                                <dxe:GridViewDataTextColumn Caption="Unit" FieldName="BRANCH_DESC" Width="240px"
                                    VisibleIndex="1" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Cash / Bank" FieldName="AC_NAME" Width="300px"
                                    VisibleIndex="5">
                                </dxe:GridViewDataTextColumn>
                        ...
                        ContextTypeName="ReportSourceDataContext" TableName="CASHBANKBOOKSUM_REPORT"></dx:LinqServerModeDataSource>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsCashBankBookSum" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
