...
{
    public partial class CashBankReport_NEW : System.Web.UI.Page
    {
        ...
        protected void ReportSourceDataContext_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            e.KeyExpression = "SrlNo";
            string connectionString = ConfigurationManager.ConnectionStrings["crmConnectionString"].ConnectionString;

            ReportSourceDataContext dc = new ReportSourceDataContext(connectionString);
            var q = from d in dc.tbl_Report_CashBankBooks
                    orderby d.TRANDATE descending
                    select d;
            e.QueryableSource = q;
        }
