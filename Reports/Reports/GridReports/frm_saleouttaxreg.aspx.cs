    ...
    public partial class frm_saleouttaxreg : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "GST Output Tax Register";
                ...
                Session["GSTIN"] = null;
                Session["IsSaleOutTaxFilter"] = null;
                dtFrom = DateTime.Now;
                dtTo = DateTime.Now;
                //   BindDropDownList();
                ...
                dr = dtdoctype.NewRow();
                dr["doctype_code"] = "TSB";
                dr["doctype_description"] = "Transit Sale Invoice";
                dtdoctype.Rows.Add(dr);
                dr = dtdoctype.NewRow();
                ...
                // REV SAYANTANI
                dr["doctype_code"] = "SR";
                dr["doctype_description"] = "Sale Return";
                dtdoctype.Rows.Add(dr);
                dr = dtdoctype.NewRow();
        ...
        public void bindexport(int Filter)
        {
            if (OPTREGGrid.VisibleRowCount > 0)
            {
                ...
                FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "GST Output Tax Register" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
                //Rev Subhra 18-12-2018   0017670
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsSaleOutTaxFilter = Convert.ToString(hfIsSaleOutTaxFilter.Value);
            Session["IsSaleOutTaxFilter"] = IsSaleOutTaxFilter;
            ...
            if (Session["SI_ComponentData_Branch"] != null)
            {
                ...
                string custinternlid = Convert.ToString(hdnCustomerId.Value);
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsSaleOutTaxFilter"]) == "Y")
            {
                var q = from d in dc.SALE_GST_OUTPUTTAXREG_REPORTs
