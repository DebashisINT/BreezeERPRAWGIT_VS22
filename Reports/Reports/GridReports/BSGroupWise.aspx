...
<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="BSGroupWise.aspx.cs" Inherits="Reports.Reports.GridReports.BSGroupWise" %>
    ...
    <script type="text/javascript">
        function OnWaitingGridKeyPress(e) {
            if (e.key == "Enter" || e.key == "NumpadEnter") {
                ...
                var ledger = Grid.GetRow(index).children[9].innerHTML;
                var branchid = $('#ddlbranchHO').val();
                $("#hfIsBSGroupwiseDetails").val("Y");
                //var ledgertype = Grid.GetRow(index).children[7].innerHTML;
                var ledgertype = Grid.GetRow(index).children[8].innerHTML;
                if (ledger.trim() == "0") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyboardSupport="true" KeyFieldName="SLNO"
                            ...
                            <columns>   
                                ...
                                <dxe:GridViewDataTextColumn FieldName="LAYOUTDETAILS_NAME" Caption="Group Name" Width="190px" VisibleIndex="2" GroupIndex="1">
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="MAINACCOUNT_NAME" Caption="Ledger Name" Width="420px" VisibleIndex="3" >
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="OPENING" Caption="Opening" Width="220px" VisibleIndex="4" Settings-AllowAutoFilter="False">                                    
                                    <PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="0.00"></PropertiesTextEdit>
                                    <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="PERIOD" Caption="Period Balance" Width="220px" VisibleIndex="5" Settings-AllowAutoFilter="False">                                    
                                    <PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="0.00"></PropertiesTextEdit>
                                    <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="CLOSEBAL" Caption="Closing Balance" Width="220px" VisibleIndex="6" Settings-AllowAutoFilter="False">                                    
                                    <PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="0.00"></PropertiesTextEdit>
                                    <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="YTD" Caption="YTD Amount" Width="220px" VisibleIndex="7" Settings-AllowAutoFilter="False">                                    
                                    <PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="0.00"></PropertiesTextEdit>
                                    <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="TYPEX" Caption="HIDETYPEX" Width="0" VisibleIndex="8" >
                                <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                 <dxe:GridViewDataTextColumn FieldName="MAINACCOUNT_REFERENCEID" Caption="MAINACCOUNT_REFERENCEID" Width="0px" VisibleIndex="9" />
                            </columns>
                        ...
                        ContextTypeName="ReportSourceDataContext" TableName="BALANCESHEETGROUPWISE_REPORT" />
                    </div>
                </td>
            </tr>
        </table>
    ...
    <dxe:ASPxPopupControl ID="popup" runat="server" ClientInstanceName="cpopup2ndLevel"
        Width="1100px" Height="600px" ScrollBars="Vertical" HeaderText="Balance Sheet (Group wise) - Detailed" PopupHorizontalAlign="WindowCenter" HeaderStyle-CssClass="wht"
        ...
        <contentcollection>
                <dxe:PopupControlContentControl runat="server">
                    ...
                    <div class="clearfix" onkeypress="OnWaitingGridKeyPress2(event)">
                        ...
                        ContextTypeName="ReportSourceDataContext" TableName="BALANCESHEETGROUPWISEDETAILED_REPORT" />
                    </div>
    ...
    <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
                <asp:HiddenField ID="hfIsBSGroupwise" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
     ...
     <dxe:ASPxCallbackPanel runat="server" ID="CallbackPanelDetail" ClientInstanceName="cCallbackPanelDetail" OnCallback="CallbackPanelDetail_Callback">
        <PanelCollection>
            <dxe:PanelContent runat="server">
                <asp:HiddenField ID="hfIsBSGroupwiseDetails" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
