    ...
    public partial class SalesReturnRegister_Details : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Sales Return Register - Detail";
                ...
                Session["IsSaleRetRegDetFilter"] = null;
        ...
        public void bindexport(int Filter)
        {
                ...
                FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true,true, true, true) + Environment.NewLine + "Sales Return Register Details Report" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
                //Rev Subhra 20-12-2018   0017670
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsSaleRetRegDetFilter = Convert.ToString(hfIsSaleRetRegDetFilter.Value);
            Session["IsSaleRetRegDetFilter"] = IsSaleRetRegDetFilter;
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsSaleRetRegDetFilter"]) == "Y")
            {
                var q = from d in dc.SALESREGISTERPRODUCTDETAILS_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.TRAN_TYPE) == "SR"
                        orderby d.SEQ
                        select d;
                e.QueryableSource = q;
            }
