...
{
    public partial class SRVMaterialInOutRegisterDetail : System.Web.UI.Page
    {
        DateTime dtFrom;
        DateTime dtTo;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Components In-Out Register - Details";
        ...
        {
            string filename = "ComponentsIORegDet";
            exporter.FileName = filename;
            string FileHeader = "";

            BusinessLogicLayer.Reports RptHeader = new BusinessLogicLayer.Reports();

            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Components In-Out Register - Details" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
        ...
        #region =======================Material I/O Register Detail=========================
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetMaterialIORegisterDet(FROMDATE, TODATE, WH_ID));
            PopulateStockTrialDataTask.RunSynchronously();
        }

        public void GetMaterialIORegisterDet(string FROMDATE, string TODATE, string WHID)
        {
            try
            {
        ...
        protected void ShowGrid_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            ...
            {
                dtWHTotalForDetail = oDBEngine.GetDataTable("SELECT PRODDESC,OP_QTY,IN_QTY,OUT_QTY,BAL_QTY FROM SRVMATERIALIOREGISTER_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND REPORTMODE='Detail' AND WHID=9999999999 AND PRODDESC='Gross Total :'");
        ...
        protected void ShowGrid_HtmlDataCellPrepared(object sender, ASPxGridViewTableDataCellEventArgs e)
        {
            ...
            {
                Session["chk_MatIORegDettotal"] = 1;
            }
            if (Convert.ToInt32(Session["chk_MatIORegDettotal"]) == 1)
            {
