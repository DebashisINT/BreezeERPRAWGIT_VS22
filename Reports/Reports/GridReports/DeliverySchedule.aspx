<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="DeliverySchedule.aspx.cs" Inherits="Reports.Reports.GridReports.DeliverySchedule" %>
  ...
  <script type="text/javascript">
   ...
   <%-- For Product multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function OpenDocDetails(order, type) {
            var url = '';
            if (type == 'SO') {
                url = '/OMS/Management/Activities/SalesOrderAdd.aspx?key=' + order + '&IsTagged=1&req=V&type=SO';
            }
            ...
            <dxe:PanelContent runat="server">
                 <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SEQ"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Customer" Width="250px" FieldName="PARTYNAME" VisibleIndex="2" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="ORDNO" Width="130px" Caption="Order No." >
                                    ...
                                    <DataItemTemplate>
                                        <a href="javascript:void(0)" onclick="OpenDocDetails('<%#Eval("ORDID") %>','<%#Eval("DOCTYPE") %>')">
                                            <%#Eval("ORDNO")%>
                                        </a>
                                    </DataItemTemplate>
                                ...
                                <dxe:GridViewDataDateColumn Caption="Order Date" Width="100px" FieldName="ORDDT" VisibleIndex="4" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>

                                <dxe:GridViewDataTextColumn FieldName="TOTORDQTY" Caption="Total Order Qty." Width="100px" VisibleIndex="5">
                                     <HeaderStyle HorizontalAlign="Right" />
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Product" FieldName="PRODNAME" Width="300px" VisibleIndex="6">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="PRODQTY" Caption="Product Ord. Qty." Width="120px" VisibleIndex="7">
                                     <HeaderStyle HorizontalAlign="Right" />
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="UOM" FieldName="STOCKUOM" Width="80px" VisibleIndex="8">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataDateColumn Caption="Schedule Del. Date" Width="120px" FieldName="SCHDELDT" VisibleIndex="9" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>

                                <dxe:GridViewDataTextColumn FieldName="SCHDELQTY" Caption="Schedule Del. Qty." Width="120px" VisibleIndex="10">
                                     <HeaderStyle HorizontalAlign="Right" />
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataDateColumn Caption="Actual Delivery Date" Width="140px" FieldName="ACTDELDT" VisibleIndex="11" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>

                                <dxe:GridViewDataTextColumn FieldName="ACTDELQTY" Caption="Actual Delivery Qty." Width="130px" VisibleIndex="12">
                                     <HeaderStyle HorizontalAlign="Right" />
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="PENDDELQTY" Caption="Pending Delivery Qty." Width="130px" VisibleIndex="13">
                                     <HeaderStyle HorizontalAlign="Right" />
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="WARRANTYDAYS" Caption="Warranty Day(s)" Width="120px" VisibleIndex="14">
                                     <HeaderStyle HorizontalAlign="Right" />
                                     <CellStyle HorizontalAlign="Right"></CellStyle>
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataDateColumn Caption="Warranty Start Date" Width="120px" FieldName="WARRANTYSTDT" VisibleIndex="15" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>

                                <dxe:GridViewDataDateColumn Caption="Warranty End Date" Width="120px" FieldName="WARRANTYENDDT" VisibleIndex="16" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy">
                                    <Settings AutoFilterCondition="Contains" />
                                </dxe:GridViewDataDateColumn>
                            </Columns>
                            ...
                            <TotalSummary>
                                <dxe:ASPxSummaryItem FieldName="PARTYNAME" SummaryType="Custom" Tag="Item_Prod"/>
                                <dxe:ASPxSummaryItem FieldName="TOTORDQTY" SummaryType="Custom" Tag="Item_TotOrdQty"/>
                                <dxe:ASPxSummaryItem FieldName="PRODQTY" SummaryType="Custom" Tag="Item_OrdQty"/>
                                <dxe:ASPxSummaryItem FieldName="SCHDELQTY" SummaryType="Custom" Tag="Item_SchDelQty"/>
                                <dxe:ASPxSummaryItem FieldName="ACTDELQTY" SummaryType="Custom" Tag="Item_ActDelQty"/>
                                <dxe:ASPxSummaryItem FieldName="PENDDELQTY" SummaryType="Custom" Tag="Item_PendDelQty"/>
                                <dxe:ASPxSummaryItem FieldName="WARRANTYDAYS" SummaryType="Custom" Tag="Item_WarrantyDays"/>
                            </TotalSummary>
                        </dxe:ASPxGridView>
                    <dx:LinqServerModeDataSource ID="GenerateEntityServerModeDataSource" runat="server" OnSelecting="GenerateEntityServerModeDataSource_Selecting"
                            ContextTypeName="ReportSourceDataContext" TableName="DELIVERYSCHEDULE_REPORT"></dx:LinqServerModeDataSource>

            <asp:HiddenField ID="hfIsDelvSchldFilter" runat="server" />
            </dxe:PanelContent>
        </PanelCollection>
