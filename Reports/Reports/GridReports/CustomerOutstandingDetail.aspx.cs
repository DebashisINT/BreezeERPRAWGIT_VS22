...
{
    public partial class CustomerOutstandingDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/CustomerOutstandingDetail.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Customer Outstanding - Detail";
                ...
                BranchHoOffice();
                Session["IsCustOutDetFilter"] = null;
            ...
            if (!IsPostBack)
            {
                ...
                //    ShowGridCustOut.Columns[9].Visible = false;
                //}
                //else
                //{
                //    ShowGridCustOut.Columns[8].Visible = true;
                //    ShowGridCustOut.Columns[9].Visible = true;
                //}

                //if (Convert.ToString(strsalesman) == "0")
                //{
                //    ShowGridCustOut.Columns[10].Visible = false;
                //}
                //else
                //{
                //    ShowGridCustOut.Columns[10].Visible = true;
                //}

                //if(chkRetention.Checked==false)
                //{
                //    ShowGridCustOut.Columns[12].Visible = false;
                //    ShowGridCustOut.Columns[13].Visible = false;
                //}
                //else
                //{
                //    ShowGridCustOut.Columns[12].Visible = true;
                //    ShowGridCustOut.Columns[13].Visible = true;
                //}

                //if (Convert.ToString(strprintdatechk) == "0")
                //{
                //    //ShowGridCustOut.Columns[13].Visible = false;
                //    ShowGridCustOut.Columns[15].Visible = false;
                //}
                //else
                //{
                //    //ShowGridCustOut.Columns[13].Visible = true;
                //    ShowGridCustOut.Columns[15].Visible = true;
                //}
                //End of Rev 1.0 Mantis: 0027273
            }
        }
        ...
        {
            string filename = "Customer Outstanding-Detail Report";
            ...
            //FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true,true) + Environment.NewLine + "Customer Outstanding-Detail Report" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxAsOnDate.Date).ToString("dd-MM-yyyy");
            ////Rev Subhra 24-12-2018   0017670
            ...
            if (Filter == 1 || Filter == 2)
            {
                ...
                con.Open();
                //Rev 1.0 Mantis: 0027273
                //string selectQuery = "SELECT PARTYNAME,BRANCH_DESCRIPTION,DOC_TYPE,ISOPENING,PROJ_NAME,DOC_NO,DOC_DATE,DUE_DATE,PARTYORD_NO,PARTYORD_DATE,SALESMAN,CONVERT(DECIMAL(18,2),REPLACE(REPLACE(DOC_AMOUNT,'(',CASE WHEN SUBSTRING(DOC_AMOUNT,1,1)='(' THEN '-' ELSE '' END),')','')) AS DOC_AMOUNT,RETENTIONBLKAMT,AFTRETENTIONAMT,CONVERT(DECIMAL(18,2),REPLACE(REPLACE(BAL_AMOUNT,'(',CASE WHEN SUBSTRING(BAL_AMOUNT,1,1)='(' THEN '-' ELSE '' END),')','')) AS BAL_AMOUNT,DAYS FROM PARTYOUTSTANDINGDET_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SLNO<>999999999 AND DOC_TYPE<>'Gross Outstanding:' AND PARTYTYPE='C' order by SEQ";
                ...
                //dtExport.Columns[0].ColumnName = "Customer Name";
                //dtExport.Columns[1].ColumnName = "Unit";
                //dtExport.Columns[2].ColumnName = "Doc. Type";
                //dtExport.Columns[3].ColumnName = "Opening?";
                //dtExport.Columns[4].ColumnName = "Project Name";
                //dtExport.Columns[5].ColumnName = "Doc. No.";
                //dtExport.Columns[6].ColumnName = "Doc. Date";
                //dtExport.Columns[7].ColumnName = "Due Date";
                //dtExport.Columns[8].ColumnName = "Party Order No.";
                //dtExport.Columns[9].ColumnName = "Party Order Date";
                //dtExport.Columns[10].ColumnName = "Salesman";
                //dtExport.Columns[11].ColumnName = "Doc. Amt.";
                //dtExport.Columns[12].ColumnName = "Balance Amount";
                //dtExport.Columns[13].ColumnName = "Days";
            ...
            switch (Filter)
            {
                case 1:
                    ...
                    objExcel.ExportToExcelforExcel(dtExport, "Customer Outstanding-Detail Report", "Total:", "Party Outstanding:", dtReportHeader, dtReportFooter);
                    //End of Rev Debashis
                    break;
                case 2:
                    //Rev Debashis    
                    //exporter.WriteXlsxToResponse(new XlsxExportOptionsEx() { ExportType = ExportType.WYSIWYG });
                    objExcel.ExportToPDF(dtExport, "Customer Outstanding-Detail Report", "Total:", "Party Outstanding:", dtReportHeader, dtReportFooter);
                    //End of Rev Debashis
                    break;
                //Rev Debashis
                //case 3:
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsCustOutDetFilter = Convert.ToString(hfIsCustOutDetFilter.Value);
            Session["IsCustOutDetFilter"] = IsCustOutDetFilter;
            ...
            //End of Rev
            Task PopulateStockTrialDataTask = new Task(() => GetCustOutstandingDetdata(ASONDATE, BRANCH_ID, HEAD_BRANCH, PARTY_TYPE, DUEDATE, ALLPARTY, PRINT_DAYS, SALESMAN, CBVOUCHER, JVOUCHER, DNCNNOTE, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
            //ShowGridCustOut.ExpandAll();
        }
        public void GetCustOutstandingDetdata(string ASONDATE, string BRANCH_ID, string HEAD_BRANCH, string PARTY_TYPE, string DUEDATE, string ALLPARTY, string PRINT_DAYS, string SALESMAN, string CBVOUCHER, string JVOUCHER, string DNCNNOTE, string PROJECT_ID)
        {
            try
            {               
                DataSet ds = new DataSet();
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(strsalesman) == "0")
            {
                //Rev 1.0 Mantis: 0027273
                //ShowGridCustOut.Columns[10].Visible = false;
                ShowGridCustOut.Columns[11].Visible = false;
                //End of Rev 1.0 Mantis: 0027273
            }
            else
            {
                //Rev 1.0 Mantis: 0027273
                //ShowGridCustOut.Columns[10].Visible = true;
                ShowGridCustOut.Columns[11].Visible = true;
                //End of Rev 1.0 Mantis: 0027273
            }
            ...
            if (chkRetention.Checked==false)
            {
                ...
                //ShowGridCustOut.Columns[13].Visible = false;
                ShowGridCustOut.Columns[13].Visible = false;
                ShowGridCustOut.Columns[14].Visible = false;
                //End of Rev 1.0 Mantis: 0027273
            }
            else
            {
                ...
                //ShowGridCustOut.Columns[13].Visible = true;
                ShowGridCustOut.Columns[13].Visible = true;
                ShowGridCustOut.Columns[14].Visible = true;
                //End of Rev 1.0 Mantis: 0027273
            }
            ...
            if (Convert.ToString(strprintdatechk) == "0")
            {
                ...
                //Rev 1.0 Mantis: 0027273
                //ShowGridCustOut.Columns[15].Visible = false;
                ShowGridCustOut.Columns[16].Visible = false;
                //End of Rev 1.0 Mantis: 0027273
            }
            else
            {
                ...
                //Rev 1.0 Mantis: 0027273
                //ShowGridCustOut.Columns[15].Visible = true;
                ShowGridCustOut.Columns[16].Visible = true;
                //End of Rev 1.0 Mantis: 0027273
            }
