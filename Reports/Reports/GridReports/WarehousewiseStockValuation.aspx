...
<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="WarehousewiseStockValuation.aspx.cs" Inherits="Reports.Reports.GridReports.WarehousewiseStockValuation" %>
   ...
   <%-- For Brand multiselection--%>
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            e.preventDefault;
            var data = "OnDateChanged";
            $("#hfIsWHwiseStockValFilter").val("Y");
            data += '~' + cxdeFromDate.GetDate();
            data += '~' + cxdeToDate.GetDate();
        ...
        function OpenStockDetails(branchid,whid, prodid) {
            $("#hfIsWHwiseStockValDetFilter").val("Y");
            cCallbackPanelDetail.PerformCallback('BndPopupgrid~' + branchid +'~'+ whid + '~' + prodid);
            cpopupApproval.Show();
            return true;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="outer-div-main">
        ...
        <div class="clearfix row">
            ...
            <div class="col-md-2 pTop10 hide">
            ...
            <div class="col-md-2 pTop10">
             ...
             <div class="col-md-3">
                <div style="color: #b5285f; padding-top: 30px" class="clsTo">
            ...
            <div class="clear"></div>
            <div class="col-md-2" style="margin-top:18px;color: #b5285f;">
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyFieldName="SLNO"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="WHDESC" Width="280" Caption="Warehouse" VisibleIndex="2" />
                                <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="SPRODUCTS_DESCRIPTION" Width="420" Caption="Product Name">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>
                                        <a href="javascript:void(0)" onclick="OpenStockDetails('<%#Eval("BRANCH_ID") %>','<%#Eval("WHID") %>','<%#Eval("SPRODUCTS_ID") %>')" class="pad">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="STOCKUOM" Width="80" Caption="Stock Unit" VisibleIndex="4" />
                                <dxe:GridViewDataTextColumn FieldName="PRODUCTCLASS_DESCRIPTION" Width="280" Caption="Class" VisibleIndex="5" />
                                <dxe:GridViewDataTextColumn FieldName="BRAND_NAME" Width="220" Caption="Brand" VisibleIndex="6" />
                                <dxe:GridViewDataTextColumn FieldName="IN_QTY_OP" Width="110" Caption="Quantity" VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="0.00">
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="IN_PRICE_OP" Width="110" Caption="Rate" VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="0.00">
                                     <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="IN_TOTAL_OP" Width="110" Caption="Total" VisibleIndex="9" PropertiesTextEdit-DisplayFormatString="0.00">
                                     <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                        ...
                        ContextTypeName="ReportSourceDataContext" TableName="WAREHOUSEWISESTOCKVALUATION_REPORT" ></dx:LinqServerModeDataSource>
    ...
    <dxe:ASPxPopupControl ID="popupApproval" runat="server" ClientInstanceName="cpopupApproval"
        Width="1200px" Height="600px" ScrollBars="Vertical" HeaderText="Warehouse wise Valuation Detail" PopupHorizontalAlign="WindowCenter" HeaderStyle-CssClass="wht"
                    ...
                    <div class="col-md-12">
                        <dxe:ASPxGridView ID="grivaluation" runat="server" AutoGenerateColumns="False" Width="100%" ClientInstanceName="cgridValuationdetails" KeyFieldName="SLNO"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Document Type" FieldName="TRANS_TYPE" VisibleIndex="2" Width="150px">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Warehouse" FieldName="WHDESC" VisibleIndex="3" Width="250px">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Product" FieldName="SPRODUCTS_DESCRIPTION" VisibleIndex="4" Width="250px">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                
                                <dxe:GridViewDataTextColumn FieldName="PRODUCTCLASS_DESCRIPTION" Width="100px" Caption="Class" VisibleIndex="5" />

                                <dxe:GridViewDataTextColumn FieldName="BRAND_NAME" Width="100px" Caption="Brand" VisibleIndex="6" />

                                <dxe:GridViewDataTextColumn FieldName="STOCKUOM" Width="80px" Caption="Stock Unit" VisibleIndex="7" />

                                <dxe:GridViewDataTextColumn FieldName="ALTSTOCKUOM" Width="80px" Caption="Alt. Unit" VisibleIndex="8" />

                                <dxe:GridViewDataTextColumn FieldName="IN_QTY_OP" Caption="Available Stock" Width="120px" VisibleIndex="9">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="ALTIN_QTY" Caption="Alt. Stock Qty." Width="120px" VisibleIndex="10">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="IN_PRICE_OP" Caption="Rate" Width="120px" VisibleIndex="11">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
...
<dxe:ASPxCallbackPanel runat="server" ID="CallbackPanel" ClientInstanceName="cCallbackPanel" OnCallback="CallbackPanel_Callback">
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsWHwiseStockValFilter" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
...
<dxe:ASPxCallbackPanel runat="server" ID="CallbackPanelDetail" ClientInstanceName="cCallbackPanelDetail" OnCallback="CallbackPanelDetail_Callback">
    <PanelCollection>
        <dxe:PanelContent runat="server">
        <asp:HiddenField ID="hfIsWHwiseStockValDetFilter" runat="server" />
        </dxe:PanelContent>
    </PanelCollection>
