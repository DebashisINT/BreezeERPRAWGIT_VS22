...
{
    public partial class PendingProjectSORegister_Details : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/PendingProjectSORegister_Details.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Project - Pending Sale Order Register - Detail";
                ...
                Session["IsPendProjectSaleOrdRegDetFilter"] = null;
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Project - Pending Sale Order Register - Detail";
        ...
        {
            string IsPendProjectSaleOrdRegDetFilter = Convert.ToString(hfIsPendSaleOrdRegDetFilter.Value);
            Session["IsPendProjectSaleOrdRegDetFilter"] = IsPendProjectSaleOrdRegDetFilter;
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetPENDSALEORDRegdata(BRANCH_ID, FROMDATE, TODATE, PROJECT_ID));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetPENDSALEORDRegdata(string BRANCH_ID, string FROMDATE, string TODATE, string PROJECT_ID)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@TRANSACTION_TYPE", "S");
        ...
        {
            if (e.Item.FieldName == "SALESMAN_NAME")
            {
                e.Text = "Total";
            }
            else
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (Convert.ToString(Session["IsPendProjectSaleOrdRegDetFilter"]) == "Y")
            {
                var q = from d in dc.PENDING_SALEPURCHASEPROJECTORDER_REPORTs
                        where Convert.ToString(d.USERID) == Userid && Convert.ToString(d.TRANSACTION_TYPE) == "S"
                        orderby d.SLNO
                        select d;
                e.QueryableSource = q;
            }
