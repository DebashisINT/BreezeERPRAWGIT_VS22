...
{
    public partial class VendorOutstandingSummary : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/VendorOutstandingSummary.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            ...
            if (!String.IsNullOrEmpty(ProjectSelectInEntryModule))
            {
                if (ProjectSelectInEntryModule == "Yes")
                {
                    ...
                    ShowGridVendOut.Columns[3].Visible = true;
                ...
                else if (ProjectSelectInEntryModule.ToUpper().Trim() == "NO")
                {
                    ...
                    ShowGridVendOut.Columns[3].Visible = false;
            ...
            if (!IsPostBack)
            {
                ...
                RptHeading.Text = "Vendor Outstanding - Summary";
                ...
                BranchHoOffice();
                Session["IsVendOutSummFilter"] = null;
                Session["exportval"] = null;

                ShowGridVendOut.Columns[5].Visible = false;
                ShowGridVendOut.Columns[6].Visible = false;
        ...
        public void cmbExport_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            if (Convert.ToString(Session["IsVendOutSummFilter"]) == "Y")
            {
                if (Filter != 0)
                {
                    bindexport(Filter);
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Vendor Outstanding-Summary Report";
            ...
            //FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true, true) + Environment.NewLine + "Vendor Outstanding-Summary Report" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxAsOnDate.Date).ToString("dd-MM-yyyy");
            ////Rev Subhra 24-12-2018   0017670
            ...
            if (Filter == 1 || Filter == 2)
            {
                ...
                HeaderRow6[0] = "Vendor Outstanding-Summary Report";
            ...
            switch (Filter)
            {
                case 1:
                    ...
                    objExcel.ExportToExcelforExcel(dtExport, "Vendor Outstanding-Summary Report", "Total:", "Party Outstanding:", dtReportHeader, dtReportFooter);
                    //End of Rev Debashis
                    break;
                case 2:
                    //Rev Debashis
                    //exporter.WriteXlsxToResponse(new XlsxExportOptionsEx() { ExportType = ExportType.WYSIWYG });
                    objExcel.ExportToPDF(dtExport, "Vendor Outstanding-Summary Report", "Total:", "Party Outstanding:", dtReportHeader, dtReportFooter);
                    //End of Rev Debashis
                    break;
                //Rev Debashis
                //case 3:
        ...
        protected void CallbackPanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string IsVendOutSummFilter = Convert.ToString(hfIsVendOutSummFilter.Value);
            Session["IsVendOutSummFilter"] = IsVendOutSummFilter;
            ...
            //End of Rev
            Task PopulateStockTrialDataTask = new Task(() => GetVendOutstandingDetdata(ASONDATE, BRANCH_ID, HEAD_BRANCH, PARTY_TYPE, ALLPARTY, CBVOUCHER, JVOUCHER, DNCNNOTE, PROJECT_ID, VendOrTransporter));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetVendOutstandingDetdata(string ASONDATE, string BRANCH_ID, string HEAD_BRANCH, string PARTY_TYPE, string ALLPARTY, string CBVOUCHER, string JVOUCHER, string DNCNNOTE, string PROJECT_ID, string VendOrTransporter)
        {
            try
            {
                DataSet ds = new DataSet();
        ...
        protected void ShowGridVendOut_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            if (Convert.ToString(Session["IsVendOutSummFilter"]) == "Y")
            {
                dtPartyTotal = oDBEngine.GetDataTable("Select DOC_TYPE,BAL_AMOUNT from PARTYOUTSTANDINGSUM_REPORT Where USERID=" + Convert.ToInt32(Session["userid"]) + " AND SLNO=999999999 AND DOC_TYPE='Gross Outstanding:' AND PARTYTYPE='V'");
        ...
        protected void GenerateEntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            {
                ShowGridVendOut.Columns[5].Visible = true;
                ShowGridVendOut.Columns[6].Visible = true;
            }
