...
<body onload="noBack();setInterval('blinkIt()',500);" onpageshow="if (event.persisted) noBack();"
    ...
    <div class="container boxWraper">
        <div class="centerd-box">
            <div class="logo-wrap">
                <img src="/assests/images/logo.png" width="230" height="70" alt="" />
            </div>
            <div>
            ...
            <div class="loginArea">
                <form action="" method="post" runat="server" novalidate="novalidate">
                    ...
                    <div class="form-group logoicon">
                        <div>
                            <asp:TextBox ID="txtUserName" onblur="return ChangeCompany();" CssClass="form-control smalltext fontAwesome" runat="server" placeholder=" User Name" TabIndex="1"></asp:TextBox>
                        </div>
