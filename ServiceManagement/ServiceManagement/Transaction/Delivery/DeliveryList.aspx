<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="DeliveryList.aspx.cs" Inherits="ServiceManagement.ServiceManagement.Transaction.Delivery.DeliveryList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../CSS/DeliveryList.css" rel="stylesheet" />
    <script src="../JS/DeliveryList.js?v=1.0.0.03"></script>
   
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <span class="hddd font-pp">Delivery </span>
    <div class="clearfix font-pp" style="margin-bottom:10px">
        <div class="clearfix text-center ">
            <ul class="circulerUl">
                <li id="d1"><%-- class="activeCrcl"--%>
                    <div class="crcl" onclick="TotalEntered();">
                        <div id="DivTotalEntered">0</div>
                        <i class="fa fa-check-circle icn"></i>
                    </div>
                    <div>Total Entered</div>
                </li>
                <li id="d2">
                    <div class="crcl" onclick="TotalDelivered();">
                        <div id="DivTotalDelivered">0</div>
                        <i class="fa fa-check-circle icn"></i>
                    </div>
                    <div>Total Delivered</div>
                </li>
                <li id="d3">
                    <div class="crcl" onclick="Pendingdelivery();">
                        <div id="divPendingdelivery">0</div>
                        <i class="fa fa-check-circle icn"></i>
                    </div>
    ...
    <div class="" id="LodingId">
        <div class="clearfix">
            <div class="relative">
                <div style="position: absolute; right: 230px; z-index: 10;">
                    <span onclick="MassConfirm();" id="spnMassConfirm"><span class="btn btn-success" data-toggle="modal" data-target="#confirmModal"><i class="fa fa-users" aria-hidden="true"></i>Mass Confirm</span></span>
                    ...
                    <table id="dataTable" class="table table-striped table-bordered display nowrap" style="width: 100%">
                        <thead>
                            <tr>
                                ...
                                <th>Delivery By</th>
                                <th>Delivery On</th>
                                <th>Delivery Update By</th>
                                <th>Delivery Update On</th>
                                <th>Status</th>
                                <th>Action</th>
                            </tr>
                        </thead>
    ...
    <!--Mass add popup -->
    <div class="modal fade pmsModal" id="confirmModal" role="dialog" aria-labelledby="" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Mass Confirm </h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="MassDeliveryConfirm();">Confirm</button>
