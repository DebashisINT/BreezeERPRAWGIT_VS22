<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderApproval.aspx.cs" Inherits="ServiceManagement.ServiceManagement.Transaction.OrderMView.OrderApproval" %>
   ...
   <style>
    ...
    <script>
        ...
        $(function () {
            ...
            $.ajax({
                type: "POST",
                url: "OrderApproval.aspx/GetData",
                ...
                success: function (data) {
                    ...
                    var topData = data.d;
                    convertDate(topData[0].PurchaseOrder_Date)
                    $("#DocumentNo").text(topData[0].PurchaseOrder_Number);
                    $("#IndentNo").text(topData[0].Indent_Num);
                    $("#Branch").text(topData[0].branch_description);
                    var date = topData[0].PurchaseOrder_Date;
                    var dateAct = date.split(" ");
                    var MDate = dateAct[0];
                    var datearray = MDate.split("/");
                    var newdate = datearray[1] + '/' + datearray[0] + '/' + datearray[2];
                    $("#PostingDate").text(newdate);
                    $("#appRemarks").text(topData[0].ProjectPurchase_ApprovalRemarks);
                    $.ajax({
                        type: "POST",
                        url: "OrderApproval.aspx/GetListData",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                    ...
                    HideDoneRej(topData[0].ProjectPurchase_ApproveStatus);
                    AddRejButtons(topData[0].ProjectPurchase_ApproveStatus)
                }
        ...
        function createRows(data) {
            ...
            for (i = 0; i < data.length; i++) {
                tableRow += "<tr>";
                tableRow += "<td>" + data[i].OrderDetailsId + "</td>"
        ...
        function DoneRejectSubmit() {
            ...
            if (validate == true) {
                ...
                var Order_ApprovalRemarks = $("#appRemarks").val();
                //rev Pratik
                ...
                $.ajax({
                    type: "POST",
                    url: "OrderApproval.aspx/JobStatusUpdate",
                    data: JSON.stringify({ AppRej: AppRej, Order_ApprovalRemarks: Order_ApprovalRemarks, udtOrderDetailsAction: myTableArray, Order_Id: Order_Id }),
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <div class="box">
                ...
                <div>
                    <span class="hdtec">IndentNo : </span> 
                    <span id="IndentNo" class="inp"></span>
                </div>
                <div>
