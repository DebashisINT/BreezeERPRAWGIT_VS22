<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BranchRequisitionView.aspx.cs" Inherits="ServiceManagement.ServiceManagement.Transaction.BranchRequisitionView.BranchRequisitionView" %>
   ...
   <style>
    ...
    <script>
        ...
        $(function () {
            ...
            $.ajax({
                type: "POST",
                url: "BranchRequisitionView.aspx/GetData",
                ...
                success: function (data) {
                    ...
                    var date = topData[0].Indent_RequisitionDate;
                    ...
                    $.ajax({
                        type: "POST",
                        url: "BranchRequisitionView.aspx/GetListData",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
