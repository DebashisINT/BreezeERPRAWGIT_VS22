<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="SchemeDirectorApproval.aspx.cs" Inherits="ServiceManagement.STBManagement.STBSchemeDirectorApproval.SchemeDirectorApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function TotalCancelation() {
            //WorkingRoster();
            //if (rosterstatus) {
            $("#hdnFilterby").val('Cancel');
            $("#hdnFilterByStatus").val('Cancel');
            $("#hfIsFilter").val('Y');
            $('.circulerUl>li').removeClass('activeCrcl').addClass('ds');
        ...
        function ApproveDocument() {
            ...
            $.ajax({
                type: "POST",
                url: "SchemeDirectorApproval.aspx/ApproveDocument",
        ...
        function ButtonCount() {
            $.ajax({
                type: "POST",
                url: "SchemeDirectorApproval.aspx/CountButton",
    ...
    <script>
        function ClickOnApproval(val) {
            //WorkingRoster();
            //if (rosterstatus) {
            var uri = "../STBSchemeReceived/STBSchemeReceivedAdd.aspx?id=" + val + "&Key=edit&status=1";
    ...
    <script>
        ...
        function ClickOnViewDetails(values) {
            setTimeout(function () {
                $.ajax({
                    type: "POST",
                    url: "SchemeDirectorApproval.aspx/SchemeReceivedDetails",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <span class="hddd font-pp">STB Scheme - Director Approval</span>
    <div class="">
        <div class="clearfix font-pp">
            <div class="clearfix text-center ">
                <ul class="circulerUl">
                    <% if (rights.CanHolds && rights.CanDirectorApproval && rights.CanCancel)
                       { %>
                    <li id="d1">
                    ...
                    <% if (rights.CanCancel)
                       { %>
                    <li id="d6">
                        <div class="crcl red" onclick="TotalCancelation();">
                            <div id="divCancel" runat="server">0</div>
                            <i class="fa fa-check-circle icn"></i>
                        </div>
                        <div class="colRed">Cancel</div>
                    </li>
                    <% } %>
                </ul>
            </div>
                           ...
                           <div class="floatedIcons">
                            <div class='floatedBtnArea'>                           
                                <% if (rights.CanApproved)
                                   { %>
                                 <a href="javascript:void(0);" onclick="ClickOnApproval('<%# Container.KeyValue %>')" id="a_ApprovalSTBReq" class="pad onlyMonitorLink" title="Approve" style=''>
