<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ReturnRequisition.aspx.cs" Inherits="ServiceManagement.STBManagement.ReturnRequisition.ReturnRequisition" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../JS/ReturnRequisition.js?v=2.0"></script>
    <style>
        .mtop8 {
            margin-top: 8px;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading clearfix">
        <div class="panel-title pull-left">
            <h3>
                <%--Add Return Requisition--%>
                <span id="spnHeaderName">
                    <asp:Label runat="server" ID="HeaderName"></asp:Label></span>
            </h3>
        </div>
        <div id="divcross" runat="server" class="crossBtn"><a href="ReturnRequisitionList.aspx"><i class="fa fa-times"></i></a></div>
    </div>
    <div class="form_main clearfix">
        ...
        <div class="pmsForm slick boxModel clearfix" style="border-radius: 0 0 5px 5px" id="divDetails1EntryLeven" runat="server">
            <div class="row">
                <div class="col-md-2">
                    <label>Model  </label>
                    <div class="dropDev">
                        <dxe:ASPxComboBox ID="ddlModel" runat="server" ClientInstanceName="cddlModel" Width="100%" OnCallback="ddlModel_CustomCallback">
        ...
        <div style="margin-top: 2px;">
            <div class="row">
                <div class="col-md-12" style="padding-left: 15px;">
                    ...
                    <dxe:GridViewDataTextColumn Caption="OSTB Vendor " FieldName="OSTBVendor"
        ...
        <div class="headerPy hide">Payment Details</div>
        <div class="pmsForm slick boxModel clearfix hide" style="border-radius: 0 0 5px 5px">
            <div class="row">
                <div class="col-md-3">
                    <%--<label>&nbsp;</label>--%>
                    <div class="checkbox">
                ...
                <div class="col-md-6">
                    <div class="checkbox">
                        <div class="col-md-5">Payment related remarks/notes</div>
                        <div class="col-md-6">
                            <div>
        ...
        <asp:HiddenField runat="server" ID="hdnIsAproval" />
          ...
          <asp:HiddenField runat="server" ID="hdnIsEntityInformationEditableInReturnReq" />
</asp:Content>
