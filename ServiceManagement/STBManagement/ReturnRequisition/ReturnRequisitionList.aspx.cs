...
{
    public partial class ReturnRequisitionList : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string DeleteReturnRequisition(int ReturnRequisitionID)
        {
            ...
            try
            {
                if (HttpContext.Current.Session["userid"] != null)
                {
                    ...
                    proc.AddIntegerPara("@ReturnRequisitionID", ReturnRequisitionID);
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                ...
                if (strBranchID == "0")
                {
                    ...
                    var q = from d in dc.V_STB_ReturnRequisitionLists
        ...
        protected void cmbExport_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Status == "true")
            {
                exporter.GridViewID = "GrdReturnRequisition";
                string filename = "ReturnRequisition";
                exporter.FileName = filename;

                exporter.PageHeader.Left = "Return Requisition";
        ...
        [WebMethod]
        public static string CancelReturnRequisitionOnRequest(string keyValue, string Reason)
        {
            CRMSalesOrderDtlBL objCRMSalesOrderDtlBL = new CRMSalesOrderDtlBL();
            int CancelRecharge = 0;
            CancelRecharge = ClosedCancelReturnRequisitionOnRequest("CancelReturnRequisition", keyValue, Reason);
            return Convert.ToString(CancelRecharge);

        }

        public static int ClosedCancelReturnRequisitionOnRequest(String Action, string KeyVal, string Reason)
        {
            int i;
            int rtrnvalue = 0;
            int user_id = Convert.ToInt32(HttpContext.Current.Session["userid"]);
