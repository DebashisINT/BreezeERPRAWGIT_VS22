<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/PopUp.Master" AutoEventWireup="true" CodeBehind="reqApproval.aspx.cs" Inherits="ServiceManagement.STBManagement.reqApprovalM.reqApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnClickDelete(val) {
            jConfirm('Confirm Delete?', 'Alert', function (r) {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: "reqApproval.aspx/DeleteData",
                        data: JSON.stringify({ HiddenID: val }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (msg) {
        ...
        function AddDetails2Device() {
            ...
            $.ajax({
                type: "POST",
                url: "reqApproval.aspx/AddDetails2Data",
                data: JSON.stringify({
                    Model: Model,
                    UnitPrice: UnitPrice,
                    Quantity: Quantity,
        ...
        function ClickOnDetails2Edit(val) {
            ...
            $.ajax({
                type: "POST",
                url: "reqApproval.aspx/EditDetails2Data",
                data: JSON.stringify({ HiddenID: val }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
        ...
        function OnClickDetails2Delete(val) {
            jConfirm('Confirm Delete?', 'Alert', function (r) {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: "reqApproval.aspx/DeleteDetails2Data",
                        data: JSON.stringify({ HiddenID: val }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (msg) {
        ...
        function ddlDetails2Model_ValueChange() {
            ...
            $.ajax({
                type: "POST",
                url: "reqApproval.aspx/GetUnitPrice",
                data: JSON.stringify({
