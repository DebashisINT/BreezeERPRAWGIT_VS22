<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="ServiceManagement.STBManagement.Search.search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../JS/SearchSTB.js?V=2.26"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form_main">
        ...
        <div class=" boxModel clearfix mBot10 mTop5 hide" style="background: rgb(249, 249, 249); display: block; border-radius: 0; border-style: dashed">
            <div class="row">
                <div class="col-md-2">
                    ...
                    <div>
                        <div class="relative">
                            <select id="idType" class="form-control">
                                ...
                                <option value="2">Wallet Recharge</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div id="DivSTBReturnCancelData" class="pmsForm slick boxModel clearfix" style="border-radius: 0 0 5px 5px">
                    <div class="row ">
                        ...
                        <div class="col-md-2 trY">
                            <label class="">No Payment (Due): </label><span id="spnNoPaymentReturn"></span>
                        </div>
                        <div class="col-md-6 trY">
                            <label class="">Payment related remarks/notes:</label>
                            <div>
