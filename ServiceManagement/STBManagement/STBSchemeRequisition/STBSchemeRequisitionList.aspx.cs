...
{
    public partial class STBSchemeRequisitionList : System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/STBSchemeRequisition/STBSchemeRequisitionList.aspx");
            ...
            if (!IsPostBack)
            {
                ProcedureExecute procd = new ProcedureExecute("Prc_STBSchemeReceivedPendingRequisitionCloseCount");
                procd.AddPara("@BranchID", userbranch);
                DataTable dtCount = procd.GetTable();

                if (dtCount != null && dtCount.Rows.Count > 0)
                {
                    divPendingRequisitionClose.InnerHtml = Convert.ToString(dtCount.Rows[0]["PendingRequisitionClose"]);
                }
                else
                {
                    divPendingRequisitionClose.InnerHtml = "0";
                }
            }
        }
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                ...
                if (strBranchID == "0")
                {
                    ...
                    var q = from d in dc.V_STBSchemePendingRequisitionLists
        ...
        public static STB_ButtonCount CountButton(String UserType)
        {
            ...
            if (HttpContext.Current.Session["userid"] != null)
            {
                ...
                if (dtCount != null && dtCount.Rows.Count > 0)
                {
                    ...
                    {
                        ret.PendingRequisitionClose = item["PendingRequisitionClose"].ToString();
                        break;
                    }
                }
            }
        ...
        {
            public String PendingRequisitionClose { get; set; }
        }
