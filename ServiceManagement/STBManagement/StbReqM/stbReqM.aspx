<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="stbReqM.aspx.cs" Inherits="ServiceManagement.STBManagement.StbReqM.stbReqM" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function AddDetails2Device() {
            ...
            $.ajax({
                type: "POST",
                url: "stbReqM.aspx/AddDetails2Data",
                data: JSON.stringify({
                    Model: Model,
                    UnitPrice: UnitPrice,
                    Quantity: Quantity,
        ...
        function ClickOnDetails2Edit(val) {
            ...
            $.ajax({
                type: "POST",
                url: "stbReqM.aspx/EditDetails2Data",
                data: JSON.stringify({ HiddenID: val }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
        ...
        function OnClickDetails2Delete(val) {
            jConfirm('Confirm Delete?', 'Alert', function (r) {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: "stbReqM.aspx/DeleteDetails2Data",
                        data: JSON.stringify({ HiddenID: val }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (msg) {
            ...
            <div class="clearfix">
                ...
                <div class="row">
                    <div>
                        ...
                        <div class="col-md-3">
                            <label id="divEmployee" class="hide"><div>Employee</div></label>
