<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ServiceManagement.STBManagement.WalletRecharge.index" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function OnAddButtonClick() {
            WorkingRoster();
            if (rosterstatus) {
                var url = '/STBManagement/WalletRecharge/WalletAdd.aspx?Key=Add';
        ...
        function ClickOnEdit(id) {
            WorkingRoster();
            if (rosterstatus) {
                location.href = "WalletAdd.aspx?id=" + id + "&Key=edit";
            }
            else {
                //jAlert("Working period is over. Try in next working period.");
                $("#divPopHead").removeClass('hide');
        ...
        function ClickOnView(id) {
            WorkingRoster();
            if (rosterstatus) {
                location.href = "WalletAdd.aspx?id=" + id + "&Key=view";
            }
            else {
                // jAlert("Working period is over. Try in next working period.");
                $("#divPopHead").removeClass('hide');
            ...
            if (rosterstatus) {
                jConfirm('Confirm Delete?', 'Alert', function (r) {
                    if (r) {
                        $.ajax({
                            type: "POST",
                            url: "index.aspx/DeleteWalletRecharge",
                            data: JSON.stringify({ WalletRecharge_ID: val }),
                            async: false,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: function (response) {
                                if (response.d) {
                                    if (response.d == "true") {
                                        jAlert("Wallet Recharge delete sucessfully.");
                                        var url = 'index.aspx';
                                        cGrdWalletRechargeList.Refresh();
                                    }
        ...
        function OnCancelClick(keyValue, visibleIndex) {
            ...
            if (rosterstatus) {
                ...
                cGrdWalletRechargeList.SetFocusedRowIndex(visibleIndex);
                jConfirm('Do you want to cancel the Wallet Recharge ?', 'Confirm Dialog', function (r) {
                    if (r == true) {
        ...
        function OnCloseClick(keyValue, visibleIndex) {
            ...
            cGrdWalletRechargeList.SetFocusedRowIndex(visibleIndex);
            jConfirm('Do you want to close the Wallet Recharge ?', 'Confirm Dialog', function (r) {
                if (r == true) {
                    $('#MandatoryRemarksFeedback').attr('style', 'display:none;position: absolute; right: -20px; top: 8px;');
                    cPopup_Feedback.Show();
                }
        ...
        function CallFeedback_save() {
            ...
            if (Remarks == "" || Remarks == null) {
                ...
                CancelWalletRecharge(KeyVal, Remarks);
                cGrdWalletRechargeList.Refresh();
            }
            return flag;
        }

        function CancelWalletRecharge(keyValue, Reason) {

            $.ajax({
                type: "POST",
                url: "index.aspx/CancelWalletRechargeOnRequest",
                ...
                success: function (msg) {
                    ...
                    if (status == "1") {
                        ...
                        jAlert("Wallet Recharge is not cancelled.Try again later");
                    }
                    else if (status == "-2") {
                        jAlert("Selected Wallet Recharge is tagged in other module. Cannot proceed.");
                    }
                    else if (status == "-3") {
                        jAlert("Cancellation Requisition is already generated.");
                    }
                    else if (status == "-4") {
                        jAlert("Wallet Recharge is already closed. Cannot proceed.");
                    }
                }
            });
        }
    ...
    <script>
        ...
        function OnclickViewAttachment(obj) {
            WorkingRoster();
            if (rosterstatus) {
                var URL = '../../../OMS/Management/Activities/EntriesDocuments.aspx?idbldng=' + obj + '&type=STBWalletRecharge';
                window.location.href = URL;
            }
            else {
                // jAlert("Working period is over. Try in next working period.");
        ...
        $(document).ready(function () {
            setTimeout(function () {
                if ($('body').hasClass('mini-navbar')) {
                    ...
                    cGrdWalletRechargeList.SetWidth(cntWidth);
                } else {
                    var windowWidth = $(window).width();
        ...
        <table class="TableMain100" style="width: 100%">
                        ...
                        <tr>
                            <td id="ShowFilter">
                                ...
                                <a href="javascript:void(0);" onclick="javascript:OnAddButtonClick();" class="btn btn-success btn-radius">
                                    <span class="btn-icon"><i class="fa fa-plus"></i></span>Recharge</a>
                                <%} %>
                                <% if (rights.CanExport)
                                   { %>
            ...
            <tr>
                <td class="gridcellcenter relative" colspan="2">
                    <dxe:ASPxGridView ID="GrdWalletRecharge" runat="server" KeyFieldName="WalletRecharge_ID" AutoGenerateColumns="False" SettingsBehavior-AllowFocusedRow="true"
                        ...
                        Width="100%" ClientInstanceName="cGrdWalletRechargeList">
                        <settingssearchpanel visible="True" delay="5000" />
                        <columns>
                            
                            <dxe:GridViewDataTextColumn FieldName="WalletRecharge_ID" Visible="false" SortOrder="Descending">
                            ...
                            <dxe:GridViewDataTextColumn Caption="Document No" FieldName="DocumentNumber" FixedStyle="Left"
                             ...
                             <dxe:GridViewDataTextColumn Caption="Date" Width="100px" FieldName="DocumentDate" VisibleIndex="3" FixedStyle="Left">
                                <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                            </dxe:GridViewDataTextColumn>

                            <dxe:GridViewDataTextColumn Caption="Amount" FieldName="Amount" VisibleIndex="4" Width="100px">
                            ...
                            <dxe:GridViewDataTextColumn Caption="Location" FieldName="branch_description" VisibleIndex="5" Width="150px">
                                <CellStyle CssClass="gridcellright" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                              ...
                              <dxe:GridViewDataTextColumn Caption="Entity Code" FieldName="EntityCode" VisibleIndex="6" Width="150px">
                                <CellStyle CssClass="gridcellright" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                              ...
                              <dxe:GridViewDataTextColumn Caption="Network Name" FieldName="NetworkName" VisibleIndex="7" Width="150px">
                                <CellStyle CssClass="gridcellright" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                              ...
                              <dxe:GridViewDataTextColumn Caption="Contact Person" FieldName="ContactPerson" VisibleIndex="8" Width="150px">
                                <CellStyle CssClass="gridcellright" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                               ...
                               <dxe:GridViewDataTextColumn Caption="Contact Number" FieldName="ContactNo" VisibleIndex="9" Width="150px">
                                <CellStyle CssClass="gridcellright" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                             ...
                             <dxe:GridViewDataTextColumn Caption="DAS" FieldName="DAS" VisibleIndex="10" Width="150px">
                                <CellStyle CssClass="gridcellright" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                            </dxe:GridViewDataTextColumn>
                             <dxe:GridViewDataTextColumn Caption="Status" FieldName="CancelStatus" VisibleIndex="11" Width="200px">
                                <CellStyle CssClass="gridcellright" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                            ...
                            <dxe:GridViewDataTextColumn Caption="Cancel Reason" FieldName="CancelReason" VisibleIndex="12" Width="200px">
                              ...
                              <dxe:GridViewDataTextColumn Caption="Reject Reason" FieldName="RejectReason" VisibleIndex="13" Width="200px">
                                <CellStyle CssClass="gridcellright" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                            ...
                            <dxe:GridViewDataTextColumn Caption="Print Count" FieldName="PrintCount" VisibleIndex="14" Width="100px">
                                <CellStyle CssClass="gridcellright" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                            </dxe:GridViewDataTextColumn>
                            <dxe:GridViewDataTextColumn Caption="Entered By" FieldName="Create_by" Width="150px" VisibleIndex="15">
                                <CellStyle CssClass="gridcellleft" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                            </dxe:GridViewDataTextColumn>
                              <dxe:GridViewDataTextColumn Caption="Entered On" FieldName="Create_date" Width="150px" VisibleIndex="16">
                              ...
                              <dxe:GridViewDataTextColumn Caption="Updated By" FieldName="Update_by" Width="150px" VisibleIndex="17">
                                <CellStyle CssClass="gridcellleft" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <Settings AutoFilterCondition="Contains" />
                            </dxe:GridViewDataTextColumn>
                              <dxe:GridViewDataTextColumn Caption="Updated On" FieldName="Update_date" Width="150px" VisibleIndex="18">
                                <%--<PropertiesTextEdit DisplayFormatString="dd-MM-yyyy HH:mm:ss"></PropertiesTextEdit>--%>
                                     <CellStyle CssClass="gridcellright" Wrap="true">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                    ...
                    <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                        ContextTypeName="ServicveManagementDataClassesDataContext" TableName="V_STB_WalletRechargeList" />
