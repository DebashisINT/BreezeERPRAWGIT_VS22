...
namespace ServiceManagement.STBManagement.WalletRecharge
{
    public partial class index : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string DeleteWalletRecharge(int WalletRecharge_ID)
        {
            ...
            try
            {
                if (HttpContext.Current.Session["userid"] != null)
                {
                    ...
                    proc.AddIntegerPara("@WalletRecharge_ID", WalletRecharge_ID);
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            e.KeyExpression = "WalletRecharge_ID";
            ...
            if (IsFilter == "Y")
            {
                ...
                if (strBranchID == "0")
                {
                    ...
                    var q = from d in dc.V_STB_WalletRechargeLists
                            ...
                            orderby d.WalletRecharge_ID descending
                            select d;
                    e.QueryableSource = q;
                }
                else
        ...
        {
            exporter.GridViewID = "GrdWalletRecharge";
            string filename = "WalletRecharge";
            exporter.FileName = filename;

            exporter.PageHeader.Left = "Wallet Recharge";
        ...
        [WebMethod]
        public static string CancelWalletRechargeOnRequest(string keyValue, string Reason)
        {
            CRMSalesOrderDtlBL objCRMSalesOrderDtlBL = new CRMSalesOrderDtlBL();
            int CancelRecharge = 0;
            CancelRecharge = ClosedCancelWalletRechargeOnRequest("CancelWalletRecharge", keyValue, Reason);
            return Convert.ToString(CancelRecharge);

        }

        public static int ClosedCancelWalletRechargeOnRequest(String Action, string KeyVal, string Reason)
        {
            int i;
            int rtrnvalue = 0;
            int user_id = Convert.ToInt32(HttpContext.Current.Session["userid"]);
