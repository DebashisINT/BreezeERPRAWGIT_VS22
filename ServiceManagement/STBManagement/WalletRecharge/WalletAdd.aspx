<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="WalletAdd.aspx.cs" Inherits="ServiceManagement.STBManagement.WalletRecharge.WalletAdd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <link href="../../ServiceManagement/Transaction/CSS/SearchPopup.css" rel="stylesheet" />
    <script src="../../ServiceManagement/Transaction/JS/SearchMultiPopup.js"></script>
    ...
    <script src="../JS/WalletRechargeJs.js?v2.0"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading clearfix">
        <div class="panel-title pull-left">
            <h3>
                <%--<span id="HeaderName">Add Wallet Recharge </span>--%>
    ...
    <div class="form_main clearfix">
        <div class="pmsForm slick boxModel clearfix">
            <div class="row" style="margin-top: 5px">
                ...
                <div class="col-md-2 noLabelmargin">
                    ...
                    <div>
                        <asp:TextBox ID="txtDocumentNumber" runat="server" Width="100%" MaxLength="30" CssClass="form-control">                             
                        </asp:TextBox>
                ...
                <div class="col-md-2">
                    <div >
                        <label id="lblCancelMsg" runat="server" class="red" style="background: #fbcccc;
                    padding: 5px;
                    border-radius: 4px;
                    font-weight: 500;
                    text-align: center;
                    margin-top: 21px;
                    font-size: 13px;margin-bottom:0"></label>
                    </div>
                </div>
            ...
            <table class="ptTbl">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <%--<asp:TextBox ID="txtAmount" runat="server" Width="95%" MaxLength="30" CssClass="form-control"> </asp:TextBox>--%>
                            <div class="dropDev ">
                                <dxe:ASPxTextBox ID="txtAmount" ClientInstanceName="ctxtAmount" runat="server" Width="100%">
        ...
        <div class="row">
            <div class="col-md-12" style="padding-left: 15px; margin-top: 2px">
        ...
        <div class="headerPy hide" id="DivCancelDetails">Cancellation Details</div>
            ...
            <%--    class="pmsForm slick boxModel clearfix" style="border-radius: 0 0 5px 5px"--%>
                <div class="col-md-6">
                    <label class="red">Reason For Cancellation Request:</label>
                    <div>
                        <textarea class="form-control textareaBig" id="txtReasonCancel" maxlength="500" runat="server" disabled></textarea>
                    </div>
                </div>
                <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mtop8">
                <p class="red">( Remember minimum wallet payment is Rs.5000 and for Cash mode, maximum payment you can take is Rs.20000 )</p>
            </div>
            <div class="col-md-12 mtop8">
                ...
                <div id="divPrintCount" class="hide" style="font-size: large;">
    ...
    <asp:HiddenField runat="server" ID="hdnWalletRechargeID" />
