<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="setTopBox.aspx.cs" Inherits="ServiceManagement.STBManagement.STB.setTopBox" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnAddButtonClick() {
            WorkingRoster();
            if (rosterstatus) {
                var url = '/STBManagement/STB/setTopBoxAdd.aspx?Key=Add';
            ...
            if (rosterstatus) {
                jConfirm('Confirm Delete?', 'Alert', function (r) {
                    if (r) {
                        $.ajax({
                            type: "POST",
                            url: "setTopBox.aspx/DeleteSetTopBox",
                            data: JSON.stringify({ SetTopBox_ID: val }),
                            async: false,
                            ...
                            success: function (response) {
                                if (response.d) {
                                    if (response.d == "true") {
                                        jAlert("Set Top Box delete sucessfully.");
                                        var url = 'setTopBox.aspx';
                                        cgridSetTopBox.Refresh();
                                    }
        ...
        function ClickOnEdit(id) {
            WorkingRoster();
            if (rosterstatus) {
                location.href = "setTopBoxAdd.aspx?id=" + id + "&Key=edit";
            }
            else {
                $("#divPopHead").removeClass('hide');
            }
        ...
        function ClickOnView(id) {
            WorkingRoster();
            if (rosterstatus) {
                location.href = "setTopBoxAdd.aspx?id=" + id + "&Key=view";
            }
            else {
                $("#divPopHead").removeClass('hide');
            }
        ...
        function gridRowclick(s, e) {
            $('#gridSetTopBox').find('tr').removeClass('rowActive');
        ...
        function WorkingRoster() {
            $.ajax({
                type: "POST",
                url: 'setTopBox.aspx/CheckWorkingRoster',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        <table class="TableMain100" style="width: 100%">
            ...
            <tr>
                ...
                <td class="gridcellcenter relative" colspan="2">
                    <dxe:ASPxGridView ID="gridSetTopBox" runat="server" KeyFieldName="SetTopBox_Id" AutoGenerateColumns="False" SettingsBehavior-AllowFocusedRow="true"
                        ...
                        Width="100%" ClientInstanceName="cgridSetTopBox">
                        <settingssearchpanel visible="True" delay="5000" />
                        <columns>                           
                            <dxe:GridViewDataTextColumn VisibleIndex="0" FieldName="ModelDesc"
                                Caption="Model-STB-01" Width="150px">
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="1" FieldName="STBModel_Name"
                                Caption="Model-STB-02" Width="150px">
                                <CellStyle CssClass="gridcellleft" Wrap="True">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <EditFormSettings Visible="False"></EditFormSettings>
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="STBType"
                                Caption="STB Type" Width="150px">
                                <CellStyle CssClass="gridcellleft" Wrap="True">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <EditFormSettings Visible="False"></EditFormSettings>
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="Manufacturer_Name"
                                Caption="Manufacturer" Width="150px">
                                <CellStyle CssClass="gridcellleft" Wrap="True">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <EditFormSettings Visible="False"></EditFormSettings>
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="4" FieldName="PriceDAS1"
                                Caption="DAS - I" Visible="True" Width="100px">
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="5" FieldName="PriceDAS2"
                                Caption="DAS - II" Visible="true" Width="100px">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <EditFormSettings Visible="False"></EditFormSettings>
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="6" FieldName="PriceDAS3"
                                Caption="DAS - III" Visible="True" Width="100px">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <EditFormSettings Visible="False"></EditFormSettings>
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="7" FieldName="PriceDAS4"
                                Caption="DAS - IV" Visible="True" Width="100px">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <Settings AllowAutoFilterTextInputTimer="False" />
                                <EditFormSettings Visible="False"></EditFormSettings>
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="8" FieldName="IsActive"
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="9" FieldName="CreatedOn"
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="10" FieldName="CreatedBy"
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="11" FieldName="UpdatedOn"
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="12" FieldName="UpdatedBy"
                    ...
                    <dx:LinqServerModeDataSource ID="EntityServerModeDataSource" runat="server" OnSelecting="EntityServerModeDataSource_Selecting"
                        ContextTypeName="ServicveManagementDataClassesDataContext" TableName="V_STB_SetTopBoxList" />
