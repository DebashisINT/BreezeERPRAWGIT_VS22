...
namespace OpeningBusinessLogic.Customerconsolidate
{
    ...
    public class Consolidatecustomer
    {
        ...
        public int InsertReplacementDetails(string modelXML, string Action,string Amount,string type,string CusID,int ModId,Int64 Project_id,string RetAmount,string Gl,DateTime? DueDate)
        {
            int i;
            int rtrnvalue = 0;
